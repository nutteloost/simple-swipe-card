const t="2.0.0",i={cards:[],show_pagination:!0,card_spacing:15,enable_loopback:!1,swipe_direction:"horizontal",enable_auto_swipe:!1,auto_swipe_interval:2e3,enable_reset_after:!1,reset_after_timeout:3e4,reset_target_card:1},e=8,s=300,n=.3,o="_simpleSwipeEditorRegistry",a="_simpleSwipeCardEditors",r={EDITOR:!0,EVENT:!0,CONFIG:!0,SWIPE:!0,ERROR:!0,INIT:!0,SYSTEM:!0,ELEMENT:!0,AUTO:!1,CARD_MOD:!0,VISIBILITY:!0,RESET:!0},d=new Map,c=(t,...i)=>{if(!1===r[t])return;const e=`${t}:${i[0]}`,s=Date.now();if(d.has(e)){if(s-d.get(e)<5e3)return}(["AUTO","SWIPE","VISIBILITY"].includes(t)||["Setting hass","Visible cards updated","Auto-swipe","Updating slider"].some(t=>i[0]&&i[0].toString().includes(t)))&&d.set(e,s)};let h,l,p,u;try{if(window.customElements&&window.customElements.get("ha-card")){const t=customElements.get("ha-card").__proto__.constructor.__proto__.constructor;h=t,l=window.lit?.html||window.LitElement?.html,p=window.lit?.css||window.LitElement?.css,c("SYSTEM","Using Home Assistant built-in LitElement")}}catch(t){c("SYSTEM","Could not use built-in LitElement, will try CDN fallback:",t.message)}if(!h||!l||!p){const t=async()=>{try{const t=["https://cdn.jsdelivr.net/npm/lit-element@2.5.1/+esm","https://unpkg.com/lit-element@2.5.1/lit-element.js?module","https://cdn.skypack.dev/lit-element@2.5.1"];let i=!1;for(const e of t)try{c("SYSTEM",`Attempting to load LitElement from: ${e}`);const t=await import(e);h=t.LitElement,l=t.html,p=t.css,i=!0,c("SYSTEM",`Successfully loaded LitElement from: ${e}`);break}catch(t){console.warn(`SimpleSwipeCard: Failed to load from ${e}:`,t.message)}if(!i)throw new Error("Could not load LitElement from any CDN source")}catch(t){console.error("SimpleSwipeCard: All LitElement loading attempts failed:",t),c("SYSTEM","Using emergency HTMLElement fallback with polyfills"),h=HTMLElement,l=(t,...i)=>t.reduce((t,e,s)=>t+e+(i[s]||""),""),p=t=>t[0]}};try{await t()}catch(t){c("SYSTEM","Emergency fallback initialization failed, using minimal polyfills"),h=HTMLElement,l=(t,...i)=>t.reduce((t,e,s)=>t+e+(i[s]||""),""),p=t=>t[0]}}try{if(window.customCards&&window.fireEvent)u=window.fireEvent,c("SYSTEM","Using Home Assistant global fireEvent");else{const t=await import("https://unpkg.com/custom-card-helpers@^1?module");u=t.fireEvent,c("SYSTEM","Loaded fireEvent from custom-card-helpers")}}catch(t){c("SYSTEM","Using fallback fireEvent implementation"),u=(t,i,e={})=>{const s=new CustomEvent(i,{detail:e,bubbles:!0,composed:!0});t.dispatchEvent(s)}}function g(){return window.loadCardHelpers?window.loadCardHelpers():Promise.resolve({createCardElement:async t=>{const i=document.createElement("div");return i.innerHTML=`\n        <ha-card>\n          <div style="padding: 16px; text-align: center;">\n            <ha-icon icon="mdi:alert-circle" style="color: var(--warning-color); margin-bottom: 8px;"></ha-icon>\n            <div>Card type "${t.type}" not available offline</div>\n            <div style="font-size: 12px; color: var(--secondary-text-color); margin-top: 8px;">\n              This card requires an internet connection to load properly.\n            </div>\n          </ha-card>\n        </div>\n      `,i.firstElementChild},createErrorCardElement:(t,i)=>{const e=document.createElement("div");return e.innerHTML=`\n        <ha-card>\n          <div style="padding: 16px; text-align: center; color: var(--error-color);">\n            <ha-icon icon="mdi:alert" style="margin-bottom: 8px;"></ha-icon>\n            <div>Error: ${i}</div>\n          </div>\n        </ha-card>\n      `,e.firstElementChild}})}function m(t,i){return!t||!Array.isArray(t)||0===t.length||(i?t.every(t=>{try{return function(t,i){if(!t||"object"!=typeof t)return!0;const{condition:e,entity:s,state:n,state_not:o}=t;switch(e){case"state":{if(!s||!i.states[s])return c("VISIBILITY",`Entity ${s} not found for state condition`),!1;const t=i.states[s].state;if(void 0!==n){const i=String(n),e=String(t),o=e===i;return c("VISIBILITY",`State condition: ${s} = ${e}, expected: ${i}, result: ${o}`),o}if(void 0!==o){const i=String(o),e=String(t),n=e!==i;return c("VISIBILITY",`State not condition: ${s} = ${e}, not expected: ${i}, result: ${n}`),n}return!0}case"numeric_state":{if(!s||!i.states[s])return c("VISIBILITY",`Entity ${s} not found for numeric_state condition`),!1;const e=parseFloat(i.states[s].state);if(isNaN(e))return!1;let n=!0;return void 0!==t.above&&(n=n&&e>parseFloat(t.above)),void 0!==t.below&&(n=n&&e<parseFloat(t.below)),c("VISIBILITY",`Numeric state condition: ${s} = ${e}, result: ${n}`),n}case"screen":{const i=t.media_query;if(i&&window.matchMedia){const t=window.matchMedia(i).matches;return c("VISIBILITY",`Screen condition: ${i}, result: ${t}`),t}return!0}case"user":if(t.users&&Array.isArray(t.users)){const e=i.user;if(e&&e.id){const i=t.users.includes(e.id);return c("VISIBILITY",`User condition: current user ${e.id}, allowed users: ${t.users}, result: ${i}`),i}}return!0;default:return c("VISIBILITY",`Unknown condition type: ${e}`),!0}}(t,i)}catch(i){return c("VISIBILITY","Error evaluating condition:",t,i),!0}}):(c("VISIBILITY","No hass object available for condition evaluation"),!0))}class v{constructor(t){this.card=t,this.t=!1,this.i=0,this.o=0,this.h=0,this.l=0,this.p=0,this.u=0,this.m=!1,this.v=!1,this.S=0,this.I=0,this.T=!1,this.C=e,this.$=null,this.N=!1,this.k=s,this._=0,this.R=n,this.D=this.O.bind(this),this.A=this.M.bind(this),this.L=this.P.bind(this),this.V=this.M.bind(this),this.H=this.P.bind(this),this.W=this.Y.bind(this),this.F=this.U.bind(this)}removeGestures(){c("SWIPE","Attempting to remove swipe listeners."),this.card.cardContainer&&(this.card.cardContainer.removeEventListener("touchstart",this.D,{passive:!0}),this.card.cardContainer.removeEventListener("touchmove",this.A,{passive:!1}),this.card.cardContainer.removeEventListener("touchend",this.L,{passive:!0}),this.card.cardContainer.removeEventListener("touchcancel",this.L,{passive:!0}),this.card.cardContainer.removeEventListener("mousedown",this.D,{passive:!1}),this.card.cardContainer.removeEventListener("click",this.W,{capture:!0,passive:!1}),this.card.cardContainer.removeEventListener("pointerdown",this.F,{capture:!0,passive:!1}),this.card.cardContainer.removeEventListener("pointerup",this.F,{capture:!0,passive:!1}),c("SWIPE","Removed swipe listeners from cardContainer.")),window.removeEventListener("mousemove",this.V,{passive:!1}),window.removeEventListener("mouseup",this.H,{passive:!0}),c("SWIPE","Removed potential swipe listeners from window."),this.t=!1,this.m=!1,this.$&&(clearTimeout(this.$),this.$=null,this.N=!1)}addGestures(){this.removeGestures(),!this.card.cardContainer||this.card.visibleCardIndices.length<=1||!this.card.initialized?c("SWIPE","Skipping addSwiperGesture",{container:!!this.card.cardContainer,visibleCount:this.card.visibleCardIndices.length,init:this.card.initialized}):(c("SWIPE","Adding swipe listeners with click prevention."),this.card.cardContainer.addEventListener("touchstart",this.D,{passive:!0}),this.card.cardContainer.addEventListener("touchmove",this.A,{passive:!1}),this.card.cardContainer.addEventListener("touchend",this.L,{passive:!0}),this.card.cardContainer.addEventListener("touchcancel",this.L,{passive:!0}),this.card.cardContainer.addEventListener("mousedown",this.D,{passive:!1}),this.card.cardContainer.addEventListener("click",this.W,{capture:!0,passive:!1}),this.card.cardContainer.addEventListener("pointerdown",this.F,{capture:!0,passive:!1}),this.card.cardContainer.addEventListener("pointerup",this.F,{capture:!0,passive:!1}))}Y(t){if(this.N||this.t)return c("SWIPE","Click prevented during/after swipe gesture"),t.preventDefault(),t.stopPropagation(),t.stopImmediatePropagation(),!1}U(t){if(this.t&&this.T)return t.preventDefault(),t.stopPropagation(),!1}J(t=this.k){this.N=!0,this._=Date.now(),this.$&&clearTimeout(this.$),this.$=setTimeout(()=>{this.N=!1,this.$=null,c("SWIPE","Click blocking period ended")},t),c("SWIPE",`Blocking clicks for ${t}ms`)}O(t){if(c("SWIPE","Swipe Start:",t.type),this.t||"mousedown"===t.type&&0!==t.button)return void c("SWIPE","Swipe Start ignored (already dragging or wrong button)");if(this.B(t.target))return void c("SWIPE","Swipe Start ignored (interactive element):",t.target);this.t=!0,this.m=!1,this.T=!1,this.I=0,this.S=Date.now(),this.v=!0;const i="touchstart"===t.type?t.touches[0]:t;if(this.i=i.clientX,this.o=i.clientY,this.h=this.i,this.l=this.o,this.u=this.S,this.card.sliderElement){const t=window.getComputedStyle(this.card.sliderElement),i=new DOMMatrixReadOnly(t.transform);this.p=i.m41,"vertical"===this.card.j&&(this.p=i.m42),this.card.sliderElement.style.transition=this.card.X(!1),this.card.sliderElement.style.cursor="grabbing"}"mousedown"===t.type&&(c("SWIPE","Attaching mousemove/mouseup listeners to window"),t.preventDefault(),window.addEventListener("mousemove",this.V,{passive:!1}),window.addEventListener("mouseup",this.H,{passive:!0})),this.card.G.enable_auto_swipe&&this.card.autoSwipe?.pause(5e3)}M(t){if(!this.t)return;const i="touchmove"===t.type?t.touches[0]:t,e=i.clientX,s=i.clientY,n=e-this.i,o=s-this.o,a=Date.now(),r=Math.sqrt(n*n+o*o);this.I=Math.max(this.I,r);const d="horizontal"===this.card.j,h=d?n:o,l=d?o:n;if(!this.m&&Math.abs(l)>Math.abs(h)&&Math.abs(l)>10&&(c("SWIPE",`${d?"Vertical":"Horizontal"} scroll detected, cancelling ${d?"horizontal":"vertical"} drag.`),this.m=!0,this.v=!1),r>this.C&&(this.T=!0),!this.m&&Math.abs(h)>this.C){c("SWIPE",(d?"Horizontal":"Vertical")+" move detected"),t.cancelable&&t.preventDefault(),d?this.h=e:this.l=s;let i=h;if(!(!0===this.card.G.enable_loopback)){const t=0===this.card.currentIndex,e=this.card.currentIndex===this.card.visibleCardIndices.length-1;if(t&&i>0||e&&i<0){i*=.5*(.3+.7/(1+Math.abs(i)/(d?this.card.slideWidth:this.card.slideHeight)*.5))}}const n=this.p+i;this.card.sliderElement&&(this.card.sliderElement.style.transform=d?`translateX(${n}px)`:`translateY(${n}px)`),this.u=a}}P(t){c("SWIPE","Swipe End:",t.type),this.t?("mouseup"===t.type&&(c("SWIPE","Removing mousemove/mouseup listeners from window"),window.removeEventListener("mousemove",this.V),window.removeEventListener("mouseup",this.H)),this.v=!1,Promise.resolve().then(()=>{if(!this.card.sliderElement)return;const i=this.t;if(this.t=!1,this.card.sliderElement.style.transition=this.card.X(!0),this.card.sliderElement.style.cursor="",!i)return void c("SWIPE","Swipe End: Not dragging or already processed.");if(this.m||"touchcancel"===t.type)return c("SWIPE","Swipe End: Scrolling or Cancelled - Snapping back."),this.card.updateSlider(),void(this.m=!1);const e="horizontal"===this.card.j,s=e?this.h-this.i:this.l-this.o,n=Date.now()-this.u,o=n>10?Math.abs(s)/n:0,a=.2*(e?this.card.slideWidth:this.card.slideHeight);let r=this.card.currentIndex;const d=!0===this.card.G.enable_loopback,h=this.card.visibleCardIndices.length;(Math.abs(s)>a||Math.abs(o)>this.R)&&(s>0?this.card.currentIndex>0?r--:d&&h>1&&(r=h-1,c("SWIPE","Loopback: Looping from first to last visible card")):s<0&&(this.card.currentIndex<h-1?r++:d&&h>1&&(r=0,c("SWIPE","Loopback: Looping from last to first visible card")))),r!==this.card.currentIndex?(c("SWIPE",`Swipe resulted in index change to ${r}`),this.card.goToSlide(r),setTimeout(()=>{this.card.isConnected&&!this.card.q&&this.card.resetAfter?.startTimer()},100)):(c("SWIPE","Swipe did not cross threshold or velocity, snapping back."),this.card.updateSlider(!0))})):c("SWIPE","Swipe End ignored (not dragging)")}B(t){if(!t||t===this.card.cardContainer||t===this.card.sliderElement)return!1;const i=t.localName?.toLowerCase(),e=t.getAttribute("role");if(["input","textarea","select","button","a","audio","video","ha-switch","ha-checkbox","mwc-checkbox","paper-checkbox","ha-textfield","ha-slider","paper-slider","ha-control-button","ha-control-select","ha-control-slider","ha-control-button-group","ha-text-input","mwc-button","paper-button","ha-icon-button","paper-icon-button","ha-select","paper-dropdown-menu","vaadin-combo-box","ha-card","hui-entity-button","more-info-content"].includes(i)||e&&["button","checkbox","switch","slider","link","menuitem","textbox","combobox","option"].includes(e))return c("SWIPE","_isInteractiveOrScrollable: Found interactive tag/role:",i||e),!0;if(t.classList.contains("clickable")||t.hasAttribute("clickable")||t.getAttribute("data-domain")||t.closest(".entity, .clickable, [data-domain]"))return c("SWIPE","_isInteractiveOrScrollable: Found clickable element"),!0;if(t.closest("\n            ha-control-button, ha-control-select, ha-control-slider, ha-control-button-group, \n            ha-alert[action], ha-more-info-control, hui-buttons-base, ha-form, ha-formfield, \n            ha-icon-button, mwc-list-item, paper-item, ha-list-item, hui-entity-button,\n            more-info-content, ha-card[clickable], .clickable\n        ".replace(/\s+/g," ").trim()))return c("SWIPE","_isInteractiveOrScrollable: Found interactive ancestor component."),!0;let s=t,n=0;for(;s&&s!==this.card.sliderElement&&s!==this.card.cardContainer&&n<10;){if(s.nodeType===Node.ELEMENT_NODE)try{const t=window.getComputedStyle(s),i=("auto"===t.overflowY||"scroll"===t.overflowY)&&s.scrollHeight>s.clientHeight+1,e=("auto"===t.overflowX||"scroll"===t.overflowX)&&s.scrollWidth>s.clientWidth+1;if(i||e)return c("SWIPE","_isInteractiveOrScrollable: Found scrollable ancestor:",s),!0;if("ha-logbook"===s.localName||"hui-logbook-card"===s.localName||"hui-history-graph-card"===s.localName)return c("SWIPE","_isInteractiveOrScrollable: Found specific scrollable card type:",s.localName),!0}catch(t){c("ERROR","Error accessing style/scroll properties for:",s,t)}s=s.assignedSlot||s.parentNode||(s.getRootNode()instanceof ShadowRoot?s.getRootNode().host:null),n++}return!1}}class f{constructor(t){this.card=t,this.Z=null,this.K=!1,this.tt=null,this.q=!1,this.it=1,this.et=0,this.st=this.nt.bind(this)}manage(){this.card.initialized&&this.card.isConnected&&(this.stop(),this.card.G.enable_auto_swipe&&this.card.visibleCardIndices.length>1&&(c("AUTO","Starting auto-swipe with interval:",this.card.G.auto_swipe_interval),this.start()))}start(){this.Z&&this.stop(),this.it=1,this.K=!1,this.Z=setInterval(this.st,this.card.G.auto_swipe_interval),c("AUTO","Auto-swipe timer started with interval:",this.card.G.auto_swipe_interval)}stop(){this.Z&&(clearInterval(this.Z),this.Z=null,c("AUTO","Auto-swipe timer stopped")),this.tt&&(clearTimeout(this.tt),this.tt=null)}pause(t=5e3){this.card.G.enable_auto_swipe&&(c("AUTO",`Auto-swipe paused for ${t}ms`),this.K=!0,this.tt&&clearTimeout(this.tt),this.tt=setTimeout(()=>{this.K=!1,c("AUTO","Auto-swipe pause ended"),this.card.isConnected&&this.card.G.enable_auto_swipe&&this.start()},t))}nt(){const t=this.card.visibleCardIndices.length;if(!this.card.isConnected||!this.card.initialized||t<=1)return void(this.Z&&(c("AUTO","Stopping auto-swipe, conditions not met or insufficient visible cards."),this.stop()));if(this.card.swipeGestures?.t){const t=Date.now();return void(t-this.et>5e3&&(c("AUTO","Skipping auto-swipe: currently dragging"),this.et=t))}const i=Date.now();let e,s=i-this.et>1e4;this.card.G.enable_loopback?(e=this.card.currentIndex+1,e>=t&&(e=0,s=!0)):(1===this.it?this.card.currentIndex>=t-1?(this.it=-1,e=this.card.currentIndex-1,s=!0):e=this.card.currentIndex+1:this.card.currentIndex<=0?(this.it=1,e=this.card.currentIndex+1,s=!0):e=this.card.currentIndex-1,e=Math.max(0,Math.min(e,t-1))),s&&(c("AUTO",`Auto-swipe: ${this.card.currentIndex} → ${e} (${this.it>0?"forward":"backward"})`),this.et=i),this.q=!0,this.card.goToSlide(e),this.q=!1}get isInProgress(){return this.q}}class w{constructor(t){this.card=t,this.ot=null,this.rt=0,this.dt=!1,this.ct=null,this.ht=this.lt.bind(this)}manage(){this.card.initialized&&this.card.isConnected&&(this.stopTimer(),this.card.G.enable_reset_after&&!this.card.G.enable_auto_swipe&&this.card.visibleCardIndices.length>1?c("RESET","Reset-after feature enabled with timeout:",this.card.G.reset_after_timeout):c("RESET","Reset-after feature disabled",{enabled:this.card.G.enable_reset_after,autoSwipeDisabled:!this.card.G.enable_auto_swipe,multipleCards:this.card.visibleCardIndices.length>1}))}startTimer(){!this.card.G.enable_reset_after||this.card.G.enable_auto_swipe||this.card.visibleCardIndices.length<=1||!this.card.initialized||!this.card.isConnected||(this.stopTimer(),this.rt=Date.now(),c("RESET",`Starting reset-after timer: ${this.card.G.reset_after_timeout}ms`),this.ot=setTimeout(this.ht,this.card.G.reset_after_timeout))}stopTimer(){this.ot&&(clearTimeout(this.ot),this.ot=null,c("RESET","Reset-after timer stopped"))}preserveState(){if(this.card.G.enable_reset_after&&!this.card.G.enable_auto_swipe)if(this.ot){const t=this.card.G.reset_after_timeout-(Date.now()-this.rt);t>1e3?(this.ct={remainingTime:Math.max(1e3,t),targetCard:this.card.G.reset_target_card,wasActive:!0},c("RESET","Preserved reset-after state:",this.ct)):this.ct=null}else this.ct=null;else this.ct=null}restoreState(){this.ct&&this.card.G.enable_reset_after&&!this.card.G.enable_auto_swipe?(this.ct.wasActive&&this.card.visibleCardIndices.length>1&&(c("RESET","Restoring reset-after timer with remaining time:",this.ct.remainingTime),this.rt=Date.now()-(this.card.G.reset_after_timeout-this.ct.remainingTime),this.ot=setTimeout(this.ht,this.ct.remainingTime)),this.ct=null):this.ct=null}lt(){const t=this.card.visibleCardIndices.length;if(!this.card.isConnected||!this.card.initialized||t<=1)return void c("RESET","Reset-after skipped: conditions not met");let i=(parseInt(this.card.G.reset_target_card)||1)-1;const e=i,s=this.card.visibleCardIndices.indexOf(e);if(-1!==s)i=s,c("RESET",`Target card ${this.card.G.reset_target_card} is visible at position ${i}`);else{let t=0;for(let i=0;i<this.card.visibleCardIndices.length;i++)if(this.card.visibleCardIndices[i]>=e){t=i;break}i=t,c("RESET",`Target card ${this.card.G.reset_target_card} not visible, using closest visible card at position ${i}`)}i>=t&&(i=0,c("RESET","Target index out of range, using first visible card")),this.card.currentIndex!==i?(c("RESET",`Performing reset: current=${this.card.currentIndex}, target=${i}, timeout=${this.card.G.reset_after_timeout}ms`),this.dt=!0,this.card.goToSlide(i),this.dt=!1):c("RESET","Reset-after skipped: already at target card")}get isInProgress(){return this.dt}}class b{constructor(t){this.card=t,this.paginationElement=null}create(){this.remove();if(!1!==this.card.G.show_pagination&&this.card.visibleCardIndices.length>1){c("INIT","Creating pagination for",this.card.visibleCardIndices.length,"visible cards"),this.paginationElement=document.createElement("div"),this.paginationElement.className=`pagination ${this.card.j}`;for(let t=0;t<this.card.visibleCardIndices.length;t++){const i=document.createElement("div");i.className="pagination-dot",t===this.card.currentIndex&&i.classList.add("active"),i.addEventListener("click",i=>{i.stopPropagation(),this.card.goToSlide(t)}),this.paginationElement.appendChild(i)}this.card.shadowRoot.appendChild(this.paginationElement),this.card.ut&&this.card.gt()}}update(){if(this.paginationElement){this.paginationElement.querySelectorAll(".pagination-dot").forEach((t,i)=>{t.classList.toggle("active",i===this.card.currentIndex)})}}updateLayout(){!1!==this.card.G.show_pagination&&this.card.visibleCardIndices.length>1?this.paginationElement?this.paginationElement.style.display="flex":this.create():this.paginationElement&&(this.paginationElement.style.display="none")}remove(){this.paginationElement&&(this.paginationElement.remove(),this.paginationElement=null)}}function E(t,i,e={}){try{u(t,i,e)}catch(s){c("ERROR","Failed to fire HA event:",i,s);const n=new CustomEvent(i,{detail:e,bubbles:!0,composed:!0});t.dispatchEvent(n)}}function x(t,i="Map"){return window[t]||(window[t]="Set"===i?new Set:new Map),window[t]}class y{constructor(t){this.card=t}async build(){if(this.card.building)return void c("INIT","Build already in progress, skipping.");if(!this.card.G||!this.card.G.cards||!this.card.isConnected)return void c("INIT","Build skipped (no config/cards or not connected).");this.card.building=!0,c("INIT","Starting build..."),this.card.resetAfter?.preserveState(),this.card.cards=[],this.card.currentIndex=0,this.card.resizeObserver?.cleanup(),this.card.swipeGestures?.removeGestures(),this.card.autoSwipe?.stop(),this.card.resetAfter?.stopTimer(),this.card.shadowRoot&&(this.card.shadowRoot.innerHTML="");const t=this.card.shadowRoot,i=await g();if(!i)return console.error("SimpleSwipeCard: Card helpers not loaded."),t.innerHTML='<ha-alert alert-type="error">Card Helpers are required for this card to function. Please ensure they are loaded.</ha-alert>',this.card.building=!1,void(this.card.initialized=!1);const e=document.createElement("style");if(e.textContent='\n     :host {\n        display: block;\n        overflow: hidden;\n        width: 100%;\n        height: 100%;\n        position: relative;\n        border-radius: var(--ha-card-border-radius, 12px);\n        background: transparent;\n     }\n\n     /* --- START PREVIEW STYLES --- */\n     .preview-container {\n        display: flex;\n        flex-direction: column;\n        align-items: center;\n        justify-content: center;\n        text-align: center;\n        padding: 16px;\n        box-sizing: border-box;\n        height: 100%;\n        background: var(--ha-card-background, var(--card-background-color, white));\n        border-radius: var(--ha-card-border-radius, 12px);\n        border: none; /* Ensure no border */\n     }\n     .preview-icon-container {\n        margin-bottom: 16px;\n     }\n     .preview-icon-container ha-icon {\n        color: var(--primary-color, #03a9f4); /* Use primary color for consistency */\n        font-size: 48px; /* Match Actions Card */\n        width: 48px;\n        height: 48px;\n     }\n     .preview-text-container {\n        margin-bottom: 16px;\n     }\n     .preview-title {\n        font-size: 18px;\n        font-weight: bold;\n        margin-bottom: 8px;\n        color: var(--primary-text-color);\n     }\n     .preview-description {\n        font-size: 14px;\n        color: var(--secondary-text-color);\n        max-width: 300px;\n        line-height: 1.4;\n        margin: 0 auto; /* Center description text block */\n     }\n     .preview-actions ha-button {\n       /* Rely on default raised button styles for consistency */\n     }\n     /* --- END PREVIEW STYLES --- */\n\n     .card-container {\n        position: relative;\n        width: 100%;\n        height: 100%;\n        overflow: hidden;\n        border-radius: inherit;\n        background: transparent;\n     }\n     .slider {\n        position: relative;\n        display: flex;\n        height: 100%;\n        transition: transform var(--simple-swipe-card-transition-speed, 0.3s) var(--simple-swipe-card-transition-easing, ease-out);\n        will-change: transform;\n        background: transparent;\n     }\n     \n     /* Horizontal slider (default) */\n     .slider[data-swipe-direction="horizontal"] {\n        flex-direction: row;\n     }\n     \n     /* Vertical slider */\n     .slider[data-swipe-direction="vertical"] {\n        flex-direction: column;\n     }\n     \n     .slide {\n        flex: 0 0 100%;\n        width: 100%;\n        min-width: 100%;\n        height: 100%;\n        min-height: 100%;\n        box-sizing: border-box;\n        position: relative;\n        display: flex;\n        flex-direction: column;\n        overflow: hidden;\n        background: transparent;\n     }\n    .pagination {\n        position: absolute;\n        display: flex;\n        justify-content: center;\n        z-index: 1;\n        background-color: var(--simple-swipe-card-pagination-background, transparent);\n        pointer-events: auto;\n        transition: opacity 0.2s ease-in-out;\n        padding: var(--simple-swipe-card-pagination-padding, 4px 8px);\n        border-radius: 12px;\n    }\n    \n    /* Horizontal pagination (bottom) */\n    .pagination.horizontal {\n        bottom: var(--simple-swipe-card-pagination-bottom, 8px);\n        left: 50%;\n        transform: translateX(-50%);\n        flex-direction: row;\n    }\n    \n    /* Vertical pagination (right) */\n    .pagination.vertical {\n        right: var(--simple-swipe-card-pagination-right, 8px);\n        top: 50%;\n        transform: translateY(-50%);\n        flex-direction: column;\n    }\n    \n     .pagination.hide {\n        opacity: 0;\n        pointer-events: none;\n     }\n    .pagination-dot {\n        width: var(--simple-swipe-card-pagination-dot-size, 8px);\n        height: var(--simple-swipe-card-pagination-dot-size, 8px);\n        border-radius: var(--simple-swipe-card-pagination-border-radius, 50%);\n        background-color: var(--simple-swipe-card-pagination-dot-inactive-color, rgba(127, 127, 127, 0.6));\n        cursor: pointer;\n        transition: background-color 0.2s ease, width 0.2s ease, height 0.2s ease;\n        border: none;\n        opacity: var(--simple-swipe-card-pagination-dot-inactive-opacity, 1);\n    }\n    \n    /* Spacing for horizontal pagination dots */\n    .pagination.horizontal .pagination-dot {\n        margin: 0 var(--simple-swipe-card-pagination-dot-spacing, 4px);\n    }\n    \n    /* Spacing for vertical pagination dots */\n    .pagination.vertical .pagination-dot {\n        margin: var(--simple-swipe-card-pagination-dot-spacing, 4px) 0;\n    }\n    \n    .pagination-dot.active {\n        background-color: var(--simple-swipe-card-pagination-dot-active-color, var(--primary-color, #03a9f4));\n        width: var(--simple-swipe-card-pagination-dot-active-size, var(--simple-swipe-card-pagination-dot-size, 8px));\n        height: var(--simple-swipe-card-pagination-dot-active-size, var(--simple-swipe-card-pagination-dot-size, 8px));\n        opacity: var(--simple-swipe-card-pagination-dot-active-opacity, 1);\n    }\n     ha-alert {\n        display: block;\n        margin: 0;\n        width: 100%;\n        box-sizing: border-box;\n        border-radius: 0;\n        border: none;\n        background-color: transparent;\n     }\n     .slide > *:first-child {\n        flex-grow: 1;\n        width: 100%;\n        display: flex;\n        flex-direction: column;\n        min-height: 0;\n     }\n     .slide > * > ha-card,\n     .slide > * > .card-content {\n        margin: 0 !important;\n        padding: 0 !important;\n        box-shadow: none !important;\n        border-radius: 0 !important;\n        border: none !important;\n        height: 100%;\n        display: flex;\n        flex-direction: column;\n     }\n   ',t.appendChild(e),this.card.cardContainer=document.createElement("div"),this.card.cardContainer.className="card-container",this.card.sliderElement=document.createElement("div"),this.card.sliderElement.className="slider",this.card.sliderElement.setAttribute("data-swipe-direction",this.card.j),this.card.cardContainer.appendChild(this.card.sliderElement),t.appendChild(this.card.cardContainer),this.card.vt(),0===this.card.G.cards.length){c("INIT","Building preview state.");const i=function(t,i){const e=document.createElement("div");e.className="preview-container";const s=document.createElement("div");s.className="preview-icon-container";const n=document.createElement("ha-icon");n.icon="horizontal"===t?"mdi:gesture-swipe-horizontal":"mdi:gesture-swipe-vertical",s.appendChild(n);const o=document.createElement("div");o.className="preview-text-container";const a=document.createElement("div");a.className="preview-title",a.textContent="Simple Swipe Card";const r=document.createElement("div");r.className="preview-description",r.textContent=`Create a swipeable container with multiple cards. Swipe ${"horizontal"===t?"horizontally":"vertically"} between cards. Open the editor to add your first card.`,o.appendChild(a),o.appendChild(r);const d=document.createElement("div");d.className="preview-actions";const c=document.createElement("ha-button");return c.raised=!0,c.textContent="EDIT CARD",c.setAttribute("aria-label","Edit Card"),c.addEventListener("click",i),d.appendChild(c),e.appendChild(s),e.appendChild(o),e.appendChild(d),e}(this.card.j,t=>function(t,i){t.stopPropagation(),c("EDITOR","Edit button clicked, firing show-edit-card event"),E(i,"show-edit-card",{element:i})}(t,this.card));return t.innerHTML="",t.appendChild(e),t.appendChild(i),this.card.initialized=!0,void(this.card.building=!1)}if(0===this.card.visibleCardIndices.length){c("INIT","No visible cards, showing empty state.");const i=function(){const t=document.createElement("div");return t.className="preview-container",t.innerHTML='\n        <div class="preview-icon-container">\n            <ha-icon icon="mdi:eye-off" style="color: var(--secondary-text-color); font-size: 48px; width: 48px; height: 48px;"></ha-icon>\n        </div>\n        <div class="preview-text-container">\n            <div class="preview-title">No Visible Cards</div>\n            <div class="preview-description">All cards in this swipe card are currently hidden due to their visibility conditions.</div>\n        </div>\n    ',t}();return t.innerHTML="",t.appendChild(e),t.appendChild(i),this.card.initialized=!0,void(this.card.building=!1)}c("INIT","Building ALL visible cards:",this.card.visibleCardIndices.length,"out of",this.card.G.cards.length);const s=Array.from({length:this.card.visibleCardIndices.length},(t,i)=>i).map(t=>{const e=this.card.visibleCardIndices[t];return this.createCard(this.card.G.cards[e],t,e,i)});await Promise.allSettled(s),this.card.cards.filter(Boolean).sort((t,i)=>t.visibleIndex-i.visibleIndex).forEach(t=>{t.slide&&(t.slide.setAttribute("data-index",t.originalIndex),t.slide.setAttribute("data-visible-index",t.visibleIndex),t.config&&t.config.type&&t.slide.setAttribute("data-card-type",t.config.type),this.card.sliderElement.appendChild(t.slide))}),this.card.pagination?.create(),this.card.gt(),requestAnimationFrame(()=>this.finishBuildLayout()),this.card.initialized=!0,this.card.building=!1,c("INIT","Build finished - all cards loaded upfront."),this.card.resetAfter?.restoreState()}preloadAdjacentCards(){c("INIT","preloadAdjacentCards called but all cards already loaded")}async createCard(t,i,e,s){const n=function(){const t=document.createElement("div");return t.className="slide",t}();let o;const a={visibleIndex:i,originalIndex:e,slide:n,config:JSON.parse(JSON.stringify(t)),error:!1};try{o=await s.createCardElement(t),this.card.ft&&(o.hass=this.card.ft),a.element=o,"picture-elements"===t.type&&(o.setAttribute("data-swipe-card-picture-elements","true"),n.setAttribute("data-has-picture-elements","true")),requestAnimationFrame(()=>{try{if("todo-list"===t.type){const t=o.shadowRoot?.querySelector("ha-textfield"),i=t?.shadowRoot?.querySelector("input");i&&(i.enterKeyHint="done")}}catch(t){console.warn("Error applying post-creation logic:",t)}}),n.appendChild(o)}catch(o){c("ERROR",`Error creating card ${i} (original ${e}):`,t,o),a.error=!0;const r=await s.createErrorCardElement({type:"error",error:`Failed to create card: ${o.message}`,origConfig:t},this.card.ft);a.element=r,n.appendChild(r)}this.card.cards[i]=a}finishBuildLayout(){if(!this.card.cardContainer||!this.card.isConnected||this.card.building)return void c("INIT","_finishBuildLayout skipped",{container:!!this.card.cardContainer,connected:this.card.isConnected,building:this.card.building});c("INIT","Finishing build layout...");const t=this.card.cardContainer.offsetWidth,i=this.card.cardContainer.offsetHeight;if(t<=0||i<=0)return null===this.card.offsetParent?void c("INIT","Layout calculation skipped, element is hidden."):(c("INIT","Container dimensions are 0, retrying layout..."),this.card.wt=(this.card.wt||0)+1,void(this.card.wt<5?setTimeout(()=>requestAnimationFrame(()=>this.finishBuildLayout()),100):(console.error("SimpleSwipeCard: Failed to get container dimensions."),this.card.wt=0)));this.card.wt=0,this.card.slideWidth=t,this.card.slideHeight=i;const e=this.card.visibleCardIndices.length;this.card.currentIndex=Math.max(0,Math.min(this.card.currentIndex,e-1)),function(t,i){const e=getComputedStyle(i).borderRadius;t.forEach(t=>{t&&t.slide&&(t.slide.style.borderRadius=e)})}(this.card.cards,this.card.cardContainer),this.card.updateSlider(!1),this.card.bt(),e>1?this.card.swipeGestures?.addGestures():this.card.swipeGestures?.removeGestures(),c("INIT","Layout finished, slideWidth:",this.card.slideWidth,"slideHeight:",this.card.slideHeight,"currentIndex:",this.card.currentIndex,"visible cards:",e),this.card.autoSwipe?.manage(),this.card.resetAfter?.manage(),this.card.stateSynchronization?.manage()}}class S{constructor(t){this.card=t,this.Et=null,this.xt=null,this.yt=null,this.St=!1,this.It=null,this.Tt=this.Ct.bind(this)}manage(){this.card.initialized&&this.card.isConnected&&(this.stop(),this.card.G.state_entity&&this.card.ft?(this.Et=this.card.G.state_entity,this.$t()?(c("STATE","State synchronization enabled for entity:",this.Et),this.Nt()):(c("STATE","Invalid or missing entity:",this.Et),this.Et=null)):c("STATE","State synchronization disabled",{hasEntity:!!this.card.G.state_entity,hasHass:!!this.card.ft}))}stop(){this.It&&(clearTimeout(this.It),this.It=null),this.Et=null,this.xt=null,this.yt=null,this.St=!1}onCardNavigate(t){if(!this.Et||!this.card.ft||this.St)return;const i=this.kt(t);if(null===i)return;const e=this.card.ft.states[this.Et];if(e&&e.state===i)c("STATE","Entity already at correct state:",i);else{c("STATE",`Updating entity ${this.Et} to:`,i),this.St=!0;try{"input_select"===this.xt?this.card.ft.callService("input_select","select_option",{entity_id:this.Et,option:i}):"input_number"===this.xt&&this.card.ft.callService("input_number","set_value",{entity_id:this.Et,value:i}),this.yt=i,setTimeout(()=>{this.St=!1},500)}catch(t){c("ERROR","Failed to update entity:",t),this.St=!1}}}$t(){if(!this.card.ft||!this.Et)return!1;const t=this.card.ft.states[this.Et];if(!t)return c("STATE","Entity not found:",this.Et),!1;if(this.Et.startsWith("input_select.")){if(this.xt="input_select",!t.attributes.options||!Array.isArray(t.attributes.options))return c("STATE","input_select entity has no options:",this.Et),!1}else{if(!this.Et.startsWith("input_number."))return c("STATE","Entity is not input_select or input_number:",this.Et),!1;this.xt="input_number"}return!0}Nt(){if(!this.card.ft||!this.Et)return;const t=this.card.ft.states[this.Et];if(!t)return;this.yt=t.state;const i=this._t(t.state);null!==i&&i!==this.card.currentIndex&&(c("STATE",`Initial sync: setting card to index ${i} from entity state:`,t.state),this.card.G.enable_auto_swipe&&this.card.autoSwipe?.pause(2e3),this.card.goToSlide(i))}Ct(){if(!this.card.ft||!this.Et||this.St)return;const t=this.card.ft.states[this.Et];if(!t)return;const i=t.state;if(i===this.yt)return;c("STATE",`Entity ${this.Et} changed from "${this.yt}" to "${i}"`),this.yt=i;const e=this._t(i);null!==e&&e!==this.card.currentIndex&&(c("STATE",`Navigating to card index ${e} from entity change`),this.card.G.enable_auto_swipe&&this.card.autoSwipe?.pause(5e3),this.card.goToSlide(e))}_t(t){if("input_select"===this.xt){const i=this.card.ft.states[this.Et];if(!i||!i.attributes.options)return null;const e=i.attributes.options,s=e.indexOf(t);return-1===s?(c("STATE",`Option "${t}" not found in input_select options:`,e),null):s>=this.card.visibleCardIndices.length?(c("STATE",`Option index ${s} exceeds visible cards count ${this.card.visibleCardIndices.length}`),null):s}if("input_number"===this.xt){const i=parseInt(t);if(isNaN(i))return null;const e=i-1;return e<0||e>=this.card.visibleCardIndices.length?(c("STATE",`Index ${e} is outside visible cards range [0, ${this.card.visibleCardIndices.length-1}]`),null):e}return null}kt(t){if(t<0||t>=this.card.visibleCardIndices.length)return null;if("input_select"===this.xt){const i=this.card.ft.states[this.Et];if(!i||!i.attributes.options)return null;const e=i.attributes.options;return t>=e.length?(c("STATE",`Card index ${t} exceeds input_select options count ${e.length}`),null):e[t]}return"input_number"===this.xt?t+1:null}onHassChange(t,i){if(!this.Et||!i)return;const e=t?.states[this.Et],s=i.states[this.Et];if(!s)return c("STATE","Configured entity no longer exists:",this.Et),void this.stop();e&&e.state===s.state||(this.It&&clearTimeout(this.It),this.It=setTimeout(()=>{this.Ct(),this.It=null},100))}}class SimpleSwipeCard extends(h||HTMLElement){constructor(){super(),c("INIT","SimpleSwipeCard Constructor invoked."),this.G={},this.ft=null,this.cards=[],this.visibleCardIndices=[],this.currentIndex=0,this.slideWidth=0,this.slideHeight=0,this.cardContainer=null,this.sliderElement=null,this.initialized=!1,this.building=!1,this.resizeObserver=null,this.j="horizontal",this.q=!1,this.ut=null,this.Rt=null,this.swipeGestures=new v(this),this.autoSwipe=new f(this),this.resetAfter=new w(this),this.pagination=new b(this),this.cardBuilder=new y(this),this.stateSynchronization=new S(this),this.Dt=null,this.Ot=this.At.bind(this),this.Mt=Math.random().toString(36).substring(2,15),window._simpleSwipeDialogStack||(window._simpleSwipeDialogStack=[])}static async getConfigElement(){return c("SYSTEM","SimpleSwipeCard.getConfigElement called"),await customElements.whenDefined("simple-swipe-card-editor"),document.createElement("simple-swipe-card-editor")}static getStubConfig(){return c("SYSTEM","SimpleSwipeCard.getStubConfig called"),{type:"custom:simple-swipe-card",cards:[]}}setConfig(t){if(c("CONFIG","setConfig received:",JSON.stringify(t)),!t||"object"!=typeof t)return void this.Lt("Configuration must be an object");if(!t.cards||!Array.isArray(t.cards))return c("CONFIG","No cards array found in configuration, creating empty array"),this.G={...i},void(this.isConnected&&this.cardBuilder.build());const e=JSON.stringify(this.G),s=JSON.stringify(t);if(e===s)return void c("CONFIG","setConfig: No change detected, skipping update.");this.G=JSON.parse(s),void 0!==this.G.parameters?.show_pagination&&(this.G.show_pagination=this.G.parameters.show_pagination,delete this.G.parameters),Object.keys(i).forEach(t=>{void 0===this.G[t]&&(this.G[t]=i[t])}),this.G.card_spacing=parseInt(this.G.card_spacing),(isNaN(this.G.card_spacing)||this.G.card_spacing<0)&&(this.G.card_spacing=i.card_spacing),this.G.auto_swipe_interval=parseInt(this.G.auto_swipe_interval),(isNaN(this.G.auto_swipe_interval)||this.G.auto_swipe_interval<500)&&(this.G.auto_swipe_interval=i.auto_swipe_interval),this.G.reset_after_timeout=parseInt(this.G.reset_after_timeout),(isNaN(this.G.reset_after_timeout)||this.G.reset_after_timeout<5e3)&&(this.G.reset_after_timeout=i.reset_after_timeout),["horizontal","vertical"].includes(this.G.swipe_direction)||(this.G.swipe_direction=i.swipe_direction),this.G.state_entity&&"string"!=typeof this.G.state_entity&&(c("CONFIG","Invalid state_entity, must be string"),this.G.state_entity=null),t.card_mod?(c("CARD_MOD","Card-mod configuration detected",t.card_mod),this.ut=JSON.parse(JSON.stringify(t.card_mod))):this.ut=null,this.j=this.G.swipe_direction,delete this.G.title,this.vt();(!this.initialized||!this.isConnected||this.cards.length!==this.visibleCardIndices.length)&&this.isConnected?(c("CONFIG","setConfig triggering rebuild"),this.cardBuilder.build()):this.initialized&&(c("CONFIG","setConfig triggering updates (no rebuild)"),this.zt(),this.Pt(),this.autoSwipe.manage(),this.resetAfter.manage(),this.stateSynchronization.manage())}vt(){if(!this.G?.cards||!this.ft){const t=0===this.visibleCardIndices.length;return this.visibleCardIndices=[],void(t||c("VISIBILITY","No cards or hass available, cleared visible indices"))}const t=[...this.visibleCardIndices];this.visibleCardIndices=[],this.G.cards.forEach((t,i)=>{m(t.visibility,this.ft)&&this.visibleCardIndices.push(i)});JSON.stringify(t)!==JSON.stringify(this.visibleCardIndices)&&(c("VISIBILITY",`Visible cards changed: ${this.visibleCardIndices.length}/${this.G.cards.length} visible`,this.visibleCardIndices),this.Vt(t))}Vt(t){if(0===this.visibleCardIndices.length)return void(this.currentIndex=0);const i=t[this.currentIndex],e=this.visibleCardIndices.indexOf(i);if(-1!==e)this.currentIndex=e,c("VISIBILITY",`Current card still visible, adjusted index to ${this.currentIndex}`);else{const t=this.visibleCardIndices.length;this.currentIndex>=t?(this.currentIndex=t-1,c("VISIBILITY",`Adjusted to last visible card: ${this.currentIndex}`)):(this.currentIndex=Math.min(this.currentIndex,t-1),this.currentIndex=Math.max(0,this.currentIndex),c("VISIBILITY",`Adjusted to maintain relative position: ${this.currentIndex}`))}}At(){this.Dt&&clearTimeout(this.Dt),this.Dt=setTimeout(()=>{this.vt(),this.Dt=null},50)}Lt(t){c("ERROR",`${t}`),this.G={...i},this.visibleCardIndices=[],this.isConnected&&this.cardBuilder.build()}zt(){c("CONFIG","Updating child card configs"),this.cards&&this.cards.length===this.visibleCardIndices.length&&this.visibleCardIndices.forEach((t,i)=>{const e=this.G.cards[t],s=this.cards[i];if(s&&!s.error&&s.element?.setConfig&&JSON.stringify(s.config)!==JSON.stringify(e)){c("CONFIG","Updating config for visible card",i,"original index",t);try{s.element.setConfig(e),s.config=JSON.parse(JSON.stringify(e))}catch(t){console.error(`Error setting config on child card ${i}:`,t)}}})}Pt(){if(c("CONFIG","Updating layout options (pagination, spacing, direction)"),this.j!==this.G.swipe_direction)return this.j=this.G.swipe_direction,void this.cardBuilder.build();this.pagination.updateLayout(),this.updateSlider(!1),this.ut&&this.gt()}set hass(t){if(!t)return;const i=this.ft;if(i===t||i&&t&&i.states===t.states&&i.user===t.user&&JSON.stringify(i.config)===JSON.stringify(t.config))this.cards&&this.cards.forEach(i=>{if(i.element&&!i.error)try{i.element.hass=t}catch(t){console.error("Error setting hass on child card:",t)}});else{if(c("INIT","Setting hass (changed)"),this.ft=t,this.stateSynchronization?.onHassChange(i,t),i!==t){const t=[...this.visibleCardIndices];this.Ot();const i=this.visibleCardIndices.length;if(Math.abs(i-t.length)>1){this.Dt&&(clearTimeout(this.Dt),this.Dt=null),this.vt();JSON.stringify(t)!==JSON.stringify(this.visibleCardIndices)&&this.initialized&&this.isConnected&&this.cardBuilder.build()}}this.cards&&this.cards.forEach(i=>{if(i.element&&!i.error)try{i.element.hass=t}catch(t){console.error("Error setting hass on child card:",t)}})}}connectedCallback(){c("INIT","connectedCallback"),this.addEventListener("config-changed",this.Ht.bind(this)),!this.initialized&&this.G?.cards?(c("INIT","connectedCallback: Initializing build."),this.cardBuilder.build()):this.initialized&&this.cardContainer&&(c("INIT","connectedCallback: Re-initializing observers and gestures."),this.bt(),this.visibleCardIndices.length>1&&(this.swipeGestures.removeGestures(),setTimeout(()=>{this.isConnected&&this.swipeGestures.addGestures()},50)),this.ut&&(this.gt(),this.Wt()),this.autoSwipe.manage(),this.resetAfter.manage(),this.stateSynchronization.manage())}disconnectedCallback(){c("INIT","disconnectedCallback");try{this.resizeObserver?.cleanup(),this.swipeGestures?.removeGestures(),this.autoSwipe?.stop(),this.resetAfter?.stopTimer(),this.stateSynchronization?.stop(),this.Yt&&(clearTimeout(this.Yt),this.Yt=null),this.Rt&&(this.Rt.disconnect(),this.Rt=null,c("CARD_MOD","Disconnected card-mod observer"))}catch(t){console.warn("Error during cleanup:",t)}this.initialized=!1}Ht(t){t.detail?.fromSwipeCardEditor&&t.detail?.editorId===this.Ft||(c("EVENT","Root element received config-changed event:",t.detail),(t.detail?.fromElementEditor||t.detail?.elementConfig||t.detail?.element)&&c("ELEMENT","Caught element editor event, allowing normal propagation"))}bt(){!this.resizeObserver&&this.cardContainer&&(this.resizeObserver=function(t,i){if(!t)return null;c("INIT","Setting up resize observer.");let e=null;const s=new ResizeObserver(s=>{window.requestAnimationFrame(()=>{if(t.isConnected)for(const n of s){const s=n.contentRect.width,o=n.contentRect.height;e&&clearTimeout(e),e=setTimeout(()=>{t&&(s>0&&s!==n.previousWidth||o>0&&o!==n.previousHeight)&&(c("INIT","Resize detected, recalculating layout.",{oldWidth:n.previousWidth,newWidth:s,oldHeight:n.previousHeight,newHeight:o}),i(s,o))},50),n.previousWidth=s,n.previousHeight=o}})});return s.observe(t),{observer:s,cleanup:()=>{c("INIT","Removing resize observer."),s&&s.disconnect(),e&&(clearTimeout(e),e=null)}}}(this.cardContainer,(t,i)=>{(t>0&&Math.abs(t-this.slideWidth)>1||i>0&&Math.abs(i-this.slideHeight)>1)&&(c("INIT","Resize detected, recalculating layout.",{oldWidth:this.slideWidth,newWidth:t,oldHeight:this.slideHeight,newHeight:i}),this.cardBuilder.finishBuildLayout())}))}X(t){return function(t,i=null){if(!t)return"none";let e="0.3s",s="ease-out";if(i&&i.isConnected){const t=getComputedStyle(i),n=t.getPropertyValue("--simple-swipe-card-transition-speed").trim(),o=t.getPropertyValue("--simple-swipe-card-transition-easing").trim();n&&(e=n),o&&(s=o)}return`transform ${e} ${s}`}(t,this)}gt(){!function(t,i,e,s,n){if(t&&i){if(t.style){c("CARD_MOD","Applying card-mod styles");const o=document.createElement("style");o.setAttribute("id","card-mod-styles"),o.textContent=t.style;const a=i.querySelector("#card-mod-styles");if(a&&i.removeChild(a),i.appendChild(o),e){c("CARD_MOD","Forwarding CSS variables from host to shadow DOM");const t=window.getComputedStyle(e),o=[i.querySelector(".card-container"),s,n].filter(Boolean),a=["--simple-swipe-card-pagination-dot-inactive-color","--simple-swipe-card-pagination-dot-active-color","--simple-swipe-card-pagination-dot-inactive-opacity","--simple-swipe-card-pagination-dot-active-opacity","--simple-swipe-card-pagination-dot-size","--simple-swipe-card-pagination-dot-active-size","--simple-swipe-card-pagination-border-radius","--simple-swipe-card-pagination-dot-spacing","--simple-swipe-card-pagination-background","--simple-swipe-card-pagination-padding","--simple-swipe-card-pagination-bottom","--simple-swipe-card-pagination-right"];o.forEach(i=>{i&&a.forEach(e=>{const s=t.getPropertyValue(e);s&&(c("CARD_MOD",`Forwarding ${e}: ${s}`),i.style.setProperty(e,s))})})}}}else c("CARD_MOD","No card-mod config or shadow root, skipping style application")}(this.ut,this.shadowRoot,this.shadowRoot?.host,this.sliderElement,this.pagination.paginationElement)}Wt(){this.Rt&&(this.Rt.disconnect(),this.Rt=null),this.Rt=function(t,i){const e=new MutationObserver(t=>{t.some(t=>"attributes"===t.type&&("style"===t.attributeName||t.attributeName.includes("style")))&&(c("CARD_MOD","Host style attribute changed, reapplying card-mod styles"),i())});return t&&t.host&&(e.observe(t.host,{attributes:!0,attributeFilter:["style"]}),c("CARD_MOD","Set up mutation observer for style changes")),e}(this.shadowRoot,()=>{this.gt()})}goToSlide(t){const i=this.visibleCardIndices.length;if(!this.visibleCardIndices||0===i||!this.initialized||this.building)return void c("SWIPE","goToSlide skipped",{totalVisible:i,initialized:this.initialized,building:this.building});!0===this.G.enable_loopback&&i>1?t<0?t=i-1:t>=i&&(t=0):t=Math.max(0,Math.min(t,i-1)),t!==this.currentIndex||this.autoSwipe.isInProgress||this.resetAfter.isInProgress?(c("SWIPE",`Going to visible slide ${t}`),this.currentIndex=t,this.stateSynchronization?.onCardNavigate(t),this.updateSlider(),this.autoSwipe.isInProgress||this.resetAfter.isInProgress||this.resetAfter.startTimer(),!this.G.enable_auto_swipe||this.autoSwipe.isInProgress||this.resetAfter.isInProgress||this.autoSwipe.pause(5e3)):c("SWIPE",`goToSlide: visible index ${t} is current, no change needed.`)}updateSlider(t=!0){const i=this.visibleCardIndices.length;if(c("SWIPE",`Updating slider to visible index ${this.currentIndex}`,{animate:t,totalVisible:i}),!this.sliderElement||0===i||!this.initialized||this.building)return void c("SWIPE","updateSlider skipped",{slider:!!this.sliderElement,totalVisible:i,init:this.initialized,building:this.building});const e=Math.max(0,parseInt(this.G.card_spacing))||0,s="horizontal"===this.j;!0===this.G.enable_loopback&&i>1?this.currentIndex<0?this.currentIndex=i-1:this.currentIndex>=i&&(this.currentIndex=0):this.currentIndex=Math.max(0,Math.min(this.currentIndex,i-1)),this.sliderElement.style.gap=`${e}px`;let n=0;n=s?this.currentIndex*(this.slideWidth+e):this.currentIndex*(this.slideHeight+e),this.sliderElement.style.transition=this.X(t),this.sliderElement.style.transform=s?`translateX(-${n}px)`:`translateY(-${n}px)`,this.cards.forEach(t=>{t&&t.slide&&(t.slide.style.marginRight="0px",t.slide.style.marginLeft="0px",t.slide.style.marginTop="0px",t.slide.style.marginBottom="0px")}),this.pagination.update(),c("SWIPE",`Slider updated, transform: -${n}px along ${s?"X":"Y"} axis`)}getCardSize(){if(0===this.visibleCardIndices.length)return 3;let t=3;if(this.cards&&this.cards.length>0){const i=this.cards[this.currentIndex];if(i?.element&&!i.error&&"function"==typeof i.element.getCardSize)try{t=i.element.getCardSize()}catch(i){console.warn("Error getting card size from current element:",i),t=3}else i?.element&&i.element.offsetHeight&&(t=Math.max(1,Math.ceil(i.element.offsetHeight/50)))}return c("CONFIG","Calculated card size:",t),Math.max(3,t)}}function I(t,i,e,s,n,o,a,r){const d=!0===t.enable_loopback,c=!0===t.enable_auto_swipe,h=t.auto_swipe_interval??2e3,p=!0===t.enable_reset_after,u=t.reset_after_timeout??3e4,g=t.reset_target_card??1,m=t.state_entity||"";let v=0,f=0;d&&v++,c&&v++,p&&!c&&v++,p&&c&&f++,m&&v++;let w="",b="";return v>0&&(w=`${v} active`),f>0&&(b=`${f} blocked`),l`
    <div class="collapsible-section">
      ...
      >
        ...
        ${w?l`<div class="section-toggle-badge">${w}</div>`:""}
        ${b?l`<div class="section-toggle-badge blocked-only">
              ${b}
            </div>`:""}
      </div>
  ...
  `}function T(t,i,e,s,n,o,a,r,d,c,h,p){return l`
    <div class="section cards-section">
      ...
      <div class="card-list">
        ${0===t.length?l`<div class="no-cards">
              ...
              card.
            </div>`:t.map((u,g)=>function(t,i,e,s,n,o,a,r,d,c,h,p,u,g){const v=r(t),f=d(t),w=f?c(t):[],b=h(t),E=!s||m(t.visibility,s);return l`
    <div
    ...
    >
      <div class="card-info">
        ...
        ${b&&E?l`<span class="visibility-badge">Conditional</span>`:""}
        ${v.name?l`<span class="card-name">(${v.name})</span>`:""}
      </div>
      <div class="card-actions">
        ${b&&!E?l`<ha-icon class="hidden-icon" icon="mdi:eye-off"></ha-icon>`:""}
        <ha-icon-button
          label="Move Up"
          ?disabled=${0===i}
...
`}constructor(){super(),this.shadowRoot||this.constructor!==HTMLElement||this.attachShadow({mode:"open"}),c("EDITOR","SimpleSwipeCardEditor Constructor invoked."),c("EDITOR","Editor styles method available:",!!this.constructor.styles),this.Ft=`swipe-card-editor-${Math.random().toString(36).substring(2,15)}`,this.Ut=this.Jt.bind(this),this.Bt=this.jt.bind(this),this.Xt=new Set,this.Gt=null,this.qt=!1,this.Zt={active:!1,parentDialogId:null,elementId:null,timestamp:null,savedState:null},this.Kt={advanced:!1,cards:!0};x(o).set(this.Ft,this)}Qt(t){if(t.detail&&(t.detail.fromElementEditor||t.detail.elementConfig||t.detail.elementToEdit||t.detail.element))return c("ELEMENT","Element editor detected through event detail"),!0;const i=t.composedPath?t.composedPath():[];for(const t of i)if(t&&t.localName){if("hui-element-editor"===t.localName||"hui-dialog-edit-element"===t.localName||t.localName.includes("element-editor"))return c("ELEMENT","Element editor detected through path node localName:",t.localName),!0;if(t.ti||t.ii||t.getAttribute&&(t.getAttribute("element-id")||t.getAttribute("data-element-id"))||t.classList&&t.classList.contains("element-editor"))return c("ELEMENT","Element editor detected through specialized attributes"),!0;if("HUI-DIALOG"===t.tagName&&(t.querySelector(".element-editor")||t.ei&&"string"==typeof t.ei&&t.ei.toLowerCase().includes("element")))return c("ELEMENT","Element editor detected through hui-dialog with element editor content"),!0}return"element-updated"===t.type||"config-changed"===t.type&&t.target&&("hui-element-editor"===t.target.localName||t.target.closest("hui-element-editor"))?(c("ELEMENT","Element editor detected through event characteristics"),!0):!!(this.Zt.active&&Date.now()-this.Zt.timestamp<5e3)&&(c("ELEMENT","Element editor event detected through active editing session"),!0)}si(t){if(!t)return!1;if(t.ni)return!0;try{const i=t.cardConfig;return i&&"custom:actions-card"===i.type}catch(t){return!1}}oi(t){return t&&"picture-elements"===t.type}ai(t){return t&&Array.isArray(t.visibility)&&t.visibility.length>0}ri(t){this.Kt[t]=!this.Kt[t],this.requestUpdate()}di(t){return!("custom:actions-card"!==t.type||!t.card)&&(Array.isArray(t.card)?t.card.length>0:!!t.card)}ci(t){return this.di(t)?Array.isArray(t.card)?t.card:[t.card]:[]}hi(t,i,e){if(!this.G?.cards||!this.G.cards[t])return;const s=this.G.cards[t];if(!this.di(s))return;const n=this.ci(s),o=i+e;if(o<0||o>=n.length)return;c("EDITOR",`Moving nested card ${t}.${i} to position ${t}.${o}`),[n[i],n[o]]=[n[o],n[i]];const a=[...this.G.cards];a[t]={...s,card:n},this.G={...this.G,cards:a},this.li(),this.requestUpdate()}pi(t,i){if(!this.G?.cards||!this.G.cards[t])return;const e=this.G.cards[t];if(!this.di(e))return;let s=this.ci(e);if(i<0||i>=s.length)return;c("EDITOR",`Removing nested card ${t}.${i}`),s=s.filter((t,e)=>e!==i);const n=[...this.G.cards];n[t]={...e,card:s},this.G={...this.G,cards:n},this.li(),this.requestUpdate()}async ui(t,i){if(c("EDITOR",`_editNestedCard called for parent ${t}, nested ${i}`),!this.G?.cards||!this.G.cards[t]||!this.di(this.G.cards[t]))return void c("ERROR","SimpleSwipeCardEditor: Invalid indices for nested card editing:",t,i);const e=this.G.cards[t],s=this.ci(e);if(i<0||i>=s.length)return;const n=s[i],o=this.hass,a=document.querySelector("home-assistant");if(o&&a)try{await customElements.whenDefined("hui-dialog-edit-card");const r=document.createElement("hui-dialog-edit-card");r.hass=o,document.body.appendChild(r),this.Xt.add(r),r.gi=this.Ft,this.oi(n)&&(r.setAttribute("data-editing-picture-elements","true"),r.mi=!0),r.addEventListener("config-changed",t=>{if(this.Qt(t))return c("ELEMENT","Nested card: Detected element editor event, allowing natural propagation"),r.fi=!0,this.Zt.active=!0,this.Zt.timestamp=Date.now(),void(t.detail&&t.detail.config&&(r.wi=JSON.parse(JSON.stringify(t.detail.config)),r.bi=!0));(t.detail?.fromExternalEditor||t.detail?.fromActionCardEditor||t.detail?.fromSwipeCardEditor)&&(c("EDITOR","Marking nested event as already handled in _editNestedCard's dialog"),t.Ei=!0)},!0);const d=()=>{if(r.removeEventListener("dialog-closed",d),r.fi&&(c("ELEMENT","Dialog handling element edit is closing, ending element edit session"),this.Zt.active=!1),this.Xt.delete(r),r.parentNode===document.body)try{document.body.removeChild(r)}catch(t){console.warn("Error removing nested card dialog:",t)}setTimeout(()=>this.xi(),100)};r.addEventListener("dialog-closed",d);const h={cardConfig:n,lovelaceConfig:this.lovelace||a.lovelace,saveCardConfig:async n=>{if(r.bi||r.fi){if(c("ELEMENT","Nested card: Save detected from element editor, preserving dialog state"),r.bi=!1,this.Zt.timestamp=Date.now(),n){c("ELEMENT","Silently updating nested card config with element changes");const o=[...s];o[i]=n;const a={...e,card:o},r=[...this.G.cards];r[t]=a,this.G={...this.G,cards:r},this.li({maintainEditorState:!0,fromElementEditor:!0,updatedCardIndex:t,nestedCardIndex:i})}return n}if(r.wi&&!n)return c("ELEMENT","Nested card: Element editor cancel detected, restoring previous config"),void(r.wi=null);if(!n)return;c("EDITOR",`Saving nested card ${t}.${i} with new config`);const o=[...s];o[i]=n;const a={...e,card:o},d=[...this.G.cards];d[t]=a,this.G={...this.G,cards:d},this.li(),this.requestUpdate(),setTimeout(()=>this.xi(),100)}};await r.showDialog(h)}catch(o){c("ERROR","SimpleSwipeCardEditor: Error opening edit dialog for nested card:",o),E(this,"ll-show-dialog",{dialogTag:"hui-dialog-edit-card",dialogImport:()=>import("hui-dialog-edit-card"),dialogParams:{cardConfig:n,lovelaceConfig:this.lovelace||a.lovelace,saveCardConfig:async n=>{if(!n)return;const o=[...s];o[i]=n;const a={...e,card:o},r=[...this.G.cards];r[t]=a,this.G={...this.G,cards:r},this.li(),this.requestUpdate(),setTimeout(()=>this.xi(),100)}}})}else c("ERROR","SimpleSwipeCardEditor: Cannot find Home Assistant instance")}async yi(t){if(c("EDITOR",`_editCard called for index ${t}`),!this.G||!this.G.cards||t<0||t>=this.G.cards.length)return void c("ERROR","SimpleSwipeCardEditor: Invalid index for card editing:",t);const i=this.G.cards[t],e=this.hass,s=document.querySelector("home-assistant");if(e&&s)try{await customElements.whenDefined("hui-dialog-edit-card");const n=document.createElement("hui-dialog-edit-card");n.hass=e,document.body.appendChild(n),this.Xt.add(n),n.gi=this.Ft,this.oi(i)&&(n.setAttribute("data-editing-picture-elements","true"),n.mi=!0),c("EDITOR",`[CARD INDEX ${t}] hui-dialog-edit-card created and added to body. Tracking it.`);const o=this.Si.bind(this,t,n),a=this.Ii.bind(this,t);n.addEventListener("config-changed",o,{capture:!0}),n.addEventListener("show-dialog",a,{capture:!0}),n.addEventListener("ll-show-dialog",a,{capture:!0}),this.oi(i)&&(n.addEventListener("element-updated",t=>{c("ELEMENT","Element updated event on dialog",t.detail),n.fi=!0,this.Zt.active=!0,this.Zt.timestamp=Date.now()},{capture:!0}),n.addEventListener("show-edit-element",t=>{c("ELEMENT","Show edit element event on dialog",t.detail),n.fi=!0,this.Zt.active=!0,this.Zt.timestamp=Date.now()},{capture:!0})),"custom:actions-card"===i.type&&(n.ni=!0);const r=()=>{if(c("EDITOR",`[CARD INDEX ${t}] hui-dialog-edit-card closed event received.`),n.removeEventListener("dialog-closed",r),n.removeEventListener("config-changed",o,{capture:!0}),n.removeEventListener("show-dialog",a,{capture:!0}),n.removeEventListener("ll-show-dialog",a,{capture:!0}),this.oi(i)&&(n.removeEventListener("element-updated",d,{capture:!0}),n.removeEventListener("show-edit-element",h,{capture:!0})),this.Xt.delete(n),c("EDITOR",`[CARD INDEX ${t}] hui-dialog-edit-card removed from tracking. Active child editors: ${this.Xt.size}`),n.fi&&(c("ELEMENT","Element edit session reset due to dialog close"),setTimeout(()=>{this.Zt.active&&Date.now()-this.Zt.timestamp>500&&(this.Zt.active=!1)},500)),n.parentNode===document.body)try{document.body.removeChild(n),c("EDITOR",`[CARD INDEX ${t}] hui-dialog-edit-card removed from body.`)}catch(i){console.warn(`[CARD INDEX ${t}] Error removing dialog from body:`,i)}setTimeout(()=>this.xi(),100)};n.addEventListener("dialog-closed",r);const d=t=>{c("ELEMENT","Element updated event on dialog",t.detail),n.fi=!0,this.Zt.active=!0,this.Zt.timestamp=Date.now()},h=t=>{c("ELEMENT","Show edit element event on dialog",t.detail),n.fi=!0,this.Zt.active=!0,this.Zt.timestamp=Date.now()};this.oi(i)&&(n.addEventListener("element-updated",d,{capture:!0}),n.addEventListener("show-edit-element",h,{capture:!0}));const l={cardConfig:i,lovelaceConfig:this.lovelace||s.lovelace,saveCardConfig:async i=>{if(c("EDITOR",`[CARD INDEX ${t}] saveCardConfig callback in hui-dialog-edit-card invoked.`),n.bi||n.fi){if(c("ELEMENT",`[CARD INDEX ${t}] Save detected from element editor, preserving dialog state`),n.bi=!1,this.Zt.timestamp=Date.now(),i){c("ELEMENT","Silently updating config with element changes");const e=[...this.G.cards];e[t]=i,this.G={...this.G,cards:e},this.li({maintainEditorState:!0,fromElementEditor:!0,updatedCardIndex:t})}return i}if(n.wi&&!i)return c("ELEMENT",`[CARD INDEX ${t}] Element editor cancel detected, restoring previous config`),void(n.wi=null);if(!i)return;const e=[...this.G.cards];e[t]=i,this.G={...this.G,cards:e},this.li({reason:"child_dialog_saved"}),this.requestUpdate(),setTimeout(()=>this.xi(),100)}};c("EDITOR",`[CARD INDEX ${t}] About to call dialog.showDialog()`),await n.showDialog(l),c("EDITOR",`[CARD INDEX ${t}] dialog.showDialog() finished.`)}catch(e){c("ERROR","SimpleSwipeCardEditor: Error opening edit dialog:",e),E(this,"ll-show-dialog",{dialogTag:"hui-dialog-edit-card",dialogImport:()=>import("hui-dialog-edit-card"),dialogParams:{cardConfig:i,lovelaceConfig:this.lovelace||s.lovelace,saveCardConfig:async i=>{if(!i)return;const e=[...this.G.cards];e[t]=i,this.G={...this.G,cards:e},this.li({reason:"child_dialog_saved_fallback"}),this.requestUpdate(),setTimeout(()=>this.xi(),100)}}})}else c("ERROR","SimpleSwipeCardEditor: Cannot find Home Assistant instance")}Si(t,i,e){{const t=e.composedPath?e.composedPath().map(t=>t.localName||t.nodeName).join(" > "):"No path",i=e.detail?JSON.stringify(e.detail,null,2):"{}";c("EVENT","Config change event details:",{target:e.target.localName,path:t,detail:JSON.parse(i),rawDetail:i,currentTarget:e.currentTarget.localName})}if(this.Qt(e)){if(c("ELEMENT",`[CARD INDEX ${t}] Element editor event detected, preserving and allowing propagation`),i.fi=!0,this.Zt.active=!0,this.Zt.timestamp=Date.now(),e.detail&&e.detail.config&&(i.wi=JSON.parse(JSON.stringify(e.detail.config)),i.bi=!0,i.mi))try{c("ELEMENT","Silently updating picture-elements config");const i=[...this.G.cards];i[t]=e.detail.config,this.G={...this.G,cards:i},this.li({maintainEditorState:!0,fromElementEditor:!0,elementEditorEvent:!0,updatedCardIndex:t})}catch(t){c("ERROR","Error silently updating config:",t)}}else if(e.target!==i&&e.detail&&e.detail.config){e.stopPropagation();const i=e.detail.config;c("EDITOR",`[CARD INDEX ${t}] Config received in handler: ${JSON.stringify(i.type)}`);const s=[...this.G.cards];s[t]=i,this.G={...this.G,cards:s},this.li({maintainEditorState:!0,updatedCardIndex:t,reason:"child_dialog_update_"+(e.detail.fromActionCardEditor?"action_card":"generic")}),this.requestUpdate(),c("EDITOR",`[CARD INDEX ${t}] Processed config-changed from content, stopped propagation OUTSIDE dialog.`)}else c("EDITOR",`[CARD INDEX ${t}] config-changed ignored or allowed to bubble (no config or event target is the dialog itself)`)}Ii(t,i){if(i.detail&&(i.detail.dialogTag&&("hui-dialog-edit-element"===i.detail.dialogTag||i.detail.dialogTag.includes("element-editor"))||i.detail.elementToEdit)){c("ELEMENT",`[CARD INDEX ${t}] Element editor dialog detected, allowing normal event flow`);const e=i.currentTarget;return e&&(e.fi=!0),this.Zt.active=!0,this.Zt.timestamp=Date.now(),void(i.detail&&i.detail.elementId&&(this.Zt.elementId=i.detail.elementId))}const e=i.detail?JSON.stringify(i.detail):"{}";c("EDITOR",`[CARD INDEX ${t}] INTERCEPTED "${i.type}" event from hui-dialog-edit-card OR ITS CONTENT`,{detail:JSON.parse(e),target:i.target.localName}),i.stopPropagation(),i.stopImmediatePropagation&&i.stopImmediatePropagation(),i.cancelable&&i.preventDefault(),c("EDITOR",`[CARD INDEX ${t}] Re-firing "${i.type}" event from SimpleSwipeCardEditor.`),E(this,i.type,i.detail)}async connectedCallback(){super.connectedCallback&&super.connectedCallback(),c("EDITOR","SimpleSwipeCardEditor connectedCallback");x(a,"Set").add(this),await this.Ti(),setTimeout(()=>this.xi(),50),document.addEventListener("config-changed",this.Bt,{capture:!0}),this.Ci=t=>{if(this.Qt(t)){if(c("ELEMENT","Config-changed event from element editor, allowing propagation"),t.target&&t.target.closest("hui-dialog-edit-card")){const i=t.target.closest("hui-dialog-edit-card");i&&(i.fi=!0,this.Zt.active=!0,this.Zt.parentDialogId=i.gi||null,this.Zt.timestamp=Date.now())}}else if("config-changed"===t.type&&t.detail?.config){const i="custom:actions-card"===t.detail?.config?.type;if("hui-card-picker"===t.target?.tagName?.toLowerCase()){if((t.composedPath?t.composedPath():[]).some(t=>t===this||t.shadowRoot&&t.shadowRoot.contains(this)||this.shadowRoot&&this.shadowRoot.contains(t))&&(c("EDITOR","Card picker selection captured by global handler:",t.detail.config.type),i&&!this.qt))return this.Gt={time:Date.now(),config:t.detail.config},this.qt=!0,this.$i(t.detail.config),t.stopImmediatePropagation&&t.stopImmediatePropagation(),void t.stopPropagation()}}},document.addEventListener("config-changed",this.Ci,{capture:!0}),this.Ni=t=>{if(t.ki)return c("EVENT","Intercepted iron-select event already processed by actions card editor"),void t.stopPropagation()},document.addEventListener("iron-select",this.Ni,{capture:!0}),this._i=t=>{if(t.target&&"HUI-DIALOG-EDIT-CARD"===t.target.tagName){const i=t.target;c("EDITOR","A HUI-DIALOG-EDIT-CARD closed",{tracked:this.Xt.has(i),isActions:this.si(i),handlingElementEdit:i.fi}),i.fi&&(c("ELEMENT","Dialog handling element edit is closing, ending element edit session"),this.Zt.active=!1,i.wi&&(c("ELEMENT","Preserving element config on dialog close"),this.Zt.savedState=i.wi,i.wi=null)),this.Xt.has(i)&&(this.Xt.delete(i),this.requestUpdate(),setTimeout(()=>this.xi(),100))}t.target&&("HUI-DIALOG-EDIT-ELEMENT"===t.target.tagName||"HUI-DIALOG"===t.target.tagName&&this.Qt(t))&&(c("ELEMENT","Element editor dialog closed"),setTimeout(()=>{this.Zt.active&&Date.now()-this.Zt.timestamp>500&&(c("ELEMENT","Resetting element edit session after timeout"),this.Zt.active=!1)},500))},document.addEventListener("dialog-closed",this._i,{capture:!0}),this.Ri=t=>{"element-updated"!==t.type&&"show-edit-element"!==t.type||this.Zt.active||(c("ELEMENT",`Capturing ${t.type} event, starting element edit session`),this.Zt.active=!0,this.Zt.timestamp=Date.now(),t.detail&&t.detail.elementId&&(this.Zt.elementId=t.detail.elementId))},document.addEventListener("element-updated",this.Ri,{capture:!0}),document.addEventListener("show-edit-element",this.Ri,{capture:!0})}async Ti(){let t=0;for(;!customElements.get("hui-card-picker")&&t<50;)await this.Di(),customElements.get("hui-card-picker")||(await new Promise(t=>setTimeout(t,100)),t++);customElements.get("hui-card-picker")||console.error("Failed to load hui-card-picker after multiple attempts")}async Di(){if(!customElements.get("hui-card-picker"))try{const t=[()=>customElements.get("hui-entities-card")?.getConfigElement?.(),()=>customElements.get("hui-conditional-card")?.getConfigElement?.(),()=>customElements.get("hui-vertical-stack-card")?.getConfigElement?.(),()=>customElements.get("hui-horizontal-stack-card")?.getConfigElement?.()];for(const i of t)try{if(await i(),customElements.get("hui-card-picker"))break}catch(t){}}catch(t){console.warn("Could not load hui-card-picker",t)}}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),c("EDITOR","SimpleSwipeCardEditor disconnectedCallback"),document.removeEventListener("config-changed",this.Ci,{capture:!0}),document.removeEventListener("iron-select",this.Ni,{capture:!0}),document.removeEventListener("config-changed",this.Bt,{capture:!0}),document.removeEventListener("dialog-closed",this._i,{capture:!0}),document.removeEventListener("element-updated",this.Ri,{capture:!0}),document.removeEventListener("show-edit-element",this.Ri,{capture:!0}),this.Xt.forEach(t=>{try{t.removeEventListener("config-changed",this.Oi),t.removeEventListener("show-dialog",this.Ai),t.removeEventListener("ll-show-dialog",this.Ai),t.close&&"function"==typeof t.close&&t.close(),t.parentNode&&t.parentNode.removeChild(t)}catch(t){console.warn("Error cleaning up dialog:",t)}}),this.Xt.clear(),this.Ut=null,this.Bt=null,this.Ci=null,this.Ni=null,this._i=null,this.Ri=null;x(a,"Set").delete(this);x(o).delete(this.Ft)}jt(t){if(this.Qt(t)){c("ELEMENT","Detected element editor event in _handleNestedCardEvents");if(t.composedPath&&t.composedPath().some(t=>this.Xt.has(t)||t.gi&&t.gi===this.Ft))return void c("ELEMENT","Element editor event is related to our dialog stack, handling specially")}if(t.Mi||!t.detail?.fromActionCardEditor)return;const i=t.target.closest("[data-index]");if(!i||!this.G?.cards)return;const e=parseInt(i.getAttribute("data-index"));if(!(isNaN(e)||e<0||e>=this.G.cards.length)){if(c("EVENT",`Handling nested card event from actions card at index ${e}`,t.detail),t.stopPropagation(),t.preventDefault&&t.preventDefault(),t.detail.maintainEditorState){c("EVENT","Event marked to maintain editor state, preventing propagation");const i=[...this.G.cards];i[e]=t.detail.config,this.G={...this.G,cards:i},this.li({nestedCardUpdate:!0,updatedCardIndex:e,nestedCardType:t.detail.config.type,maintainEditorState:!0})}else{const i=[...this.G.cards];i[e]=t.detail.config,this.G={...this.G,cards:i},this.li({nestedCardUpdate:!0,updatedCardIndex:e,nestedCardType:t.detail.config.type})}t.Mi=!0,this.requestUpdate()}}$i(t){if(t&&this.G)try{const i=Array.isArray(this.G.cards)?[...this.G.cards]:[],e={...this.G,cards:[...i,t]};this.G=e,this.li({isSafeCardAddition:!0,addedCardType:t.type}),this.requestUpdate(),setTimeout(()=>this.xi(),50),c("EDITOR","Safely added card:",t.type)}catch(t){c("ERROR","Failed to safely add card:",t)}}xi(){if(!this.shadowRoot)return void c("EDITOR","_ensureCardPickerLoaded: No shadowRoot, returning.");c("EDITOR","_ensureCardPickerLoaded called");const t=this.shadowRoot.querySelector("#card-picker-container");if(t){t.style.display="block",t.hasAttribute("event-barrier-applied")||(t.setAttribute("event-barrier-applied","true"),t.addEventListener("config-changed",t=>{if(c("EDITOR","Intercepted config-changed at container level:",t.detail?.config?.type),t.target&&t.target.tagName&&"hui-card-picker"===t.target.tagName.toLowerCase()&&t.detail&&t.detail.config){const i=t.detail.config;if(c("EDITOR","Processing card selection:",i.type),this.G){const t=Array.isArray(this.G.cards)?[...this.G.cards]:[];t.push(i),this.G={...this.G,cards:t},this.li({cardAdded:!0,cardType:i.type}),this.requestUpdate()}}return t.stopPropagation(),t.stopImmediatePropagation&&t.stopImmediatePropagation(),!1},{capture:!0}));const i=t.querySelector("hui-card-picker");i&&(i.style.display="block",i.requestUpdate&&i.requestUpdate())}this.requestUpdate()}setConfig(t){if(!t)throw new Error("Invalid configuration");if(c("EDITOR","Editor setConfig received:",JSON.stringify(t)),this.G=JSON.parse(JSON.stringify(t)),Array.isArray(this.G.cards)||(this.G.cards=[]),void 0===this.G.show_pagination&&(this.G.show_pagination=!0),void 0===this.G.card_spacing)this.G.card_spacing=15;else{const t=parseInt(this.G.card_spacing);this.G.card_spacing=isNaN(t)||t<0?15:t}void 0===this.G.enable_loopback&&(this.G.enable_loopback=!1),void 0!==this.G.swipe_direction&&["horizontal","vertical"].includes(this.G.swipe_direction)||(this.G.swipe_direction="horizontal"),void 0===this.G.enable_auto_swipe&&(this.G.enable_auto_swipe=!1),void 0===this.G.auto_swipe_interval?this.G.auto_swipe_interval=2e3:(this.G.auto_swipe_interval=parseInt(this.G.auto_swipe_interval),(isNaN(this.G.auto_swipe_interval)||this.G.auto_swipe_interval<500)&&(this.G.auto_swipe_interval=2e3)),void 0===this.G.enable_reset_after&&(this.G.enable_reset_after=!1),void 0===this.G.reset_after_timeout?this.G.reset_after_timeout=3e4:(this.G.reset_after_timeout=parseInt(this.G.reset_after_timeout),(isNaN(this.G.reset_after_timeout)||this.G.reset_after_timeout<5e3)&&(this.G.reset_after_timeout=3e4)),void 0===this.G.reset_target_card?this.G.reset_target_card=1:this.G.reset_target_card=Math.max(1,parseInt(this.G.reset_target_card)),delete this.G.title,setTimeout(()=>this.xi(),50)}Li(t){if(!this.G||!t.target)return;const i=t.target,e=i.configValue||i.getAttribute("data-option"),s=i.parentElement?.configValue||i.parentElement?.getAttribute("data-option"),n=e||s;if(!n)return;let o;"ha-entity-picker"===i.localName&&"value-changed"===t.type?o=t.detail.value||null:"ha-switch"===i.localName?o=i.checked:"ha-textfield"===i.localName&&"number"===i.type?(o=parseInt(i.value),(isNaN(o)||o<0)&&(o="card_spacing"===n?15:"auto_swipe_interval"===n?2e3:"reset_after_timeout"===n?3e4:0)):o=i.value,this.G[n]!==o&&(c("EDITOR",`Value changed for ${n}:`,o),this.G={...this.G,[n]:o},this.li())}li(t={}){!function(t,i,e={}){if(!i)return;const s=!e.maintainEditorState,n=new CustomEvent("config-changed",{detail:{config:i,...e},bubbles:s,composed:!0});c("EVENT","Firing config-changed event",{bubble:s,...e}),t.dispatchEvent(n)}(this,this.zi(this.G),{editorId:this.Ft,fromSwipeCardEditor:!0,...t})}Jt(t){if(c("EDITOR","Fallback _handleCardPicked called:",t.detail?.config?.type),t.stopPropagation(),t.stopImmediatePropagation&&t.stopImmediatePropagation(),!t.detail?.config)return;const i=t.detail.config;c("EDITOR","Adding card in fallback handler:",i.type);const e=Array.isArray(this.G.cards)?[...this.G.cards]:[],s={...this.G,cards:[...e,i]};this.G=s,this.li(),this.requestUpdate()}Pi(t){if(!t?.type)return{typeName:"Unknown",name:"",isPictureElements:!1};const i=t.type.startsWith("custom:")?t.type.substring(7):t.type;return{typeName:i.split(/[-_]/).map(t=>t.charAt(0).toUpperCase()+t.slice(1)).join(" "),name:t.title||t.name||"",isPictureElements:"picture-elements"===i}}Vi(t,i){if(!this.G?.cards)return;const e=[...this.G.cards],s=t+i;s<0||s>=e.length||(c("EDITOR",`Moving card ${t} to position ${s}`),[e[t],e[s]]=[e[s],e[t]],this.G={...this.G,cards:e},this.li(),this.requestUpdate())}Hi(t){if(!this.G?.cards||t<0||t>=this.G.cards.length)return;c("EDITOR",`Removing card at index ${t}`);const i=this.G.cards.filter((i,e)=>e!==t);this.G={...this.G,cards:i},this.li(),this.requestUpdate()}render(){if(!this.hass||!this.G)return l`<ha-circular-progress
        active
        alt="Loading editor"
  ...
  `}(this.G,this.Li.bind(this))}
        ${I(this.G,this.Kt,this.Li.bind(this),this.ri.bind(this),i,this.Wi.bind(this),this.Yi.bind(this),this.hass)}
        ${T(i,this.hass,this.Vi.bind(this),this.yi.bind(this),this.Hi.bind(this),this.Pi.bind(this),this.di.bind(this),this.ci.bind(this),this.ai.bind(this),this.hi.bind(this),this.ui.bind(this),this.pi.bind(this))}
        ${e=this.hass,s=this.lovelace,n=this.Ut,l`
