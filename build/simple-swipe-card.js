...
`;function Ct(t,i,e={}){try{((t,i,e={})=>{const s=new CustomEvent(i,{detail:e,bubbles:!0,composed:!0});t.dispatchEvent(s)})(t,i,e)}catch(s){d("ERROR","Failed to fire HA event:",i,s);const n=new CustomEvent(i,{detail:e,bubbles:!0,composed:!0});t.dispatchEvent(n)}}function $t(t,i="Map"){return window[t]||(window[t]="Set"===i?new Set:new Map),window[t]}class _t{constructor(t){this.card=t}async build(){if(this.card.building)return void d("INIT","Build already in progress, skipping.");if(!this.card.ii||!this.card.ii.cards||!this.card.isConnected)return void d("INIT","Build skipped (no config/cards or not connected).");this.card.building=!0,d("INIT","Starting build..."),this.card.resetAfter?.preserveState(),this.card.cards=[];this.card.currentIndex;if(this.card.ii.state_entity&&this.card.Oi||(this.card.currentIndex=0),this.card.virtualIndex=0,this.card.realIndex=0,this.card.resizeObserver?.cleanup(),this.card.swipeGestures?.removeGestures(),this.card.autoSwipe?.stop(),this.card.resetAfter?.stopTimer(),!this.card.shadowRoot)return d("INIT","Waiting for LitElement to create shadowRoot..."),setTimeout(()=>{this.card.isConnected&&this.build()},10),void(this.card.building=!1);this.card.shadowRoot&&(this.card.shadowRoot.innerHTML="");const t=this.card.shadowRoot;d("INIT","Building with shadowRoot:",!!t);const i=await vt();if(!i)return console.error("SimpleSwipeCard: Card helpers not loaded."),t.innerHTML='<ha-alert alert-type="error">Card Helpers are required for this card to function. Please ensure they are loaded.</ha-alert>',this.card.building=!1,void(this.card.initialized=!1);const e=document.createElement("style");if(e.textContent='\n     :host {\n        display: block;\n        overflow: hidden;\n        width: 100%;\n        height: 100%;\n        position: relative;\n        border-radius: var(--ha-card-border-radius, 12px);\n        background: transparent;\n     }\n\n     :host([data-vertical-no-grid]:not([data-editor-mode])) {\n       height: 250px; /* Set a reasonable default height for the whole card */\n     }\n\n     :host([data-vertical-no-grid]:not([data-editor-mode])) .card-container {\n       height: 100%;\n       max-height: 100%;\n     }\n\n     :host([data-vertical-no-grid]:not([data-editor-mode])) .slider[data-swipe-direction="vertical"] {\n       height: 100%;\n       max-height: 100%;\n     }\n\n     :host([data-vertical-no-grid]:not([data-editor-mode])) .slider[data-swipe-direction="vertical"] .slide {\n       height: 100%;\n       min-height: 100%;\n       max-height: 100%;\n       flex: 0 0 100%;\n     } \n\n     /* Auto Height Mode */\n     :host([data-auto-height]:not([data-editor-mode])) .card-container {\n       height: auto;\n       transition: height 0.2s ease-out;\n     }\n\n     :host([data-auto-height]:not([data-editor-mode])) .slider[data-swipe-direction="horizontal"] {\n       height: auto;\n       align-items: flex-start; /* prevents flex from stretching children */\n     }\n\n     :host([data-auto-height]:not([data-editor-mode])) .slider[data-swipe-direction="horizontal"] .slide {\n       height: auto;\n       min-height: 0;\n       max-height: none;\n       flex-basis: auto;\n     }\n\n     /* Override child card heights */\n     :host([data-auto-height]:not([data-editor-mode])) .slide > * > ha-card,\n     :host([data-auto-height]:not([data-editor-mode])) .slide > * > .card-content {\n       height: auto;\n     } \n\n     /* --- START PREVIEW STYLES --- */\n     .preview-container {\n        display: flex;\n        flex-direction: column;\n        align-items: center;\n        justify-content: center;\n        text-align: center;\n        padding: 16px;\n        box-sizing: border-box;\n        height: 100%;\n        background: var(--ha-card-background, var(--card-background-color, white));\n        border-radius: var(--ha-card-border-radius, 12px);\n        border: none; /* Ensure no border */\n     }\n     .preview-icon-container {\n        margin-bottom: 16px;\n     }\n     .preview-icon-container ha-icon {\n        color: var(--primary-color, #03a9f4); /* Use primary color for consistency */\n        font-size: 48px; /* Match Actions Card */\n        width: 48px;\n        height: 48px;\n     }\n     .preview-text-container {\n        margin-bottom: 16px;\n     }\n     .preview-title {\n        font-size: 18px;\n        font-weight: bold;\n        margin-bottom: 8px;\n        color: var(--primary-text-color);\n     }\n     .preview-description {\n        font-size: 14px;\n        color: var(--secondary-text-color);\n        max-width: 300px;\n        line-height: 1.4;\n        margin: 0 auto; /* Center description text block */\n     }\n     .preview-actions ha-button {\n       /* Rely on default raised button styles for consistency */\n     }\n     /* --- END PREVIEW STYLES --- */\n\n     .card-container {\n        position: relative;\n        width: 100%;\n        height: 100%;\n        overflow: hidden;\n        border-radius: inherit;\n        background: transparent;\n     }\n     .slider {\n        position: relative;\n        display: flex;\n        height: 100%;\n        transition: transform var(--simple-swipe-card-transition-speed, 0.3s) var(--simple-swipe-card-transition-easing, ease-out);\n        will-change: transform;\n        background: transparent;\n     }\n\n     .slider.dropdown-fix-active {\n        transform: none !important;\n        will-change: auto !important;\n        transition: none !important;\n     }\n\n     /* Immediately hide all slides except the current one during dropdown fix */\n     .slider.dropdown-fix-active-hide-adjacent .slide {\n       display: none !important;\n     }\n\n     /* Show only the current slide during dropdown fix */\n     .slider.dropdown-fix-active-hide-adjacent .slide.current-active {\n       display: flex !important;\n       overflow: visible !important;\n     }     \n     \n     /* Horizontal slider (default) */\n     .slider[data-swipe-direction="horizontal"] {\n        flex-direction: row;\n     }\n     \n     /* Vertical slider */\n     .slider[data-swipe-direction="vertical"] {\n        flex-direction: column;\n        height: 100%;\n        max-height: 100%;\n        overflow: visible; /* Allow transforms to move content outside */\n        flex-wrap: nowrap;\n     }\n     \n     .slide {\n        flex: 0 0 100%;\n        width: 100%;\n        min-width: 100%;\n        height: 100%;\n        min-height: 100%;\n        box-sizing: border-box;\n        position: relative;\n        display: flex;\n        flex-direction: column;\n        overflow: hidden;\n        background: transparent;\n     }\n\n    .slide.carousel-mode {\n      flex: 0 0 auto; /* Don\'t grow/shrink, use calculated width */\n      width: var(--carousel-card-width); /* Will be set dynamically */\n      min-width: var(--carousel-card-width);\n    }\n\n    /* Carousel container adjustments */\n    .slider[data-view-mode="carousel"] {\n      /* Allow overflow to show partial cards */\n      overflow: visible;\n    }\n\n    .card-container[data-view-mode="carousel"] {\n      /* Ensure container can handle overflow */\n      overflow: hidden;\n      position: relative;\n    }\n\n    .pagination {\n        position: absolute;\n        display: flex;\n        justify-content: center;\n        z-index: 1;\n        background-color: var(--simple-swipe-card-pagination-background, transparent);\n        pointer-events: auto;\n        transition: opacity 0.2s ease-in-out;\n        padding: var(--simple-swipe-card-pagination-padding, 4px 8px);\n        border-radius: 12px;\n        /* Prevent container from sizing to content during animations */\n        box-sizing: border-box;\n    }\n\n    /* Horizontal pagination (bottom) */\n    .pagination.horizontal {\n        bottom: var(--simple-swipe-card-pagination-bottom, 8px);\n        left: 50%;\n        transform: translateX(-50%);\n        flex-direction: row;\n        align-items: center;\n        /* Remove any height properties - will be set by JavaScript */\n    }\n\n    /* Vertical pagination (right) */\n    .pagination.vertical {\n        right: var(--simple-swipe-card-pagination-right, 8px);\n        top: 50%;\n        transform: translateY(-50%);\n        flex-direction: column;\n        align-items: center;\n        /* Remove any width properties - will be set by JavaScript */\n    }\n    \n     .pagination.hide {\n        opacity: 0;\n        pointer-events: none;\n     }\n\n    .pagination-dot {\n        width: var(--simple-swipe-card-pagination-dot-size, 8px);\n        height: var(--simple-swipe-card-pagination-dot-size, 8px);\n        border-radius: var(--simple-swipe-card-pagination-border-radius, 50%);\n        background-color: var(--simple-swipe-card-pagination-dot-inactive-color, rgba(127, 127, 127, 0.6));\n        cursor: pointer;\n        opacity: var(--simple-swipe-card-pagination-dot-inactive-opacity, 1);\n        \n        /* Border support */\n        border-width: var(--simple-swipe-card-pagination-dot-border-width, 0px);\n        border-color: var(--simple-swipe-card-pagination-dot-border-color, transparent);\n        border-style: var(--simple-swipe-card-pagination-dot-border-style, solid);\n        \n        /* Box shadow support */\n        box-shadow: var(--simple-swipe-card-pagination-dot-box-shadow, none);\n        \n        /* Updated transition to include new animatable properties */\n        transition: background-color 0.2s ease, width 0.2s ease, height 0.2s ease, border-color 0.2s ease, box-shadow 0.2s ease, transform 0.2s ease;\n    }\n    \n    /* Hover effects */\n    .pagination-dot:hover {\n        background-color: var(--simple-swipe-card-pagination-dot-hover-color, var(--simple-swipe-card-pagination-dot-inactive-color, rgba(127, 127, 127, 0.6)));\n        opacity: var(--simple-swipe-card-pagination-dot-hover-opacity, var(--simple-swipe-card-pagination-dot-inactive-opacity, 1));\n        border-color: var(--simple-swipe-card-pagination-dot-hover-border-color, var(--simple-swipe-card-pagination-dot-border-color, transparent));\n        transform: var(--simple-swipe-card-pagination-dot-hover-transform, none);\n        box-shadow: var(--simple-swipe-card-pagination-dot-hover-box-shadow, var(--simple-swipe-card-pagination-dot-box-shadow, none));\n    }    \n\n    /* Active hover state */\n    .pagination-dot.active:hover {\n        background-color: var(--simple-swipe-card-pagination-dot-active-hover-color, var(--simple-swipe-card-pagination-dot-active-color, var(--primary-color, #03a9f4)));\n        opacity: var(--simple-swipe-card-pagination-dot-active-hover-opacity, var(--simple-swipe-card-pagination-dot-active-opacity, 1));\n        border-color: var(--simple-swipe-card-pagination-dot-active-hover-border-color, var(--simple-swipe-card-pagination-dot-active-border-color, var(--simple-swipe-card-pagination-dot-border-color, transparent)));\n        transform: var(--simple-swipe-card-pagination-dot-active-hover-transform, var(--simple-swipe-card-pagination-dot-hover-transform, none));\n        box-shadow: var(--simple-swipe-card-pagination-dot-active-hover-box-shadow, var(--simple-swipe-card-pagination-dot-active-box-shadow, var(--simple-swipe-card-pagination-dot-box-shadow, none)));\n    }    \n\n    /* Spacing for horizontal pagination dots */\n    .pagination.horizontal .pagination-dot {\n        margin: 0 var(--simple-swipe-card-pagination-dot-spacing, 4px);\n    }\n    \n    /* Spacing for vertical pagination dots */\n    .pagination.vertical .pagination-dot {\n        margin: var(--simple-swipe-card-pagination-dot-spacing, 4px) 0;\n    }\n    \n    .pagination-dot.active {\n        background-color: var(--simple-swipe-card-pagination-dot-active-color, var(--primary-color, #03a9f4));\n        width: var(--simple-swipe-card-pagination-dot-active-size, var(--simple-swipe-card-pagination-dot-size, 8px));\n        height: var(--simple-swipe-card-pagination-dot-active-size, var(--simple-swipe-card-pagination-dot-size, 8px));\n        opacity: var(--simple-swipe-card-pagination-dot-active-opacity, 1);\n        \n        /* Separate active border radius */\n        border-radius: var(--simple-swipe-card-pagination-dot-active-border-radius, var(--simple-swipe-card-pagination-border-radius, 50%));\n        \n        /* Active border support */\n        border-width: var(--simple-swipe-card-pagination-dot-active-border-width, var(--simple-swipe-card-pagination-dot-border-width, 0px));\n        border-color: var(--simple-swipe-card-pagination-dot-active-border-color, var(--simple-swipe-card-pagination-dot-border-color, transparent));\n        border-style: var(--simple-swipe-card-pagination-dot-active-border-style, var(--simple-swipe-card-pagination-dot-border-style, solid));\n        \n        /* Active box shadow support */\n        box-shadow: var(--simple-swipe-card-pagination-dot-active-box-shadow, var(--simple-swipe-card-pagination-dot-box-shadow, none));\n    }\n\n     ha-alert {\n        display: block;\n        margin: 0;\n        width: 100%;\n        box-sizing: border-box;\n        border-radius: 0;\n        border: none;\n        background-color: transparent;\n     }\n     .slide > *:first-child {\n        flex-grow: 1;\n        width: 100%;\n        display: flex;\n        flex-direction: column;\n        min-height: 0;\n     }\n     .slide > * > ha-card,\n     .slide > * > .card-content {\n        margin: 0 !important;\n        padding: 0 !important;\n        box-shadow: none !important;\n        border-radius: 0 !important;\n        border: none !important;\n        height: 100%;\n        display: flex;\n        flex-direction: column;\n     }\n   ',t.appendChild(e),this.card.cardContainer=document.createElement("div"),this.card.cardContainer.className="card-container",this.card.sliderElement=document.createElement("div"),this.card.sliderElement.className="slider",this.card.sliderElement.setAttribute("data-swipe-direction",this.card.Qt),this.card.cardContainer.appendChild(this.card.sliderElement),t.appendChild(this.card.cardContainer),this.card.Vi(),0===this.card.ii.cards.length){d("INIT","Building preview state.");const i=function(t,i){const e=document.createElement("div");e.className="preview-container";const s=document.createElement("div");s.className="preview-icon-container";const n=document.createElement("ha-icon");n.icon="horizontal"===t?"mdi:gesture-swipe-horizontal":"mdi:gesture-swipe-vertical",s.appendChild(n);const o=document.createElement("div");o.className="preview-text-container";const a=document.createElement("div");a.className="preview-title",a.textContent="Simple Swipe Card";const r=document.createElement("div");r.className="preview-description",r.textContent=`Create a swipeable container with multiple cards. Swipe ${"horizontal"===t?"horizontally":"vertically"} between cards. Open the editor to add your first card.`,o.appendChild(a),o.appendChild(r);const h=document.createElement("div");h.className="preview-actions";const d=document.createElement("ha-button");return d.raised=!0,d.textContent="EDIT CARD",d.setAttribute("aria-label","Edit Card"),d.addEventListener("click",i),h.appendChild(d),e.appendChild(s),e.appendChild(o),e.appendChild(h),e}(this.card.Qt,t=>function(t,i){t.stopPropagation(),d("EDITOR","Edit button clicked, firing show-edit-card event"),Ct(i,"show-edit-card",{element:i})}(t,this.card));return t.innerHTML="",t.appendChild(e),t.appendChild(i),this.card.initialized=!0,void(this.card.building=!1)}if(0===this.card.visibleCardIndices.length)return d("INIT","No visible cards, hiding entire card."),this.card.style.display="none",t.innerHTML="",this.card.initialized=!0,void(this.card.building=!1);this.card.style.display="block",this.card.loopMode.initialize();const s=this.card.loopMode.prepareCardsForLoading(this.card.visibleCardIndices,this.card.ii.cards);this.card.loopMode.isInfiniteMode,d("INIT","Building cards:",{totalVisible:this.card.visibleCardIndices.length,totalToLoad:s.length,infiniteMode:this.card.loopMode.isInfiniteMode});if("carousel"===(this.card.ii.view_mode||"single")){d("INIT","Carousel mode detected - creating DOM structure for layout, loading content progressively"),s.forEach(t=>{const i=St();i.setAttribute("data-index",t.originalIndex),i.setAttribute("data-visible-index",t.visibleIndex),t.isDuplicate&&i.setAttribute("data-duplicate","true"),t.config?.type&&i.setAttribute("data-card-type",t.config.type),this.card.cards.push({visibleIndex:t.visibleIndex,originalIndex:t.originalIndex,slide:i,config:JSON.parse(JSON.stringify(t.config)),error:!1,isDuplicate:t.isDuplicate,element:null,contentLoaded:!1}),this.card.sliderElement.appendChild(i),this.card.autoHeight?.enabled&&this.card.autoHeight.observeSlide(i,t.visibleIndex)}),this.card.cards.sort((t,i)=>t.visibleIndex-i.visibleIndex),d("INIT","Carousel DOM structure created, now loading content progressively");const t=this.Bi(s),e=t[0]||[];e.length>0&&await this.Yi(e,i,"priority");for(let e=1;e<t.length;e++){const s=t[e];setTimeout(async()=>{this.card.isConnected&&await this.Yi(s,i,`batch-${e+1}`)},150*e)}}else{const t=this.Bi(s);d("INIT","Single mode stagger loading strategy:",{totalBatches:t.length,batchSizes:t.map(t=>t.length),firstBatchCards:t[0]?.map(t=>`${t.visibleIndex}(${t.originalIndex})`)||[]});const e=t[0]||[];if(e.length>0){d("INIT","Loading priority batch immediately:",e.length);const t=e.map(t=>this.createCard(t.config,t.visibleIndex,t.originalIndex,i,t.isDuplicate).catch(i=>(console.warn(`Priority card ${t.visibleIndex} failed to load:`,i),null)));await Promise.allSettled(t),this.Wi(),d("INIT","Priority batch loaded and displayed")}for(let e=1;e<t.length;e++){const s=t[e],n=200*e;setTimeout(async()=>{if(!this.card.isConnected)return;d("INIT",`Loading batch ${e+1}/${t.length} after ${n}ms`);const o=s.map(t=>this.createCard(t.config,t.visibleIndex,t.originalIndex,i,t.isDuplicate).catch(i=>(console.warn(`Background card ${t.visibleIndex} failed to load:`,i),null)));await Promise.allSettled(o),this.Wi(),d("INIT",`Batch ${e+1} completed`)},n)}this.Wi()}if(this.card.ii.state_entity&&this.card.Oi){const t=this.Hi();t!==this.card.currentIndex&&(d("STATE","Setting initial index from state sync:",t),this.card.currentIndex=t)}this.card.pagination.create(),d("INIT","All cards initialized."),this.card.initialized||(this.card.initialized=!0),requestAnimationFrame(()=>{this.finishBuildLayout()}),this.card.building=!1,d("INIT","Build completed successfully")}async createCard(t,i,e,s,n=!1){const o=St();let a;const r={visibleIndex:i,originalIndex:e,slide:o,config:JSON.parse(JSON.stringify(t)),error:!1,isDuplicate:n};try{a=await s.createCardElement(t),this.card.Oi&&(a.hass=this.card.Oi,d("INIT",`Set hass immediately after creation for card ${i} (type: ${t.type})`)),r.element=a,"picture-elements"===t.type&&(a.setAttribute("data-swipe-card-picture-elements","true"),o.setAttribute("data-has-picture-elements","true")),o.appendChild(a),await new Promise(t=>{requestAnimationFrame(()=>{setTimeout(t,30)})}),requestAnimationFrame(()=>{try{if("todo-list"===t.type){const t=a.shadowRoot?.querySelector("ha-textfield"),i=t?.shadowRoot?.querySelector("input");i&&(i.enterKeyHint="done")}}catch(t){console.warn("Error applying post-creation logic:",t)}})}catch(n){d("ERROR",`Error creating card ${i} (original ${e}):`,t,n),r.error=!0;const a=await s.createErrorCardElement({type:"error",error:`Failed to create card: ${n.message}`,origConfig:t},this.card.Oi);r.element=a,o.appendChild(a)}this.card.cards.push(r)}Fi(t,i){d("VISIBILITY",`Conditional card ${t} visibility changed to: ${i}`);const e=this.card.cards.find(i=>i.originalIndex===t);e&&(e.conditionallyVisible=i),this.card.Ui()}finishBuildLayout(){if(!this.card.cardContainer||!this.card.isConnected||this.card.building)return void d("INIT","_finishBuildLayout skipped",{container:!!this.card.cardContainer,connected:this.card.isConnected,building:this.card.building});d("INIT","Finishing build layout...");const t=this.card.cardContainer.offsetWidth,i=this.card.cardContainer.offsetHeight;if(t<=0||i<=0){if(null===this.card.offsetParent)return void d("INIT","Layout calculation skipped, element is hidden.");if(this.card.ji=(this.card.ji||0)+1,this.card.ji<5)return d("INIT",`Container dimensions are 0, retrying layout (attempt ${this.card.ji}/5)...`),void setTimeout(()=>requestAnimationFrame(()=>this.finishBuildLayout()),100);{console.warn("SimpleSwipeCard: Failed to get container dimensions after 5 retries. Proceeding with fallback dimensions. This may indicate a child card failed to load.");const t=300,i=100;this.card.slideWidth=t,this.card.slideHeight=i,this.card.ji=0,d("INIT",`Using fallback dimensions: ${t}x${i}px`)}}else this.card.ji=0,this.card.slideWidth=t,this.card.slideHeight=i;const e=this.card.ii.view_mode||"single";"carousel"===e&&this.Gi(this.card.slideWidth,this.card.slideHeight);const s=this.card.visibleCardIndices.length;this.card.currentIndex=Math.max(0,Math.min(this.card.currentIndex,s-1)),function(t,i){const e=getComputedStyle(i).borderRadius;t.forEach(t=>{t&&t.slide&&(t.slide.style.borderRadius=e)})}(this.card.cards,this.card.cardContainer),this.card.sliderElement&&(this.card.sliderElement.style.opacity="0"),this.card.updateSlider(!1),this.card.Ji(),s>1?this.card.swipeGestures?.addGestures():this.card.swipeGestures?.removeGestures(),d("INIT","Layout finished, slideWidth:",this.card.slideWidth,"slideHeight:",this.card.slideHeight,"currentIndex:",this.card.currentIndex,"visible cards:",s,"view mode:",e),this.card.autoSwipe?.manage(),this.card.resetAfter?.manage(),this.card.stateSynchronization?.manage(),this.card.ki?(d("CARD_MOD","Applying card-mod styles in finishBuildLayout"),this.card.Di(),this.card.Xi(),setTimeout(()=>{this.card.isConnected&&this.recalculateCarouselLayout()},100)):d("CARD_MOD","No card-mod config found in finishBuildLayout"),setTimeout(()=>{if(this.card.isConnected&&this.card.cardContainer&&this.card.sliderElement){const t=this.card.cardContainer.offsetWidth,i=this.card.cardContainer.offsetHeight;(Math.abs(t-this.card.slideWidth)>1||Math.abs(i-this.card.slideHeight)>1)&&(d("INIT",`Layout settled to new dimensions (${t}x${i}px), re-updating slider.`),this.card.slideWidth=t,this.card.slideHeight=i,this.card.updateSlider(!1)),this.card.sliderElement.style.transition="opacity 0.2s ease-in",this.card.sliderElement.style.opacity="1",setTimeout(()=>{this.card.sliderElement&&(this.card.sliderElement.style.transition="")},200)}},50)}Hi(){if(!this.card.ii.state_entity||!this.card.Oi)return this.card.currentIndex;const t=this.card.ii.state_entity,i=this.card.Oi.states[t];if(!i)return d("STATE","State entity not found during build:",t),this.card.currentIndex;const e=i.state;let s=null;if(t.startsWith("input_select.")){if(!i.attributes.options||!Array.isArray(i.attributes.options))return this.card.currentIndex;const t=i.attributes.options.indexOf(e);-1!==t&&t<this.card.visibleCardIndices.length&&(s=t)}else if(t.startsWith("input_number.")){const t=parseInt(e);if(!isNaN(t)){const i=t-1;i>=0&&i<this.card.visibleCardIndices.length&&(s=i)}}return null!==s?(d("STATE",`State sync initial index determined during build: ${s} from entity state: ${e}`),s):this.card.currentIndex}qi(t,i){const e=getComputedStyle(this.card).getPropertyValue("--carousel-card-width").trim();if(d("INIT","Checking for CSS override:",{computedWidth:e,hasValue:!!e,isEmpty:""===e,isAuto:"auto"===e}),e&&""!==e&&"auto"!==e){const s=parseFloat(e),n=(t+i)/(s+i);return d("INIT","✅ Using CSS-overridden card width:",{cardWidth:s.toFixed(2),cardsVisible:n.toFixed(2),source:"card-mod or CSS"}),{cardWidth:s,cardsVisible:Math.max(1.1,n)}}let s;if(d("INIT","❌ No CSS override found, calculating from config"),void 0!==this.card.ii.cards_visible)s=this.card.ii.cards_visible,d("INIT","Using legacy cards_visible approach:",s);else{const e=this.card.ii.card_min_width||200,n=(t+i)/(e+i);s=Math.max(1.1,Math.round(10*n)/10),d("INIT","Using responsive approach:",{minWidth:e,containerWidth:t,cardSpacing:i,rawCardsVisible:n.toFixed(2),finalCardsVisible:s})}return{cardWidth:(t-(s-1)*i)/s,cardsVisible:s}}recalculateCarouselLayout(){if("carousel"!==(this.card.ii.view_mode||"single"))return;const t=this.card.cardContainer?.offsetWidth;t&&(d("INIT","🔄 Recalculating carousel layout after card-mod"),this.Gi(t),this.card.updateSlider(!1))}Gi(t){const i=Math.max(0,parseInt(this.card.ii.card_spacing))||0,{cardWidth:e,cardsVisible:s}=this.qi(t,i);d("INIT","Carousel layout setup:",{containerWidth:t,cardsVisible:s.toFixed(2),cardSpacing:i,cardWidth:e.toFixed(2)});const n=getComputedStyle(this.card).getPropertyValue("--carousel-card-width").trim();n&&""!==n&&"auto"!==n?d("INIT","Skipping CSS variable set - already overridden:",n):(this.card.style.setProperty("--carousel-card-width",`${e}px`),d("INIT","Set --carousel-card-width to calculated value:",`${e}px`)),this.card.Zi=e,this.card.Ki=s,this.card.sliderElement.setAttribute("data-view-mode","carousel"),this.card.cardContainer.setAttribute("data-view-mode","carousel"),this.card.cards.forEach(t=>{t&&t.slide&&t.slide.classList.add("carousel-mode")})}Bi(t){const i=this.card.currentIndex||0,e=this.card.ii.view_mode||"single",s=this.card.loopMode.isInfiniteMode;d("INIT","Determining visible cards for stagger loading:",{currentIndex:i,viewMode:e,isInfiniteMode:s,totalCardsToLoad:t.length});let n=[];if(s)n=this.Qi(i,t,e);else{const t=this.card.visibleCardIndices.length;if("single"===e)n=[i-1,i,i+1].filter(i=>i>=0&&i<t);else if("carousel"===e){const e=this.te(i,t);n=[];for(let t=e.startIndex;t<=e.endIndex;t++)n.push(t)}else n=[i]}const o=[],a=[];t.forEach(t=>{n.includes(t.visibleIndex)?(o.push(t),d("INIT",`Priority card: visibleIndex ${t.visibleIndex}, originalIndex ${t.originalIndex}, isDuplicate: ${t.isDuplicate}`)):a.push(t)}),o.sort((t,e)=>Math.abs(t.visibleIndex-i)-Math.abs(e.visibleIndex-i));const r=[];if("carousel"===e&&o.length>0)r.push(o),d("INIT",`Carousel mode: All ${o.length} priority cards in first batch`);else for(let t=0;t<o.length;t+=3)r.push(o.slice(t,t+3));for(let t=0;t<a.length;t+=3)r.push(a.slice(t,t+3));return d("INIT","Batch creation completed:",{visibleIndices:n,priorityCards:o.map(t=>`${t.visibleIndex}(${t.originalIndex}${t.isDuplicate?"D":""})`),regularCards:a.map(t=>`${t.visibleIndex}(${t.originalIndex}${t.isDuplicate?"D":""})`),totalBatches:r.length,firstBatchSize:r[0]?.length||0}),r}Qi(t,i,e){const s=this.card.visibleCardIndices.length,n=this.card.loopMode.getDuplicateCount(),o=n+t;d("INIT","Infinite mode position mapping:",{virtualCurrentIndex:t,realDOMPosition:o,duplicateCount:n,totalRealCards:s,totalCardsInDOM:i.length});let a=[];if("single"===e)a=[o-1,o,o+1].filter(t=>t>=0&&t<i.length);else if("carousel"===e){const t=this.ie();let e=o,s=Math.min(i.length-1,e+Math.ceil(t)-1);s>=i.length&&(s=i.length-1,e=Math.max(0,s-Math.ceil(t)+1));for(let t=e;t<=s;t++)a.push(t);d("INIT","Infinite carousel visible range calculation:",{cardsVisible:t,realDOMPosition:o,startDOM:e,endDOM:s,visibleDOMPositions:a,calculation:`Start from DOM ${o}, show ${Math.ceil(t)} cards: ${e} to ${s}`})}else a=[o];const r=[];return a.forEach(t=>{if(t>=0&&t<i.length){const e=i[t];e&&r.push(e.visibleIndex)}}),r}ie(){if(void 0!==this.card.ii.cards_visible)return this.card.ii.cards_visible;const t=this.card.cardContainer?.offsetWidth||300,i=this.card.ii.card_min_width||200,e=Math.max(0,parseInt(this.card.ii.card_spacing))||0,s=Math.max(1,(t+e)/(i+e));return Math.max(1.1,Math.round(10*s)/10)}te(t,i){const e=this.ie();if(i<=Math.floor(e))return{startIndex:0,endIndex:i-1,cardsVisible:e};const s=e/2;let n=t-Math.floor(s);n<0&&(n=0);let o=n+Math.ceil(e)-1;o>=i&&(o=i-1,n=Math.max(0,o-Math.ceil(e)+1));return{startIndex:Math.max(0,Math.floor(n)),endIndex:Math.min(o,i-1),cardsVisible:e}}async Yi(t,i,e){d("INIT",`Loading carousel ${e} content:`,t.length);const s=t.map(async t=>{try{const e=this.card.cards.find(i=>i.visibleIndex===t.visibleIndex&&i.originalIndex===t.originalIndex);if(!e||e.contentLoaded)return null;const s=await i.createCardElement(t.config);return this.card.Oi&&(s.hass=this.card.Oi),"picture-elements"===t.config.type&&(s.setAttribute("data-swipe-card-picture-elements","true"),e.slide.setAttribute("data-has-picture-elements","true")),requestAnimationFrame(()=>{try{if("todo-list"===t.config.type){const t=s.shadowRoot?.querySelector("ha-textfield"),i=t?.shadowRoot?.querySelector("input");i&&(i.enterKeyHint="done")}}catch(t){console.warn("Error applying post-creation logic:",t)}}),e.slide.appendChild(s),e.element=s,e.contentLoaded=!0,s}catch(e){d("ERROR",`Error loading carousel card ${t.visibleIndex}:`,e);const s=this.card.cards.find(i=>i.visibleIndex===t.visibleIndex&&i.originalIndex===t.originalIndex);if(s){s.error=!0,s.contentLoaded=!0;try{const n=await i.createErrorCardElement({type:"error",error:`Failed to create card: ${e.message}`,origConfig:t.config},this.card.Oi);s.slide.appendChild(n),s.element=n}catch(t){console.error("Failed to create error card:",t)}}return null}});await Promise.allSettled(s),d("INIT",`Carousel ${e} content loading completed`)}Wi(){if(!this.card.sliderElement)return void d("ERROR","_insertLoadedCardsIntoDom: sliderElement is null, skipping");const t=this.card.cards.filter(t=>t&&t.slide&&!t.slide.parentElement).sort((t,i)=>t.visibleIndex-i.visibleIndex);t.forEach(t=>{t.slide.setAttribute("data-index",t.originalIndex),t.slide.setAttribute("data-visible-index",t.visibleIndex),t.isDuplicate&&t.slide.setAttribute("data-duplicate","true"),t.config?.type&&t.slide.setAttribute("data-card-type",t.config.type);const i=Array.from(this.card.sliderElement.children);let e=i.length;for(let s=0;s<i.length;s++){if(parseInt(i[s].getAttribute("data-visible-index")||"0")>t.visibleIndex){e=s;break}}e===i.length?this.card.sliderElement.appendChild(t.slide):this.card.sliderElement.insertBefore(t.slide,i[e]),this.card.autoHeight?.enabled&&this.card.autoHeight.observeSlide(t.slide,t.visibleIndex)})}}class Ot{constructor(t){this.card=t,this.ee=null,this.se=null,this.ne=null,this.oe=!1,this.ae=null,this.re=this.he.bind(this)}manage(){this.card.initialized&&this.card.isConnected&&(this.stop(),this.card.ii.state_entity&&this.card.Oi?(this.ee=this.card.ii.state_entity,this.de()?(d("STATE","State synchronization enabled for entity:",this.ee),this.ce()):(d("STATE","Invalid or missing entity:",this.ee),this.ee=null)):d("STATE","State synchronization disabled",{hasEntity:!!this.card.ii.state_entity,hasHass:!!this.card.Oi}))}stop(){this.ae&&(clearTimeout(this.ae),this.ae=null),this.ee=null,this.se=null,this.ne=null,this.oe=!1}onCardNavigate(t){if(!this.ee||!this.card.Oi||this.oe)return;const i=this.le(t);if(null===i)return;const e=this.card.Oi.states[this.ee];if(e&&e.state===i)d("STATE","Entity already at correct state:",i);else{d("STATE",`Updating entity ${this.ee} to:`,i),this.oe=!0;try{"input_select"===this.se?this.card.Oi.callService("input_select","select_option",{entity_id:this.ee,option:i}):"input_number"===this.se&&this.card.Oi.callService("input_number","set_value",{entity_id:this.ee,value:i}),this.ne=i,setTimeout(()=>{this.oe=!1},500)}catch(t){d("ERROR","Failed to update entity:",t),this.oe=!1}}}de(){if(!this.card.Oi||!this.ee)return!1;const t=this.card.Oi.states[this.ee];if(!t)return d("STATE","Entity not found:",this.ee),!1;if(this.ee.startsWith("input_select.")){if(this.se="input_select",!t.attributes.options||!Array.isArray(t.attributes.options))return d("STATE","input_select entity has no options:",this.ee),!1}else{if(!this.ee.startsWith("input_number."))return d("STATE","Entity is not input_select or input_number:",this.ee),!1;this.se="input_number"}return!0}ce(){if(!this.card.Oi||!this.ee)return;const t=this.card.Oi.states[this.ee];if(!t)return;this.ne=t.state;const i=this.pe(t.state);null===i||i!==this.card.currentIndex?null!==i&&i!==this.card.currentIndex&&(d("STATE",`Initial sync: setting card to index ${i} from entity state:`,t.state),this.card.ii.enable_auto_swipe&&this.card.autoSwipe?.pause(2e3),this.card.goToSlide(i,1,!1)):d("STATE",`Initial sync: card already at correct position ${i}, skipping initial positioning`)}he(){if(!this.card.Oi||!this.ee||this.oe)return;const t=this.card.Oi.states[this.ee];if(!t)return;const i=t.state;if(i===this.ne)return;d("STATE",`Entity ${this.ee} changed from "${this.ne}" to "${i}"`),this.ne=i;const e=this.pe(i);null!==e&&e!==this.card.currentIndex&&(d("STATE",`Navigating to card index ${e} from entity change`),this.card.ii.enable_auto_swipe&&this.card.autoSwipe?.pause(5e3),this.card.goToSlide(e))}pe(t){if("input_select"===this.se){const i=this.card.Oi.states[this.ee];if(!i||!i.attributes.options)return null;const e=i.attributes.options,s=e.indexOf(t);return-1===s?(d("STATE",`Option "${t}" not found in input_select options:`,e),null):s>=this.card.visibleCardIndices.length?(d("STATE",`Option index ${s} exceeds visible cards count ${this.card.visibleCardIndices.length}`),null):s}if("input_number"===this.se){const i=parseInt(t);if(isNaN(i))return null;const e=i-1;return e<0||e>=this.card.visibleCardIndices.length?(d("STATE",`Index ${e} is outside visible cards range [0, ${this.card.visibleCardIndices.length-1}]`),null):e}return null}le(t){if(t<0||t>=this.card.visibleCardIndices.length)return null;if("input_select"===this.se){const i=this.card.Oi.states[this.ee];if(!i||!i.attributes.options)return null;const e=i.attributes.options;return t>=e.length?(d("STATE",`Card index ${t} exceeds input_select options count ${e.length}`),null):e[t]}return"input_number"===this.se?t+1:null}onHassChange(t,i){if(!this.ee||!i)return;const e=t?.states[this.ee],s=i.states[this.ee];if(!s)return d("STATE","Configured entity no longer exists:",this.ee),void this.stop();e&&e.state===s.state||(this.ae&&clearTimeout(this.ae),this.ae=setTimeout(()=>{this.he(),this.ae=null},100))}}class Nt{constructor(t){this.card=t,this.slideObservers=new Map,this.cardHeights={},this.enabled=!1}initialize(){const t=!0===this.card.ii.auto_height,i="single"===this.card.ii.view_mode&&"horizontal"===this.card.ii.swipe_direction&&"infinite"!==this.card.ii.loop_mode;this.enabled=t&&i,this.enabled?(this.card.setAttribute("data-auto-height",""),d("AUTO_HEIGHT","Auto height enabled")):(this.card.removeAttribute("data-auto-height"),this.cleanup())}observeSlide(t,i){if(!this.enabled||!t)return;if(this.slideObservers.has(i))return;const e=new ResizeObserver(t=>{for(const e of t){const t=e.contentRect.height;if(t<10)return void d("AUTO_HEIGHT",`Card ${i} height too small (${t}px), waiting for content to load`);this.cardHeights[i]!==t&&(d("AUTO_HEIGHT",`Card ${i} height changed to ${t}px`),this.cardHeights[i]=t,i===this.card.currentIndex&&this.updateContainerHeight(t))}});e.observe(t),this.slideObservers.set(i,e),d("AUTO_HEIGHT",`Now observing slide ${i}`)}updateContainerHeight(t){if(this.enabled&&this.card.cardContainer){if(!t||0===t){if(this.card.cardContainer.offsetHeight>0)return void d("AUTO_HEIGHT","Invalid height, keeping current height");t=250,d("AUTO_HEIGHT","Using fallback height: 250px")}this.card.cardContainer.style.height=`${t}px`,d("AUTO_HEIGHT",`Container height set to ${t}px`)}}updateForCurrentCard(){if(!this.enabled)return;const t=this.cardHeights[this.card.currentIndex];t&&t>0?this.updateContainerHeight(t):d("AUTO_HEIGHT",`No height cached for card ${this.card.currentIndex}, waiting for ResizeObserver`)}cleanup(){this.slideObservers.forEach((t,i)=>{t.disconnect(),d("AUTO_HEIGHT",`Stopped observing slide ${i}`)}),this.slideObservers.clear(),this.cardHeights={},this.card.cardContainer&&(this.card.cardContainer.style.height="")}}class kt{constructor(t){this.card=t}calculateTransform(t){if(!this.card.cards||0===this.card.cards.length)return 0;const i=this.card.cardContainer.offsetWidth,e=Math.max(0,parseInt(this.card.ii.card_spacing))||0;let s,n;if(this.card.Zi&&this.card.Ki)s=this.card.Zi,n=this.card.Ki,d("SWIPE","Using stored carousel dimensions:",{cardWidth:s.toFixed(2),cardsVisible:n.toFixed(2)});else{const t=getComputedStyle(this.card).getPropertyValue("--carousel-card-width").trim();if(t&&""!==t&&"auto"!==t)s=parseFloat(t),n=(i+e)/(s+e);else{if(void 0!==this.card.ii.cards_visible)n=this.card.ii.cards_visible;else{const t=(i+e)/((this.card.ii.card_min_width||200)+e);n=Math.max(1.1,Math.round(10*t)/10)}s=(i-(n-1)*e)/n}d("SWIPE","Recalculated carousel dimensions:",{cardWidth:s.toFixed(2),cardsVisible:n.toFixed(2)})}const o=this.card.visibleCardIndices.length,a=this.card.ii.loop_mode||"none";if(o<=Math.floor(n)&&"infinite"!==this.card.ii.loop_mode)return d("SWIPE","Insufficient cards for carousel transform, staying at position 0"),0;let r;if("infinite"===a&&o>1){const i=this.card.loopMode.getDuplicateCount();r=t+i,d("SWIPE","Carousel infinite mode: logical index",t,"-> DOM position",r,"duplicateCount:",i)}else r=Math.min(t,Math.max(0,o-1));const h=s+e,c=r*h;return d("SWIPE","Carousel transform calculation:",{targetIndex:t,domPosition:r,totalCards:o,cardsVisible:n.toFixed(2),cardWidth:s.toFixed(2),cardSpacing:e,moveDistance:h.toFixed(2),transform:c.toFixed(2),loopMode:a}),c}updateSliderPosition(t,i=!0){if(!this.card.sliderElement)return;const e=this.calculateTransform(t);if(i&&"free"===this.card.ii.swipe_behavior&&this.card.ue>1){const t=this.card.swipeBehavior.calculateAnimationDuration(this.card.ue),i=this.card.swipeBehavior.getEasingFunction(this.card.ue);this.card.sliderElement.style.transition=`transform ${t}ms ${i}`,d("SWIPE",`Carousel multi-card animation: ${this.card.ue} cards, ${t}ms duration, easing: ${i}`)}else this.card.sliderElement.style.transition=this.card.ti(i);this.card.sliderElement.style.transform=`translateX(-${e}px)`,d("SWIPE",`Carousel slider updated to index ${t}, transform: -${e.toFixed(2)}px`)}handleLoopback(t){return this.card.loopMode.handleNavigation(t,!0)}ge(t){const i=this.card.visibleCardIndices.length;return t<0?i-1:t>=i?0:t}}class Dt{constructor(t){this.card=t,this.isInfiniteMode=!1,this.virtualIndex=0,this.realIndex=0,this.totalRealCards=0,this.me=null,this.fe=null}getMode(){return this.card.ii.loop_mode||"none"}isInfinite(){return"infinite"===this.getMode()&&this.card.visibleCardIndices.length>1}initialize(){if(this.isInfiniteMode=this.isInfinite(),this.isInfiniteMode)d("LOOP","Infinite loop mode initialized for",this.card.visibleCardIndices.length,"visible cards");else{this.virtualIndex=0,this.realIndex=0,this.totalRealCards=0;"infinite"===this.getMode()&&d("LOOP","Infinite loop mode disabled - only",this.card.visibleCardIndices.length,"visible card(s)")}}getDuplicateCount(){if(!this.isInfiniteMode)return 0;if(this.card.visibleCardIndices.length<=1)return 0;const t=this.card.ii.view_mode||"single",i=this.card.ii.swipe_behavior||"single";if("single"===t)return"free"===i?4:1;{const t=this.card.ii.cards_visible||this.card.ai(),e=Math.max(5,Math.ceil(2*t));if("free"===i){return e+Math.min(5,Math.ceil(t))}return e}}prepareCardsForLoading(t,i){const e=[];if(!this.isInfiniteMode)return t.forEach((t,s)=>{e.push({config:i[t],visibleIndex:s,originalIndex:t,isDuplicate:!1})}),e;const s=this.getDuplicateCount(),n=t.length;for(let o=0;o<s;o++){const a=o-s;let r;r=a<0?(a%n+n)%n:a%n;const h=t[r];e.push({config:i[h],visibleIndex:o-s,originalIndex:h,isDuplicate:!0})}t.forEach((t,s)=>{e.push({config:i[t],visibleIndex:s,originalIndex:t,isDuplicate:!1})});for(let o=0;o<s;o++){const s=t[o%n];e.push({config:i[s],visibleIndex:n+o,originalIndex:s,isDuplicate:!0})}return this.totalRealCards=e.length,e}virtualToRealIndex(t){if(!this.isInfiniteMode)return t;const i=this.card.visibleCardIndices.length;if(0===i)return 0;return this.getDuplicateCount()+(t%i+i)%i}realToVirtualIndex(t){if(!this.isInfiniteMode)return t;if(0===this.card.visibleCardIndices.length)return 0;return t-this.getDuplicateCount()}isOnDuplicateCard(t=this.card.currentIndex){if(!this.isInfiniteMode)return!1;const i=this.card.visibleCardIndices.length,e=this.getDuplicateCount();return t<e||t>=e+i}getCorrespondingRealIndex(t=this.card.currentIndex){if(!this.isInfiniteMode||!this.isOnDuplicateCard(t))return t;const i=this.card.visibleCardIndices.length,e=this.getDuplicateCount();if(t<e){return e+i-(e-t)}return e+(t-(e+i))}shouldPerformSeamlessJump(t=this.card.currentIndex){if(!this.isInfiniteMode)return!1;const i=this.card.visibleCardIndices.length;return"carousel"===(this.card.ii.view_mode||"single")?t>=i||t<0:t<0||t>=i}scheduleSeamlessJump(t,i=null){if(this.ve(),!this.shouldPerformSeamlessJump(t))return void d("LOOP",`Seamless jump not needed for target index ${t}`);let e;if(null!==i)e=i;else try{const t=this.card.ti(!0);d("LOOP","DEBUG: transitionStyle =",t);const i=t.match(/transform\s+([\d.]+)([a-z]*)\s/);if(d("LOOP","DEBUG: regex match =",i),i){const t=parseFloat(i[1]),s=i[2]||"s";d("LOOP","DEBUG: parsed duration =",t,"unit =",s),e="s"===s?1e3*t:"ms"===s?t:400,d("LOOP","DEBUG: final transitionDuration =",e)}else d("LOOP","DEBUG: regex match failed, using fallback"),e=400}catch(t){d("LOOP","Error reading CSS transition duration:",t),e=400}d("LOOP",`Scheduling seamless jump for target index ${t} after ${e}ms animation`);let s=!1;const n=()=>{if(!s){if(s=!0,this.me&&(clearTimeout(this.me),this.me=null),!this.card.isConnected||this.card.building)return d("LOOP","Seamless jump cancelled - card disconnected or building"),void(this.card.si=!1);requestAnimationFrame(()=>{try{const i=this.card.currentIndex;if(d("LOOP",`Seamless jump executing: target was ${t}, actual current is ${i}`),!this.shouldPerformSeamlessJump(i))return d("LOOP",`Seamless jump cancelled - conditions changed (target: ${t}, actual: ${i})`),void(this.card.si=!1);const e=this.card.visibleCardIndices.length;let s;if(i<0)s=e+i%e,s>=e&&(s=e-1);else{if(!(i>=e))return d("LOOP",`Seamless jump not needed - already in valid position (${i})`),void(this.card.si=!1);s=i%e}d("LOOP",`Performing seamless jump: virtual ${i} → real ${s}`),this.card.si=!0,this.card.sliderElement&&(this.card.sliderElement.style.transition="none",this.card.sliderElement.offsetHeight),this.card.currentIndex=s,this.card.updateSlider(!1),requestAnimationFrame(()=>{try{this.card.sliderElement&&(this.card.sliderElement.style.transition=this.card.ti(!0)),d("LOOP",`Seamless jump completed - now at real position ${s}, ready for continued scrolling`)}catch(t){d("ERROR","Error in seamless jump transition restoration:",t)}finally{this.card.si=!1}})}catch(t){d("ERROR","Error during seamless jump execution:",t),this.card.si=!1}})}},o=t=>{t.target!==this.card.sliderElement||"transform"!==t.propertyName||s||(d("LOOP","Transform transition ended, executing seamless jump"),this.card.sliderElement.removeEventListener("transitionend",o),this.fe=null,setTimeout(n,10))};this.card.sliderElement&&e>0&&(this.fe=o,this.card.sliderElement.addEventListener("transitionend",o));const a=e+Math.min(100,.1*e);this.me=setTimeout(()=>{this.fe&&this.card.sliderElement&&(this.card.sliderElement.removeEventListener("transitionend",this.fe),this.fe=null),s||(d("LOOP","Executing seamless jump via timeout fallback"),n())},a)}ve(){this.me&&(clearTimeout(this.me),this.me=null,this.card.si&&(d("LOOP","Clearing seamless jump flag during cancellation"),this.card.si=!1),this.fe&&this.card.sliderElement&&(this.card.sliderElement.removeEventListener("transitionend",this.fe),this.fe=null),d("LOOP","Cancelled pending seamless jump and cleaned up event listeners"))}handleNavigation(t,i=!1){const e=this.getMode(),s=this.card.visibleCardIndices.length;if("infinite"===e)return t;if(!("loopback"===e&&s>1))return Math.max(0,Math.min(t,s-1));if(i){if(t<0)return s-1;if(t>=s)return 0}else{if(t<0)return s-1;if(t>=s)return 0}return t}getWrappedIndexForPagination(t=this.card.currentIndex){if(!this.isInfiniteMode)return t;const i=this.card.visibleCardIndices.length;return(t%i+i)%i}handleAutoSwipeNavigation(t,i){const e=this.getMode(),s=this.card.visibleCardIndices.length;if("infinite"===e)return{nextIndex:t+1,shouldChangeDirection:!1};if("loopback"===e){let i=t+1;return i>=s&&(i=0),{nextIndex:i,shouldChangeDirection:!1}}{let e=t,n=!1;return 1===i?t>=s-1?(n=!0,e=t-1):e=t+1:t<=0?(n=!0,e=t+1):e=t-1,e=Math.max(0,Math.min(e,s-1)),{nextIndex:e,shouldChangeDirection:n}}}handleSwipeNavigation(t,i){const e=this.getMode(),s=this.card.visibleCardIndices.length;let n=t;return i>0?(n=t-Math.abs(i),n<0&&("none"!==e&&s>1?"infinite"===e||(n=s+n,n<0&&(n=s-1)):n=0)):i<0&&(n=t+Math.abs(i),n>=s&&("none"!==e&&s>1?"infinite"===e||(n-=s,n>=s&&(n=0)):n=s-1)),d("LOOP","Swipe navigation:",{currentIndex:t,skipCount:i,mode:e,totalVisibleCards:s,nextIndex:n}),n}}class Mt{constructor(t){this.card=t}getBehavior(){return this.card.ii.swipe_behavior||"single"}calculateSkipCount(t,i,e,s){if("single"===s)return 1;let n;if("carousel"===(this.card.ii.view_mode||"single")){const t=this.card.ii.cards_visible||this.card.ai(),i=(t-1)*(Math.max(0,parseInt(this.card.ii.card_spacing))||0);n=(this.card.slideWidth-i)/t}else n="horizontal"===this.card.Qt?this.card.slideWidth:this.card.slideHeight;const o=Math.max(1,Math.round(i/n));if(t>.8){let s=1;t>.8&&(s=2),t>1.5&&(s=3),t>2.5&&(s=4);const a=Math.max(s,o);return d("SWIPE","Quick swipe detected:",{velocity:t.toFixed(3),distance:i.toFixed(0),unitSize:n.toFixed(0),velocityBasedSkip:s,distanceBasedSkip:o,result:a}),Math.min(a,Math.min(4,e-1))}return d("SWIPE","Controlled drag detected:",{velocity:t.toFixed(3),distance:i.toFixed(0),unitSize:n.toFixed(0),distanceBasedSkip:o}),Math.min(o,e-1)}calculateAnimationDuration(t){const i=this.card.visibleCardIndices.length;if(i<=3){const i=800,e=500*(t-1),s=Math.min(i+e,2400);return d("SWIPE","Animation duration (few cards):",t,"cards,",s+"ms"),s}const e=200*(t-1),s=Math.min(1200+50*i,2e3),n=Math.min(600+e,s);return d("SWIPE","Animation duration (many cards):",{skipCount:t,totalCards:i,baseDuration:600,extraDuration:e,maxDuration:s,finalDuration:n+"ms"}),n}getEasingFunction(t){return 1===t?"ease-out":"cubic-bezier(0.25, 0.46, 0.45, 0.94)"}}class SimpleSwipeCard extends mt{constructor(){super(),d("INIT","SimpleSwipeCard Constructor invoked."),this.ii={},this.Oi=null,this.cards=[],this.visibleCardIndices=[],this.currentIndex=0,this.slideWidth=0,this.slideHeight=0,this.cardContainer=null,this.sliderElement=null,this.initialized=!1,this.building=!1,this.resizeObserver=null,this.Qt="horizontal",this.ni=void 0,this.we=void 0,this.ki=null,this.be=null,this.swipeGestures=new It(this),this.autoSwipe=new yt(this),this.resetAfter=new xt(this),this.pagination=new Et(this),this.cardBuilder=new _t(this),this.stateSynchronization=new Ot(this),this.carouselView=new kt(this),this.loopMode=new Dt(this),this.swipeBehavior=new Mt(this),this.autoHeight=new Nt(this),this.Ie=!1,this.ye=!1,this.xe=null,this.Ee=null,window._simpleSwipeDialogStack||(window._simpleSwipeDialogStack=[]),this.Se=this.Se.bind(this),d("INIT","SimpleSwipeCard Constructor completed successfully.")}firstUpdated(){d("LIFECYCLE","firstUpdated called for wrapper card"),!this.initialized&&this.ii?.cards&&(d("INIT","firstUpdated: Initializing build."),this.cardBuilder.build().then(()=>{this.isConnected&&(d("LIFECYCLE","Build finished in firstUpdated, setting up features"),this.Te())}).catch(t=>{console.error("SimpleSwipeCard: Build failed in firstUpdated:",t),d("ERROR","Build failed, card may not function properly")}))}static async getConfigElement(){return d("SYSTEM","SimpleSwipeCard.getConfigElement called"),await customElements.whenDefined("simple-swipe-card-editor"),document.createElement("simple-swipe-card-editor")}static getStubConfig(){return d("SYSTEM","SimpleSwipeCard.getStubConfig called"),{type:"custom:simple-swipe-card",cards:[]}}setConfig(t){if(!t)throw new Error("Invalid configuration");if(d("EDITOR","Editor setConfig received:",JSON.stringify(t)),this.ii=JSON.parse(JSON.stringify(t)),Array.isArray(this.ii.cards)||(this.ii.cards=[]),void 0===this.ii.show_pagination&&(this.ii.show_pagination=!0),void 0===this.ii.auto_hide_pagination)this.ii.auto_hide_pagination=0;else{const t=parseInt(this.ii.auto_hide_pagination);isNaN(t)||t<0?this.ii.auto_hide_pagination=0:this.ii.auto_hide_pagination=Math.min(t,3e4)}if(void 0===this.ii.card_spacing)this.ii.card_spacing=15;else{const t=parseInt(this.ii.card_spacing);this.ii.card_spacing=isNaN(t)||t<0?15:t}if(void 0!==this.ii.enable_loopback&&void 0===this.ii.loop_mode&&(this.ii.loop_mode=this.ii.enable_loopback?"loopback":"none",delete this.ii.enable_loopback,d("CONFIG","Migrated enable_loopback to loop_mode:",this.ii.loop_mode)),void 0===this.ii.loop_mode&&(this.ii.loop_mode="none"),["none","loopback","infinite"].includes(this.ii.loop_mode)||(d("CONFIG","Invalid loop_mode, defaulting to 'none':",this.ii.loop_mode),this.ii.loop_mode="none"),this.loopMode?.initialize(),void 0!==this.ii.swipe_direction&&["horizontal","vertical"].includes(this.ii.swipe_direction)||(this.ii.swipe_direction="horizontal"),"vertical"!==this.ii.swipe_direction||t.grid_options?this.removeAttribute("data-vertical-no-grid"):this.setAttribute("data-vertical-no-grid",""),this.closest("hui-card-preview")||this.closest("hui-card-element-editor")?this.setAttribute("data-editor-mode",""):this.removeAttribute("data-editor-mode"),void 0===this.ii.swipe_behavior&&(this.ii.swipe_behavior="single"),["single","free"].includes(this.ii.swipe_behavior)?"free"===this.ii.swipe_behavior&&"infinite"!==this.ii.loop_mode&&(this.ii.swipe_behavior="single",d("CONFIG","Free swipe behavior requires infinite loop mode, defaulting to single")):this.ii.swipe_behavior="single",void 0===this.ii.auto_height&&(this.ii.auto_height=!1),!0===this.ii.auto_height){("carousel"===this.ii.view_mode||"vertical"===this.ii.swipe_direction||"infinite"===this.ii.loop_mode)&&(delete this.ii.auto_height,d("CONFIG","auto_height removed: incompatible with current mode (carousel, vertical, or infinite loop)"))}if(void 0===this.ii.enable_auto_swipe&&(this.ii.enable_auto_swipe=!1),void 0===this.ii.auto_swipe_interval?this.ii.auto_swipe_interval=2e3:(this.ii.auto_swipe_interval=parseInt(this.ii.auto_swipe_interval),(isNaN(this.ii.auto_swipe_interval)||this.ii.auto_swipe_interval<500)&&(this.ii.auto_swipe_interval=2e3)),void 0===this.ii.enable_reset_after&&(this.ii.enable_reset_after=!1),void 0===this.ii.reset_after_timeout?this.ii.reset_after_timeout=3e4:(this.ii.reset_after_timeout=parseInt(this.ii.reset_after_timeout),(isNaN(this.ii.reset_after_timeout)||this.ii.reset_after_timeout<5e3)&&(this.ii.reset_after_timeout=3e4)),void 0===this.ii.reset_target_card?this.ii.reset_target_card=1:this.ii.reset_target_card=Math.max(1,parseInt(this.ii.reset_target_card)),void 0===this.ii.view_mode&&(this.ii.view_mode="single"),["single","carousel"].includes(this.ii.view_mode)||(this.ii.view_mode="single"),"carousel"===this.ii.view_mode){if(void 0===this.ii.card_min_width)this.ii.card_min_width=200;else{const t=parseInt(this.ii.card_min_width);(isNaN(t)||t<50||t>500)&&(this.ii.card_min_width=200)}if(void 0!==this.ii.cards_visible){const t=parseFloat(this.ii.cards_visible);isNaN(t)||t<1.1||t>8?this.ii.cards_visible=2.5:this.ii.cards_visible=Math.round(10*t)/10}}t.card_mod?(d("CARD_MOD","Card-mod configuration detected",t.card_mod),this.ki=JSON.parse(JSON.stringify(t.card_mod))):this.ki=null,this.Qt=this.ii.swipe_direction,this.Ce=this.ii.view_mode||"single",delete this.ii.title,this.autoHeight?.initialize(),this.requestUpdate()}ai(){if(!this.cardContainer)return 2.5;const t=this.cardContainer.offsetWidth;if(t<=0)return d("LOOP","Container width not available, using default cards_visible: 2.5"),2.5;const i=this.ii.card_min_width||200,e=Math.max(0,parseInt(this.ii.card_spacing))||0,s=(t+e)/(i+e);return Math.max(1.1,Math.round(10*s)/10)}Ui(){d("VISIBILITY","Handling conditional card visibility change"),this.$e&&clearTimeout(this.$e),this.$e=setTimeout(()=>{this._e(),this.$e=null},150)}_e(){if(!this.ii?.cards||!this.Oi){const t=0===this.visibleCardIndices.length;return this.visibleCardIndices=[],void(t||d("VISIBILITY","No cards or hass available, cleared visible indices"))}const t=[...this.visibleCardIndices];this.visibleCardIndices=[],this.ii.cards.forEach((t,i)=>{const e=wt(t.visibility,this.Oi);let s=!0;if("conditional"===t.type&&this.cards){const t=this.cards.find(t=>t&&t.originalIndex===i);t&&(s=t.conditionallyVisible)}e&&s&&this.visibleCardIndices.push(i)});JSON.stringify(t)!==JSON.stringify(this.visibleCardIndices)&&(d("VISIBILITY",`Visible cards changed: ${this.visibleCardIndices.length}/${this.ii.cards.length} visible`,this.visibleCardIndices),this.Oe(t),this.initialized&&this.isConnected&&this.cardBuilder.build())}Vi(){if(!this.ii?.cards||!this.Oi){const t=0===this.visibleCardIndices.length;return this.visibleCardIndices=[],void(t||d("VISIBILITY","No cards or hass available, cleared visible indices"))}const t=[...this.visibleCardIndices];this.visibleCardIndices=[],this.ii.cards.forEach((t,i)=>{const e=wt(t.visibility,this.Oi);let s=!0;"conditional"===t.type&&t.conditions&&(s=this.Ne(t.conditions));e&&s&&this.visibleCardIndices.push(i)});if(JSON.stringify(t)!==JSON.stringify(this.visibleCardIndices)){if(d("VISIBILITY",`Visible cards changed: ${this.visibleCardIndices.length}/${this.ii.cards.length} visible`,this.visibleCardIndices),this.Oe(t),this.building||!this.initialized)return void d("VISIBILITY","Skipping visibility rebuild during initial setup to prevent flicker");this.ke()}}Ne(t){return!t||!Array.isArray(t)||0===t.length||(!this.Oi||t.every(t=>{try{return this.De(t)}catch(i){return d("VISIBILITY","Error evaluating conditional card condition:",t,i),!0}}))}De(t){if(!t||"object"!=typeof t)return!0;const{condition:i,entity:e,state:s,state_not:n,above:o,below:a}=t,r=i||(!e||void 0===s&&void 0===n?null:"state")||(!e||void 0===o&&void 0===a?null:"numeric_state");switch(r){case"and":{if(!t.conditions||!Array.isArray(t.conditions))return d("VISIBILITY","Conditional card AND condition missing 'conditions' array"),!1;if(0===t.conditions.length)return d("VISIBILITY","Conditional card AND condition has empty 'conditions' array"),!0;const i=t.conditions.every(t=>{try{return this.De(t)}catch(i){return d("VISIBILITY","Error evaluating nested conditional card AND condition:",t,i),!1}});return d("VISIBILITY",`Conditional card AND condition result: ${i} (${t.conditions.length} nested conditions)`),i}case"or":{if(!t.conditions||!Array.isArray(t.conditions))return d("VISIBILITY","Conditional card OR condition missing 'conditions' array"),!1;if(0===t.conditions.length)return d("VISIBILITY","Conditional card OR condition has empty 'conditions' array"),!1;const i=t.conditions.some(t=>{try{return this.De(t)}catch(i){return d("VISIBILITY","Error evaluating nested conditional card OR condition:",t,i),!1}});return d("VISIBILITY",`Conditional card OR condition result: ${i} (${t.conditions.length} nested conditions)`),i}case"not":if(!t.condition)return d("VISIBILITY","Conditional card NOT condition missing 'condition' property"),!1;try{const i=this.De(t.condition),e=!i;return d("VISIBILITY",`Conditional card NOT condition result: ${e} (nested was ${i})`),e}catch(i){return d("VISIBILITY","Error evaluating nested conditional card NOT condition:",t.condition,i),!1}case"state":{if(!e||!this.Oi.states[e])return d("VISIBILITY",`Entity ${e} not found for conditional card state condition`),!1;const t=this.Oi.states[e].state;if(void 0!==s){const i=String(s),n=String(t),o=n===i;return d("VISIBILITY",`Conditional card state condition: ${e} = ${n}, expected: ${i}, result: ${o}`),o}if(void 0!==n){const i=String(n),s=String(t),o=s!==i;return d("VISIBILITY",`Conditional card state not condition: ${e} = ${s}, not expected: ${i}, result: ${o}`),o}return!0}case"numeric_state":{if(!e||!this.Oi.states[e])return d("VISIBILITY",`Entity ${e} not found for conditional card numeric_state condition`),!1;const t=parseFloat(this.Oi.states[e].state);if(isNaN(t))return!1;let i=!0;return void 0!==o&&(i=i&&t>parseFloat(o)),void 0!==a&&(i=i&&t<parseFloat(a)),d("VISIBILITY",`Conditional card numeric state condition: ${e} = ${t}, result: ${i}`),i}case"screen":{const i=t.media_query;if(i&&window.matchMedia){const t=window.matchMedia(i).matches;return d("VISIBILITY",`Conditional card screen condition: ${i}, result: ${t}`),t}return!0}case"user":if(t.users&&Array.isArray(t.users)){const i=this.Oi.user;if(i&&i.id){const e=t.users.includes(i.id);return d("VISIBILITY",`Conditional card user condition: current user ${i.id}, allowed users: ${t.users}, result: ${e}`),e}}return!0;default:return e?(d("VISIBILITY","Unknown or invalid conditional card condition:",t),!1):(d("VISIBILITY",`Unknown conditional card condition type: ${r}`),!0)}}ke(){this.Me&&clearTimeout(this.Me),this.Me=setTimeout(()=>{this.initialized&&this.isConnected&&!this.building&&(d("VISIBILITY","Performing debounced rebuild due to visibility changes"),this.cardBuilder.build()),this.Me=null},300)}Oe(t){if(0===this.visibleCardIndices.length)return void(this.currentIndex=0);const i=t[this.currentIndex],e=this.visibleCardIndices.indexOf(i);if(-1!==e)this.currentIndex=e,d("VISIBILITY",`Current card still visible, adjusted index to ${this.currentIndex}`);else{const t=this.visibleCardIndices.length;this.currentIndex>=t?(this.currentIndex=t-1,d("VISIBILITY",`Adjusted to last visible card: ${this.currentIndex}`)):(this.currentIndex=Math.min(this.currentIndex,t-1),this.currentIndex=Math.max(0,this.currentIndex),d("VISIBILITY",`Adjusted to maintain relative position: ${this.currentIndex}`))}}Re(){this.Ae&&clearTimeout(this.Ae),this.Ae=setTimeout(()=>{this.Vi(),this.Ae=null},200)}Le(t){d("ERROR",`${t}`),this.ii={...i},this.visibleCardIndices=[],this.isConnected&&this.cardBuilder.build()}Pe(){d("CONFIG","Updating child card configs"),this.cards&&this.cards.length===this.visibleCardIndices.length&&this.visibleCardIndices.forEach((t,i)=>{const e=this.ii.cards[t],s=this.cards[i];if(s&&!s.error&&s.element?.setConfig&&JSON.stringify(s.config)!==JSON.stringify(e)){d("CONFIG","Updating config for visible card",i,"original index",t);try{s.element.setConfig(e),s.config=JSON.parse(JSON.stringify(e))}catch(t){console.error(`Error setting config on child card ${i}:`,t)}}})}ze(){if(d("CONFIG","Updating layout options (pagination, spacing, direction)"),this.Qt!==this.ii.swipe_direction)return this.Qt=this.ii.swipe_direction,void this.cardBuilder.build();this.pagination.updateLayout(),this.updateSlider(!1),this.ki&&this.Di()}set hass(t){if(!t)return;const i=this.Oi;if(i===t)return;const e=!i||i.states!==t.states,s=!i||i.user!==t.user,n=!i||JSON.stringify(i.config)!==JSON.stringify(t.config);if(e||s||n){if(d("INIT","Setting hass (changed)"),this.Oi=t,this.stateSynchronization?.onHassChange(i,t),this.si)return d("LOOP","Skipping hass-triggered visibility update during seamless jump"),void this.Ve(t);if(this.building)return d("VISIBILITY","Skipping visibility update during build to prevent rebuild flicker"),void this.Ve(t);e&&(this.Ae&&(clearTimeout(this.Ae),this.Ae=null),this.Vi()),this.Ve(t)}else this.Ve(t)}Ve(t){this.cards&&this.cards.forEach(i=>{if(i.element&&!i.error)try{i.element.hass=t}catch(t){console.error("Error setting hass on child card:",t)}})}connectedCallback(){super.connectedCallback(),d("LIFECYCLE","connectedCallback - simplified for wrapper card"),this.si&&(d("INIT","Clearing stuck seamless jump flag on connect"),this.si=!1),this.addEventListener("config-changed",this.Se.bind(this));this.cards&&this.cards.length>0&&!this.cardContainer&&this.ii?(d("LIFECYCLE","Detected reconnection scenario - rebuilding card"),this.cardBuilder.build().then(()=>{this.isConnected&&(d("LIFECYCLE","Reconnection build completed"),this.Te())}).catch(t=>{console.error("SimpleSwipeCard: Reconnection build failed:",t),d("ERROR","Reconnection build failed, swipe may not work")})):this.initialized&&this.cardContainer&&(d("LIFECYCLE","connectedCallback: Handling reconnection with intact DOM"),this.Ji(),this.visibleCardIndices.length>1&&(this.swipeGestures.removeGestures(),setTimeout(()=>{this.isConnected&&this.swipeGestures.addGestures()},50)),this.ki&&(this.Di(),this.Xi()),this.autoSwipe.manage(),this.resetAfter.manage(),this.stateSynchronization.manage(),d("LIFECYCLE","About to call _handleDropdownOverflow (reconnection)"),this.Te()),d("LIFECYCLE","connectedCallback finished")}disconnectedCallback(){super.disconnectedCallback(),d("INIT","disconnectedCallback - Enhanced cleanup starting"),this.Be&&(clearTimeout(this.Be),this.Be=null),this.Ye&&this.cardContainer&&(this.cardContainer.removeEventListener("click",this.Ye,{capture:!0}),this.Ye=null),this.We&&(clearTimeout(this.We),this.We=null),this.Ie&&this.He(),this.xe&&window.removeEventListener("pointerdown",this.xe,{capture:!0}),this.ye=!1,this.removeEventListener("config-changed",this.Se.bind(this));try{this.Fe(),this.Ue(),this.je(),this.Ge(),this.Je()}catch(t){console.warn("Error during cleanup:",t)}this.initialized=!1,d("INIT","disconnectedCallback - Enhanced cleanup completed")}Fe(){["_visibilityRebuildTimeout","_conditionalVisibilityTimeout","_visibilityUpdateTimeout","_layoutRetryCount"].forEach(t=>{this[t]&&(clearTimeout(this[t]),this[t]=null,d("INIT",`Cleared timeout: ${t}`))})}Ue(){try{this.resizeObserver&&(this.resizeObserver.cleanup(),this.resizeObserver=null),this.swipeGestures&&(this.swipeGestures.removeGestures(),this.swipeGestures.bt=!1,this.swipeGestures.Ct=!1),this.autoSwipe&&(this.autoSwipe.stop(),this.autoSwipe.li=null,this.autoSwipe.ui=null),this.resetAfter&&(this.resetAfter.stopTimer(),this.resetAfter.bi=null),this.stateSynchronization&&this.stateSynchronization.stop(),this.autoHeight&&this.autoHeight.cleanup(),d("INIT","Feature managers cleaned up (state preserved)")}catch(t){console.warn("Error cleaning up feature managers:",t)}}je(){this.cardContainer=null,this.sliderElement=null,this.pagination&&this.pagination.paginationElement&&(this.pagination.paginationElement=null),d("INIT","DOM references and observers cleaned up (cards preserved)")}Ge(){if(this.be)try{this.be.disconnect(),this.be=null,d("CARD_MOD","Card-mod observer cleaned up")}catch(t){console.warn("Error cleaning up card-mod observer:",t)}}Je(){this.swipeGestures&&this.swipeGestures.Dt&&(clearTimeout(this.swipeGestures.Dt),this.swipeGestures.Dt=null,this.swipeGestures.Mt=!1),this.loopMode&&this.loopMode.me&&(clearTimeout(this.loopMode.me),this.loopMode.me=null,this.si=!1),d("INIT","Remaining event listeners cleared")}Se(t){t.detail?.fromSwipeCardEditor&&t.detail?.editorId===this.Xe||(d("EVENT","Root element received config-changed event:",t.detail),(t.detail?.fromElementEditor||t.detail?.elementConfig||t.detail?.element)&&d("ELEMENT","Caught element editor event, allowing normal propagation"))}Ji(){!this.resizeObserver&&this.cardContainer&&(this.resizeObserver=function(t,i){if(!t)return null;d("INIT","Setting up resize observer.");let e=null;const s=new ResizeObserver(s=>{window.requestAnimationFrame(()=>{if(t.isConnected)for(const n of s){const s=n.contentRect.width,o=n.contentRect.height;e&&clearTimeout(e),e=setTimeout(()=>{t&&(s>0&&s!==n.previousWidth||o>0&&o!==n.previousHeight)&&(d("INIT","Resize detected, recalculating layout.",{oldWidth:n.previousWidth,newWidth:s,oldHeight:n.previousHeight,newHeight:o}),i(s,o))},50),n.previousWidth=s,n.previousHeight=o}})});return s.observe(t),{observer:s,cleanup:()=>{d("INIT","Removing resize observer."),s&&s.disconnect(),e&&(clearTimeout(e),e=null)}}}(this.cardContainer,()=>this.recalculateLayout()))}recalculateLayout(){if(!this.cardContainer||!this.isConnected)return;const t=this.cardContainer.offsetWidth,i=this.cardContainer.offsetHeight;(t>0&&Math.abs(t-this.slideWidth)>1||i>0&&Math.abs(i-this.slideHeight)>1)&&(d("SYSTEM","Recalculating layout due to resize.",{oldWidth:this.slideWidth,newWidth:t,oldHeight:this.slideHeight,newHeight:i}),this.slideWidth=t,this.slideHeight=i,this.updateSlider(!1))}ti(t){return function(t,i=null){if(!t)return"none";let e="0.3s",s="ease-out";if(i&&i.isConnected){const t=getComputedStyle(i),n=t.getPropertyValue("--simple-swipe-card-transition-speed").trim(),o=t.getPropertyValue("--simple-swipe-card-transition-easing").trim();n&&(e=n),o&&(s=o)}return`transform ${e} ${s}`}(t,this)}Di(){!function(t,i,e,s,n){if(t&&i){if(t.style){d("CARD_MOD","Applying card-mod styles");const o=document.createElement("style");o.setAttribute("id","card-mod-styles"),o.textContent=t.style;const a=i.querySelector("#card-mod-styles");if(a)try{i.removeChild(a)}catch(t){d("CARD_MOD","Error removing existing style:",t)}try{if(!i||!i.appendChild)return void d("ERROR","shadowRoot is invalid for appendChild operation");i.appendChild(o)}catch(t){return void d("ERROR","Failed to append card-mod styles:",t)}if(e){d("CARD_MOD","Forwarding CSS variables from host to shadow DOM");try{const t=window.getComputedStyle(e),o=[i.querySelector(".card-container"),s,n].filter(Boolean),a=["--simple-swipe-card-pagination-dot-inactive-color","--simple-swipe-card-pagination-dot-active-color","--simple-swipe-card-pagination-dot-inactive-opacity","--simple-swipe-card-pagination-dot-active-opacity","--simple-swipe-card-pagination-dot-size","--simple-swipe-card-pagination-dot-active-size","--simple-swipe-card-pagination-border-radius","--simple-swipe-card-pagination-dot-spacing","--simple-swipe-card-pagination-background","--simple-swipe-card-pagination-padding","--simple-swipe-card-pagination-bottom","--simple-swipe-card-pagination-right","--simple-swipe-card-transition-speed","--simple-swipe-card-transition-easing","--simple-swipe-card-pagination-fade-duration","--simple-swipe-card-pagination-animation-type","--simple-swipe-card-pagination-animation-delay","--simple-swipe-card-pagination-animation-easing"];o.forEach(i=>{i&&a.forEach(e=>{try{const s=t.getPropertyValue(e);s&&(d("CARD_MOD",`Forwarding ${e}: ${s}`),i.style.setProperty(e,s))}catch(t){d("CARD_MOD",`Error forwarding ${e}:`,t)}})})}catch(t){d("ERROR","Error forwarding CSS variables:",t)}}}}else d("CARD_MOD","No card-mod config or shadow root, skipping style application")}(this.ki,this.shadowRoot,this.shadowRoot?.host,this.sliderElement,this.pagination.paginationElement)}Xi(){this.be&&(this.be.disconnect(),this.be=null),this.be=function(t,i){const e=new MutationObserver(t=>{t.some(t=>"attributes"===t.type&&("style"===t.attributeName||t.attributeName.includes("style")))&&(d("CARD_MOD","Host style attribute changed, reapplying card-mod styles"),i())});return t&&t.host&&(e.observe(t.host,{attributes:!0,attributeFilter:["style"]}),d("CARD_MOD","Set up mutation observer for style changes")),e}(this.shadowRoot,()=>{this.Di()})}goToSlide(t,i=1,e=!0){this.ue=i;const s=this.visibleCardIndices.length;if(!this.visibleCardIndices||0===s||!this.initialized||this.building)return void d("SWIPE","goToSlide skipped",{totalVisible:s,initialized:this.initialized,building:this.building});const n=this.ii.view_mode||"single",o=this.ii.loop_mode||"none";t=this.loopMode.handleNavigation(t,"carousel"===n),this.currentIndex=t,d("SWIPE",`Going to visible slide ${this.currentIndex} (${n} mode)`);const a="infinite"===o?(this.currentIndex%s+s)%s:this.currentIndex;this.stateSynchronization?.onCardNavigate(a),this.updateSlider(e),this.autoHeight?.updateForCurrentCard(),this.autoSwipe.isInProgress||this.resetAfter.isInProgress||this.resetAfter.startTimer(),!this.ii.enable_auto_swipe||this.autoSwipe.isInProgress||this.resetAfter.isInProgress||this.autoSwipe.pause(5e3)}updateSlider(t=!0){this.cardContainer&&(this.slideWidth=this.cardContainer.offsetWidth,this.slideHeight=this.cardContainer.offsetHeight);const i=this.visibleCardIndices.length;if(d("SWIPE",`Updating slider to visible index ${this.currentIndex}`,{animate:t,totalVisible:i,viewMode:this.ii.view_mode}),!this.sliderElement||0===i||!this.initialized||this.building)return void d("SWIPE","updateSlider skipped",{slider:!!this.sliderElement,totalVisible:i,init:this.initialized,building:this.building});const e=Math.max(0,parseInt(this.ii.card_spacing))||0,s=this.ii.view_mode||"single",n=this.ii.loop_mode||"none";if("carousel"===s&&this.carouselView){this.sliderElement.style.gap=`${e}px`;let i=t?null:0;if(t&&"free"===this.ii.swipe_behavior&&this.ue>1){i=this.swipeBehavior.calculateAnimationDuration(this.ue);const t=this.swipeBehavior.getEasingFunction(this.ue);this.sliderElement.style.transition=`transform ${i}ms ${t}`,d("SWIPE",`Carousel multi-card animation: ${this.ue} cards, ${i}ms duration, easing: ${t}`)}return this.carouselView.updateSliderPosition(this.currentIndex,t),this.pagination.update(t),this.ue=1,void(t&&(i>0||null===i)&&this.loopMode.scheduleSeamlessJump(this.currentIndex,i))}const o="horizontal"===this.Qt;let a=this.currentIndex;if("infinite"===n&&i>1){const t=this.loopMode.getDuplicateCount();a=this.currentIndex+t,d("SWIPE",`Infinite mode: logical index ${this.currentIndex} -> DOM position ${a}`)}else"none"!==n&&i>1?this.currentIndex<0?this.currentIndex=i-1:this.currentIndex>=i&&(this.currentIndex=0):this.currentIndex=Math.max(0,Math.min(this.currentIndex,i-1)),a=this.currentIndex;this.sliderElement.style.gap=`${e}px`;let r=0;r=o?a*(this.slideWidth+e):a*(this.slideHeight+e);let h=null;if(t&&"free"===this.ii.swipe_behavior&&this.ue>1){h=this.swipeBehavior.calculateAnimationDuration(this.ue);const t=this.swipeBehavior.getEasingFunction(this.ue);this.sliderElement.style.transition=`transform ${h}ms ${t}`,d("SWIPE",`Multi-card animation: ${this.ue} cards, ${h}ms duration, easing: ${t}`)}else this.sliderElement.style.transition=this.ti(t);this.sliderElement.style.transform=o?`translateX(-${r}px)`:`translateY(-${r}px)`,this.cards.forEach(t=>{t&&t.slide&&(t.slide.style.marginRight="0px",t.slide.style.marginLeft="0px",t.slide.style.marginTop="0px",t.slide.style.marginBottom="0px")}),this.pagination.update(t),this.ue=1,d("SWIPE",`Slider updated, DOM position: ${a}, transform: -${r}px along ${o?"X":"Y"} axis`),t&&(h>0||null===h)&&this.loopMode.scheduleSeamlessJump(this.currentIndex,h)}qe(t){if(this.pagination.paginationElement){this.pagination.paginationElement.querySelectorAll(".pagination-dot").forEach((i,e)=>{i.classList.toggle("active",e===t)})}}getCardSize(){if(0===this.visibleCardIndices.length)return 3;let t=3;if(this.cards&&this.cards.length>0){const i=this.cards[this.currentIndex];if(i?.element&&!i.error&&"function"==typeof i.element.getCardSize)try{t=i.element.getCardSize()}catch(i){console.warn("Error getting card size from current element:",i),t=3}else i?.element&&i.element.offsetHeight&&(t=Math.max(1,Math.ceil(i.element.offsetHeight/50)))}return d("CONFIG","Calculated card size:",t),Math.max(3,t)}Te(){this.cardContainer&&!this.ye&&(this.ye=!0,this.xe=this.He.bind(this),this.cardContainer.addEventListener("pointerdown",t=>{if(this.Ie)return;const i=Date.now();if(this.Ee&&i-this.Ee<100)return;this.Ee=i;const e=this.Zt(t);if(!this.Ze(e))return;if(d("SYSTEM","Dropdown trigger detected. Applying layout fix with click-controlled restoration."),this.Ie=!0,this.Be&&(clearTimeout(this.Be),this.Be=null),this.swipeGestures.removeGestures(),this.sliderElement&&this.cardContainer){const t=this.cardContainer.getBoundingClientRect(),i=this.sliderElement.getBoundingClientRect();this.Ke={containerHeight:t.height,sliderWidth:i.width},this.cardContainer.style.height=`${this.Ke.containerHeight}px`,this.Qe=this.sliderElement.style.transform;const e=this.currentIndex;let s=e;if("infinite"===this.ii.loop_mode&&this.visibleCardIndices.length>1){const t=this.loopMode.getDuplicateCount();s=e+t}this.sliderElement.classList.add("dropdown-fix-active"),this.sliderElement.classList.add("dropdown-fix-active-hide-adjacent"),this.sliderElement.style.transform="none";this.sliderElement.querySelectorAll(".slide").forEach((t,i)=>{i===s?t.classList.add("current-active"):t.classList.remove("current-active")}),this.sliderElement.style.position="absolute",this.sliderElement.style.width=`${this.Ke.sliderWidth}px`,this.sliderElement.style.left="0px",this.sliderElement.style.top="0px"}this.shadowRoot.host.style.overflow="visible",this.cardContainer.style.overflow="visible";let s=null,n=this.Zt(t);for(let t=0;t<10&&n&&n!==this.cardContainer;t++){if(n.getAttribute&&"combobox"===n.getAttribute("role")){s=n,d("SYSTEM","Found and stored combobox element for monitoring");break}n=n.parentElement}this.ts=s,this.We=setTimeout(()=>{this.Ie&&this.isConnected&&(this.es(),d("SYSTEM","Click restoration listener added. Will restore after next click."))},300),d("SYSTEM","Layout fix applied. Click listener will be added in 300ms.")},{capture:!0}))}es(){if(!this.cardContainer)return;const t=this.ts;if(!t)return d("SYSTEM","No combobox stored, using fallback click listener"),void this.ss();d("SYSTEM","Monitoring dropdown state via aria-expanded attribute on stored combobox"),this.ns=new MutationObserver(i=>{for(const e of i)if("aria-expanded"===e.attributeName){"true"===t.getAttribute("aria-expanded")||(d("SYSTEM","Dropdown closed detected via aria-expanded=false, restoring layout"),this.ns&&(this.ns.disconnect(),this.ns=null),this.Be=setTimeout(()=>{this.He()},100))}}),this.ns.observe(t,{attributes:!0,attributeFilter:["aria-expanded"]})}ss(){if(!this.cardContainer)return;const t=i=>{d("SYSTEM","Click detected (fallback), restoring layout in 200ms"),this.cardContainer.removeEventListener("click",t,{capture:!0}),this.Be=setTimeout(()=>{this.He()},200)};this.cardContainer.addEventListener("click",t,{capture:!0}),this.Ye=t}He(){if(this.Ie){if(this.Ie=!1,d("SYSTEM","Restoring layout and card visibility."),this.Be&&(clearTimeout(this.Be),this.Be=null),this.Ye&&this.cardContainer&&(this.cardContainer.removeEventListener("click",this.Ye,{capture:!0}),this.Ye=null),this.ns&&(this.ns.disconnect(),this.ns=null),this.ts=null,this.sliderElement&&this.cardContainer){const t=this.sliderElement.style.transition;if(this.sliderElement.style.transition="none",void 0!==this.Qe){this.Qe=void 0;const t=this.visibleCardIndices.length,i=this.ii.loop_mode||"none";let e=this.currentIndex;if("infinite"===i&&t>1){const t=this.loopMode.getDuplicateCount();e=this.currentIndex+t}const s=this.ii.card_spacing||0,n="horizontal"===(this.ii.swipe_direction||"horizontal");let o=0;o=n?e*(this.slideWidth+s):e*(this.slideHeight+s);const a=n?"X":"Y";this.sliderElement.style.transform=`translate${a}(-${o}px)`,d("SYSTEM",`Set correct transform: translate${a}(-${o}px) for index ${this.currentIndex}`)}this.sliderElement.style.position="",this.sliderElement.style.left="",this.sliderElement.style.top="",this.sliderElement.style.width="",this.sliderElement.offsetHeight,this.sliderElement.classList.remove("dropdown-fix-active"),this.sliderElement.classList.remove("dropdown-fix-active-hide-adjacent");this.sliderElement.querySelectorAll(".slide").forEach(t=>{t.classList.remove("current-active")}),this.cardContainer.style.height="",this.Ke=null,requestAnimationFrame(()=>{this.sliderElement&&(this.sliderElement.style.transition=t||"")})}this.shadowRoot.host.style.overflow="",this.cardContainer&&(this.cardContainer.style.overflow=""),setTimeout(()=>{this.isConnected&&this.visibleCardIndices.length>1&&(this.swipeGestures.addGestures(),d("SWIPE","Swipe gestures re-enabled after dropdown restore")),this.Ee=null},150)}}Ze(t){if(!t)return!1;let i=t;for(let t=0;t<8&&i&&i!==this.cardContainer;t++){const t=i.tagName?.toLowerCase(),e=i.className||"",s=i.getAttribute&&i.getAttribute("role");if("ha-select"===t||"mwc-select"===t||"mushroom-select"===t||"mushroom-select-card"===t)return!0;if("combobox"===s)return!0;if(i.classList?.contains("mdc-select"))return!0;if("string"==typeof e&&(e.includes("mushroom-select")||e.includes("mushroom-card")||e.includes("mdc-menu")||e.includes("mdc-list-item")||e.includes("mdc-select__anchor")||e.includes("mdc-select__selected-text")))return!0;if(i.hasAttribute&&(i.hasAttribute("data-mdc-select")||i.hasAttribute("aria-haspopup")))return!0;i=i.parentElement}let e=t;for(;e&&e!==this.cardContainer;){if("mushroom-select-card"===e.tagName?.toLowerCase())return!0;e=e.parentElement}return!1}Zt(t){return t.composedPath&&t.composedPath().length?t.composedPath()[0]:t.target}}class Rt{constructor(t){this.editor=t,this.collapsibleState={advanced:!1,cards:!0},this.rs=null,this.hs=null}cleanup(){this.rs&&(clearTimeout(this.rs),this.rs=null),this.hs&&(clearTimeout(this.hs),this.hs=null),d("EDITOR","EditorUIManager cleanup completed")}async initializeEditor(){this.editor.Xe=`swipe-card-editor-${Math.random().toString(36).substring(2,15)}`,this.editor.ds=this.editor.cardManagement.handleCardPicked.bind(this.editor.cardManagement),this.editor.cs=this.editor.eventHandling.ls.bind(this.editor.eventHandling),this.editor.ps=new Set,this.editor.us=null,this.editor.gs=!1,this.editor.fs={active:!1,parentDialogId:null,elementId:null,timestamp:null,savedState:null};$t(o).set(this.editor.Xe,this)}toggleSection(t){this.collapsibleState[t]=!this.collapsibleState[t],this.editor.requestUpdate()}getCollapsibleState(){return this.collapsibleState}async ensureComponentsLoaded(){let t=0;if(!customElements.get("hui-card-picker"))for(;!customElements.get("hui-card-picker")&&t<10;){try{if(await this.loadCustomElements(),customElements.get("hui-card-picker"))return}catch(t){}await new Promise(t=>setTimeout(t,100)),t++}}async loadCustomElements(){if(!customElements.get("hui-card-picker"))try{const t=[()=>customElements.get("hui-entities-card")?.getConfigElement?.(),()=>customElements.get("hui-conditional-card")?.getConfigElement?.(),()=>customElements.get("hui-vertical-stack-card")?.getConfigElement?.(),()=>customElements.get("hui-horizontal-stack-card")?.getConfigElement?.()];for(const i of t)try{if(await i(),customElements.get("hui-card-picker"))break}catch(t){}}catch(t){}}ensureCardPickerLoaded(){this.editor.shadowRoot&&(this.rs&&clearTimeout(this.rs),this.rs=setTimeout(()=>{this.vs(),this.rs=null},100))}vs(){if(d("EDITOR","_ensureCardPickerLoaded called"),!this.editor.shadowRoot)return void d("EDITOR","shadowRoot not ready, skipping card picker load");const t=this.editor.shadowRoot.querySelector("#card-picker-container");if(!t)return void d("EDITOR","Card picker container not found, skipping");t.style.display="block",t.hasAttribute("event-barrier-applied")||(t.setAttribute("event-barrier-applied","true"),t.addEventListener("config-changed",t=>{this.ws(t)},{capture:!0,passive:!1}));const i=t.querySelector("hui-card-picker");i?(i.style.display="block",i.requestUpdate&&!i.bs&&(i.requestUpdate(),i.bs=!0)):d("EDITOR","hui-card-picker element not found in container"),this.Is()}ws(t){if(d("EDITOR","Intercepted config-changed at container level:",t.detail?.config?.type),t.target&&t.target.tagName&&"hui-card-picker"===t.target.tagName.toLowerCase()&&t.detail&&t.detail.config){const i=t.detail.config;if(d("EDITOR","Processing card selection:",i.type),this.editor.ii){const t=Array.isArray(this.editor.ii.cards)?[...this.editor.ii.cards]:[];t.push(i),this.editor.ii={...this.editor.ii,cards:t},this.editor.configManager.fireConfigChanged({cardAdded:!0,cardType:i.type}),this.Is()}}return t.stopPropagation(),t.stopImmediatePropagation&&t.stopImmediatePropagation(),!1}Is(){this.hs||(this.hs=setTimeout(()=>{this.editor.requestUpdate(),this.hs=null},50))}}class At{constructor(t){this.editor=t,this.hs=null}setConfig(t){if(!t)throw new Error("Invalid configuration");if(d("EDITOR","Editor setConfig received:",JSON.stringify(t)),this.editor.ii=JSON.parse(JSON.stringify(t)),Array.isArray(this.editor.ii.cards)||(this.editor.ii.cards=[]),void 0===this.editor.ii.show_pagination&&(this.editor.ii.show_pagination=!0),void 0===this.editor.ii.auto_hide_pagination)this.editor.ii.auto_hide_pagination=0;else{const t=parseInt(this.editor.ii.auto_hide_pagination);isNaN(t)||t<0?this.editor.ii.auto_hide_pagination=0:this.editor.ii.auto_hide_pagination=Math.min(t,3e4)}if(void 0===this.editor.ii.card_spacing)this.editor.ii.card_spacing=15;else{const t=parseInt(this.editor.ii.card_spacing);this.editor.ii.card_spacing=isNaN(t)||t<0?15:t}if(void 0!==this.editor.ii.enable_loopback&&void 0===this.editor.ii.loop_mode&&(this.editor.ii.loop_mode=this.editor.ii.enable_loopback?"loopback":"none",delete this.editor.ii.enable_loopback,d("CONFIG","Migrated enable_loopback to loop_mode:",this.editor.ii.loop_mode)),void 0===this.editor.ii.loop_mode&&(this.editor.ii.loop_mode="none"),["none","loopback","infinite"].includes(this.editor.ii.loop_mode)||(d("CONFIG","Invalid loop_mode, defaulting to 'none':",this.editor.ii.loop_mode),this.editor.ii.loop_mode="none"),void 0!==this.editor.ii.swipe_direction&&["horizontal","vertical"].includes(this.editor.ii.swipe_direction)||(this.editor.ii.swipe_direction="horizontal"),void 0===this.editor.ii.swipe_behavior&&(this.editor.ii.swipe_behavior="single"),["single","free"].includes(this.editor.ii.swipe_behavior)?"free"===this.editor.ii.swipe_behavior&&"infinite"!==this.editor.ii.loop_mode&&(this.editor.ii.swipe_behavior="single",d("CONFIG","Free swipe behavior requires infinite loop mode, defaulting to single")):this.editor.ii.swipe_behavior="single",void 0===this.editor.ii.auto_height&&(this.editor.ii.auto_height=!1),!0===this.editor.ii.auto_height){("carousel"===this.editor.ii.view_mode||"vertical"===this.editor.ii.swipe_direction||"infinite"===this.editor.ii.loop_mode)&&(delete this.editor.ii.auto_height,d("CONFIG","auto_height removed: incompatible with current mode (carousel, vertical, or infinite loop)"))}if(void 0===this.editor.ii.enable_auto_swipe&&(this.editor.ii.enable_auto_swipe=!1),void 0===this.editor.ii.auto_swipe_interval?this.editor.ii.auto_swipe_interval=2e3:(this.editor.ii.auto_swipe_interval=parseInt(this.editor.ii.auto_swipe_interval),(isNaN(this.editor.ii.auto_swipe_interval)||this.editor.ii.auto_swipe_interval<500)&&(this.editor.ii.auto_swipe_interval=2e3)),void 0===this.editor.ii.enable_reset_after&&(this.editor.ii.enable_reset_after=!1),void 0===this.editor.ii.reset_after_timeout?this.editor.ii.reset_after_timeout=3e4:(this.editor.ii.reset_after_timeout=parseInt(this.editor.ii.reset_after_timeout),(isNaN(this.editor.ii.reset_after_timeout)||this.editor.ii.reset_after_timeout<5e3)&&(this.editor.ii.reset_after_timeout=3e4)),void 0===this.editor.ii.reset_target_card?this.editor.ii.reset_target_card=1:this.editor.ii.reset_target_card=Math.max(1,parseInt(this.editor.ii.reset_target_card)),void 0===this.editor.ii.view_mode&&(this.editor.ii.view_mode="single"),["single","carousel"].includes(this.editor.ii.view_mode)||(this.editor.ii.view_mode="single"),"carousel"===this.editor.ii.view_mode){if(void 0===this.editor.ii.card_min_width)this.editor.ii.card_min_width=200;else{const t=parseInt(this.editor.ii.card_min_width);(isNaN(t)||t<50||t>500)&&(this.editor.ii.card_min_width=200)}if(void 0!==this.editor.ii.cards_visible){const t=parseFloat(this.editor.ii.cards_visible);isNaN(t)||t<1.1||t>8?this.editor.ii.cards_visible=2.5:this.editor.ii.cards_visible=Math.round(10*t)/10}}delete this.editor.ii.title,setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),50)}handleValueChanged(t){if(!this.editor.ii||!t.target)return;const i=t.target,e=i.configValue||i.getAttribute("data-option"),s=i.parentElement?.configValue||i.parentElement?.getAttribute("data-option"),n=e||s;if(!n)return;let o;if("ha-entity-picker"===i.localName&&"value-changed"===t.type?o=t.detail.value||null:"ha-switch"===i.localName?o=i.checked:"ha-slider"===i.localName?(o=i.value,null==o&&(o=t.detail?.value||0)):"ha-textfield"===i.localName&&"number"===i.type?(o=parseFloat(i.value),(isNaN(o)||o<0)&&(o="card_spacing"===n?15:"auto_swipe_interval"===n?2e3:"reset_after_timeout"===n?3e4:"cards_visible"===n?2.5:0)):o=i.value,"auto_hide_pagination"===n&&(o=1e3*parseFloat(o),isNaN(o)||o<0?o=0:o>3e4&&(o=3e4),d("EDITOR",`Auto-hide pagination: ${o/1e3}s = ${o}ms`)),this.editor.ii[n]!==o){if("view_mode"===n){d("EDITOR",`View mode changing from ${this.editor.ii[n]} to ${o}`);const t={...this.editor.ii,[n]:o};return"carousel"===o?(delete t.swipe_direction,t.auto_height&&(delete t.auto_height,d("EDITOR","Removed auto_height (incompatible with carousel mode)")),t.cards_visible||t.card_min_width||(t.card_min_width=200),d("EDITOR","Cleaned config for carousel mode:",Object.keys(t))):"single"===o&&(delete t.cards_visible,delete t.card_min_width,t.swipe_direction||(t.swipe_direction="horizontal"),d("EDITOR","Cleaned config for single mode:",Object.keys(t))),this.editor.ii=t,this.fireConfigChanged(),void this.Is()}if("card_min_width"===n){if(d("EDITOR",`User changed card_min_width to ${o}, migrating from legacy mode`),void 0!==this.editor.ii.cards_visible){const t={...this.editor.ii};delete t.cards_visible,t.card_min_width=o,this.editor.ii=t,d("EDITOR","Migrated from cards_visible to card_min_width")}else this.editor.ii={...this.editor.ii,[n]:o};return this.fireConfigChanged(),void this.Is()}if("view_mode"===n&&"carousel"===o||"swipe_direction"===n&&"vertical"===o||"loop_mode"===n&&"infinite"===o){d("EDITOR",`Mode change detected that affects auto_height: ${n} = ${o}`);const t={...this.editor.ii,[n]:o};return t.auto_height&&(delete t.auto_height,d("EDITOR",`Removed auto_height due to incompatible mode: ${n} = ${o}`)),this.editor.ii=t,this.fireConfigChanged(),void this.Is()}d("EDITOR",`Value changed for ${n}:`,o),this.editor.ii={...this.editor.ii,[n]:o},this.fireConfigChanged(),this.Is()}}Is(){this.hs||(this.hs=setTimeout(()=>{this.editor.requestUpdate(),this.hs=null},50))}handleTimeoutChange(t){const i=parseInt(t.target.value);if(!isNaN(i)&&i>=5){const t=1e3*i;this.editor.ii={...this.editor.ii,reset_after_timeout:t},this.fireConfigChanged()}}handleTargetChange(t){const i=parseInt(t.target.value);!isNaN(i)&&i>=1&&(this.editor.ii={...this.editor.ii,reset_target_card:i},this.fireConfigChanged())}getCleanConfig(t){if(!t)return{};const i={type:t.type};t.view_mode&&"single"!==t.view_mode&&(i.view_mode=t.view_mode),"carousel"===t.view_mode&&(void 0!==t.cards_visible?i.cards_visible=t.cards_visible:void 0!==t.card_min_width&&200!==t.card_min_width&&(i.card_min_width=t.card_min_width));const e={show_pagination:!0,card_spacing:15,loop_mode:"none",swipe_direction:"horizontal",swipe_behavior:"single",enable_auto_swipe:!1,auto_swipe_interval:2e3,enable_reset_after:!1,reset_after_timeout:3e4,reset_target_card:1};["card_spacing","swipe_direction","swipe_behavior","show_pagination","auto_hide_pagination","auto_height"].forEach(s=>{void 0!==t[s]&&t[s]!==e[s]&&(i[s]=t[s])}),["loop_mode","enable_auto_swipe","auto_swipe_interval","enable_reset_after","reset_after_timeout","reset_target_card","state_entity"].forEach(s=>{"state_entity"===s?t.state_entity&&null!==t.state_entity&&""!==t.state_entity&&(i.state_entity=t.state_entity):void 0!==t[s]&&t[s]!==e[s]&&(i[s]=t[s])}),Array.isArray(t.cards)&&(i.cards=t.cards);return["grid_options","layout_options","view_layout"].forEach(e=>{void 0!==t[e]&&(i[e]=t[e])}),void 0!==t.card_mod&&(i.card_mod=t.card_mod),i}fireConfigChanged(t={}){const i=this.getCleanConfig(this.editor.ii);!function(t,i,e={}){if(!i)return;const s=!e.maintainEditorState,n=new CustomEvent("config-changed",{detail:{config:i,...e},bubbles:s,composed:!0});d("EVENT","Firing config-changed event",{bubble:s,...e}),t.dispatchEvent(n)}(this.editor,i,{editorId:this.editor.Xe,fromSwipeCardEditor:!0,...t})}cleanup(){this.hs&&(clearTimeout(this.hs),this.hs=null),d("EDITOR","EditorConfigManager cleanup completed")}}class Lt{constructor(t){this.editor=t}getCardDescriptor(t){if(!t?.type)return{typeName:"Unknown",name:"",isPictureElements:!1};const i=t.type.startsWith("custom:")?t.type.substring(7):t.type,e=i.split(/[-_]/).map(t=>t.charAt(0).toUpperCase()+t.slice(1)).join(" ");return{typeName:e,name:t.title||t.name||"",isPictureElements:"picture-elements"===i}}hasNestedCards(t){return!("custom:actions-card"!==t.type||!t.card)&&(Array.isArray(t.card)?t.card.length>0:!!t.card)}getNestedCards(t){return this.hasNestedCards(t)?Array.isArray(t.card)?t.card:[t.card]:[]}hasVisibilityConditions(t){return t&&Array.isArray(t.visibility)&&t.visibility.length>0}isPictureElementsCard(t){return t&&"picture-elements"===t.type}moveCard(t,i){if(!this.editor.ii?.cards)return;const e=[...this.editor.ii.cards],s=t+i;s<0||s>=e.length||(d("EDITOR",`Moving card ${t} to position ${s}`),[e[t],e[s]]=[e[s],e[t]],this.editor.ii={...this.editor.ii,cards:e},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate())}removeCard(t){if(!this.editor.ii?.cards||t<0||t>=this.editor.ii.cards.length)return;d("EDITOR",`Removing card at index ${t}`);const i=this.editor.ii.cards.filter((i,e)=>e!==t);this.editor.ii={...this.editor.ii,cards:i},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate()}moveNestedCard(t,i,e){if(!this.editor.ii?.cards||!this.editor.ii.cards[t])return;const s=this.editor.ii.cards[t];if(!this.hasNestedCards(s))return;const n=this.getNestedCards(s),o=i+e;if(o<0||o>=n.length)return;d("EDITOR",`Moving nested card ${t}.${i} to position ${t}.${o}`),[n[i],n[o]]=[n[o],n[i]];const a=[...this.editor.ii.cards];a[t]={...s,card:n},this.editor.ii={...this.editor.ii,cards:a},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate()}removeNestedCard(t,i){if(!this.editor.ii?.cards||!this.editor.ii.cards[t])return;const e=this.editor.ii.cards[t];if(!this.hasNestedCards(e))return;let s=this.getNestedCards(e);if(i<0||i>=s.length)return;d("EDITOR",`Removing nested card ${t}.${i}`),s=s.filter((t,e)=>e!==i);const n=[...this.editor.ii.cards];n[t]={...e,card:s},this.editor.ii={...this.editor.ii,cards:n},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate()}async editCard(t){if(d("EDITOR",`_editCard called for index ${t}`),!this.editor.ii||!this.editor.ii.cards||t<0||t>=this.editor.ii.cards.length)return void d("ERROR","SimpleSwipeCardEditor: Invalid index for card editing:",t);const i=this.editor.ii.cards[t],e=this.editor.hass,s=document.querySelector("home-assistant");if(e&&s)try{await customElements.whenDefined("hui-dialog-edit-card");const n=document.createElement("hui-dialog-edit-card");n.hass=e,document.body.appendChild(n),this.editor.ps.add(n),n.ys=this.editor.Xe,this.isPictureElementsCard(i)&&(n.setAttribute("data-editing-picture-elements","true"),n.xs=!0),d("EDITOR",`[CARD INDEX ${t}] hui-dialog-edit-card created and added to body. Tracking it.`);const o=this.editor.eventHandling.handleDialogConfigChanged.bind(this.editor.eventHandling,t,n),a=this.editor.eventHandling.handleDialogShowDialog.bind(this.editor.eventHandling,t);n.addEventListener("config-changed",o,{capture:!0}),n.addEventListener("show-dialog",a,{capture:!0}),n.addEventListener("ll-show-dialog",a,{capture:!0}),this.isPictureElementsCard(i)&&(n.addEventListener("element-updated",t=>{d("ELEMENT","Element updated event on dialog",t.detail),n.Es=!0,this.editor.eventHandling.fs.active=!0,this.editor.eventHandling.fs.timestamp=Date.now()},{capture:!0}),n.addEventListener("show-edit-element",t=>{d("ELEMENT","Show edit element event on dialog",t.detail),n.Es=!0,this.editor.eventHandling.fs.active=!0,this.editor.eventHandling.fs.timestamp=Date.now()},{capture:!0})),"custom:actions-card"===i.type&&(n.Ss=!0);const r=()=>{if(d("EDITOR",`[CARD INDEX ${t}] hui-dialog-edit-card closed event received.`),n.removeEventListener("dialog-closed",r),n.removeEventListener("config-changed",o,{capture:!0}),n.removeEventListener("show-dialog",a,{capture:!0}),n.removeEventListener("ll-show-dialog",a,{capture:!0}),this.isPictureElementsCard(i)&&(n.removeEventListener("element-updated",h,{capture:!0}),n.removeEventListener("show-edit-element",c,{capture:!0})),this.editor.ps.delete(n),d("EDITOR",`[CARD INDEX ${t}] hui-dialog-edit-card removed from tracking. Active child editors: ${this.editor.ps.size}`),n.Es&&(d("ELEMENT","Element edit session reset due to dialog close"),setTimeout(()=>{this.editor.eventHandling.fs.active&&Date.now()-this.editor.eventHandling.fs.timestamp>500&&(this.editor.eventHandling.fs.active=!1)},500)),n.parentNode===document.body)try{document.body.removeChild(n),d("EDITOR",`[CARD INDEX ${t}] hui-dialog-edit-card removed from body.`)}catch(i){console.warn(`[CARD INDEX ${t}] Error removing dialog from body:`,i)}setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)};n.addEventListener("dialog-closed",r);const h=t=>{d("ELEMENT","Element updated event on dialog",t.detail),n.Es=!0,this.editor.eventHandling.fs.active=!0,this.editor.eventHandling.fs.timestamp=Date.now()},c=t=>{d("ELEMENT","Show edit element event on dialog",t.detail),n.Es=!0,this.editor.eventHandling.fs.active=!0,this.editor.eventHandling.fs.timestamp=Date.now()};this.isPictureElementsCard(i)&&(n.addEventListener("element-updated",h,{capture:!0}),n.addEventListener("show-edit-element",c,{capture:!0}));const l={cardConfig:i,lovelaceConfig:this.editor.lovelace||s.lovelace,saveCardConfig:async i=>{if(d("EDITOR",`[CARD INDEX ${t}] saveCardConfig callback in hui-dialog-edit-card invoked.`),n.Ts||n.Es){if(d("ELEMENT",`[CARD INDEX ${t}] Save detected from element editor, preserving dialog state`),n.Ts=!1,this.editor.eventHandling.fs.timestamp=Date.now(),i){d("ELEMENT","Silently updating config with element changes");const e=[...this.editor.ii.cards];e[t]=i,this.editor.ii={...this.editor.ii,cards:e},this.editor.configManager.fireConfigChanged({maintainEditorState:!0,fromElementEditor:!0,updatedCardIndex:t})}return i}if(n.Cs&&!i)return d("ELEMENT",`[CARD INDEX ${t}] Element editor cancel detected, restoring previous config`),void(n.Cs=null);if(!i)return;const e=[...this.editor.ii.cards];e[t]=i,this.editor.ii={...this.editor.ii,cards:e},this.editor.configManager.fireConfigChanged({reason:"child_dialog_saved"}),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)}};d("EDITOR",`[CARD INDEX ${t}] About to call dialog.showDialog()`),await n.showDialog(l),d("EDITOR",`[CARD INDEX ${t}] dialog.showDialog() finished.`)}catch(e){d("ERROR","SimpleSwipeCardEditor: Error opening edit dialog:",e),Ct(this.editor,"ll-show-dialog",{dialogTag:"hui-dialog-edit-card",dialogImport:()=>import("hui-dialog-edit-card"),dialogParams:{cardConfig:i,lovelaceConfig:this.editor.lovelace||s.lovelace,saveCardConfig:async i=>{if(!i)return;const e=[...this.editor.ii.cards];e[t]=i,this.editor.ii={...this.editor.ii,cards:e},this.editor.configManager.fireConfigChanged({reason:"child_dialog_saved_fallback"}),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)}}})}else d("ERROR","SimpleSwipeCardEditor: Cannot find Home Assistant instance")}async editNestedCard(t,i){if(d("EDITOR",`_editNestedCard called for parent ${t}, nested ${i}`),!this.editor.ii?.cards||!this.editor.ii.cards[t]||!this.hasNestedCards(this.editor.ii.cards[t]))return void d("ERROR","SimpleSwipeCardEditor: Invalid indices for nested card editing:",t,i);const e=this.editor.ii.cards[t],s=this.getNestedCards(e);if(i<0||i>=s.length)return;const n=s[i],o=this.editor.hass,a=document.querySelector("home-assistant");if(o&&a)try{await customElements.whenDefined("hui-dialog-edit-card");const r=document.createElement("hui-dialog-edit-card");r.hass=o,document.body.appendChild(r),this.editor.ps.add(r),r.ys=this.editor.Xe,this.isPictureElementsCard(n)&&(r.setAttribute("data-editing-picture-elements","true"),r.xs=!0),r.addEventListener("config-changed",t=>{if(this.editor.eventHandling.$s(t))return d("ELEMENT","Nested card: Detected element editor event, allowing natural propagation"),r.Es=!0,this.editor.eventHandling.fs.active=!0,this.editor.eventHandling.fs.timestamp=Date.now(),void(t.detail&&t.detail.config&&(r.Cs=JSON.parse(JSON.stringify(t.detail.config)),r.Ts=!0));(t.detail?.fromExternalEditor||t.detail?.fromActionCardEditor||t.detail?.fromSwipeCardEditor)&&(d("EDITOR","Marking nested event as already handled in _editNestedCard's dialog"),t._s=!0)},!0);const h=()=>{if(r.removeEventListener("dialog-closed",h),r.Es&&(d("ELEMENT","Dialog handling element edit is closing, ending element edit session"),this.editor.eventHandling.fs.active=!1),this.editor.ps.delete(r),r.parentNode===document.body)try{document.body.removeChild(r)}catch(t){console.warn("Error removing nested card dialog:",t)}setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)};r.addEventListener("dialog-closed",h);const c={cardConfig:n,lovelaceConfig:this.editor.lovelace||a.lovelace,saveCardConfig:async n=>{if(r.Ts||r.Es){if(d("ELEMENT","Nested card: Save detected from element editor, preserving dialog state"),r.Ts=!1,this.editor.eventHandling.fs.timestamp=Date.now(),n){d("ELEMENT","Silently updating nested card config with element changes");const o=[...s];o[i]=n;const a={...e,card:o},r=[...this.editor.ii.cards];r[t]=a,this.editor.ii={...this.editor.ii,cards:r},this.editor.configManager.fireConfigChanged({maintainEditorState:!0,fromElementEditor:!0,updatedCardIndex:t,nestedCardIndex:i})}return n}if(r.Cs&&!n)return d("ELEMENT","Nested card: Element editor cancel detected, restoring previous config"),void(r.Cs=null);if(!n)return;d("EDITOR",`Saving nested card ${t}.${i} with new config`);const o=[...s];o[i]=n;const a={...e,card:o},h=[...this.editor.ii.cards];h[t]=a,this.editor.ii={...this.editor.ii,cards:h},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)}};await r.showDialog(c)}catch(o){d("ERROR","SimpleSwipeCardEditor: Error opening edit dialog for nested card:",o),Ct(this.editor,"ll-show-dialog",{dialogTag:"hui-dialog-edit-card",dialogImport:()=>import("hui-dialog-edit-card"),dialogParams:{cardConfig:n,lovelaceConfig:this.editor.lovelace||a.lovelace,saveCardConfig:async n=>{if(!n)return;const o=[...s];o[i]=n;const a={...e,card:o},r=[...this.editor.ii.cards];r[t]=a,this.editor.ii={...this.editor.ii,cards:r},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)}}})}else d("ERROR","SimpleSwipeCardEditor: Cannot find Home Assistant instance")}safelyAddCard(t){if(t&&this.editor.ii)try{const i=Array.isArray(this.editor.ii.cards)?[...this.editor.ii.cards]:[],e={...this.editor.ii,cards:[...i,t]};this.editor.ii=e,this.editor.configManager.fireConfigChanged({isSafeCardAddition:!0,addedCardType:t.type}),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),50),d("EDITOR","Safely added card:",t.type)}catch(t){d("ERROR","Failed to safely add card:",t)}}handleCardPicked(t){if(d("EDITOR","Fallback _handleCardPicked called:",t.detail?.config?.type),t.stopPropagation(),t.stopImmediatePropagation&&t.stopImmediatePropagation(),!t.detail?.config)return;const i=t.detail.config;d("EDITOR","Adding card in fallback handler:",i.type);const e=Array.isArray(this.editor.ii.cards)?[...this.editor.ii.cards]:[],s={...this.editor.ii,cards:[...e,i]};this.editor.ii=s,this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate()}}class Pt{constructor(t){this.editor=t,this.cs=this.ls.bind(this),this.fs={active:!1,parentDialogId:null,elementId:null,timestamp:null,savedState:null},this.Os=0,this.Ns=1e3}setupEventListeners(){document.addEventListener("config-changed",this.cs,{capture:!0}),this.ks=t=>{if(this.$s(t)){if(d("ELEMENT","Config-changed event from element editor, allowing propagation"),t.target&&t.target.closest("hui-dialog-edit-card")){const i=t.target.closest("hui-dialog-edit-card");i&&(i.Es=!0,this.fs.active=!0,this.fs.parentDialogId=i.ys||null,this.fs.timestamp=Date.now())}}else if("config-changed"===t.type&&t.detail?.config){const i="custom:actions-card"===t.detail?.config?.type;if("hui-card-picker"===t.target?.tagName?.toLowerCase()){if((t.composedPath?t.composedPath():[]).some(t=>t===this.editor||t.shadowRoot&&t.shadowRoot.contains(this.editor)||this.editor.shadowRoot&&this.editor.shadowRoot.contains(t))&&(d("EDITOR","Card picker selection captured by global handler:",t.detail.config.type),i&&!this.editor.gs))return this.editor.us={time:Date.now(),config:t.detail.config},this.editor.gs=!0,this.editor.Ds(t.detail.config),t.stopImmediatePropagation&&t.stopImmediatePropagation(),void t.stopPropagation()}}},document.addEventListener("config-changed",this.ks,{capture:!0}),this.Ms=t=>{if(t.Rs)return d("EVENT","Intercepted iron-select event already processed by actions card editor"),void t.stopPropagation()},document.addEventListener("iron-select",this.Ms,{capture:!0}),this.As=t=>{if(t.target&&"HUI-DIALOG-EDIT-CARD"===t.target.tagName){const i=t.target;d("EDITOR","A HUI-DIALOG-EDIT-CARD closed",{tracked:this.editor.ps?.has(i)||!1,isActions:this.Ls(i),handlingElementEdit:i.Es}),i.Es&&(d("ELEMENT","Dialog handling element edit is closing, ending element edit session"),this.fs.active=!1,i.Cs&&(d("ELEMENT","Preserving element config on dialog close"),this.fs.savedState=i.Cs,i.Cs=null)),this.editor.ps?.has(i)&&(this.editor.ps.delete(i),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100))}t.target&&("HUI-DIALOG-EDIT-ELEMENT"===t.target.tagName||"HUI-DIALOG"===t.target.tagName&&this.$s(t))&&(d("ELEMENT","Element editor dialog closed"),setTimeout(()=>{this.fs.active&&Date.now()-this.fs.timestamp>500&&(d("ELEMENT","Resetting element edit session after timeout"),this.fs.active=!1)},500))},document.addEventListener("dialog-closed",this.As,{capture:!0}),this.Ps=t=>{"element-updated"!==t.type&&"show-edit-element"!==t.type||this.fs.active||(d("ELEMENT",`Capturing ${t.type} event, starting element edit session`),this.fs.active=!0,this.fs.timestamp=Date.now(),t.detail&&t.detail.elementId&&(this.fs.elementId=t.detail.elementId))},document.addEventListener("element-updated",this.Ps,{capture:!0}),document.addEventListener("show-edit-element",this.Ps,{capture:!0})}removeEventListeners(){document.removeEventListener("config-changed",this.ks,{capture:!0}),document.removeEventListener("iron-select",this.Ms,{capture:!0}),document.removeEventListener("config-changed",this.cs,{capture:!0}),document.removeEventListener("dialog-closed",this.As,{capture:!0}),document.removeEventListener("element-updated",this.Ps,{capture:!0}),document.removeEventListener("show-edit-element",this.Ps,{capture:!0})}$s(t){if(!t)return!1;const i=Date.now(),e=i-this.Os>this.Ns;if(t.detail&&(t.detail.fromElementEditor||t.detail.elementConfig||t.detail.elementToEdit||t.detail.element))return e&&(d("ELEMENT","Element editor detected through event detail"),this.Os=i),!0;const s=t.composedPath?t.composedPath():[];for(const t of s)if(t&&t.localName){if("hui-element-editor"===t.localName||"hui-dialog-edit-element"===t.localName||"hui-card-element-editor"===t.localName||t.localName.includes("element-editor"))return e&&(d("ELEMENT","Element editor detected through path node localName:",t.localName),this.Os=i),!0;if(t.zs||t.Vs||t.getAttribute&&(t.getAttribute("element-id")||t.getAttribute("data-element-id"))||t.classList&&t.classList.contains("element-editor"))return d("ELEMENT","Element editor detected through specialized attributes"),!0;if("HUI-DIALOG"===t.tagName&&(t.querySelector(".element-editor")||t.Bs&&"string"==typeof t.Bs&&t.Bs.toLowerCase().includes("element")))return d("ELEMENT","Element editor detected through hui-dialog with element editor content"),!0}return"element-updated"===t.type||"config-changed"===t.type&&t.target&&("hui-element-editor"===t.target.localName||t.target.closest("hui-element-editor"))?(d("ELEMENT","Element editor detected through event characteristics"),!0):!!(this.fs.active&&Date.now()-this.fs.timestamp<5e3)&&(d("ELEMENT","Element editor event detected through active editing session"),!0)}Ls(t){if(!t)return!1;if(t.Ss)return!0;try{const i=t.cardConfig;return i&&"custom:actions-card"===i.type}catch(t){return!1}}ls(t,i){let e,s;if(t&&"function"==typeof t.preventDefault?(e=t,s=null):(s=t,e=i),!e)return;if(s&&"auto_hide_pagination"===s.option)return;if(e.detail&&(e.detail.fromSwipeCardEditor||e.detail.fromElementEditor||e.detail.elementEditorEvent||e.detail.maintainEditorState))return void d("ELEMENT","Skipping our own generated event to prevent loop");if(this.$s(e)){d("ELEMENT","Detected element editor event in _handleNestedCardEvents");if(e.composedPath&&this.editor.ps&&e.composedPath().some(t=>this.editor.ps.has(t)||t.ys&&t.ys===this.editor.Xe))return void d("ELEMENT","Element editor event is related to our dialog stack, handling specially")}if(e.Ys||!e.detail?.fromActionCardEditor)return;const n=e.target.closest("[data-index]");if(!n||!this.editor.ii?.cards)return;const o=parseInt(n.getAttribute("data-index"));if(!(isNaN(o)||o<0||o>=this.editor.ii.cards.length)){if(d("EVENT",`Handling nested card event from actions card at index ${o}`,e.detail),e.stopPropagation(),e.preventDefault&&e.preventDefault(),e.detail.maintainEditorState){d("EVENT","Event marked to maintain editor state, preventing propagation");const t=[...this.editor.ii.cards];t[o]=e.detail.config,this.editor.ii={...this.editor.ii,cards:t},this.editor.configManager.fireConfigChanged({nestedCardUpdate:!0,updatedCardIndex:o,nestedCardType:e.detail.config.type,maintainEditorState:!0})}else{const t=[...this.editor.ii.cards];t[o]=e.detail.config,this.editor.ii={...this.editor.ii,cards:t},this.editor.configManager.fireConfigChanged({nestedCardUpdate:!0,updatedCardIndex:o,nestedCardType:e.detail.config.type})}e.Ys=!0,this.editor.requestUpdate()}}handleDialogConfigChanged(t,i,e){{const t=e.composedPath?e.composedPath().map(t=>t.localName||t.nodeName).join(" > "):"No path",i=e.detail?JSON.stringify(e.detail,null,2):"{}";d("EVENT","Config change event details:",{target:e.target.localName,path:t,detail:JSON.parse(i),rawDetail:i,currentTarget:e.currentTarget.localName})}if(this.$s(e)){if(d("ELEMENT",`[CARD INDEX ${t}] Element editor event detected, preserving and allowing propagation`),i.Es=!0,this.fs.active=!0,this.fs.timestamp=Date.now(),e.detail&&e.detail.config&&(i.Cs=JSON.parse(JSON.stringify(e.detail.config)),i.Ts=!0,i.xs))try{d("ELEMENT","Silently updating picture-elements config");const i=[...this.editor.ii.cards];i[t]=e.detail.config,this.editor.ii={...this.editor.ii,cards:i},this.editor.configManager.fireConfigChanged({maintainEditorState:!0,fromElementEditor:!0,elementEditorEvent:!0,updatedCardIndex:t})}catch(t){d("ERROR","Error silently updating config:",t)}}else if(e.target!==i&&e.detail&&e.detail.config){e.stopPropagation();const i=e.detail.config;d("EDITOR",`[CARD INDEX ${t}] Config received in handler: ${JSON.stringify(i.type)}`);const s=[...this.editor.ii.cards];s[t]=i,this.editor.ii={...this.editor.ii,cards:s},this.editor.configManager.fireConfigChanged({maintainEditorState:!0,updatedCardIndex:t,reason:"child_dialog_update_"+(e.detail.fromActionCardEditor?"action_card":"generic")}),this.editor.requestUpdate(),d("EDITOR",`[CARD INDEX ${t}] Processed config-changed from content, stopped propagation OUTSIDE dialog.`)}else d("EDITOR",`[CARD INDEX ${t}] config-changed ignored or allowed to bubble (no config or event target is the dialog itself)`)}handleDialogShowDialog(t,i){if(i.detail&&(i.detail.dialogTag&&("hui-dialog-edit-element"===i.detail.dialogTag||i.detail.dialogTag.includes("element-editor"))||i.detail.elementToEdit)){d("ELEMENT",`[CARD INDEX ${t}] Element editor dialog detected, allowing normal event flow`);const e=i.currentTarget;return e&&(e.Es=!0),this.fs.active=!0,this.fs.timestamp=Date.now(),void(i.detail&&i.detail.elementId&&(this.fs.elementId=i.detail.elementId))}const e=i.detail?JSON.stringify(i.detail):"{}";d("EDITOR",`[CARD INDEX ${t}] INTERCEPTED "${i.type}" event from hui-dialog-edit-card OR ITS CONTENT`,{detail:JSON.parse(e),target:i.target.localName}),i.stopPropagation(),i.stopImmediatePropagation&&i.stopImmediatePropagation(),i.cancelable&&i.preventDefault(),d("EDITOR",`[CARD INDEX ${t}] Re-firing "${i.type}" event from SimpleSwipeCardEditor.`),Ct(this.editor,i.type,i.detail)}}function zt(t,i,e,s,n,o,a,r){const h=t.loop_mode||"none",d=!0===t.enable_auto_swipe,c=t.auto_swipe_interval??2e3,l=!0===t.enable_reset_after,p=t.reset_after_timeout??3e4,u=t.reset_target_card??1,g=t.state_entity||"";let m=0,f=0;"none"!==h&&m++,d&&m++,l&&!d&&m++,l&&d&&f++,g&&m++;let v="",w="";return m>0&&(v=`${m} active`),f>0&&(w=`${f} blocked`),Z`
  ...
  `}class SimpleSwipeCardEditor extends mt{static get properties(){return{hass:{type:Object},ii:{type:Object,state:!0},lovelace:{type:Object}}}static get styles(){return Tt()}constructor(){super(),d("EDITOR","SimpleSwipeCardEditor Constructor invoked."),d("EDITOR","Editor styles method available:",!!this.constructor.styles),this.uiManager=new Rt(this),this.configManager=new At(this),this.cardManagement=new Lt(this),this.eventHandling=new Pt(this),this.uiManager.initializeEditor()}$s(t){return this.eventHandling.$s(t)}Ls(t){return this.eventHandling.Ls(t)}Ws(t){return this.cardManagement.isPictureElementsCard(t)}Hs(t){return this.cardManagement.hasVisibilityConditions(t)}Fs(t){this.uiManager.toggleSection(t)}Us(t){return this.cardManagement.hasNestedCards(t)}js(t){return this.cardManagement.getNestedCards(t)}Gs(t,i,e){this.cardManagement.moveNestedCard(t,i,e)}Js(t,i){this.cardManagement.removeNestedCard(t,i)}async Xs(t,i){await this.cardManagement.editNestedCard(t,i)}async qs(t){await this.cardManagement.editCard(t)}Zs(t){this.cardManagement.handleCardPicked(t)}Ks(t){return this.cardManagement.getCardDescriptor(t)}Qs(t,i){this.cardManagement.moveCard(t,i)}tn(t){this.cardManagement.removeCard(t)}Ds(t){this.cardManagement.safelyAddCard(t)}en(){this.uiManager.ensureCardPickerLoaded()}setConfig(t){this.configManager||(d("EDITOR","Reinitializing managers in setConfig"),this.uiManager=new Rt(this),this.configManager=new At(this),this.cardManagement=new Lt(this),this.eventHandling=new Pt(this),this.uiManager.initializeEditor()),this.configManager.setConfig(t)}sn(t){this.configManager.handleValueChanged(t)}nn(t={}){this.configManager.fireConfigChanged(t)}render(){if(!this.hass||!this.ii)return Z`<ha-circular-progress
        active
        alt="Loading editor"
  ...
  `}(this.ii,this.sn.bind(this))}
          ${zt(this.ii,this.uiManager.getCollapsibleState(),this.sn.bind(this),this.Fs.bind(this),i,this.an.bind(this),this.rn.bind(this),this.hass)}
          ${Vt(i,this.hass,this.Qs.bind(this),this.qs.bind(this),this.tn.bind(this),this.Ks.bind(this),this.Us.bind(this),this.js.bind(this),this.Hs.bind(this),this.Gs.bind(this),this.Xs.bind(this),this.Js.bind(this))}
          ${e=this.hass,s=this.lovelace,n=this.ds,Z`
  ...
  `}
      ...
      `}catch(t){return console.error("Simple Swipe Card Editor render error:",t),Z`<div style="color: red; padding: 16px;">
        ...
        <small
          ...
          persists.</small
        >
      </div>`}var e,s,n}an(t){this.configManager.handleTimeoutChange(t)}rn(t){this.configManager.handleTargetChange(t)}hn(t){const i=1e3*parseFloat(t.target.value);this.ii={...this.ii,auto_hide_pagination:i},this.dn()}async connectedCallback(){super.connectedCallback&&super.connectedCallback(),d("EDITOR","SimpleSwipeCardEditor connectedCallback");try{this.uiManager||(d("EDITOR","Reinitializing managers after reconnection"),this.uiManager=new Rt(this),this.configManager=new At(this),this.cardManagement=new Lt(this),this.eventHandling=new Pt(this),this.uiManager.initializeEditor());$t(a,"Set").add(this);try{await this.uiManager.ensureComponentsLoaded()}catch(t){d("EDITOR","Warning: Could not load all components")}this.eventHandling?.setupEventListeners&&this.eventHandling.setupEventListeners(),setTimeout(()=>{this.uiManager?.ensureCardPickerLoaded&&this.uiManager.ensureCardPickerLoaded()},50),this.requestUpdate()}catch(t){console.error("Error during editor setup:",t),this.requestUpdate()}}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),d("EDITOR","SimpleSwipeCardEditor disconnectedCallback");try{this.uiManager&&(this.uiManager.cleanup(),this.uiManager=null),this.configManager&&(this.configManager.cleanup(),this.configManager=null),this.cardManagement=null,this.eventHandling=null,this.eventHandling?.removeEventListeners(),this.ps&&this.ps.clear(),this.Xe=null}catch(t){console.warn("Error during editor cleanup:",t)}try{$t(a,"Set").delete(this);const t=$t(o);this.Xe&&t.delete(this.Xe)}catch(t){console.warn("Error unregistering editor:",t)}d("EDITOR","SimpleSwipeCardEditor cleanup completed")}}async function Bt(){try{await async function(){return d("SYSTEM","Using bundled LitElement dependencies"),!0}(),d("SYSTEM","Dependencies loaded, registering components"),customElements.get("simple-swipe-card")||(customElements.define("simple-swipe-card",SimpleSwipeCard),d("SYSTEM","SimpleSwipeCard component registered")),customElements.get("simple-swipe-card-editor")||(customElements.define("simple-swipe-card-editor",SimpleSwipeCardEditor),d("SYSTEM","SimpleSwipeCardEditor component registered")),Yt(),console.info(`%c SIMPLE-SWIPE-CARD %c v${t} `,"color: white; background: #4caf50; font-weight: 700;","color: #4caf50; background: white; font-weight: 700;")}catch(t){console.error("SimpleSwipeCard: Failed to initialize:",t)}}function Yt(){const t={type:"simple-swipe-card",name:"Simple Swipe Card",preview:!0,description:"A swipeable container for multiple cards with touch and mouse gesture support, visibility conditions, and reset after timeout."};window.customCards&&!window.customCards.some(t=>"simple-swipe-card"===t.type)&&(window.customCards.push(t),d("SYSTEM","Card registered with Home Assistant customCards registry"))}vt()?vt().then(()=>{Yt(),Bt()}).catch(t=>{console.error("SimpleSwipeCard: Error waiting for Card Helpers:",t),Bt()}):window.customCards?(Yt(),Bt()):"loading"===document.readyState?window.addEventListener("load",()=>{Yt(),Bt()},{once:!0}):setTimeout(()=>{Yt(),Bt()},100);export{SimpleSwipeCard,SimpleSwipeCardEditor};
