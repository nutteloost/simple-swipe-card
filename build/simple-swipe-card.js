...
`;function St(t,i,e={}){try{((t,i,e={})=>{const s=new CustomEvent(i,{detail:e,bubbles:!0,composed:!0});t.dispatchEvent(s)})(t,i,e)}catch(s){d("ERROR","Failed to fire HA event:",i,s);const n=new CustomEvent(i,{detail:e,bubbles:!0,composed:!0});t.dispatchEvent(n)}}function Tt(t,i="Map"){return window[t]||(window[t]="Set"===i?new Set:new Map),window[t]}class Ct{constructor(t){this.card=t}async build(){if(this.card.building)return void d("INIT","Build already in progress, skipping.");if(!this.card.Qt||!this.card.Qt.cards||!this.card.isConnected)return void d("INIT","Build skipped (no config/cards or not connected).");this.card.building=!0,d("INIT","Starting build..."),this.card.resetAfter?.preserveState(),this.card.cards=[];const t=0===this.card.currentIndex;this.card.Qt.state_entity&&this.card.xi||(this.card.currentIndex=0),this.card.virtualIndex=0,this.card.realIndex=0,this.card.resizeObserver?.cleanup(),this.card.swipeGestures?.removeGestures(),this.card.autoSwipe?.stop(),this.card.resetAfter?.stopTimer(),this.card.shadowRoot&&(this.card.shadowRoot.innerHTML="");const i=this.card.shadowRoot,e=await ft();if(!e)return console.error("SimpleSwipeCard: Card helpers not loaded."),i.innerHTML='<ha-alert alert-type="error">Card Helpers are required for this card to function. Please ensure they are loaded.</ha-alert>',this.card.building=!1,void(this.card.initialized=!1);const s=document.createElement("style");if(s.textContent='\n     :host {\n        display: block;\n        overflow: hidden;\n        width: 100%;\n        height: 100%;\n        position: relative;\n        border-radius: var(--ha-card-border-radius, 12px);\n        background: transparent;\n     }\n\n     /* --- START PREVIEW STYLES --- */\n     .preview-container {\n        display: flex;\n        flex-direction: column;\n        align-items: center;\n        justify-content: center;\n        text-align: center;\n        padding: 16px;\n        box-sizing: border-box;\n        height: 100%;\n        background: var(--ha-card-background, var(--card-background-color, white));\n        border-radius: var(--ha-card-border-radius, 12px);\n        border: none; /* Ensure no border */\n     }\n     .preview-icon-container {\n        margin-bottom: 16px;\n     }\n     .preview-icon-container ha-icon {\n        color: var(--primary-color, #03a9f4); /* Use primary color for consistency */\n        font-size: 48px; /* Match Actions Card */\n        width: 48px;\n        height: 48px;\n     }\n     .preview-text-container {\n        margin-bottom: 16px;\n     }\n     .preview-title {\n        font-size: 18px;\n        font-weight: bold;\n        margin-bottom: 8px;\n        color: var(--primary-text-color);\n     }\n     .preview-description {\n        font-size: 14px;\n        color: var(--secondary-text-color);\n        max-width: 300px;\n        line-height: 1.4;\n        margin: 0 auto; /* Center description text block */\n     }\n     .preview-actions ha-button {\n       /* Rely on default raised button styles for consistency */\n     }\n     /* --- END PREVIEW STYLES --- */\n\n     .card-container {\n        position: relative;\n        width: 100%;\n        height: 100%;\n        overflow: hidden;\n        border-radius: inherit;\n        background: transparent;\n     }\n     .slider {\n        position: relative;\n        display: flex;\n        height: 100%;\n        transition: transform var(--simple-swipe-card-transition-speed, 0.3s) var(--simple-swipe-card-transition-easing, ease-out);\n        will-change: transform;\n        background: transparent;\n     }\n     \n     /* Horizontal slider (default) */\n     .slider[data-swipe-direction="horizontal"] {\n        flex-direction: row;\n     }\n     \n     /* Vertical slider */\n     .slider[data-swipe-direction="vertical"] {\n        flex-direction: column;\n     }\n     \n     .slide {\n        flex: 0 0 100%;\n        width: 100%;\n        min-width: 100%;\n        height: 100%;\n        min-height: 100%;\n        box-sizing: border-box;\n        position: relative;\n        display: flex;\n        flex-direction: column;\n        overflow: hidden;\n        background: transparent;\n     }\n\n    .slide.carousel-mode {\n      flex: 0 0 auto; /* Don\'t grow/shrink, use calculated width */\n      width: var(--carousel-card-width); /* Will be set dynamically */\n      min-width: var(--carousel-card-width);\n    }\n\n    /* Carousel container adjustments */\n    .slider[data-view-mode="carousel"] {\n      /* Allow overflow to show partial cards */\n      overflow: visible;\n    }\n\n    .card-container[data-view-mode="carousel"] {\n      /* Ensure container can handle overflow */\n      overflow: hidden;\n      position: relative;\n    }\n\n    .pagination {\n        position: absolute;\n        display: flex;\n        justify-content: center;\n        z-index: 1;\n        background-color: var(--simple-swipe-card-pagination-background, transparent);\n        pointer-events: auto;\n        transition: opacity 0.2s ease-in-out;\n        padding: var(--simple-swipe-card-pagination-padding, 4px 8px);\n        border-radius: 12px;\n        /* Prevent container from sizing to content during animations */\n        box-sizing: border-box;\n    }\n\n    /* Horizontal pagination (bottom) */\n    .pagination.horizontal {\n        bottom: var(--simple-swipe-card-pagination-bottom, 8px);\n        left: 50%;\n        transform: translateX(-50%);\n        flex-direction: row;\n        align-items: center;\n        /* Remove any height properties - will be set by JavaScript */\n    }\n\n    /* Vertical pagination (right) */\n    .pagination.vertical {\n        right: var(--simple-swipe-card-pagination-right, 8px);\n        top: 50%;\n        transform: translateY(-50%);\n        flex-direction: column;\n        align-items: center;\n        /* Remove any width properties - will be set by JavaScript */\n    }\n    \n     .pagination.hide {\n        opacity: 0;\n        pointer-events: none;\n     }\n\n    .pagination-dot {\n        width: var(--simple-swipe-card-pagination-dot-size, 8px);\n        height: var(--simple-swipe-card-pagination-dot-size, 8px);\n        border-radius: var(--simple-swipe-card-pagination-border-radius, 50%);\n        background-color: var(--simple-swipe-card-pagination-dot-inactive-color, rgba(127, 127, 127, 0.6));\n        cursor: pointer;\n        opacity: var(--simple-swipe-card-pagination-dot-inactive-opacity, 1);\n        \n        /* Border support */\n        border-width: var(--simple-swipe-card-pagination-dot-border-width, 0px);\n        border-color: var(--simple-swipe-card-pagination-dot-border-color, transparent);\n        border-style: var(--simple-swipe-card-pagination-dot-border-style, solid);\n        \n        /* Box shadow support */\n        box-shadow: var(--simple-swipe-card-pagination-dot-box-shadow, none);\n        \n        /* Updated transition to include new animatable properties */\n        transition: background-color 0.2s ease, width 0.2s ease, height 0.2s ease, border-color 0.2s ease, box-shadow 0.2s ease, transform 0.2s ease;\n    }\n    \n    /* Hover effects */\n    .pagination-dot:hover {\n        background-color: var(--simple-swipe-card-pagination-dot-hover-color, var(--simple-swipe-card-pagination-dot-inactive-color, rgba(127, 127, 127, 0.6)));\n        opacity: var(--simple-swipe-card-pagination-dot-hover-opacity, var(--simple-swipe-card-pagination-dot-inactive-opacity, 1));\n        border-color: var(--simple-swipe-card-pagination-dot-hover-border-color, var(--simple-swipe-card-pagination-dot-border-color, transparent));\n        transform: var(--simple-swipe-card-pagination-dot-hover-transform, none);\n        box-shadow: var(--simple-swipe-card-pagination-dot-hover-box-shadow, var(--simple-swipe-card-pagination-dot-box-shadow, none));\n    }    \n\n    /* Active hover state */\n    .pagination-dot.active:hover {\n        background-color: var(--simple-swipe-card-pagination-dot-active-hover-color, var(--simple-swipe-card-pagination-dot-active-color, var(--primary-color, #03a9f4)));\n        opacity: var(--simple-swipe-card-pagination-dot-active-hover-opacity, var(--simple-swipe-card-pagination-dot-active-opacity, 1));\n        border-color: var(--simple-swipe-card-pagination-dot-active-hover-border-color, var(--simple-swipe-card-pagination-dot-active-border-color, var(--simple-swipe-card-pagination-dot-border-color, transparent)));\n        transform: var(--simple-swipe-card-pagination-dot-active-hover-transform, var(--simple-swipe-card-pagination-dot-hover-transform, none));\n        box-shadow: var(--simple-swipe-card-pagination-dot-active-hover-box-shadow, var(--simple-swipe-card-pagination-dot-active-box-shadow, var(--simple-swipe-card-pagination-dot-box-shadow, none)));\n    }    \n\n    /* Spacing for horizontal pagination dots */\n    .pagination.horizontal .pagination-dot {\n        margin: 0 var(--simple-swipe-card-pagination-dot-spacing, 4px);\n    }\n    \n    /* Spacing for vertical pagination dots */\n    .pagination.vertical .pagination-dot {\n        margin: var(--simple-swipe-card-pagination-dot-spacing, 4px) 0;\n    }\n    \n    .pagination-dot.active {\n        background-color: var(--simple-swipe-card-pagination-dot-active-color, var(--primary-color, #03a9f4));\n        width: var(--simple-swipe-card-pagination-dot-active-size, var(--simple-swipe-card-pagination-dot-size, 8px));\n        height: var(--simple-swipe-card-pagination-dot-active-size, var(--simple-swipe-card-pagination-dot-size, 8px));\n        opacity: var(--simple-swipe-card-pagination-dot-active-opacity, 1);\n        \n        /* Separate active border radius */\n        border-radius: var(--simple-swipe-card-pagination-dot-active-border-radius, var(--simple-swipe-card-pagination-border-radius, 50%));\n        \n        /* Active border support */\n        border-width: var(--simple-swipe-card-pagination-dot-active-border-width, var(--simple-swipe-card-pagination-dot-border-width, 0px));\n        border-color: var(--simple-swipe-card-pagination-dot-active-border-color, var(--simple-swipe-card-pagination-dot-border-color, transparent));\n        border-style: var(--simple-swipe-card-pagination-dot-active-border-style, var(--simple-swipe-card-pagination-dot-border-style, solid));\n        \n        /* Active box shadow support */\n        box-shadow: var(--simple-swipe-card-pagination-dot-active-box-shadow, var(--simple-swipe-card-pagination-dot-box-shadow, none));\n    }\n\n     ha-alert {\n        display: block;\n        margin: 0;\n        width: 100%;\n        box-sizing: border-box;\n        border-radius: 0;\n        border: none;\n        background-color: transparent;\n     }\n     .slide > *:first-child {\n        flex-grow: 1;\n        width: 100%;\n        display: flex;\n        flex-direction: column;\n        min-height: 0;\n     }\n     .slide > * > ha-card,\n     .slide > * > .card-content {\n        margin: 0 !important;\n        padding: 0 !important;\n        box-shadow: none !important;\n        border-radius: 0 !important;\n        border: none !important;\n        height: 100%;\n        display: flex;\n        flex-direction: column;\n     }\n   ',i.appendChild(s),this.card.cardContainer=document.createElement("div"),this.card.cardContainer.className="card-container",this.card.sliderElement=document.createElement("div"),this.card.sliderElement.className="slider",this.card.sliderElement.setAttribute("data-swipe-direction",this.card.Zt),this.card.cardContainer.appendChild(this.card.sliderElement),i.appendChild(this.card.cardContainer),this.card.Si(),0===this.card.Qt.cards.length){d("INIT","Building preview state.");const t=function(t,i){const e=document.createElement("div");e.className="preview-container";const s=document.createElement("div");s.className="preview-icon-container";const n=document.createElement("ha-icon");n.icon="horizontal"===t?"mdi:gesture-swipe-horizontal":"mdi:gesture-swipe-vertical",s.appendChild(n);const o=document.createElement("div");o.className="preview-text-container";const a=document.createElement("div");a.className="preview-title",a.textContent="Simple Swipe Card";const r=document.createElement("div");r.className="preview-description",r.textContent=`Create a swipeable container with multiple cards. Swipe ${"horizontal"===t?"horizontally":"vertically"} between cards. Open the editor to add your first card.`,o.appendChild(a),o.appendChild(r);const h=document.createElement("div");h.className="preview-actions";const d=document.createElement("ha-button");return d.raised=!0,d.textContent="EDIT CARD",d.setAttribute("aria-label","Edit Card"),d.addEventListener("click",i),h.appendChild(d),e.appendChild(s),e.appendChild(o),e.appendChild(h),e}(this.card.Zt,t=>function(t,i){t.stopPropagation(),d("EDITOR","Edit button clicked, firing show-edit-card event"),St(i,"show-edit-card",{element:i})}(t,this.card));return i.innerHTML="",i.appendChild(s),i.appendChild(t),this.card.initialized=!0,void(this.card.building=!1)}if(0===this.card.visibleCardIndices.length)return d("INIT","No visible cards, hiding entire card."),this.card.style.display="none",i.innerHTML="",this.card.initialized=!0,void(this.card.building=!1);this.card.style.display="block",this.card.loopMode.initialize();const n=this.card.loopMode.prepareCardsForLoading(this.card.visibleCardIndices,this.card.Qt.cards);this.card.loopMode.isInfiniteMode,d("INIT","Building cards:",{totalVisible:this.card.visibleCardIndices.length,totalToLoad:n.length,infiniteMode:this.card.isInfiniteMode});const o=n.map(t=>this.createCard(t.config,t.visibleIndex,t.originalIndex,e,t.isDuplicate));await Promise.allSettled(o),this.card.cards.filter(Boolean).sort((t,i)=>t.visibleIndex-i.visibleIndex).forEach(t=>{t.slide&&(t.slide.setAttribute("data-index",t.originalIndex),t.slide.setAttribute("data-visible-index",t.visibleIndex),t.isDuplicate&&t.slide.setAttribute("data-duplicate","true"),t.config&&t.config.type&&t.slide.setAttribute("data-card-type",t.config.type),this.card.sliderElement.appendChild(t.slide))}),t&&this.card.Qt.state_entity&&this.card.xi&&(this.card.currentIndex=this.Ti()),this.card.pagination?.create(),this.card.Ii(),requestAnimationFrame(()=>this.finishBuildLayout()),this.card.initialized=!0,this.card.building=!1,d("INIT","Build finished - all cards loaded."),this.card.resetAfter?.restoreState()}preloadAdjacentCards(){d("INIT","preloadAdjacentCards called but all cards already loaded")}async createCard(t,i,e,s,n=!1){const o=function(){const t=document.createElement("div");return t.className="slide",t}();let a;const r={visibleIndex:i,originalIndex:e,slide:o,config:JSON.parse(JSON.stringify(t)),error:!1,isDuplicate:n};try{a=await s.createCardElement(t),this.card.xi&&(a.hass=this.card.xi),r.element=a,"picture-elements"===t.type&&(a.setAttribute("data-swipe-card-picture-elements","true"),o.setAttribute("data-has-picture-elements","true")),requestAnimationFrame(()=>{try{if("todo-list"===t.type){const t=a.shadowRoot?.querySelector("ha-textfield"),i=t?.shadowRoot?.querySelector("input");i&&(i.enterKeyHint="done")}}catch(t){console.warn("Error applying post-creation logic:",t)}}),o.appendChild(a)}catch(n){d("ERROR",`Error creating card ${i} (original ${e}):`,t,n),r.error=!0;const a=await s.createErrorCardElement({type:"error",error:`Failed to create card: ${n.message}`,origConfig:t},this.card.xi);r.element=a,o.appendChild(a)}this.card.cards.push(r)}Ci(t,i){d("VISIBILITY",`Conditional card ${t} visibility changed to: ${i}`);const e=this.card.cards.find(i=>i.originalIndex===t);e&&(e.conditionallyVisible=i),this.card.$i()}finishBuildLayout(){if(!this.card.cardContainer||!this.card.isConnected||this.card.building)return void d("INIT","_finishBuildLayout skipped",{container:!!this.card.cardContainer,connected:this.card.isConnected,building:this.card.building});d("INIT","Finishing build layout...");const t=this.card.cardContainer.offsetWidth,i=this.card.cardContainer.offsetHeight;if(t<=0||i<=0)return null===this.card.offsetParent?void d("INIT","Layout calculation skipped, element is hidden."):(d("INIT","Container dimensions are 0, retrying layout..."),this.card._i=(this.card._i||0)+1,void(this.card._i<5?setTimeout(()=>requestAnimationFrame(()=>this.finishBuildLayout()),100):(console.error("SimpleSwipeCard: Failed to get container dimensions."),this.card._i=0)));this.card._i=0,this.card.slideWidth=t,this.card.slideHeight=i;const e=this.card.Qt.view_mode||"single";"carousel"===e&&this.Ni(t,i);const s=this.card.visibleCardIndices.length;this.card.currentIndex=Math.max(0,Math.min(this.card.currentIndex,s-1)),function(t,i){const e=getComputedStyle(i).borderRadius;t.forEach(t=>{t&&t.slide&&(t.slide.style.borderRadius=e)})}(this.card.cards,this.card.cardContainer),this.card.updateSlider(!1),this.card.ki(),s>1?this.card.swipeGestures?.addGestures():this.card.swipeGestures?.removeGestures(),d("INIT","Layout finished, slideWidth:",this.card.slideWidth,"slideHeight:",this.card.slideHeight,"currentIndex:",this.card.currentIndex,"visible cards:",s,"view mode:",e),this.card.autoSwipe?.manage(),this.card.resetAfter?.manage(),this.card.stateSynchronization?.manage()}Ti(){if(!this.card.Qt.state_entity||!this.card.xi)return this.card.currentIndex;const t=this.card.Qt.state_entity,i=this.card.xi.states[t];if(!i)return d("STATE","State entity not found during build:",t),this.card.currentIndex;const e=i.state;let s=null;if(t.startsWith("input_select.")){if(!i.attributes.options||!Array.isArray(i.attributes.options))return this.card.currentIndex;const t=i.attributes.options.indexOf(e);-1!==t&&t<this.card.visibleCardIndices.length&&(s=t)}else if(t.startsWith("input_number.")){const t=parseInt(e);if(!isNaN(t)){const i=t-1;i>=0&&i<this.card.visibleCardIndices.length&&(s=i)}}return null!==s?(d("STATE",`State sync initial index determined during build: ${s} from entity state: ${e}`),s):this.card.currentIndex}Ni(t){let i;const e=Math.max(0,parseInt(this.card.Qt.card_spacing))||0;if(void 0!==this.card.Qt.cards_visible)i=this.card.Qt.cards_visible,d("INIT","Carousel layout using legacy cards_visible approach:",i);else{const s=this.card.Qt.card_min_width||200,n=(t+e)/(s+e);i=Math.max(1.1,Math.round(10*n)/10),d("INIT","Carousel layout using responsive approach:",{minWidth:s,containerWidth:t,cardSpacing:e,rawCardsVisible:n.toFixed(2),finalCardsVisible:i})}const s=(i-1)*e,n=(t-s)/i;d("INIT","Carousel layout setup:",{containerWidth:t,cardsVisible:i.toFixed(2),cardSpacing:e,totalSpacing:s,cardWidth:n.toFixed(2)}),this.card.style.setProperty("--carousel-card-width",`${n}px`),this.card.sliderElement.setAttribute("data-view-mode","carousel"),this.card.cardContainer.setAttribute("data-view-mode","carousel"),this.card.cards.forEach(t=>{t&&t.slide&&t.slide.classList.add("carousel-mode")})}}class $t{constructor(t){this.card=t,this.Oi=null,this.Di=null,this.Mi=null,this.Ri=!1,this.Ai=null,this.Li=this.Pi.bind(this)}manage(){this.card.initialized&&this.card.isConnected&&(this.stop(),this.card.Qt.state_entity&&this.card.xi?(this.Oi=this.card.Qt.state_entity,this.zi()?(d("STATE","State synchronization enabled for entity:",this.Oi),this.Vi()):(d("STATE","Invalid or missing entity:",this.Oi),this.Oi=null)):d("STATE","State synchronization disabled",{hasEntity:!!this.card.Qt.state_entity,hasHass:!!this.card.xi}))}stop(){this.Ai&&(clearTimeout(this.Ai),this.Ai=null),this.Oi=null,this.Di=null,this.Mi=null,this.Ri=!1}onCardNavigate(t){if(!this.Oi||!this.card.xi||this.Ri)return;const i=this.Wi(t);if(null===i)return;const e=this.card.xi.states[this.Oi];if(e&&e.state===i)d("STATE","Entity already at correct state:",i);else{d("STATE",`Updating entity ${this.Oi} to:`,i),this.Ri=!0;try{"input_select"===this.Di?this.card.xi.callService("input_select","select_option",{entity_id:this.Oi,option:i}):"input_number"===this.Di&&this.card.xi.callService("input_number","set_value",{entity_id:this.Oi,value:i}),this.Mi=i,setTimeout(()=>{this.Ri=!1},500)}catch(t){d("ERROR","Failed to update entity:",t),this.Ri=!1}}}zi(){if(!this.card.xi||!this.Oi)return!1;const t=this.card.xi.states[this.Oi];if(!t)return d("STATE","Entity not found:",this.Oi),!1;if(this.Oi.startsWith("input_select.")){if(this.Di="input_select",!t.attributes.options||!Array.isArray(t.attributes.options))return d("STATE","input_select entity has no options:",this.Oi),!1}else{if(!this.Oi.startsWith("input_number."))return d("STATE","Entity is not input_select or input_number:",this.Oi),!1;this.Di="input_number"}return!0}Vi(){if(!this.card.xi||!this.Oi)return;const t=this.card.xi.states[this.Oi];if(!t)return;this.Mi=t.state;const i=this.Fi(t.state);null===i||i!==this.card.currentIndex?null!==i&&i!==this.card.currentIndex&&(d("STATE",`Initial sync: setting card to index ${i} from entity state:`,t.state),this.card.Qt.enable_auto_swipe&&this.card.autoSwipe?.pause(2e3),this.card.goToSlide(i,1,!1)):d("STATE",`Initial sync: card already at correct position ${i}, skipping initial positioning`)}Pi(){if(!this.card.xi||!this.Oi||this.Ri)return;const t=this.card.xi.states[this.Oi];if(!t)return;const i=t.state;if(i===this.Mi)return;d("STATE",`Entity ${this.Oi} changed from "${this.Mi}" to "${i}"`),this.Mi=i;const e=this.Fi(i);null!==e&&e!==this.card.currentIndex&&(d("STATE",`Navigating to card index ${e} from entity change`),this.card.Qt.enable_auto_swipe&&this.card.autoSwipe?.pause(5e3),this.card.goToSlide(e))}Fi(t){if("input_select"===this.Di){const i=this.card.xi.states[this.Oi];if(!i||!i.attributes.options)return null;const e=i.attributes.options,s=e.indexOf(t);return-1===s?(d("STATE",`Option "${t}" not found in input_select options:`,e),null):s>=this.card.visibleCardIndices.length?(d("STATE",`Option index ${s} exceeds visible cards count ${this.card.visibleCardIndices.length}`),null):s}if("input_number"===this.Di){const i=parseInt(t);if(isNaN(i))return null;const e=i-1;return e<0||e>=this.card.visibleCardIndices.length?(d("STATE",`Index ${e} is outside visible cards range [0, ${this.card.visibleCardIndices.length-1}]`),null):e}return null}Wi(t){if(t<0||t>=this.card.visibleCardIndices.length)return null;if("input_select"===this.Di){const i=this.card.xi.states[this.Oi];if(!i||!i.attributes.options)return null;const e=i.attributes.options;return t>=e.length?(d("STATE",`Card index ${t} exceeds input_select options count ${e.length}`),null):e[t]}return"input_number"===this.Di?t+1:null}onHassChange(t,i){if(!this.Oi||!i)return;const e=t?.states[this.Oi],s=i.states[this.Oi];if(!s)return d("STATE","Configured entity no longer exists:",this.Oi),void this.stop();e&&e.state===s.state||(this.Ai&&clearTimeout(this.Ai),this.Ai=setTimeout(()=>{this.Pi(),this.Ai=null},100))}}class _t{constructor(t){this.card=t}calculateTransform(t){if(!this.card.cards||0===this.card.cards.length)return 0;let i;const e=this.card.cardContainer.offsetWidth,s=Math.max(0,parseInt(this.card.Qt.card_spacing))||0;if(void 0!==this.card.Qt.cards_visible)i=this.card.Qt.cards_visible,d("SWIPE","Using legacy cards_visible approach:",i);else{const t=this.card.Qt.card_min_width||200,n=(e+s)/(t+s);i=Math.max(1.1,Math.round(10*n)/10),d("SWIPE","Using responsive approach:",{minWidth:t,containerWidth:e,cardSpacing:s,rawCardsVisible:n.toFixed(2),finalCardsVisible:i})}const n=this.card.visibleCardIndices.length,o=this.card.Qt.loop_mode||"none";if(n<=Math.floor(i)&&"infinite"!==this.card.Qt.loop_mode)return d("SWIPE","Insufficient cards for carousel transform, staying at position 0"),0;let a;if("infinite"===o){const i=this.card.loopMode.getDuplicateCount();a=t+i,d("SWIPE","Carousel infinite mode: logical index",t,"-> DOM position",a,"duplicateCount:",i)}else a=Math.min(t,Math.max(0,n-1));const r=(e-(i-1)*s)/i,h=r+s,c=a*h;return d("SWIPE","Carousel transform calculation:",{targetIndex:t,domPosition:a,totalCards:n,cardsVisible:i.toFixed(2),cardWidth:r.toFixed(2),cardSpacing:s,moveDistance:h.toFixed(2),transform:c.toFixed(2),loopMode:o}),c}updateSliderPosition(t,i=!0){if(!this.card.sliderElement)return;const e=this.calculateTransform(t);if(i&&"free"===this.card.Qt.swipe_behavior&&this.card.Ui>1){const t=this.card.swipeBehavior.calculateAnimationDuration(this.card.Ui),i=this.card.swipeBehavior.getEasingFunction(this.card.Ui);this.card.sliderElement.style.transition=`transform ${t}ms ${i}`,d("SWIPE",`Carousel multi-card animation: ${this.card.Ui} cards, ${t}ms duration, easing: ${i}`)}else this.card.sliderElement.style.transition=this.card.Kt(i);this.card.sliderElement.style.transform=`translateX(-${e}px)`,d("SWIPE",`Carousel slider updated to index ${t}, transform: -${e.toFixed(2)}px`)}handleLoopback(t){return this.card.loopMode.handleNavigation(t,!0)}Bi(t){const i=this.card.visibleCardIndices.length;return t<0?i-1:t>=i?0:t}}class Nt{constructor(t){this.card=t,this.isInfiniteMode=!1,this.virtualIndex=0,this.realIndex=0,this.totalRealCards=0,this.Hi=null,this.ji=null}getMode(){return this.card.Qt.loop_mode||"none"}isInfinite(){return"infinite"===this.getMode()&&this.card.visibleCardIndices.length>1}initialize(){this.isInfiniteMode=this.isInfinite(),this.isInfiniteMode?d("LOOP","Infinite loop mode initialized"):(this.virtualIndex=0,this.realIndex=0,this.totalRealCards=0)}getDuplicateCount(){const t=this.card.Qt.view_mode||"single",i=this.card.Qt.swipe_behavior||"single";if("single"===t)return"free"===i?4:1;{const t=this.card.Qt.cards_visible||this.card.ni(),e=Math.max(5,Math.ceil(2*t));if("free"===i){return e+Math.min(5,Math.ceil(t))}return e}}prepareCardsForLoading(t,i){const e=[];if(!this.isInfiniteMode)return t.forEach((t,s)=>{e.push({config:i[t],visibleIndex:s,originalIndex:t,isDuplicate:!1})}),e;const s=this.getDuplicateCount(),n=t.length;for(let o=0;o<s;o++){const a=t[(n-1-o%n+n)%n];e.push({config:i[a],visibleIndex:o-s,originalIndex:a,isDuplicate:!0})}t.forEach((t,s)=>{e.push({config:i[t],visibleIndex:s,originalIndex:t,isDuplicate:!1})});for(let o=0;o<s;o++){const s=t[o%n];e.push({config:i[s],visibleIndex:n+o,originalIndex:s,isDuplicate:!0})}return this.totalRealCards=e.length,e}virtualToRealIndex(t){if(!this.isInfiniteMode)return t;const i=this.card.visibleCardIndices.length;if(0===i)return 0;return this.getDuplicateCount()+(t%i+i)%i}realToVirtualIndex(t){if(!this.isInfiniteMode)return t;if(0===this.card.visibleCardIndices.length)return 0;return t-this.getDuplicateCount()}isOnDuplicateCard(t=this.card.currentIndex){if(!this.isInfiniteMode)return!1;const i=this.card.visibleCardIndices.length,e=this.getDuplicateCount();return t<e||t>=e+i}getCorrespondingRealIndex(t=this.card.currentIndex){if(!this.isInfiniteMode||!this.isOnDuplicateCard(t))return t;const i=this.card.visibleCardIndices.length,e=this.getDuplicateCount();if(t<e){return e+i-(e-t)}return e+(t-(e+i))}shouldPerformSeamlessJump(t=this.card.currentIndex){if(!this.isInfiniteMode)return!1;const i=this.card.visibleCardIndices.length;return t<0||t>=i}scheduleSeamlessJump(t,i=null){if(this.Yi(),!this.shouldPerformSeamlessJump(t))return void d("LOOP",`Seamless jump not needed for target index ${t}`);const e=i||400;d("LOOP",`Scheduling seamless jump for target index ${t} after ${e}ms animation`);let s=!1;const n=()=>{if(!s){if(s=!0,this.Hi&&(clearTimeout(this.Hi),this.Hi=null),!this.card.isConnected||this.card.building)return d("LOOP","Seamless jump cancelled - card disconnected or building"),void(this.card.ii=!1);requestAnimationFrame(()=>{try{const i=this.card.currentIndex;if(d("LOOP",`Seamless jump executing: target was ${t}, actual current is ${i}`),!this.shouldPerformSeamlessJump(i))return d("LOOP",`Seamless jump cancelled - conditions changed (target: ${t}, actual: ${i})`),void(this.card.ii=!1);const e=this.card.visibleCardIndices.length;let s;if(i<0)s=e+i%e,s>=e&&(s=e-1);else{if(!(i>=e))return d("LOOP",`Seamless jump not needed - already in valid position (${i})`),void(this.card.ii=!1);s=i%e}d("LOOP",`Performing seamless jump: virtual ${i} → real ${s}`),this.card.ii=!0,this.card.sliderElement&&(this.card.sliderElement.style.transition="none",this.card.sliderElement.offsetHeight),this.card.currentIndex=s,this.card.updateSlider(!1),requestAnimationFrame(()=>{try{this.card.sliderElement&&(this.card.sliderElement.style.transition=this.card.Kt(!0)),d("LOOP",`Seamless jump completed - now at real position ${s}, ready for continued scrolling`)}catch(t){d("ERROR","Error in seamless jump transition restoration:",t)}finally{this.card.ii=!1}})}catch(t){d("ERROR","Error during seamless jump execution:",t),this.card.ii=!1}})}},o=t=>{t.target!==this.card.sliderElement||"transform"!==t.propertyName||s||(d("LOOP","Transform transition ended, executing seamless jump"),this.card.sliderElement.removeEventListener("transitionend",o),this.ji=null,setTimeout(n,10))};this.card.sliderElement&&e>0&&(this.ji=o,this.card.sliderElement.addEventListener("transitionend",o));const a=e+Math.min(100,.1*e);this.Hi=setTimeout(()=>{this.ji&&this.card.sliderElement&&(this.card.sliderElement.removeEventListener("transitionend",this.ji),this.ji=null),s||(d("LOOP","Executing seamless jump via timeout fallback"),n())},a)}Yi(){this.Hi&&(clearTimeout(this.Hi),this.Hi=null,this.card.ii&&(d("LOOP","Clearing seamless jump flag during cancellation"),this.card.ii=!1),this.ji&&this.card.sliderElement&&(this.card.sliderElement.removeEventListener("transitionend",this.ji),this.ji=null),d("LOOP","Cancelled pending seamless jump and cleaned up event listeners"))}handleNavigation(t,i=!1){const e=this.getMode(),s=this.card.visibleCardIndices.length;if("infinite"===e)return t;if(!("loopback"===e&&s>1))return Math.max(0,Math.min(t,s-1));if(i){if(t<0)return s-1;if(t>=s)return 0}else{if(t<0)return s-1;if(t>=s)return 0}return t}getWrappedIndexForPagination(t=this.card.currentIndex){if(!this.isInfiniteMode)return t;const i=this.card.visibleCardIndices.length;return(t%i+i)%i}handleAutoSwipeNavigation(t,i){const e=this.getMode(),s=this.card.visibleCardIndices.length;if("infinite"===e)return{nextIndex:t+1,shouldChangeDirection:!1};if("loopback"===e){let i=t+1;return i>=s&&(i=0),{nextIndex:i,shouldChangeDirection:!1}}{let e=t,n=!1;return 1===i?t>=s-1?(n=!0,e=t-1):e=t+1:t<=0?(n=!0,e=t+1):e=t-1,e=Math.max(0,Math.min(e,s-1)),{nextIndex:e,shouldChangeDirection:n}}}handleSwipeNavigation(t,i){const e=this.getMode(),s=this.card.visibleCardIndices.length;let n=t;return i>0?(n=t-Math.abs(i),n<0&&("none"!==e&&s>1?"infinite"===e||(n=s+n,n<0&&(n=s-1)):n=0)):i<0&&(n=t+Math.abs(i),n>=s&&("none"!==e&&s>1?"infinite"===e||(n-=s,n>=s&&(n=0)):n=s-1)),d("LOOP","Swipe navigation:",{currentIndex:t,skipCount:i,mode:e,totalVisibleCards:s,nextIndex:n}),n}}class kt{constructor(t){this.card=t}getBehavior(){return this.card.Qt.swipe_behavior||"single"}calculateSkipCount(t,i,e,s){if("single"===s)return 1;let n;if("carousel"===(this.card.Qt.view_mode||"single")){const t=this.card.Qt.cards_visible||this.card.ni(),i=(t-1)*(Math.max(0,parseInt(this.card.Qt.card_spacing))||0);n=(this.card.slideWidth-i)/t}else n="horizontal"===this.card.Zt?this.card.slideWidth:this.card.slideHeight;const o=Math.max(1,Math.round(i/n));if(t>.8){let s=1;t>.8&&(s=2),t>1.5&&(s=3),t>2.5&&(s=4);const a=Math.max(s,o);return d("SWIPE","Quick swipe detected:",{velocity:t.toFixed(3),distance:i.toFixed(0),unitSize:n.toFixed(0),velocityBasedSkip:s,distanceBasedSkip:o,result:a}),Math.min(a,Math.min(4,e-1))}return d("SWIPE","Controlled drag detected:",{velocity:t.toFixed(3),distance:i.toFixed(0),unitSize:n.toFixed(0),distanceBasedSkip:o}),Math.min(o,e-1)}calculateAnimationDuration(t){const i=this.card.visibleCardIndices.length;if(i<=3){const i=800,e=500*(t-1),s=Math.min(i+e,2400);return d("SWIPE","Animation duration (few cards):",t,"cards,",s+"ms"),s}const e=200*(t-1),s=Math.min(1200+50*i,2e3),n=Math.min(600+e,s);return d("SWIPE","Animation duration (many cards):",{skipCount:t,totalCards:i,baseDuration:600,extraDuration:e,maxDuration:s,finalDuration:n+"ms"}),n}getEasingFunction(t){return 1===t?"ease-out":"cubic-bezier(0.25, 0.46, 0.45, 0.94)"}}class SimpleSwipeCard extends mt{constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),d("INIT","Created shadowRoot for manual DOM manipulation")),d("INIT","SimpleSwipeCard Constructor invoked."),this.Qt={},this.xi=null,this.cards=[],this.visibleCardIndices=[],this.currentIndex=0,this.slideWidth=0,this.slideHeight=0,this.cardContainer=null,this.sliderElement=null,this.initialized=!1,this.building=!1,this.resizeObserver=null,this.Zt="horizontal",this.ei=void 0,this.Ji=void 0,this.yi=null,this.Gi=null,this.swipeGestures=new wt(this),this.autoSwipe=new xt(this),this.resetAfter=new Et(this),this.pagination=new yt(this),this.cardBuilder=new Ct(this),this.stateSynchronization=new $t(this),this.carouselView=new _t(this),this.loopMode=new Nt(this),this.swipeBehavior=new kt(this),this.ii=!1,this.Xi=null,this.qi=null,this.Zi=this.Ki.bind(this),this.Qi=Math.random().toString(36).substring(2,15),window._simpleSwipeDialogStack||(window._simpleSwipeDialogStack=[])}static async getConfigElement(){return d("SYSTEM","SimpleSwipeCard.getConfigElement called"),await customElements.whenDefined("simple-swipe-card-editor"),document.createElement("simple-swipe-card-editor")}static getStubConfig(){return d("SYSTEM","SimpleSwipeCard.getStubConfig called"),{type:"custom:simple-swipe-card",cards:[]}}setConfig(t){if(!t)throw new Error("Invalid configuration");if(d("EDITOR","Editor setConfig received:",JSON.stringify(t)),this.Qt=JSON.parse(JSON.stringify(t)),Array.isArray(this.Qt.cards)||(this.Qt.cards=[]),void 0===this.Qt.show_pagination&&(this.Qt.show_pagination=!0),void 0===this.Qt.card_spacing)this.Qt.card_spacing=15;else{const t=parseInt(this.Qt.card_spacing);this.Qt.card_spacing=isNaN(t)||t<0?15:t}if(void 0!==this.Qt.enable_loopback&&void 0===this.Qt.loop_mode&&(this.Qt.loop_mode=this.Qt.enable_loopback?"loopback":"none",delete this.Qt.enable_loopback,d("CONFIG","Migrated enable_loopback to loop_mode:",this.Qt.loop_mode)),void 0===this.Qt.loop_mode&&(this.Qt.loop_mode="none"),["none","loopback","infinite"].includes(this.Qt.loop_mode)||(d("CONFIG","Invalid loop_mode, defaulting to 'none':",this.Qt.loop_mode),this.Qt.loop_mode="none"),this.loopMode?.initialize(),void 0!==this.Qt.swipe_direction&&["horizontal","vertical"].includes(this.Qt.swipe_direction)||(this.Qt.swipe_direction="horizontal"),void 0===this.Qt.swipe_behavior&&(this.Qt.swipe_behavior="single"),["single","free"].includes(this.Qt.swipe_behavior)?"free"===this.Qt.swipe_behavior&&"infinite"!==this.Qt.loop_mode&&(this.Qt.swipe_behavior="single",d("CONFIG","Free swipe behavior requires infinite loop mode, defaulting to single")):this.Qt.swipe_behavior="single",void 0===this.Qt.enable_auto_swipe&&(this.Qt.enable_auto_swipe=!1),void 0===this.Qt.auto_swipe_interval?this.Qt.auto_swipe_interval=2e3:(this.Qt.auto_swipe_interval=parseInt(this.Qt.auto_swipe_interval),(isNaN(this.Qt.auto_swipe_interval)||this.Qt.auto_swipe_interval<500)&&(this.Qt.auto_swipe_interval=2e3)),void 0===this.Qt.enable_reset_after&&(this.Qt.enable_reset_after=!1),void 0===this.Qt.reset_after_timeout?this.Qt.reset_after_timeout=3e4:(this.Qt.reset_after_timeout=parseInt(this.Qt.reset_after_timeout),(isNaN(this.Qt.reset_after_timeout)||this.Qt.reset_after_timeout<5e3)&&(this.Qt.reset_after_timeout=3e4)),void 0===this.Qt.reset_target_card?this.Qt.reset_target_card=1:this.Qt.reset_target_card=Math.max(1,parseInt(this.Qt.reset_target_card)),void 0===this.Qt.view_mode&&(this.Qt.view_mode="single"),["single","carousel"].includes(this.Qt.view_mode)||(this.Qt.view_mode="single"),"carousel"===this.Qt.view_mode){if(void 0===this.Qt.card_min_width)this.Qt.card_min_width=200;else{const t=parseInt(this.Qt.card_min_width);(isNaN(t)||t<50||t>500)&&(this.Qt.card_min_width=200)}if(void 0!==this.Qt.cards_visible){const t=parseFloat(this.Qt.cards_visible);isNaN(t)||t<1.1||t>8?this.Qt.cards_visible=2.5:this.Qt.cards_visible=Math.round(10*t)/10}}t.card_mod?(d("CARD_MOD","Card-mod configuration detected",t.card_mod),this.yi=JSON.parse(JSON.stringify(t.card_mod))):this.yi=null,this.Zt=this.Qt.swipe_direction,this.te=this.Qt.view_mode||"single",delete this.Qt.title}ni(){if(!this.cardContainer)return 2.5;const t=this.cardContainer.offsetWidth;if(t<=0)return d("LOOP","Container width not available, using default cards_visible: 2.5"),2.5;const i=this.Qt.card_min_width||200,e=Math.max(0,parseInt(this.Qt.card_spacing))||0,s=(t+e)/(i+e);return Math.max(1.1,Math.round(10*s)/10)}$i(){d("VISIBILITY","Handling conditional card visibility change"),this.ie&&clearTimeout(this.ie),this.ie=setTimeout(()=>{this.ee(),this.ie=null},150)}ee(){if(!this.Qt?.cards||!this.xi){const t=0===this.visibleCardIndices.length;return this.visibleCardIndices=[],void(t||d("VISIBILITY","No cards or hass available, cleared visible indices"))}const t=[...this.visibleCardIndices];this.visibleCardIndices=[],this.Qt.cards.forEach((t,i)=>{const e=bt(t.visibility,this.xi);let s=!0;if("conditional"===t.type&&this.cards){const t=this.cards.find(t=>t&&t.originalIndex===i);t&&(s=t.conditionallyVisible)}e&&s&&this.visibleCardIndices.push(i)});JSON.stringify(t)!==JSON.stringify(this.visibleCardIndices)&&(d("VISIBILITY",`Visible cards changed: ${this.visibleCardIndices.length}/${this.Qt.cards.length} visible`,this.visibleCardIndices),this.se(t),this.initialized&&this.isConnected&&this.cardBuilder.build())}Si(){if(!this.Qt?.cards||!this.xi){const t=0===this.visibleCardIndices.length;return this.visibleCardIndices=[],void(t||d("VISIBILITY","No cards or hass available, cleared visible indices"))}const t=[...this.visibleCardIndices];this.visibleCardIndices=[],this.Qt.cards.forEach((t,i)=>{const e=bt(t.visibility,this.xi);let s=!0;"conditional"===t.type&&t.conditions&&(s=this.ne(t.conditions));e&&s&&this.visibleCardIndices.push(i)});if(JSON.stringify(t)!==JSON.stringify(this.visibleCardIndices)){if(d("VISIBILITY",`Visible cards changed: ${this.visibleCardIndices.length}/${this.Qt.cards.length} visible`,this.visibleCardIndices),this.se(t),this.building||!this.initialized)return void d("VISIBILITY","Skipping visibility rebuild during initial setup to prevent flicker");this.oe()}}ne(t){return!t||!Array.isArray(t)||0===t.length||(!this.xi||t.every(t=>{try{return this.ae(t)}catch(i){return d("VISIBILITY","Error evaluating conditional card condition:",t,i),!0}}))}ae(t){if(!t||"object"!=typeof t)return!0;const{condition:i,entity:e,state:s,state_not:n,above:o,below:a}=t,r=i||(!e||void 0===s&&void 0===n?null:"state")||(!e||void 0===o&&void 0===a?null:"numeric_state");switch(r){case"state":{if(!e||!this.xi.states[e])return d("VISIBILITY",`Entity ${e} not found for conditional card state condition`),!1;const t=this.xi.states[e].state;if(void 0!==s){const i=String(s),n=String(t),o=n===i;return d("VISIBILITY",`Conditional card state condition: ${e} = ${n}, expected: ${i}, result: ${o}`),o}if(void 0!==n){const i=String(n),s=String(t),o=s!==i;return d("VISIBILITY",`Conditional card state not condition: ${e} = ${s}, not expected: ${i}, result: ${o}`),o}return!0}case"numeric_state":{if(!e||!this.xi.states[e])return d("VISIBILITY",`Entity ${e} not found for conditional card numeric_state condition`),!1;const t=parseFloat(this.xi.states[e].state);if(isNaN(t))return!1;let i=!0;return void 0!==o&&(i=i&&t>parseFloat(o)),void 0!==a&&(i=i&&t<parseFloat(a)),d("VISIBILITY",`Conditional card numeric state condition: ${e} = ${t}, result: ${i}`),i}case"screen":{const i=t.media_query;if(i&&window.matchMedia){const t=window.matchMedia(i).matches;return d("VISIBILITY",`Screen condition: ${i}, result: ${t}`),t}return!0}case"user":if(t.users&&Array.isArray(t.users)){const i=this.xi.user;if(i&&i.id){const e=t.users.includes(i.id);return d("VISIBILITY",`User condition: current user ${i.id}, allowed users: ${t.users}, result: ${e}`),e}}return!0;default:return e?(d("VISIBILITY","Unknown or invalid conditional card condition:",t),!1):(d("VISIBILITY",`Unknown condition type: ${r}`),!0)}}oe(){this.qi&&clearTimeout(this.qi),this.qi=setTimeout(()=>{this.initialized&&this.isConnected&&!this.building&&(d("VISIBILITY","Performing debounced rebuild due to visibility changes"),this.cardBuilder.build()),this.qi=null},300)}se(t){if(0===this.visibleCardIndices.length)return void(this.currentIndex=0);const i=t[this.currentIndex],e=this.visibleCardIndices.indexOf(i);if(-1!==e)this.currentIndex=e,d("VISIBILITY",`Current card still visible, adjusted index to ${this.currentIndex}`);else{const t=this.visibleCardIndices.length;this.currentIndex>=t?(this.currentIndex=t-1,d("VISIBILITY",`Adjusted to last visible card: ${this.currentIndex}`)):(this.currentIndex=Math.min(this.currentIndex,t-1),this.currentIndex=Math.max(0,this.currentIndex),d("VISIBILITY",`Adjusted to maintain relative position: ${this.currentIndex}`))}}Ki(){this.Xi&&clearTimeout(this.Xi),this.Xi=setTimeout(()=>{this.Si(),this.Xi=null},200)}re(t){d("ERROR",`${t}`),this.Qt={...i},this.visibleCardIndices=[],this.isConnected&&this.cardBuilder.build()}he(){d("CONFIG","Updating child card configs"),this.cards&&this.cards.length===this.visibleCardIndices.length&&this.visibleCardIndices.forEach((t,i)=>{const e=this.Qt.cards[t],s=this.cards[i];if(s&&!s.error&&s.element?.setConfig&&JSON.stringify(s.config)!==JSON.stringify(e)){d("CONFIG","Updating config for visible card",i,"original index",t);try{s.element.setConfig(e),s.config=JSON.parse(JSON.stringify(e))}catch(t){console.error(`Error setting config on child card ${i}:`,t)}}})}de(){if(d("CONFIG","Updating layout options (pagination, spacing, direction)"),this.Zt!==this.Qt.swipe_direction)return this.Zt=this.Qt.swipe_direction,void this.cardBuilder.build();this.pagination.updateLayout(),this.updateSlider(!1),this.yi&&this.Ii()}set hass(t){if(!t)return;const i=this.xi;if(i===t)return;const e=!i||i.states!==t.states,s=!i||i.user!==t.user,n=!i||JSON.stringify(i.config)!==JSON.stringify(t.config);if(e||s||n){if(d("INIT","Setting hass (changed)"),this.xi=t,this.stateSynchronization?.onHassChange(i,t),this.ii)return d("LOOP","Skipping hass-triggered visibility update during seamless jump"),void this.ce(t);if(this.building)return d("VISIBILITY","Skipping visibility update during build to prevent rebuild flicker"),void this.ce(t);e&&(this.Xi&&(clearTimeout(this.Xi),this.Xi=null),this.Si()),this.ce(t)}else this.ce(t)}ce(t){this.cards&&this.cards.forEach(i=>{if(i.element&&!i.error)try{i.element.hass=t}catch(t){console.error("Error setting hass on child card:",t)}})}connectedCallback(){d("INIT","connectedCallback"),this.ii&&(d("INIT","Clearing stuck seamless jump flag on connect"),this.ii=!1),this.addEventListener("config-changed",this.le.bind(this)),!this.initialized&&this.Qt?.cards?(d("INIT","connectedCallback: Initializing build."),this.cardBuilder.build()):this.initialized&&this.cardContainer&&(d("INIT","connectedCallback: Re-initializing observers and gestures."),this.ki(),this.visibleCardIndices.length>1&&(this.swipeGestures.removeGestures(),setTimeout(()=>{this.isConnected&&this.swipeGestures.addGestures()},50)),this.yi&&(this.Ii(),this.pe()),this.autoSwipe.manage(),this.resetAfter.manage(),this.stateSynchronization.manage())}disconnectedCallback(){d("INIT","disconnectedCallback - Enhanced cleanup starting"),this.removeEventListener("config-changed",this.le.bind(this));try{this.ue(),this.ge(),this.me(),this.ve(),this.fe()}catch(t){console.warn("Error during cleanup:",t)}this.initialized=!1,d("INIT","disconnectedCallback - Enhanced cleanup completed")}ue(){["_visibilityRebuildTimeout","_conditionalVisibilityTimeout","_visibilityUpdateTimeout","_layoutRetryCount"].forEach(t=>{this[t]&&(clearTimeout(this[t]),this[t]=null,d("INIT",`Cleared timeout: ${t}`))})}ge(){try{this.resizeObserver&&(this.resizeObserver.cleanup(),this.resizeObserver=null),this.swipeGestures&&(this.swipeGestures.removeGestures(),this.swipeGestures.wt=!1,this.swipeGestures.Ct=!1),this.autoSwipe&&(this.autoSwipe.stop(),this.autoSwipe.oi=null,this.autoSwipe.ri=null),this.resetAfter&&(this.resetAfter.stopTimer(),this.resetAfter.pi=null),this.stateSynchronization&&this.stateSynchronization.stop(),d("INIT","Feature managers cleaned up (state preserved)")}catch(t){console.warn("Error cleaning up feature managers:",t)}}me(){this.cardContainer=null,this.sliderElement=null,this.pagination&&this.pagination.paginationElement&&(this.pagination.paginationElement=null),d("INIT","DOM references and observers cleaned up (cards preserved)")}ve(){if(this.Gi)try{this.Gi.disconnect(),this.Gi=null,d("CARD_MOD","Card-mod observer cleaned up")}catch(t){console.warn("Error cleaning up card-mod observer:",t)}}fe(){this.swipeGestures&&this.swipeGestures.Dt&&(clearTimeout(this.swipeGestures.Dt),this.swipeGestures.Dt=null,this.swipeGestures.Mt=!1),this.loopMode&&this.loopMode.Hi&&(clearTimeout(this.loopMode.Hi),this.loopMode.Hi=null,this.ii=!1),d("INIT","Remaining event listeners cleared")}le(t){t.detail?.fromSwipeCardEditor&&t.detail?.editorId===this.be||(d("EVENT","Root element received config-changed event:",t.detail),(t.detail?.fromElementEditor||t.detail?.elementConfig||t.detail?.element)&&d("ELEMENT","Caught element editor event, allowing normal propagation"))}ki(){!this.resizeObserver&&this.cardContainer&&(this.resizeObserver=function(t,i){if(!t)return null;d("INIT","Setting up resize observer.");let e=null;const s=new ResizeObserver(s=>{window.requestAnimationFrame(()=>{if(t.isConnected)for(const n of s){const s=n.contentRect.width,o=n.contentRect.height;e&&clearTimeout(e),e=setTimeout(()=>{t&&(s>0&&s!==n.previousWidth||o>0&&o!==n.previousHeight)&&(d("INIT","Resize detected, recalculating layout.",{oldWidth:n.previousWidth,newWidth:s,oldHeight:n.previousHeight,newHeight:o}),i(s,o))},50),n.previousWidth=s,n.previousHeight=o}})});return s.observe(t),{observer:s,cleanup:()=>{d("INIT","Removing resize observer."),s&&s.disconnect(),e&&(clearTimeout(e),e=null)}}}(this.cardContainer,(t,i)=>{(t>0&&Math.abs(t-this.slideWidth)>1||i>0&&Math.abs(i-this.slideHeight)>1)&&(d("INIT","Resize detected, recalculating layout.",{oldWidth:this.slideWidth,newWidth:t,oldHeight:this.slideHeight,newHeight:i}),this.cardBuilder.finishBuildLayout())}))}Kt(t){return function(t,i=null){if(!t)return"none";let e="0.3s",s="ease-out";if(i&&i.isConnected){const t=getComputedStyle(i),n=t.getPropertyValue("--simple-swipe-card-transition-speed").trim(),o=t.getPropertyValue("--simple-swipe-card-transition-easing").trim();n&&(e=n),o&&(s=o)}return`transform ${e} ${s}`}(t,this)}Ii(){!function(t,i,e,s,n){if(t&&i){if(t.style){d("CARD_MOD","Applying card-mod styles");const o=document.createElement("style");o.setAttribute("id","card-mod-styles"),o.textContent=t.style;const a=i.querySelector("#card-mod-styles");if(a&&i.removeChild(a),i.appendChild(o),e){d("CARD_MOD","Forwarding CSS variables from host to shadow DOM");const t=window.getComputedStyle(e),o=[i.querySelector(".card-container"),s,n].filter(Boolean),a=["--simple-swipe-card-pagination-dot-inactive-color","--simple-swipe-card-pagination-dot-active-color","--simple-swipe-card-pagination-dot-inactive-opacity","--simple-swipe-card-pagination-dot-active-opacity","--simple-swipe-card-pagination-dot-size","--simple-swipe-card-pagination-dot-active-size","--simple-swipe-card-pagination-border-radius","--simple-swipe-card-pagination-dot-spacing","--simple-swipe-card-pagination-background","--simple-swipe-card-pagination-padding","--simple-swipe-card-pagination-bottom","--simple-swipe-card-pagination-right","--simple-swipe-card-transition-speed","--simple-swipe-card-transition-easing"];o.forEach(i=>{i&&a.forEach(e=>{const s=t.getPropertyValue(e);s&&(d("CARD_MOD",`Forwarding ${e}: ${s}`),i.style.setProperty(e,s))})})}}}else d("CARD_MOD","No card-mod config or shadow root, skipping style application")}(this.yi,this.shadowRoot,this.shadowRoot?.host,this.sliderElement,this.pagination.paginationElement)}pe(){this.Gi&&(this.Gi.disconnect(),this.Gi=null),this.Gi=function(t,i){const e=new MutationObserver(t=>{t.some(t=>"attributes"===t.type&&("style"===t.attributeName||t.attributeName.includes("style")))&&(d("CARD_MOD","Host style attribute changed, reapplying card-mod styles"),i())});return t&&t.host&&(e.observe(t.host,{attributes:!0,attributeFilter:["style"]}),d("CARD_MOD","Set up mutation observer for style changes")),e}(this.shadowRoot,()=>{this.Ii()})}goToSlide(t,i=1,e=!0){this.Ui=i;const s=this.visibleCardIndices.length;if(!this.visibleCardIndices||0===s||!this.initialized||this.building)return void d("SWIPE","goToSlide skipped",{totalVisible:s,initialized:this.initialized,building:this.building});const n=this.Qt.view_mode||"single",o=this.Qt.loop_mode||"none";t=this.loopMode.handleNavigation(t,"carousel"===n),this.currentIndex=t,d("SWIPE",`Going to visible slide ${this.currentIndex} (${n} mode)`);const a="infinite"===o?(this.currentIndex%s+s)%s:this.currentIndex;this.stateSynchronization?.onCardNavigate(a),this.updateSlider(e),this.autoSwipe.isInProgress||this.resetAfter.isInProgress||this.resetAfter.startTimer(),!this.Qt.enable_auto_swipe||this.autoSwipe.isInProgress||this.resetAfter.isInProgress||this.autoSwipe.pause(5e3)}updateSlider(t=!0){this.cardContainer&&(this.slideWidth=this.cardContainer.offsetWidth,this.slideHeight=this.cardContainer.offsetHeight);const i=this.visibleCardIndices.length;if(d("SWIPE",`Updating slider to visible index ${this.currentIndex}`,{animate:t,totalVisible:i,viewMode:this.Qt.view_mode}),!this.sliderElement||0===i||!this.initialized||this.building)return void d("SWIPE","updateSlider skipped",{slider:!!this.sliderElement,totalVisible:i,init:this.initialized,building:this.building});const e=Math.max(0,parseInt(this.Qt.card_spacing))||0,s=this.Qt.view_mode||"single",n=this.Qt.loop_mode||"none";if("carousel"===s&&this.carouselView){this.sliderElement.style.gap=`${e}px`;let i=t?300:0;if(t&&"free"===this.Qt.swipe_behavior&&this.Ui>1){i=this.swipeBehavior.calculateAnimationDuration(this.Ui);const t=this.swipeBehavior.getEasingFunction(this.Ui);this.sliderElement.style.transition=`transform ${i}ms ${t}`,d("SWIPE",`Carousel multi-card animation: ${this.Ui} cards, ${i}ms duration, easing: ${t}`)}return this.carouselView.updateSliderPosition(this.currentIndex,t),this.pagination.update(t),this.Ui=1,void(t&&i>0&&this.loopMode.scheduleSeamlessJump(this.currentIndex,i))}const o="horizontal"===this.Zt;let a=this.currentIndex;if("infinite"===n){const t=this.loopMode.getDuplicateCount();a=this.currentIndex+t,d("SWIPE",`Infinite mode: logical index ${this.currentIndex} -> DOM position ${a}`)}else"none"!==n&&i>1?this.currentIndex<0?this.currentIndex=i-1:this.currentIndex>=i&&(this.currentIndex=0):this.currentIndex=Math.max(0,Math.min(this.currentIndex,i-1)),a=this.currentIndex;this.sliderElement.style.gap=`${e}px`;let r=0;r=o?a*(this.slideWidth+e):a*(this.slideHeight+e);let h=300;if(t&&"free"===this.Qt.swipe_behavior&&this.Ui>1){h=this.swipeBehavior.calculateAnimationDuration(this.Ui);const t=this.swipeBehavior.getEasingFunction(this.Ui);this.sliderElement.style.transition=`transform ${h}ms ${t}`,d("SWIPE",`Multi-card animation: ${this.Ui} cards, ${h}ms duration, easing: ${t}`)}else this.sliderElement.style.transition=this.Kt(t);this.sliderElement.style.transform=o?`translateX(-${r}px)`:`translateY(-${r}px)`,this.cards.forEach(t=>{t&&t.slide&&(t.slide.style.marginRight="0px",t.slide.style.marginLeft="0px",t.slide.style.marginTop="0px",t.slide.style.marginBottom="0px")}),this.pagination.update(t),this.Ui=1,d("SWIPE",`Slider updated, DOM position: ${a}, transform: -${r}px along ${o?"X":"Y"} axis`),t&&h>0&&this.loopMode.scheduleSeamlessJump(this.currentIndex,h)}we(t){if(this.pagination.paginationElement){this.pagination.paginationElement.querySelectorAll(".pagination-dot").forEach((i,e)=>{i.classList.toggle("active",e===t)})}}getCardSize(){if(0===this.visibleCardIndices.length)return 3;let t=3;if(this.cards&&this.cards.length>0){const i=this.cards[this.currentIndex];if(i?.element&&!i.error&&"function"==typeof i.element.getCardSize)try{t=i.element.getCardSize()}catch(i){console.warn("Error getting card size from current element:",i),t=3}else i?.element&&i.element.offsetHeight&&(t=Math.max(1,Math.ceil(i.element.offsetHeight/50)))}return d("CONFIG","Calculated card size:",t),Math.max(3,t)}}class Ot{constructor(t){this.editor=t,this.collapsibleState={advanced:!1,cards:!0},this.xe=null,this.Ee=null}cleanup(){this.xe&&(clearTimeout(this.xe),this.xe=null),this.Ee&&(clearTimeout(this.Ee),this.Ee=null),d("EDITOR","EditorUIManager cleanup completed")}async initializeEditor(){this.editor.be=`swipe-card-editor-${Math.random().toString(36).substring(2,15)}`,this.editor.ye=this.editor.cardManagement.handleCardPicked.bind(this.editor.cardManagement),this.editor.Ie=this.editor.eventHandling.Se.bind(this.editor.eventHandling),this.editor.Te=new Set,this.editor.Ce=null,this.editor.$e=!1,this.editor._e={active:!1,parentDialogId:null,elementId:null,timestamp:null,savedState:null};Tt(o).set(this.editor.be,this)}toggleSection(t){this.collapsibleState[t]=!this.collapsibleState[t],this.editor.requestUpdate()}getCollapsibleState(){return this.collapsibleState}async ensureComponentsLoaded(){let t=0;for(;!customElements.get("hui-card-picker")&&t<50;)await this.loadCustomElements(),customElements.get("hui-card-picker")||(await new Promise(t=>setTimeout(t,100)),t++);customElements.get("hui-card-picker")||console.error("Failed to load hui-card-picker after multiple attempts")}async loadCustomElements(){if(!customElements.get("hui-card-picker"))try{const t=[()=>customElements.get("hui-entities-card")?.getConfigElement?.(),()=>customElements.get("hui-conditional-card")?.getConfigElement?.(),()=>customElements.get("hui-vertical-stack-card")?.getConfigElement?.(),()=>customElements.get("hui-horizontal-stack-card")?.getConfigElement?.()];for(const i of t)try{if(await i(),customElements.get("hui-card-picker"))break}catch(t){}}catch(t){console.warn("Could not load hui-card-picker",t)}}ensureCardPickerLoaded(){this.editor.shadowRoot?(this.xe&&clearTimeout(this.xe),this.xe=setTimeout(()=>{this.Ne(),this.xe=null},100)):d("EDITOR","_ensureCardPickerLoaded: No shadowRoot, returning.")}Ne(){d("EDITOR","_ensureCardPickerLoaded called");const t=this.editor.shadowRoot.querySelector("#card-picker-container");if(t){t.style.display="block",t.hasAttribute("event-barrier-applied")||(t.setAttribute("event-barrier-applied","true"),t.addEventListener("config-changed",t=>{this.ke(t)},{capture:!0,passive:!1}));const i=t.querySelector("hui-card-picker");i&&(i.style.display="block",i.requestUpdate&&!i.Oe&&(i.requestUpdate(),i.Oe=!0))}this.De()}ke(t){if(d("EDITOR","Intercepted config-changed at container level:",t.detail?.config?.type),t.target&&t.target.tagName&&"hui-card-picker"===t.target.tagName.toLowerCase()&&t.detail&&t.detail.config){const i=t.detail.config;if(d("EDITOR","Processing card selection:",i.type),this.editor.Qt){const t=Array.isArray(this.editor.Qt.cards)?[...this.editor.Qt.cards]:[];t.push(i),this.editor.Qt={...this.editor.Qt,cards:t},this.editor.configManager.fireConfigChanged({cardAdded:!0,cardType:i.type}),this.De()}}return t.stopPropagation(),t.stopImmediatePropagation&&t.stopImmediatePropagation(),!1}De(){this.Ee||(this.Ee=setTimeout(()=>{this.editor.requestUpdate(),this.Ee=null},50))}}class Dt{constructor(t){this.editor=t,this.Ee=null}setConfig(t){if(!t)throw new Error("Invalid configuration");if(d("EDITOR","Editor setConfig received:",JSON.stringify(t)),this.editor.Qt=JSON.parse(JSON.stringify(t)),Array.isArray(this.editor.Qt.cards)||(this.editor.Qt.cards=[]),void 0===this.editor.Qt.show_pagination&&(this.editor.Qt.show_pagination=!0),void 0===this.editor.Qt.card_spacing)this.editor.Qt.card_spacing=15;else{const t=parseInt(this.editor.Qt.card_spacing);this.editor.Qt.card_spacing=isNaN(t)||t<0?15:t}if(void 0!==this.editor.Qt.enable_loopback&&void 0===this.editor.Qt.loop_mode&&(this.editor.Qt.loop_mode=this.editor.Qt.enable_loopback?"loopback":"none",delete this.editor.Qt.enable_loopback,d("CONFIG","Migrated enable_loopback to loop_mode:",this.editor.Qt.loop_mode)),void 0===this.editor.Qt.loop_mode&&(this.editor.Qt.loop_mode="none"),["none","loopback","infinite"].includes(this.editor.Qt.loop_mode)||(d("CONFIG","Invalid loop_mode, defaulting to 'none':",this.editor.Qt.loop_mode),this.editor.Qt.loop_mode="none"),void 0!==this.editor.Qt.swipe_direction&&["horizontal","vertical"].includes(this.editor.Qt.swipe_direction)||(this.editor.Qt.swipe_direction="horizontal"),void 0===this.editor.Qt.swipe_behavior&&(this.editor.Qt.swipe_behavior="single"),["single","free"].includes(this.editor.Qt.swipe_behavior)?"free"===this.editor.Qt.swipe_behavior&&"infinite"!==this.editor.Qt.loop_mode&&(this.editor.Qt.swipe_behavior="single",d("CONFIG","Free swipe behavior requires infinite loop mode, defaulting to single")):this.editor.Qt.swipe_behavior="single",void 0===this.editor.Qt.enable_auto_swipe&&(this.editor.Qt.enable_auto_swipe=!1),void 0===this.editor.Qt.auto_swipe_interval?this.editor.Qt.auto_swipe_interval=2e3:(this.editor.Qt.auto_swipe_interval=parseInt(this.editor.Qt.auto_swipe_interval),(isNaN(this.editor.Qt.auto_swipe_interval)||this.editor.Qt.auto_swipe_interval<500)&&(this.editor.Qt.auto_swipe_interval=2e3)),void 0===this.editor.Qt.enable_reset_after&&(this.editor.Qt.enable_reset_after=!1),void 0===this.editor.Qt.reset_after_timeout?this.editor.Qt.reset_after_timeout=3e4:(this.editor.Qt.reset_after_timeout=parseInt(this.editor.Qt.reset_after_timeout),(isNaN(this.editor.Qt.reset_after_timeout)||this.editor.Qt.reset_after_timeout<5e3)&&(this.editor.Qt.reset_after_timeout=3e4)),void 0===this.editor.Qt.reset_target_card?this.editor.Qt.reset_target_card=1:this.editor.Qt.reset_target_card=Math.max(1,parseInt(this.editor.Qt.reset_target_card)),void 0===this.editor.Qt.view_mode&&(this.editor.Qt.view_mode="single"),["single","carousel"].includes(this.editor.Qt.view_mode)||(this.editor.Qt.view_mode="single"),"carousel"===this.editor.Qt.view_mode){if(void 0===this.editor.Qt.card_min_width)this.editor.Qt.card_min_width=200;else{const t=parseInt(this.editor.Qt.card_min_width);(isNaN(t)||t<50||t>500)&&(this.editor.Qt.card_min_width=200)}if(void 0!==this.editor.Qt.cards_visible){const t=parseFloat(this.editor.Qt.cards_visible);isNaN(t)||t<1.1||t>8?this.editor.Qt.cards_visible=2.5:this.editor.Qt.cards_visible=Math.round(10*t)/10}}delete this.editor.Qt.title,setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),50)}handleValueChanged(t){if(!this.editor.Qt||!t.target)return;const i=t.target,e=i.configValue||i.getAttribute("data-option"),s=i.parentElement?.configValue||i.parentElement?.getAttribute("data-option"),n=e||s;if(!n)return;let o;if("ha-entity-picker"===i.localName&&"value-changed"===t.type?o=t.detail.value||null:"ha-switch"===i.localName?o=i.checked:"ha-textfield"===i.localName&&"number"===i.type?(o=parseFloat(i.value),(isNaN(o)||o<0)&&(o="card_spacing"===n?15:"auto_swipe_interval"===n?2e3:"reset_after_timeout"===n?3e4:"cards_visible"===n?2.5:0)):o=i.value,this.editor.Qt[n]!==o){if("view_mode"===n){d("EDITOR",`View mode changing from ${this.editor.Qt[n]} to ${o}`);const t={...this.editor.Qt,[n]:o};return"carousel"===o?(delete t.swipe_direction,t.cards_visible||t.card_min_width||(t.card_min_width=200),d("EDITOR","Cleaned config for carousel mode:",Object.keys(t))):"single"===o&&(delete t.cards_visible,delete t.card_min_width,t.swipe_direction||(t.swipe_direction="horizontal"),d("EDITOR","Cleaned config for single mode:",Object.keys(t))),this.editor.Qt=t,this.fireConfigChanged(),void this.De()}if("card_min_width"===n){if(d("EDITOR",`User changed card_min_width to ${o}, migrating from legacy mode`),void 0!==this.editor.Qt.cards_visible){const t={...this.editor.Qt};delete t.cards_visible,t.card_min_width=o,this.editor.Qt=t,d("EDITOR","Migrated from cards_visible to card_min_width")}else this.editor.Qt={...this.editor.Qt,[n]:o};return this.fireConfigChanged(),void this.De()}d("EDITOR",`Value changed for ${n}:`,o),this.editor.Qt={...this.editor.Qt,[n]:o},this.fireConfigChanged(),this.De()}}De(){this.Ee||(this.Ee=setTimeout(()=>{this.editor.requestUpdate(),this.Ee=null},50))}handleTimeoutChange(t){const i=parseInt(t.target.value);if(!isNaN(i)&&i>=5){const t=1e3*i;this.editor.Qt={...this.editor.Qt,reset_after_timeout:t},this.fireConfigChanged()}}handleTargetChange(t){const i=parseInt(t.target.value);!isNaN(i)&&i>=1&&(this.editor.Qt={...this.editor.Qt,reset_target_card:i},this.fireConfigChanged())}getCleanConfig(t){if(!t)return{};const i={type:t.type};t.view_mode&&"single"!==t.view_mode&&(i.view_mode=t.view_mode),"carousel"===t.view_mode&&(void 0!==t.cards_visible?i.cards_visible=t.cards_visible:void 0!==t.card_min_width&&200!==t.card_min_width&&(i.card_min_width=t.card_min_width));const e={show_pagination:!0,card_spacing:15,loop_mode:"none",swipe_direction:"horizontal",swipe_behavior:"single",enable_auto_swipe:!1,auto_swipe_interval:2e3,enable_reset_after:!1,reset_after_timeout:3e4,reset_target_card:1};["card_spacing","swipe_direction","swipe_behavior","show_pagination"].forEach(s=>{void 0!==t[s]&&t[s]!==e[s]&&(i[s]=t[s])}),["loop_mode","enable_auto_swipe","auto_swipe_interval","enable_reset_after","reset_after_timeout","reset_target_card","state_entity"].forEach(s=>{"state_entity"===s?t.state_entity&&null!==t.state_entity&&""!==t.state_entity&&(i.state_entity=t.state_entity):void 0!==t[s]&&t[s]!==e[s]&&(i[s]=t[s])}),Array.isArray(t.cards)&&(i.cards=t.cards);return["grid_options","layout_options","view_layout"].forEach(e=>{void 0!==t[e]&&(i[e]=t[e])}),void 0!==t.card_mod&&(i.card_mod=t.card_mod),i}fireConfigChanged(t={}){const i=this.getCleanConfig(this.editor.Qt);!function(t,i,e={}){if(!i)return;const s=!e.maintainEditorState,n=new CustomEvent("config-changed",{detail:{config:i,...e},bubbles:s,composed:!0});d("EVENT","Firing config-changed event",{bubble:s,...e}),t.dispatchEvent(n)}(this.editor,i,{editorId:this.editor.be,fromSwipeCardEditor:!0,...t})}cleanup(){this.Ee&&(clearTimeout(this.Ee),this.Ee=null),d("EDITOR","EditorConfigManager cleanup completed")}}class Mt{constructor(t){this.editor=t}getCardDescriptor(t){if(!t?.type)return{typeName:"Unknown",name:"",isPictureElements:!1};const i=t.type.startsWith("custom:")?t.type.substring(7):t.type,e=i.split(/[-_]/).map(t=>t.charAt(0).toUpperCase()+t.slice(1)).join(" ");return{typeName:e,name:t.title||t.name||"",isPictureElements:"picture-elements"===i}}hasNestedCards(t){return!("custom:actions-card"!==t.type||!t.card)&&(Array.isArray(t.card)?t.card.length>0:!!t.card)}getNestedCards(t){return this.hasNestedCards(t)?Array.isArray(t.card)?t.card:[t.card]:[]}hasVisibilityConditions(t){return t&&Array.isArray(t.visibility)&&t.visibility.length>0}isPictureElementsCard(t){return t&&"picture-elements"===t.type}moveCard(t,i){if(!this.editor.Qt?.cards)return;const e=[...this.editor.Qt.cards],s=t+i;s<0||s>=e.length||(d("EDITOR",`Moving card ${t} to position ${s}`),[e[t],e[s]]=[e[s],e[t]],this.editor.Qt={...this.editor.Qt,cards:e},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate())}removeCard(t){if(!this.editor.Qt?.cards||t<0||t>=this.editor.Qt.cards.length)return;d("EDITOR",`Removing card at index ${t}`);const i=this.editor.Qt.cards.filter((i,e)=>e!==t);this.editor.Qt={...this.editor.Qt,cards:i},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate()}moveNestedCard(t,i,e){if(!this.editor.Qt?.cards||!this.editor.Qt.cards[t])return;const s=this.editor.Qt.cards[t];if(!this.hasNestedCards(s))return;const n=this.getNestedCards(s),o=i+e;if(o<0||o>=n.length)return;d("EDITOR",`Moving nested card ${t}.${i} to position ${t}.${o}`),[n[i],n[o]]=[n[o],n[i]];const a=[...this.editor.Qt.cards];a[t]={...s,card:n},this.editor.Qt={...this.editor.Qt,cards:a},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate()}removeNestedCard(t,i){if(!this.editor.Qt?.cards||!this.editor.Qt.cards[t])return;const e=this.editor.Qt.cards[t];if(!this.hasNestedCards(e))return;let s=this.getNestedCards(e);if(i<0||i>=s.length)return;d("EDITOR",`Removing nested card ${t}.${i}`),s=s.filter((t,e)=>e!==i);const n=[...this.editor.Qt.cards];n[t]={...e,card:s},this.editor.Qt={...this.editor.Qt,cards:n},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate()}async editCard(t){if(d("EDITOR",`_editCard called for index ${t}`),!this.editor.Qt||!this.editor.Qt.cards||t<0||t>=this.editor.Qt.cards.length)return void d("ERROR","SimpleSwipeCardEditor: Invalid index for card editing:",t);const i=this.editor.Qt.cards[t],e=this.editor.hass,s=document.querySelector("home-assistant");if(e&&s)try{await customElements.whenDefined("hui-dialog-edit-card");const n=document.createElement("hui-dialog-edit-card");n.hass=e,document.body.appendChild(n),this.editor.Te.add(n),n.Me=this.editor.be,this.isPictureElementsCard(i)&&(n.setAttribute("data-editing-picture-elements","true"),n.Re=!0),d("EDITOR",`[CARD INDEX ${t}] hui-dialog-edit-card created and added to body. Tracking it.`);const o=this.editor.eventHandling.handleDialogConfigChanged.bind(this.editor.eventHandling,t,n),a=this.editor.eventHandling.handleDialogShowDialog.bind(this.editor.eventHandling,t);n.addEventListener("config-changed",o,{capture:!0}),n.addEventListener("show-dialog",a,{capture:!0}),n.addEventListener("ll-show-dialog",a,{capture:!0}),this.isPictureElementsCard(i)&&(n.addEventListener("element-updated",t=>{d("ELEMENT","Element updated event on dialog",t.detail),n.Ae=!0,this.editor.eventHandling._e.active=!0,this.editor.eventHandling._e.timestamp=Date.now()},{capture:!0}),n.addEventListener("show-edit-element",t=>{d("ELEMENT","Show edit element event on dialog",t.detail),n.Ae=!0,this.editor.eventHandling._e.active=!0,this.editor.eventHandling._e.timestamp=Date.now()},{capture:!0})),"custom:actions-card"===i.type&&(n.Le=!0);const r=()=>{if(d("EDITOR",`[CARD INDEX ${t}] hui-dialog-edit-card closed event received.`),n.removeEventListener("dialog-closed",r),n.removeEventListener("config-changed",o,{capture:!0}),n.removeEventListener("show-dialog",a,{capture:!0}),n.removeEventListener("ll-show-dialog",a,{capture:!0}),this.isPictureElementsCard(i)&&(n.removeEventListener("element-updated",h,{capture:!0}),n.removeEventListener("show-edit-element",c,{capture:!0})),this.editor.Te.delete(n),d("EDITOR",`[CARD INDEX ${t}] hui-dialog-edit-card removed from tracking. Active child editors: ${this.editor.Te.size}`),n.Ae&&(d("ELEMENT","Element edit session reset due to dialog close"),setTimeout(()=>{this.editor.eventHandling._e.active&&Date.now()-this.editor.eventHandling._e.timestamp>500&&(this.editor.eventHandling._e.active=!1)},500)),n.parentNode===document.body)try{document.body.removeChild(n),d("EDITOR",`[CARD INDEX ${t}] hui-dialog-edit-card removed from body.`)}catch(i){console.warn(`[CARD INDEX ${t}] Error removing dialog from body:`,i)}setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)};n.addEventListener("dialog-closed",r);const h=t=>{d("ELEMENT","Element updated event on dialog",t.detail),n.Ae=!0,this.editor.eventHandling._e.active=!0,this.editor.eventHandling._e.timestamp=Date.now()},c=t=>{d("ELEMENT","Show edit element event on dialog",t.detail),n.Ae=!0,this.editor.eventHandling._e.active=!0,this.editor.eventHandling._e.timestamp=Date.now()};this.isPictureElementsCard(i)&&(n.addEventListener("element-updated",h,{capture:!0}),n.addEventListener("show-edit-element",c,{capture:!0}));const l={cardConfig:i,lovelaceConfig:this.editor.lovelace||s.lovelace,saveCardConfig:async i=>{if(d("EDITOR",`[CARD INDEX ${t}] saveCardConfig callback in hui-dialog-edit-card invoked.`),n.Pe||n.Ae){if(d("ELEMENT",`[CARD INDEX ${t}] Save detected from element editor, preserving dialog state`),n.Pe=!1,this.editor.eventHandling._e.timestamp=Date.now(),i){d("ELEMENT","Silently updating config with element changes");const e=[...this.editor.Qt.cards];e[t]=i,this.editor.Qt={...this.editor.Qt,cards:e},this.editor.configManager.fireConfigChanged({maintainEditorState:!0,fromElementEditor:!0,updatedCardIndex:t})}return i}if(n.ze&&!i)return d("ELEMENT",`[CARD INDEX ${t}] Element editor cancel detected, restoring previous config`),void(n.ze=null);if(!i)return;const e=[...this.editor.Qt.cards];e[t]=i,this.editor.Qt={...this.editor.Qt,cards:e},this.editor.configManager.fireConfigChanged({reason:"child_dialog_saved"}),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)}};d("EDITOR",`[CARD INDEX ${t}] About to call dialog.showDialog()`),await n.showDialog(l),d("EDITOR",`[CARD INDEX ${t}] dialog.showDialog() finished.`)}catch(e){d("ERROR","SimpleSwipeCardEditor: Error opening edit dialog:",e),St(this.editor,"ll-show-dialog",{dialogTag:"hui-dialog-edit-card",dialogImport:()=>import("hui-dialog-edit-card"),dialogParams:{cardConfig:i,lovelaceConfig:this.editor.lovelace||s.lovelace,saveCardConfig:async i=>{if(!i)return;const e=[...this.editor.Qt.cards];e[t]=i,this.editor.Qt={...this.editor.Qt,cards:e},this.editor.configManager.fireConfigChanged({reason:"child_dialog_saved_fallback"}),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)}}})}else d("ERROR","SimpleSwipeCardEditor: Cannot find Home Assistant instance")}async editNestedCard(t,i){if(d("EDITOR",`_editNestedCard called for parent ${t}, nested ${i}`),!this.editor.Qt?.cards||!this.editor.Qt.cards[t]||!this.hasNestedCards(this.editor.Qt.cards[t]))return void d("ERROR","SimpleSwipeCardEditor: Invalid indices for nested card editing:",t,i);const e=this.editor.Qt.cards[t],s=this.getNestedCards(e);if(i<0||i>=s.length)return;const n=s[i],o=this.editor.hass,a=document.querySelector("home-assistant");if(o&&a)try{await customElements.whenDefined("hui-dialog-edit-card");const r=document.createElement("hui-dialog-edit-card");r.hass=o,document.body.appendChild(r),this.editor.Te.add(r),r.Me=this.editor.be,this.isPictureElementsCard(n)&&(r.setAttribute("data-editing-picture-elements","true"),r.Re=!0),r.addEventListener("config-changed",t=>{if(this.editor.eventHandling.Ve(t))return d("ELEMENT","Nested card: Detected element editor event, allowing natural propagation"),r.Ae=!0,this.editor.eventHandling._e.active=!0,this.editor.eventHandling._e.timestamp=Date.now(),void(t.detail&&t.detail.config&&(r.ze=JSON.parse(JSON.stringify(t.detail.config)),r.Pe=!0));(t.detail?.fromExternalEditor||t.detail?.fromActionCardEditor||t.detail?.fromSwipeCardEditor)&&(d("EDITOR","Marking nested event as already handled in _editNestedCard's dialog"),t.We=!0)},!0);const h=()=>{if(r.removeEventListener("dialog-closed",h),r.Ae&&(d("ELEMENT","Dialog handling element edit is closing, ending element edit session"),this.editor.eventHandling._e.active=!1),this.editor.Te.delete(r),r.parentNode===document.body)try{document.body.removeChild(r)}catch(t){console.warn("Error removing nested card dialog:",t)}setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)};r.addEventListener("dialog-closed",h);const c={cardConfig:n,lovelaceConfig:this.editor.lovelace||a.lovelace,saveCardConfig:async n=>{if(r.Pe||r.Ae){if(d("ELEMENT","Nested card: Save detected from element editor, preserving dialog state"),r.Pe=!1,this.editor.eventHandling._e.timestamp=Date.now(),n){d("ELEMENT","Silently updating nested card config with element changes");const o=[...s];o[i]=n;const a={...e,card:o},r=[...this.editor.Qt.cards];r[t]=a,this.editor.Qt={...this.editor.Qt,cards:r},this.editor.configManager.fireConfigChanged({maintainEditorState:!0,fromElementEditor:!0,updatedCardIndex:t,nestedCardIndex:i})}return n}if(r.ze&&!n)return d("ELEMENT","Nested card: Element editor cancel detected, restoring previous config"),void(r.ze=null);if(!n)return;d("EDITOR",`Saving nested card ${t}.${i} with new config`);const o=[...s];o[i]=n;const a={...e,card:o},h=[...this.editor.Qt.cards];h[t]=a,this.editor.Qt={...this.editor.Qt,cards:h},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)}};await r.showDialog(c)}catch(o){d("ERROR","SimpleSwipeCardEditor: Error opening edit dialog for nested card:",o),St(this.editor,"ll-show-dialog",{dialogTag:"hui-dialog-edit-card",dialogImport:()=>import("hui-dialog-edit-card"),dialogParams:{cardConfig:n,lovelaceConfig:this.editor.lovelace||a.lovelace,saveCardConfig:async n=>{if(!n)return;const o=[...s];o[i]=n;const a={...e,card:o},r=[...this.editor.Qt.cards];r[t]=a,this.editor.Qt={...this.editor.Qt,cards:r},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)}}})}else d("ERROR","SimpleSwipeCardEditor: Cannot find Home Assistant instance")}safelyAddCard(t){if(t&&this.editor.Qt)try{const i=Array.isArray(this.editor.Qt.cards)?[...this.editor.Qt.cards]:[],e={...this.editor.Qt,cards:[...i,t]};this.editor.Qt=e,this.editor.configManager.fireConfigChanged({isSafeCardAddition:!0,addedCardType:t.type}),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),50),d("EDITOR","Safely added card:",t.type)}catch(t){d("ERROR","Failed to safely add card:",t)}}handleCardPicked(t){if(d("EDITOR","Fallback _handleCardPicked called:",t.detail?.config?.type),t.stopPropagation(),t.stopImmediatePropagation&&t.stopImmediatePropagation(),!t.detail?.config)return;const i=t.detail.config;d("EDITOR","Adding card in fallback handler:",i.type);const e=Array.isArray(this.editor.Qt.cards)?[...this.editor.Qt.cards]:[],s={...this.editor.Qt,cards:[...e,i]};this.editor.Qt=s,this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate()}}class Rt{constructor(t){this.editor=t,this.Ie=this.Se.bind(this),this._e={active:!1,parentDialogId:null,elementId:null,timestamp:null,savedState:null}}setupEventListeners(){document.addEventListener("config-changed",this.Ie,{capture:!0}),this.Fe=t=>{if(this.Ve(t)){if(d("ELEMENT","Config-changed event from element editor, allowing propagation"),t.target&&t.target.closest("hui-dialog-edit-card")){const i=t.target.closest("hui-dialog-edit-card");i&&(i.Ae=!0,this._e.active=!0,this._e.parentDialogId=i.Me||null,this._e.timestamp=Date.now())}}else if("config-changed"===t.type&&t.detail?.config){const i="custom:actions-card"===t.detail?.config?.type;if("hui-card-picker"===t.target?.tagName?.toLowerCase()){if((t.composedPath?t.composedPath():[]).some(t=>t===this.editor||t.shadowRoot&&t.shadowRoot.contains(this.editor)||this.editor.shadowRoot&&this.editor.shadowRoot.contains(t))&&(d("EDITOR","Card picker selection captured by global handler:",t.detail.config.type),i&&!this.editor.$e))return this.editor.Ce={time:Date.now(),config:t.detail.config},this.editor.$e=!0,this.editor.Ue(t.detail.config),t.stopImmediatePropagation&&t.stopImmediatePropagation(),void t.stopPropagation()}}},document.addEventListener("config-changed",this.Fe,{capture:!0}),this.Be=t=>{if(t.He)return d("EVENT","Intercepted iron-select event already processed by actions card editor"),void t.stopPropagation()},document.addEventListener("iron-select",this.Be,{capture:!0}),this.je=t=>{if(t.target&&"HUI-DIALOG-EDIT-CARD"===t.target.tagName){const i=t.target;d("EDITOR","A HUI-DIALOG-EDIT-CARD closed",{tracked:this.editor.Te.has(i),isActions:this.Ye(i),handlingElementEdit:i.Ae}),i.Ae&&(d("ELEMENT","Dialog handling element edit is closing, ending element edit session"),this._e.active=!1,i.ze&&(d("ELEMENT","Preserving element config on dialog close"),this._e.savedState=i.ze,i.ze=null)),this.editor.Te.has(i)&&(this.editor.Te.delete(i),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100))}t.target&&("HUI-DIALOG-EDIT-ELEMENT"===t.target.tagName||"HUI-DIALOG"===t.target.tagName&&this.Ve(t))&&(d("ELEMENT","Element editor dialog closed"),setTimeout(()=>{this._e.active&&Date.now()-this._e.timestamp>500&&(d("ELEMENT","Resetting element edit session after timeout"),this._e.active=!1)},500))},document.addEventListener("dialog-closed",this.je,{capture:!0}),this.Je=t=>{"element-updated"!==t.type&&"show-edit-element"!==t.type||this._e.active||(d("ELEMENT",`Capturing ${t.type} event, starting element edit session`),this._e.active=!0,this._e.timestamp=Date.now(),t.detail&&t.detail.elementId&&(this._e.elementId=t.detail.elementId))},document.addEventListener("element-updated",this.Je,{capture:!0}),document.addEventListener("show-edit-element",this.Je,{capture:!0})}removeEventListeners(){document.removeEventListener("config-changed",this.Fe,{capture:!0}),document.removeEventListener("iron-select",this.Be,{capture:!0}),document.removeEventListener("config-changed",this.Ie,{capture:!0}),document.removeEventListener("dialog-closed",this.je,{capture:!0}),document.removeEventListener("element-updated",this.Je,{capture:!0}),document.removeEventListener("show-edit-element",this.Je,{capture:!0})}Ve(t){if(t.detail&&(t.detail.fromElementEditor||t.detail.elementConfig||t.detail.elementToEdit||t.detail.element))return d("ELEMENT","Element editor detected through event detail"),!0;const i=t.composedPath?t.composedPath():[];for(const t of i)if(t&&t.localName){if("hui-element-editor"===t.localName||"hui-dialog-edit-element"===t.localName||t.localName.includes("element-editor"))return d("ELEMENT","Element editor detected through path node localName:",t.localName),!0;if(t.Ge||t.Xe||t.getAttribute&&(t.getAttribute("element-id")||t.getAttribute("data-element-id"))||t.classList&&t.classList.contains("element-editor"))return d("ELEMENT","Element editor detected through specialized attributes"),!0;if("HUI-DIALOG"===t.tagName&&(t.querySelector(".element-editor")||t.qe&&"string"==typeof t.qe&&t.qe.toLowerCase().includes("element")))return d("ELEMENT","Element editor detected through hui-dialog with element editor content"),!0}return"element-updated"===t.type||"config-changed"===t.type&&t.target&&("hui-element-editor"===t.target.localName||t.target.closest("hui-element-editor"))?(d("ELEMENT","Element editor detected through event characteristics"),!0):!!(this._e.active&&Date.now()-this._e.timestamp<5e3)&&(d("ELEMENT","Element editor event detected through active editing session"),!0)}Ye(t){if(!t)return!1;if(t.Le)return!0;try{const i=t.cardConfig;return i&&"custom:actions-card"===i.type}catch(t){return!1}}Se(t){if(this.Ve(t)){d("ELEMENT","Detected element editor event in _handleNestedCardEvents");if(t.composedPath&&t.composedPath().some(t=>this.editor.Te.has(t)||t.Me&&t.Me===this.editor.be))return void d("ELEMENT","Element editor event is related to our dialog stack, handling specially")}if(t.Ze||!t.detail?.fromActionCardEditor)return;const i=t.target.closest("[data-index]");if(!i||!this.editor.Qt?.cards)return;const e=parseInt(i.getAttribute("data-index"));if(!(isNaN(e)||e<0||e>=this.editor.Qt.cards.length)){if(d("EVENT",`Handling nested card event from actions card at index ${e}`,t.detail),t.stopPropagation(),t.preventDefault&&t.preventDefault(),t.detail.maintainEditorState){d("EVENT","Event marked to maintain editor state, preventing propagation");const i=[...this.editor.Qt.cards];i[e]=t.detail.config,this.editor.Qt={...this.editor.Qt,cards:i},this.editor.configManager.fireConfigChanged({nestedCardUpdate:!0,updatedCardIndex:e,nestedCardType:t.detail.config.type,maintainEditorState:!0})}else{const i=[...this.editor.Qt.cards];i[e]=t.detail.config,this.editor.Qt={...this.editor.Qt,cards:i},this.editor.configManager.fireConfigChanged({nestedCardUpdate:!0,updatedCardIndex:e,nestedCardType:t.detail.config.type})}t.Ze=!0,this.editor.requestUpdate()}}handleDialogConfigChanged(t,i,e){{const t=e.composedPath?e.composedPath().map(t=>t.localName||t.nodeName).join(" > "):"No path",i=e.detail?JSON.stringify(e.detail,null,2):"{}";d("EVENT","Config change event details:",{target:e.target.localName,path:t,detail:JSON.parse(i),rawDetail:i,currentTarget:e.currentTarget.localName})}if(this.Ve(e)){if(d("ELEMENT",`[CARD INDEX ${t}] Element editor event detected, preserving and allowing propagation`),i.Ae=!0,this._e.active=!0,this._e.timestamp=Date.now(),e.detail&&e.detail.config&&(i.ze=JSON.parse(JSON.stringify(e.detail.config)),i.Pe=!0,i.Re))try{d("ELEMENT","Silently updating picture-elements config");const i=[...this.editor.Qt.cards];i[t]=e.detail.config,this.editor.Qt={...this.editor.Qt,cards:i},this.editor.configManager.fireConfigChanged({maintainEditorState:!0,fromElementEditor:!0,elementEditorEvent:!0,updatedCardIndex:t})}catch(t){d("ERROR","Error silently updating config:",t)}}else if(e.target!==i&&e.detail&&e.detail.config){e.stopPropagation();const i=e.detail.config;d("EDITOR",`[CARD INDEX ${t}] Config received in handler: ${JSON.stringify(i.type)}`);const s=[...this.editor.Qt.cards];s[t]=i,this.editor.Qt={...this.editor.Qt,cards:s},this.editor.configManager.fireConfigChanged({maintainEditorState:!0,updatedCardIndex:t,reason:"child_dialog_update_"+(e.detail.fromActionCardEditor?"action_card":"generic")}),this.editor.requestUpdate(),d("EDITOR",`[CARD INDEX ${t}] Processed config-changed from content, stopped propagation OUTSIDE dialog.`)}else d("EDITOR",`[CARD INDEX ${t}] config-changed ignored or allowed to bubble (no config or event target is the dialog itself)`)}handleDialogShowDialog(t,i){if(i.detail&&(i.detail.dialogTag&&("hui-dialog-edit-element"===i.detail.dialogTag||i.detail.dialogTag.includes("element-editor"))||i.detail.elementToEdit)){d("ELEMENT",`[CARD INDEX ${t}] Element editor dialog detected, allowing normal event flow`);const e=i.currentTarget;return e&&(e.Ae=!0),this._e.active=!0,this._e.timestamp=Date.now(),void(i.detail&&i.detail.elementId&&(this._e.elementId=i.detail.elementId))}const e=i.detail?JSON.stringify(i.detail):"{}";d("EDITOR",`[CARD INDEX ${t}] INTERCEPTED "${i.type}" event from hui-dialog-edit-card OR ITS CONTENT`,{detail:JSON.parse(e),target:i.target.localName}),i.stopPropagation(),i.stopImmediatePropagation&&i.stopImmediatePropagation(),i.cancelable&&i.preventDefault(),d("EDITOR",`[CARD INDEX ${t}] Re-firing "${i.type}" event from SimpleSwipeCardEditor.`),St(this.editor,i.type,i.detail)}}function At(t,i,e,s,n,o,a,r){const h=t.loop_mode||"none",d=!0===t.enable_auto_swipe,c=t.auto_swipe_interval??2e3,l=!0===t.enable_reset_after,p=t.reset_after_timeout??3e4,u=t.reset_target_card??1,g=t.state_entity||"";let m=0,v=0;"none"!==h&&m++,d&&m++,l&&!d&&m++,l&&d&&v++,g&&m++;let f="",b="";return m>0&&(f=`${m} active`),v>0&&(b=`${v} blocked`),Z`
  ...
  `}function Lt(t,i,e,s,n,o,a,r,h,d,c,l){return Z`
    <div class="section cards-section">
      ...
      <div class="card-list">
        ${0===t.length?Z`<div class="no-cards">
              ...
              card.
            </div>`:t.map((p,u)=>function(t,i,e,s,n,o,a,r,h,d,c,l,p,u){const g=r(t),m=h(t),v=m?d(t):[],f=c(t),b=!s||bt(t.visibility,s);return Z`
    <div
    ...
    >
      <div class="card-info">
        ...
        ${f&&b?Z`<span class="visibility-badge">Conditional</span>`:""}
        ${g.name?Z`<span class="card-name">(${g.name})</span>`:""}
      </div>
      <div class="card-actions">
        ${f&&!b?Z`<ha-icon class="hidden-icon" icon="mdi:eye-off"></ha-icon>`:""}
        <ha-icon-button
          label="Move Up"
          ?disabled=${0===i}
  ...
  `}class SimpleSwipeCardEditor extends mt{static get properties(){return{hass:{type:Object},Qt:{type:Object,state:!0},lovelace:{type:Object}}}static get styles(){return It()}constructor(){super(),d("EDITOR","SimpleSwipeCardEditor Constructor invoked."),d("EDITOR","Editor styles method available:",!!this.constructor.styles),this.uiManager=new Ot(this),this.configManager=new Dt(this),this.cardManagement=new Mt(this),this.eventHandling=new Rt(this),this.uiManager.initializeEditor()}Ve(t){return this.eventHandling.Ve(t)}Ye(t){return this.eventHandling.Ye(t)}Ke(t){return this.cardManagement.isPictureElementsCard(t)}Qe(t){return this.cardManagement.hasVisibilityConditions(t)}ts(t){this.uiManager.toggleSection(t)}es(t){return this.cardManagement.hasNestedCards(t)}ss(t){return this.cardManagement.getNestedCards(t)}ns(t,i,e){this.cardManagement.moveNestedCard(t,i,e)}rs(t,i){this.cardManagement.removeNestedCard(t,i)}async hs(t,i){await this.cardManagement.editNestedCard(t,i)}async ds(t){await this.cardManagement.editCard(t)}cs(t){this.cardManagement.handleCardPicked(t)}ls(t){return this.cardManagement.getCardDescriptor(t)}ps(t,i){this.cardManagement.moveCard(t,i)}us(t){this.cardManagement.removeCard(t)}Ue(t){this.cardManagement.safelyAddCard(t)}gs(){this.uiManager.ensureCardPickerLoaded()}setConfig(t){this.configManager.setConfig(t)}vs(t){this.configManager.handleValueChanged(t)}fs(t={}){this.configManager.fireConfigChanged(t)}render(){if(!this.hass||!this.Qt)return Z`<ha-circular-progress
        active
        alt="Loading editor"
  ...
  `}(this.Qt,this.vs.bind(this))}
        ${At(this.Qt,this.uiManager.getCollapsibleState(),this.vs.bind(this),this.ts.bind(this),i,this.bs.bind(this),this.ws.bind(this),this.hass)}
        ${Lt(i,this.hass,this.ps.bind(this),this.ds.bind(this),this.us.bind(this),this.ls.bind(this),this.es.bind(this),this.ss.bind(this),this.Qe.bind(this),this.ns.bind(this),this.hs.bind(this),this.rs.bind(this))}
