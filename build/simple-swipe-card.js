...
`;function At(t,i,e={}){try{((t,i,e={})=>{const s=new CustomEvent(i,{detail:e,bubbles:!0,composed:!0});t.dispatchEvent(s)})(t,i,e)}catch(s){l('ERROR','Failed to fire HA event:',i,s);const n=new CustomEvent(i,{detail:e,bubbles:!0,composed:!0});t.dispatchEvent(n)}}function Ot(t,i='Map'){return window[t]||(window[t]='Set'===i?new Set:new Map),window[t]}let _t=null;function Nt(t,i,e,s='card'){i&&t&&(_t||(_t=customElements.whenDefined('uix-node').catch(()=>null),_t)).then(n=>{if(n&&'function'==typeof n.applyToElement)try{n.applyToElement(t,s,i,{config:e},!0,void 0),l('UIX','Applied UIX to element',{type:s})}catch(t){console.warn('SimpleSwipeCard: UIX applyToElement failed:',t)}})}class kt{constructor(t){this.card=t}zi(){const t=['hui-card-preview','hui-card-editor','hui-dialog-edit-card','hui-card-picker'];let i=this.card.parentElement;for(;i;){const e=i.tagName?.toLowerCase();if(t.includes(e))return!0;if(i.getRootNode()?.host){const e=i.getRootNode().host.tagName?.toLowerCase();if(t.includes(e))return!0}i=i.parentElement}return!1}async build(){if(this.card.building)return l('INIT','Build already in progress, skipping.'),!1;if(!this.card.ii||!this.card.ii.cards||!this.card.isConnected)return l('INIT','Build skipped (no config/cards or not connected).'),!1;this.card.building=!0,l('INIT','Starting build...');const t=Date.now();if(this.card.Fi=t,l('INIT',`Build timestamp set: ${t}`),this.card.Ui=null,this.card.Bi=null,l('INIT','Cleared cached carousel dimensions'),this.card.resetAfter?.preserveState(),this.card.Wi(),this.card.cards=[],!this.card.ii.state_entity||!this.card.Oi){const t=this.card.getEvaluatedConfigValue('reset_target_card',1);this.card.currentIndex=Math.max(0,parseInt(t)-1||0),0!==this.card.currentIndex&&l('INIT',`Setting initial index to ${this.card.currentIndex} (target card ${t})`)}if(this.card.virtualIndex=0,this.card.realIndex=0,this.card.resizeObserver?.cleanup(),this.card.swipeGestures?.removeGestures(),this.card.autoSwipe?.stop(),this.card.resetAfter?.stopTimer(),this.card.swipeEffects?.resetEffects(),!this.card.shadowRoot)return l('INIT','Waiting for LitElement to create shadowRoot...'),setTimeout(()=>{this.card.isConnected&&this.build()},10),this.card.building=!1,!1;this.card.shadowRoot&&(this.card.shadowRoot.innerHTML='');const i=this.card.shadowRoot;l('INIT','Building with shadowRoot:',!!i);const e=await bt();if(!this.card.isConnected)return l('INIT','Card disconnected while waiting for helpers, aborting build'),this.card.building=!1,this.card.initialized=!1,!1;if(!e)return console.error('SimpleSwipeCard: Card helpers not loaded.'),i.innerHTML='<ha-alert alert-type="error">Card Helpers are required for this card to function. Please ensure they are loaded.</ha-alert>',this.card.building=!1,this.card.initialized=!1,!1;const s=document.createElement('style');s.textContent=function(){let t='';for(let i=1;i<=15;i++)t+=`\n    .pagination-dot:nth-child(${i}) {\n        --ssc-pagination-dot-inactive-resolved: var(--simple-swipe-card-pagination-dot-slide${i}-color, var(--simple-swipe-card-pagination-dot-inactive-color, rgba(127, 127, 127, 0.6)));\n        --ssc-pagination-dot-active-resolved: var(--simple-swipe-card-pagination-dot-slide${i}-active-color, var(--simple-swipe-card-pagination-dot-active-color, var(--primary-color, #03a9f4)));\n    }`;return`\n     :host {\n        display: block;\n        /* Default: overflow hidden prevents scrollbars and works with expander-card */\n        overflow: hidden;\n        width: 100%;\n        height: 100%;\n        position: relative;\n        border-radius: var(--ha-card-border-radius, 12px);\n        background: transparent;\n        /* Prevent horizontal scrolling on touch devices while allowing vertical scrolling */\n        touch-action: pan-y pinch-zoom;\n        /* Ensure dropdowns appear above cards positioned below this one */\n        z-index: 1;\n     }\n\n     /* When dropdown is open: switch to visible overflow with clip-path\n        to allow vertical dropdown overflow while still clipping horizontally */\n     :host(.dropdown-open) {\n        overflow: visible;\n        z-index: 100;\n     }\n\n     :host(.dropdown-open:not([data-enable-backdrop-filter])) {\n        clip-path: polygon(\n          0 -100vh,\n          100% -100vh,\n          100% calc(100% + 100vh),\n          0 calc(100% + 100vh)\n        );\n     }\n\n     :host([data-vertical-no-grid]:not([data-editor-mode])) {\n       height: 250px; /* Set a reasonable default height for the whole card */\n     }\n\n     :host([data-vertical-no-grid]:not([data-editor-mode])) .card-container {\n       height: 100%;\n       max-height: 100%;\n     }\n\n     :host([data-vertical-no-grid]:not([data-editor-mode])) .slider[data-swipe-direction="vertical"] {\n       height: 100%;\n       max-height: 100%;\n     }\n\n     :host([data-vertical-no-grid]:not([data-editor-mode])) .slider[data-swipe-direction="vertical"] .slide {\n       height: 100%;\n       min-height: 100%;\n       max-height: 100%;\n       flex: 0 0 100%;\n     } \n\n     /* Auto Height Mode */\n     :host([data-auto-height]:not([data-editor-mode])) .card-container {\n       height: auto;\n       transition: height 0.2s ease-out;\n     }\n\n     :host([data-auto-height]:not([data-editor-mode])) .slider[data-swipe-direction="horizontal"] {\n       height: auto;\n       align-items: flex-start; /* prevents flex from stretching children */\n     }\n\n     :host([data-auto-height]:not([data-editor-mode])) .slider[data-swipe-direction="horizontal"] .slide {\n       height: auto;\n       min-height: 0;\n       max-height: none;\n       flex-basis: auto;\n     }\n\n     /* Override child card heights */\n     :host([data-auto-height]:not([data-editor-mode])) .slide > * > ha-card,\n     :host([data-auto-height]:not([data-editor-mode])) .slide > * > .card-content {\n       height: auto;\n     } \n\n     /* --- START PREVIEW STYLES --- */\n     .preview-container {\n        display: flex;\n        flex-direction: column;\n        align-items: center;\n        justify-content: center;\n        text-align: center;\n        padding: 16px;\n        box-sizing: border-box;\n        height: 100%;\n        background: var(--ha-card-background, var(--card-background-color, white));\n        border-radius: var(--ha-card-border-radius, 12px);\n        border: none; /* Ensure no border */\n     }\n     .preview-icon-container {\n        margin-bottom: 16px;\n     }\n     .preview-icon-container ha-icon {\n        color: var(--primary-color, #03a9f4); /* Use primary color for consistency */\n        font-size: 48px; /* Match Actions Card */\n        width: 48px;\n        height: 48px;\n     }\n     .preview-text-container {\n        margin-bottom: 16px;\n     }\n     .preview-title {\n        font-size: 18px;\n        font-weight: bold;\n        margin-bottom: 8px;\n        color: var(--primary-text-color);\n     }\n     .preview-description {\n        font-size: 14px;\n        color: var(--secondary-text-color);\n        max-width: 300px;\n        line-height: 1.4;\n        margin: 0 auto; /* Center description text block */\n     }\n     .preview-actions ha-button {\n       /* Rely on default raised button styles for consistency */\n     }\n     /* --- END PREVIEW STYLES --- */\n\n     .card-container {\n        position: relative;\n        width: 100%;\n        height: 100%;\n        overflow: visible;\n        border-radius: inherit;\n        background: transparent;\n        will-change: contents; /* Hint browser for optimization */\n        isolation: isolate; /* Create stacking context for proper z-index behavior */\n        /* Horizontal swipe (default): let the browser handle vertical page scroll,\n           the card captures horizontal drags. */\n        touch-action: pan-y pinch-zoom;\n     }\n\n     /* Vertical swipe: the card captures vertical drags, so the browser must NOT\n        own vertical panning (otherwise the page scrolls instead of the slides,\n        and nested vertical+horizontal cards fight each other). pan-x keeps any\n        horizontal page panning available. This also fixes vertical cards placed\n        on scrollable dashboards (e.g. Sections view). #101 */\n     .card-container:has(.slider[data-swipe-direction="vertical"]) {\n        touch-action: pan-x pinch-zoom;\n     }\n\n     /* Horizontal swipe: Clip horizontally but allow vertical overflow for dropdowns */\n     /* NOTE: clip-path is disabled when enable_backdrop_filter is true (incompatible) */\n     :host(:not([data-enable-backdrop-filter])) .card-container:has(.slider[data-swipe-direction="horizontal"]) {\n        clip-path: polygon(\n          0 -100vh,                    /* top-left, extended upward */\n          100% -100vh,                 /* top-right, extended upward */\n          100% calc(100% + 100vh),     /* bottom-right, extended downward */\n          0 calc(100% + 100vh)         /* bottom-left, extended downward */\n        );\n     }\n\n     /* Vertical swipe: No container clipping by default - we apply selective clipping to inactive slides */\n     /* But during animations, we temporarily enable container clipping via .animating class */\n     /* NOTE: clip-path is disabled when enable_backdrop_filter is true (incompatible) */\n     :host(:not([data-enable-backdrop-filter])) .card-container:has(.slider[data-swipe-direction="vertical"]) {\n        clip-path: none;\n     }\n\n     /* Vertical swipe DURING ANIMATION: Use container clipping to show only viewport */\n     /* This prevents both slides from being visible during the transition */\n     /* NOTE: clip-path is disabled when enable_backdrop_filter is true (incompatible) */\n     :host(:not([data-enable-backdrop-filter])) .card-container:has(.slider[data-swipe-direction="vertical"].animating) {\n        clip-path: polygon(\n          -100vw 0,                    /* top-left, extended leftward for dropdown overflow */\n          calc(100% + 100vw) 0,        /* top-right, extended rightward */\n          calc(100% + 100vw) 100%,     /* bottom-right, clip at container bottom */\n          -100vw 100%                  /* bottom-left, clip at container bottom */\n        );\n     }\n\n    /* Carousel mode: clip horizontally at container boundaries, allow vertical overflow */\n    /* NOTE: clip-path is disabled when enable_backdrop_filter is true (incompatible) */\n    :host(:not([data-enable-backdrop-filter])) .card-container:has(.slider[data-view-mode="carousel"]) {\n      clip-path: polygon(\n        0 -100vh,                    /* top-left, clip at edge but extend upward */\n        100% -100vh,                 /* top-right, clip at edge but extend upward */\n        100% calc(100% + 100vh),     /* bottom-right, clip at edge but extend downward */\n        0 calc(100% + 100vh)         /* bottom-left, clip at edge but extend downward */\n      );\n    }\n\n     .slider {\n        position: relative;\n        display: flex;\n        height: 100%;\n        transition: transform var(--simple-swipe-card-transition-speed, 0.3s) var(--simple-swipe-card-transition-easing, ease-out);\n        will-change: transform;\n        background: transparent;\n        backface-visibility: hidden; /* Reduce repaints */\n        z-index: 2; /* Above pagination - transform creates stacking context */\n        pointer-events: none;\n     }\n\n     /* Horizontal slider (default) */\n     .slider[data-swipe-direction="horizontal"] {\n        flex-direction: row;\n     }\n     \n     /* Vertical slider */\n     .slider[data-swipe-direction="vertical"] {\n        flex-direction: column;\n        height: 100%;\n        max-height: 100%;\n        overflow: visible; /* Allow transforms to move content outside */\n        flex-wrap: nowrap;\n     }\n     \n     .slide {\n        flex: 0 0 var(--single-slide-width, 100%);\n        width: var(--single-slide-width, 100%);\n        min-width: var(--single-slide-width, 100%);\n        height: 100%;\n        min-height: 100%;\n        box-sizing: border-box;\n        position: relative;\n        display: flex;\n        flex-direction: column;\n        overflow: visible;\n        background: transparent;\n        z-index: 2; /* Above pagination (z-index: 1) */\n        transform: translateZ(0); /* Force GPU acceleration for better iOS/Safari rendering */\n        -webkit-transform: translateZ(0);\n        pointer-events: none; /* Allow clicks to pass through to elements below/behind */\n        /* Fix iPad Safari: ensure font-size inheritance through transform boundary */\n        font-size: inherit;\n        -webkit-text-size-adjust: 100%;\n     }\n\n     /* Vertical mode: Clip inactive slides to hide adjacent cards */\n     /* BUT: During animation, disable per-slide clipping to show smooth transition */\n     /* NOTE: clip-path is disabled when enable_backdrop_filter is true (incompatible) */\n     :host(:not([data-enable-backdrop-filter])) .slider[data-swipe-direction="vertical"]:not(.animating) .slide:not(.active-slide) {\n        /* Clip to zero height - makes slide invisible while keeping it in DOM */\n        clip-path: inset(0 0 100% 0);\n     }\n\n     /* Vertical mode DURING ANIMATION: All slides visible (no per-slide clipping) */\n     /* Container clipping handles viewport boundaries */\n     /* NOTE: clip-path is disabled when enable_backdrop_filter is true (incompatible) */\n     :host(:not([data-enable-backdrop-filter])) .slider[data-swipe-direction="vertical"].animating .slide {\n        clip-path: none;\n     }\n\n     /* Vertical mode AFTER ANIMATION: Active slide has no clipping, allowing dropdowns to overflow */\n     /* NOTE: clip-path is disabled when enable_backdrop_filter is true (incompatible) */\n     :host(:not([data-enable-backdrop-filter])) .slider[data-swipe-direction="vertical"]:not(.animating) .slide.active-slide {\n        clip-path: none;\n     }\n\n     /* ========== BACKDROP FILTER MODE ========== */\n     /* When backdrop-filter is enabled, use overflow: hidden to clip adjacent cards */\n     /* Note: overflow: hidden may conflict with backdrop-filter in some browsers, */\n     /* but it's the only option that doesn't completely break the functionality */\n\n     :host([data-enable-backdrop-filter]) .card-container {\n        overflow: hidden;\n     }\n\n     /* ========== END BACKDROP FILTER MODE ========== */\n\n    .slide.carousel-mode {\n      flex: 0 0 auto; /* Don't grow/shrink, use calculated width */\n      width: var(--carousel-card-width); /* Will be set dynamically */\n      min-width: var(--carousel-card-width);\n    }\n\n    /* Fix iPad Safari: prevent flex stretching from overriding aspect-ratio in carousel mode */\n    .slide.carousel-mode > *:first-child {\n      flex-grow: 0;\n      align-self: flex-start;\n    }\n\n    /* Carousel container adjustments */\n    .slider[data-view-mode="carousel"] {\n      /* Allow overflow to show partial cards */\n      overflow: visible;\n    }\n\n    .card-container[data-view-mode="carousel"] {\n      /* Ensure container can handle overflow */\n      overflow: visible;\n      position: relative;\n    }\n\n    /* ========== NATIVE CSS SCROLL-SNAP STRATEGY (scroll_strategy: css) ========== */\n    /* The slider becomes an overflow scroll container so the browser drives\n       scrolling on the compositor thread — no JS transform per touchmove, far\n       smoother on low-power devices (#102). Placed after the direction/view-mode\n       rules above so these win on equal specificity. The one-axis scroll snap\n       container clips the cross axis, so absolutely-positioned in-card overlays\n       may be clipped; HA's fixed-position dropdowns (mwc/wa menus) escape. */\n    .slider[data-scroll-strategy="css"] {\n      transform: none !important;\n      transition: none !important;\n      will-change: auto;\n      pointer-events: auto; /* the scroll container must receive the gesture */\n      overscroll-behavior: contain;\n      scrollbar-width: none; /* Firefox */\n      -ms-overflow-style: none; /* legacy Edge */\n    }\n    /* Hide the scrollbar (WebKit/Blink) — snapping is the affordance */\n    .slider[data-scroll-strategy="css"]::-webkit-scrollbar {\n      display: none;\n    }\n    .slider[data-scroll-strategy="css"][data-swipe-direction="horizontal"] {\n      overflow-x: auto;\n      overflow-y: hidden;\n      scroll-snap-type: x mandatory;\n    }\n    .slider[data-scroll-strategy="css"][data-swipe-direction="vertical"] {\n      overflow-x: hidden;\n      overflow-y: auto;\n      scroll-snap-type: y mandatory;\n    }\n    .slider[data-scroll-strategy="css"] .slide {\n      scroll-snap-align: var(--ssc-scroll-snap-align, start);\n    }\n    /* Single mode: never skip past a slide. Carousel may fling across several. */\n    .slider[data-scroll-strategy="css"]:not([data-view-mode="carousel"]) .slide {\n      scroll-snap-stop: always;\n    }\n    /* Native vertical scroll must show every slide, so disable the inactive-slide\n       clip-path that the JS vertical mode uses to hide neighbours. */\n    :host(:not([data-enable-backdrop-filter]))\n      .slider[data-scroll-strategy="css"][data-swipe-direction="vertical"]\n      .slide {\n      clip-path: none !important;\n    }\n    /* Let the browser own the gesture in both axes while scrolling natively. */\n    .card-container:has(.slider[data-scroll-strategy="css"]) {\n      touch-action: auto;\n    }\n    /* ========== END NATIVE CSS SCROLL-SNAP STRATEGY ========== */\n\n    /* Z-INDEX HIERARCHY (within .card-container stacking context):\n    * 1. pagination (z-index: 1) - Bottom layer, behind all slide content\n    * 2. .slider (z-index: 2) - Above pagination (transform creates stacking context)\n    *    -> .slide (z-index: 2) - Within slider's stacking context\n    *       -> .slide > *:first-child (z-index: 3) - Ensures dropdowns appear above everything\n    *\n    * This hierarchy fixes:\n    * - Android: Dropdowns now appear above pagination dots and other cards\n    * - iOS: Hardware acceleration (translateZ) improves rendering\n    */\n    .pagination {\n        position: absolute;\n        display: flex;\n        justify-content: center;\n        z-index: 1; /* Lowest layer - behind slides and dropdowns */\n        background-color: var(--simple-swipe-card-pagination-background, transparent);\n        pointer-events: auto;\n        transition: opacity 0.2s ease-in-out;\n        padding: var(--simple-swipe-card-pagination-padding, 4px 8px);\n        border-radius: 12px;\n        /* Prevent container from sizing to content during animations */\n        box-sizing: border-box;\n    }\n\n    /* Horizontal pagination (bottom) */\n    .pagination.horizontal {\n        bottom: var(--simple-swipe-card-pagination-bottom, 8px);\n        left: 50%;\n        transform: translateX(-50%);\n        flex-direction: row;\n        align-items: center;\n        /* Remove any height properties - will be set by JavaScript */\n    }\n\n    /* Vertical pagination (right) */\n    .pagination.vertical {\n        right: var(--simple-swipe-card-pagination-right, 8px);\n        top: 50%;\n        transform: translateY(-50%);\n        flex-direction: column;\n        align-items: center;\n        /* Remove any width properties - will be set by JavaScript */\n    }\n    \n     .pagination.hide {\n        opacity: 0;\n        pointer-events: none;\n     }\n\n    .pagination-dot {\n        /* Resolved per-slide colors. The base values fall back to the global\n           inactive/active colors; per-slide :nth-child rules below override these\n           two variables so the state rules (base/hover/active/active-hover) inherit\n           the right color without any specificity/ordering changes. */\n        --ssc-pagination-dot-inactive-resolved: var(--simple-swipe-card-pagination-dot-inactive-color, rgba(127, 127, 127, 0.6));\n        --ssc-pagination-dot-active-resolved: var(--simple-swipe-card-pagination-dot-active-color, var(--primary-color, #03a9f4));\n\n        width: var(--simple-swipe-card-pagination-dot-size, 8px);\n        height: var(--simple-swipe-card-pagination-dot-size, 8px);\n        border-radius: var(--simple-swipe-card-pagination-border-radius, 50%);\n        background-color: var(--ssc-pagination-dot-inactive-resolved);\n        cursor: pointer;\n        opacity: var(--simple-swipe-card-pagination-dot-inactive-opacity, 1);\n        \n        /* Border support */\n        border-width: var(--simple-swipe-card-pagination-dot-border-width, 0px);\n        border-color: var(--simple-swipe-card-pagination-dot-border-color, transparent);\n        border-style: var(--simple-swipe-card-pagination-dot-border-style, solid);\n        \n        /* Box shadow support */\n        box-shadow: var(--simple-swipe-card-pagination-dot-box-shadow, none);\n        \n        /* Updated transition to include new animatable properties */\n        transition: background-color 0.2s ease, width 0.2s ease, height 0.2s ease, border-color 0.2s ease, box-shadow 0.2s ease, transform 0.2s ease;\n    }\n    \n    /* Hover effects */\n    .pagination-dot:hover {\n        background-color: var(--simple-swipe-card-pagination-dot-hover-color, var(--ssc-pagination-dot-inactive-resolved));\n        opacity: var(--simple-swipe-card-pagination-dot-hover-opacity, var(--simple-swipe-card-pagination-dot-inactive-opacity, 1));\n        border-color: var(--simple-swipe-card-pagination-dot-hover-border-color, var(--simple-swipe-card-pagination-dot-border-color, transparent));\n        transform: var(--simple-swipe-card-pagination-dot-hover-transform, none);\n        box-shadow: var(--simple-swipe-card-pagination-dot-hover-box-shadow, var(--simple-swipe-card-pagination-dot-box-shadow, none));\n    }    \n\n    /* Active hover state */\n    .pagination-dot.active:hover {\n        background-color: var(--simple-swipe-card-pagination-dot-active-hover-color, var(--ssc-pagination-dot-active-resolved));\n        opacity: var(--simple-swipe-card-pagination-dot-active-hover-opacity, var(--simple-swipe-card-pagination-dot-active-opacity, 1));\n        border-color: var(--simple-swipe-card-pagination-dot-active-hover-border-color, var(--simple-swipe-card-pagination-dot-active-border-color, var(--simple-swipe-card-pagination-dot-border-color, transparent)));\n        transform: var(--simple-swipe-card-pagination-dot-active-hover-transform, var(--simple-swipe-card-pagination-dot-hover-transform, none));\n        box-shadow: var(--simple-swipe-card-pagination-dot-active-hover-box-shadow, var(--simple-swipe-card-pagination-dot-active-box-shadow, var(--simple-swipe-card-pagination-dot-box-shadow, none)));\n    }    \n\n    /* Spacing for horizontal pagination dots */\n    .pagination.horizontal .pagination-dot {\n        margin: 0 var(--simple-swipe-card-pagination-dot-spacing, 4px);\n    }\n    \n    /* Spacing for vertical pagination dots */\n    .pagination.vertical .pagination-dot {\n        margin: var(--simple-swipe-card-pagination-dot-spacing, 4px) 0;\n    }\n    \n    .pagination-dot.active {\n        background-color: var(--ssc-pagination-dot-active-resolved);\n        width: var(--simple-swipe-card-pagination-dot-active-size, var(--simple-swipe-card-pagination-dot-size, 8px));\n        height: var(--simple-swipe-card-pagination-dot-active-size, var(--simple-swipe-card-pagination-dot-size, 8px));\n        opacity: var(--simple-swipe-card-pagination-dot-active-opacity, 1);\n        \n        /* Separate active border radius */\n        border-radius: var(--simple-swipe-card-pagination-dot-active-border-radius, var(--simple-swipe-card-pagination-border-radius, 50%));\n        \n        /* Active border support */\n        border-width: var(--simple-swipe-card-pagination-dot-active-border-width, var(--simple-swipe-card-pagination-dot-border-width, 0px));\n        border-color: var(--simple-swipe-card-pagination-dot-active-border-color, var(--simple-swipe-card-pagination-dot-border-color, transparent));\n        border-style: var(--simple-swipe-card-pagination-dot-active-border-style, var(--simple-swipe-card-pagination-dot-border-style, solid));\n        \n        /* Active box shadow support */\n        box-shadow: var(--simple-swipe-card-pagination-dot-active-box-shadow, var(--simple-swipe-card-pagination-dot-box-shadow, none));\n    }\n${t}\n\n     ha-alert {\n        display: block;\n        margin: 0;\n        width: 100%;\n        box-sizing: border-box;\n        border-radius: 0;\n        border: none;\n        background-color: transparent;\n     }\n     .slide > *:first-child {\n        flex-grow: 1;\n        width: 100%;\n        display: flex;\n        flex-direction: column;\n        min-height: 0;\n        overflow: visible !important;\n        position: relative;\n        z-index: 3; /* Above slides and pagination - ensures dropdowns are on top */\n        pointer-events: auto; /* Re-enable pointer events for card content */\n     }\n     .slide > * > ha-card,\n     .slide > * > .card-content {\n        margin: 0 !important;\n        padding: 0 !important;\n        box-shadow: none !important;\n        border-radius: 0 !important;\n        border: none !important;\n        height: 100%;\n        display: flex;\n        flex-direction: column;\n        overflow: visible !important;\n        position: relative;\n        z-index: 3; /* Same as parent - maintains stacking for dropdowns */\n     }\n\n     /* Mushroom-select dropdown positioning fix */\n     /* Note: The fixedMenuPosition property is disabled via JavaScript in CardBuilder.js */\n     /* This ensures dropdowns work correctly with CSS transforms applied to slides */\n     /* For vertical mode: Active slide has no clip-path, allowing dropdown overflow */\n     /* Inactive slides are clipped to hide adjacent cards */\n\n     /* Reduced Motion Support - Automatically disable animations when user prefers reduced motion */\n     @media (prefers-reduced-motion: reduce) {\n        /* Disable slide transitions */\n        .slider {\n           transition: none !important;\n        }\n\n        /* Disable auto-height transitions */\n        :host([data-auto-height]:not([data-editor-mode])) .card-container {\n           transition: none !important;\n        }\n\n        /* Disable pagination transitions */\n        .pagination {\n           transition: none !important;\n        }\n\n        .pagination-dot {\n           transition: none !important;\n        }\n     }\n   `}(),i.appendChild(s),this.card.cardContainer=document.createElement('div'),this.card.cardContainer.className='card-container',this.card.sliderElement=document.createElement('div'),this.card.sliderElement.className='slider',this.card.sliderElement.setAttribute('data-swipe-direction',this.card.Qt);const n=this.card.ii.scroll_strategy||'js';if(this.card.sliderElement.setAttribute('data-scroll-strategy',n),'css'===n&&this.card.sliderElement.style.setProperty('--ssc-scroll-snap-align','carousel'===this.card.ii.view_mode&&'center'===this.card.ii.carousel_alignment?'center':'start'),this.card.sliderElement.style.opacity='0',l('INIT','Slider hidden during build to prevent layout flash'),this.card.cardContainer.appendChild(this.card.sliderElement),i.appendChild(this.card.cardContainer),this.card.Yi(),0===this.card.ii.cards.length){const t=this.zi()||!0===this.card.preview;if(l('INIT',`No cards configured, show preview: ${t}`),t){l('INIT','Building preview state for editor.');const t=function(t,i){const e=document.createElement('div');e.className='preview-container';const s=document.createElement('div');s.className='preview-icon-container';const n=document.createElement('ha-icon');n.icon='horizontal'===t?'mdi:gesture-swipe-horizontal':'mdi:gesture-swipe-vertical',s.appendChild(n);const o=document.createElement('div');o.className='preview-text-container';const a=document.createElement('div');a.className='preview-title',a.textContent='Simple Swipe Card';const r=document.createElement('div');r.className='preview-description',r.textContent=`Create a swipeable container with multiple cards. Swipe ${'horizontal'===t?'horizontally':'vertically'} between cards. Open the editor to add your first card.`,o.appendChild(a),o.appendChild(r);const d=document.createElement('div');d.className='preview-actions';const l=document.createElement('ha-button');return l.raised=!0,l.textContent='EDIT CARD',l.setAttribute('aria-label','Edit Card'),l.addEventListener('click',i),d.appendChild(l),e.appendChild(s),e.appendChild(o),e.appendChild(d),e}(this.card.Qt,t=>function(t,i){t.stopPropagation(),l('EDITOR','Edit button clicked, firing show-edit-card event'),At(i,'show-edit-card',{element:i})}(t,this.card));i.innerHTML='',i.appendChild(s),i.appendChild(t)}else l('INIT','No cards and not in editor - showing empty state.'),i.innerHTML='',i.appendChild(s);return this.card.initialized=!0,this.card.building=!1,!0}if(0===this.card.visibleCardIndices.length)return l('INIT','No visible cards, hiding entire card.'),this.card.style.display='none',i.innerHTML='',this.card.initialized=!0,this.card.building=!1,!0;this.card.style.display='block',this.card.loopMode.initialize();const o=this.card.loopMode.prepareCardsForLoading(this.card.visibleCardIndices,this.card.ii.cards);l('INIT','Building cards:',{totalVisible:this.card.visibleCardIndices.length,totalToLoad:o.length,infiniteMode:this.card.loopMode.isInfiniteMode});const a=this.card.ii.view_mode||'single';if(this.ji()){const t=this.card.getAttribute('data-in-layout-container')||'unknown';l('INIT',`${t} detected - using synchronous loading for compatibility`);const i=this.card.Fi,s=o.map(t=>this.createCard(t.config,t.visibleIndex,t.originalIndex,e,t.isDuplicate,i).catch(i=>(console.warn(`Card ${t.visibleIndex} failed to load:`,i),null)));return await Promise.allSettled(s),this.card.Fi!==i?(l('INIT','Build superseded by newer build, aborting this one',{thisBuild:i,currentBuild:this.card.Fi}),this.card.cards=[],!1):this.card.isConnected&&this.card.sliderElement?(this.Gi(),l('INIT','All cards loaded synchronously for layout-card'),this.card.initialized||(this.card.initialized=!0),requestAnimationFrame(()=>{this.card.isConnected&&this.card.cardContainer&&this.finishBuildLayout(i)}),this.card.building=!1,l('INIT','Build completed successfully (layout-card mode)'),!0):(l('INIT','Card disconnected during build, aborting and cleaning up',{connected:this.card.isConnected,hasSlider:!!this.card.sliderElement}),this.card.cards=[],this.card.building=!1,this.card.initialized=!1,!1)}if('carousel'===a){l('INIT','Carousel mode detected - creating DOM structure for layout, loading content progressively'),o.forEach(t=>{const i=Ct();i.setAttribute('data-index',t.originalIndex),i.setAttribute('data-visible-index',t.visibleIndex),t.isDuplicate&&i.setAttribute('data-duplicate','true'),t.config?.type&&i.setAttribute('data-card-type',t.config.type),this.card.cards.push({visibleIndex:t.visibleIndex,originalIndex:t.originalIndex,slide:i,config:JSON.parse(JSON.stringify(t.config)),error:!1,isDuplicate:t.isDuplicate,element:null,contentLoaded:!1}),this.card.sliderElement.appendChild(i),this.card.autoHeight?.enabled&&this.card.autoHeight.observeSlide(i,t.visibleIndex)}),this.card.cards.sort((t,i)=>t.visibleIndex-i.visibleIndex),l('INIT','Carousel DOM structure created, now loading content progressively');const i=this.Ji(o),s=i[0]||[];s.length>0&&await this.qi(s,e,'priority',t);for(let s=1;s<i.length;s++){const n=i[s];setTimeout(async()=>{this.card.isConnected&&await this.qi(n,e,`batch-${s+1}`,t)},150*s)}}else{const i=this.Ji(o);l('INIT','Single mode stagger loading strategy:',{totalBatches:i.length,batchSizes:i.map(t=>t.length),firstBatchCards:i[0]?.map(t=>`${t.visibleIndex}(${t.originalIndex})`)||[]});const s=i[0]||[];if(s.length>0){l('INIT','Loading priority batch immediately:',s.length);const i=s.map(i=>this.createCard(i.config,i.visibleIndex,i.originalIndex,e,i.isDuplicate,t).catch(t=>(console.warn(`Priority card ${i.visibleIndex} failed to load:`,t),null)));await Promise.allSettled(i),this.Gi(),l('INIT','Priority batch loaded and displayed')}for(let s=1;s<i.length;s++){const n=i[s],o=200*s;setTimeout(async()=>{if(!this.card.isConnected)return;l('INIT',`Loading batch ${s+1}/${i.length} after ${o}ms`);const a=n.map(i=>this.createCard(i.config,i.visibleIndex,i.originalIndex,e,i.isDuplicate,t).catch(t=>(console.warn(`Background card ${i.visibleIndex} failed to load:`,t),null)));await Promise.allSettled(a),this.Gi(),l('INIT',`Batch ${s+1} completed`)},o)}if(!this.card.isConnected||!this.card.sliderElement)return l('INIT','Card disconnected before inserting priority cards'),this.card.cards=[],this.card.building=!1,this.card.initialized=!1,!1;this.Gi()}if(this.card.ii.state_entity&&this.card.Oi){const t=this.Xi();t!==this.card.currentIndex&&(l('STATE','Setting initial index from state sync:',t),this.card.currentIndex=t)}return this.card.pagination.create(),l('INIT','All cards initialized.'),this.card.initialized?requestAnimationFrame(()=>{this.card.isConnected&&this.card.cardContainer?this.finishBuildLayout(t):l('INIT','Card disconnected before finishBuildLayout (rebuild)')}):(this.card.initialized=!0,requestAnimationFrame(()=>{this.card.isConnected&&this.card.cardContainer?this.finishBuildLayout(t):l('INIT','Card disconnected before finishBuildLayout')})),this.card.building=!1,l('INIT','Build completed successfully'),this.card.Zi(),!0}async createCard(t,i,e,s,n=!1,o=null){const a=Ct();let r;const d={visibleIndex:i,originalIndex:e,slide:a,config:JSON.parse(JSON.stringify(t)),error:!1,isDuplicate:n};try{if(r=await s.createCardElement(t),o&&this.card.Fi!==o)return void l('INIT',`Discarding card ${i} from stale build`,{cardBuild:o,currentBuild:this.card.Fi});this.card.Oi&&(r.hass=this.card.Oi,l('INIT',`Set hass immediately after creation for card ${i} (type: ${t.type})`)),d.element=r,'picture-elements'===t.type&&(r.setAttribute('data-swipe-card-picture-elements','true'),a.setAttribute('data-has-picture-elements','true')),a.appendChild(r);const e=!!customElements.get('card-mod');if(await new Promise(t=>{requestAnimationFrame(()=>{e?setTimeout(t,30):t()})}),o&&this.card.Fi!==o)return void l('INIT',`Discarding card ${i} from stale build (after card-mod wait)`,{cardBuild:o,currentBuild:this.card.Fi});Nt(r,t?.uix,t,'card'),requestAnimationFrame(()=>{try{if('todo-list'===t.type){const t=r.shadowRoot?.querySelector('ha-textfield'),i=t?.shadowRoot?.querySelector('input');i&&(i.enterKeyHint='done')}}catch(t){console.warn('Error applying post-creation logic:',t)}})}catch(n){if(l('ERROR',`Error creating card ${i} (original ${e}):`,t,n),d.error=!0,o&&this.card.Fi!==o)return void l('INIT',`Discarding error card ${i} from stale build`);const r=await s.createErrorCardElement({type:'error',error:`Failed to create card: ${n.message}`,origConfig:t},this.card.Oi);d.element=r,a.appendChild(r)}o&&this.card.Fi!==o?l('INIT',`Discarding card ${i} from stale build (final check)`):this.card.cards.push(d)}Ki(t,i){l('VISIBILITY',`Conditional card ${t} visibility changed to: ${i}`);const e=this.card.cards.find(i=>i.originalIndex===t);e&&(e.conditionallyVisible=i),this.card.Qi()}te(){if(!this.card.sliderElement)return;l('MUSHROOM','Checking for mushroom-select elements...');const t=this.card.sliderElement.querySelectorAll('mushroom-select-card'),i=this.card.sliderElement.querySelectorAll('mushroom-select');l('MUSHROOM',`Found ${t.length} mushroom-select-card(s) and ${i.length} standalone mushroom-select element(s)`);const e=[];t.forEach(t=>{const i=t.shadowRoot?.querySelector('mushroom-card');if(i){l('MUSHROOM','Found mushroom-card inside mushroom-select-card');const s=i.querySelector('mushroom-select-option-control');if(s){l('MUSHROOM','Found mushroom-select-option-control in mushroom-card\'s light DOM');const i=s.shadowRoot?.querySelector('mushroom-select');i?(e.push({select:i,rootElement:t}),l('MUSHROOM','Found mushroom-select inside mushroom-select-option-control\'s shadow root')):l('MUSHROOM','mushroom-select-option-control found but no mushroom-select in its shadow root')}else l('MUSHROOM','mushroom-card found but no mushroom-select-option-control in its light DOM')}else l('MUSHROOM','mushroom-select-card found but no mushroom-card inside shadow root')}),i.forEach(t=>{e.push({select:t,rootElement:t})}),e.length>0?(l('MUSHROOM',`Total ${e.length} mushroom-select element(s) found, setting up dropdown positioning fix...`),e.forEach((t,i)=>{const{select:e,rootElement:s}=t;try{if(!1!==e.fixedMenuPosition&&(e.fixedMenuPosition=!1,l('MUSHROOM',`mushroom-select #${i+1} - disabled fixedMenuPosition`)),!0!==e.naturalMenuWidth&&(e.naturalMenuWidth=!0,l('MUSHROOM',`mushroom-select #${i+1} - enabled naturalMenuWidth`)),!s.closest('.slide'))return void l('MUSHROOM',`mushroom-select #${i+1} - no parent slide found`);l('MUSHROOM',`mushroom-select #${i+1} - found parent slide`);let t=!1;const n=e=>{t||(t=!0,e.addEventListener('opened',()=>{l('MUSHROOM',`mushroom-select #${i+1} - menu opened, adjusting position...`);const t=e.shadowRoot?.querySelector('.mdc-menu-surface');if(!t)return void l('MUSHROOM',`mushroom-select #${i+1} - menu surface not found`);const s=window.getComputedStyle(this.card.sliderElement).transform;l('MUSHROOM',`Slider transform: ${s}`);let n=0,o=0;if(s&&'none'!==s){const t=s.match(/matrix\(([^)]+)\)/);if(t){const i=t[1].split(',').map(t=>parseFloat(t.trim()));i.length>=6&&(n=i[4]||0,o=i[5]||0)}}l('MUSHROOM',`Detected transform offset: translateX=${n}, translateY=${o}`);const a=parseFloat(t.style.left)||0,r=parseFloat(t.style.top)||0,d=a-n,h=r-o;l('MUSHROOM',`Adjusting menu position: (${a}, ${r}) -> (${d}, ${h})`),t.style.left=`${d}px`,t.style.top=`${h}px`,l('MUSHROOM',`mushroom-select #${i+1} - position adjusted successfully`)}),l('MUSHROOM',`mushroom-select #${i+1} - menu fix listener attached`))};let o=0;const a=10,r=()=>{const t=e.shadowRoot?.querySelector('mwc-menu');if(t)n(t);else if(o++,o<a)l('MUSHROOM',`mushroom-select #${i+1} - menu not found yet, will retry (${o}/${a})`),setTimeout(r,100);else{if(l('MUSHROOM',`mushroom-select #${i+1} - menu not found after ${a} retries, setting up MutationObserver`),!e.shadowRoot)return void l('MUSHROOM',`mushroom-select #${i+1} - no shadow root, cannot observe`);const t=new MutationObserver(e=>{for(const s of e)if('childList'===s.type)for(const e of s.addedNodes)if('MWC-MENU'===e.nodeName)return l('MUSHROOM',`mushroom-select #${i+1} - menu detected via MutationObserver!`),n(e),void t.disconnect()});t.observe(e.shadowRoot,{childList:!0,subtree:!0}),l('MUSHROOM',`mushroom-select #${i+1} - MutationObserver setup complete`)}};r()}catch(t){console.warn(`Error fixing mushroom-select #${i+1}:`,t)}}),l('MUSHROOM','Mushroom-select positioning fix setup completed')):l('MUSHROOM','No mushroom-select elements found'),this.ie()}ie(){this.card.ee&&(this.card.ee.disconnect(),this.card.ee=null),this.card.sliderElement&&(l('MUSHROOM','Setting up persistent observer for new mushroom-select elements...'),this.card.ee=new MutationObserver(t=>{for(const i of t)if('childList'===i.type)for(const t of i.addedNodes)if('MUSHROOM-SELECT-CARD'===t.nodeName&&(l('MUSHROOM','Detected new mushroom-select-card being added to DOM'),setTimeout(()=>{this.se(t)},100)),t.querySelectorAll){const i=t.querySelectorAll('mushroom-select-card');i.length>0&&(l('MUSHROOM',`Detected ${i.length} nested mushroom-select-card(s) in added node`),setTimeout(()=>{i.forEach(t=>this.se(t))},100))}}),this.card.ee.observe(this.card.sliderElement,{childList:!0,subtree:!0}),l('MUSHROOM','Persistent mushroom-select observer active'))}se(t){try{const i=t.shadowRoot?.querySelector('mushroom-card');if(!i)return void l('MUSHROOM','New card: no mushroom-card found in shadow root');const e=i.querySelector('mushroom-select-option-control');if(!e)return void l('MUSHROOM','New card: no mushroom-select-option-control found');const s=e.shadowRoot?.querySelector('mushroom-select');if(!s)return void l('MUSHROOM','New card: no mushroom-select found');if(l('MUSHROOM','New card: found mushroom-select, setting up positioning fix'),s.fixedMenuPosition=!1,s.naturalMenuWidth=!0,!t.closest('.slide'))return void l('MUSHROOM','New card: no parent slide found');let n=!1;const o=t=>{n||(n=!0,t.addEventListener('opened',()=>{l('MUSHROOM','New card menu opened, adjusting position...');const i=t.shadowRoot?.querySelector('.mdc-menu-surface');if(!i)return;const e=window.getComputedStyle(this.card.sliderElement).transform;let s=0,n=0;if(e&&'none'!==e){const t=e.match(/matrix\(([^)]+)\)/);if(t){const i=t[1].split(',').map(t=>parseFloat(t.trim()));i.length>=6&&(s=i[4]||0,n=i[5]||0)}}const o=parseFloat(i.style.left)||0,a=(parseFloat(i.style.top)||0)-n;i.style.left=o-s+'px',i.style.top=`${a}px`,l('MUSHROOM','New card menu position adjusted')}))},a=s.shadowRoot?.querySelector('mwc-menu');if(a)o(a),l('MUSHROOM','New card: menu found immediately');else{l('MUSHROOM','New card: menu not found, setting up observer');const t=new MutationObserver(i=>{for(const e of i)if('childList'===e.type)for(const i of e.addedNodes)if('MWC-MENU'===i.nodeName)return l('MUSHROOM','New card: menu detected via observer'),o(i),void t.disconnect()});t.observe(s.shadowRoot,{childList:!0,subtree:!0})}}catch(t){console.warn('Error fixing new mushroom-select-card:',t)}}async finishBuildLayout(t=null){if(t&&this.card.Fi&&t!==this.card.Fi)return void l('INIT','finishBuildLayout skipped - stale build detected',{thisBuild:t,currentBuild:this.card.Fi});if(!this.card.cardContainer||!this.card.isConnected||this.card.building)return void l('INIT','finishBuildLayout skipped',{container:!!this.card.cardContainer,connected:this.card.isConnected,building:this.card.building});l('INIT','Finishing build layout...');const i=await this.ne();i?(this.card.slideWidth=i.width,this.card.slideHeight=i.height,l('INIT','Initial dimensions:',i)):(l('INIT','Initial width unavailable - using fallback dimensions (will recalc on resize)'),this.card.slideWidth=300,this.card.slideHeight=100);const e=this.card.ii.view_mode||'single';'carousel'===e?this.oe(this.card.slideWidth)||console.warn('SimpleSwipeCard: Carousel layout calculation produced invalid dimensions'):this.card.style.setProperty('--single-slide-width',this.card.ae?'100%':`${this.card.slideWidth}px`);const s=this.card.visibleCardIndices.length,n=this.card.getEvaluatedConfigValue('reset_target_card',1),o=Math.max(0,parseInt(n)-1||0);if(0!==o){const t=this.card.visibleCardIndices.indexOf(o);if(-1!==t)this.card.currentIndex=t,l('INIT',`Target card ${n} is visible at position ${t}`);else{let t=0;for(let i=0;i<this.card.visibleCardIndices.length;i++)if(this.card.visibleCardIndices[i]>=o){t=i;break}this.card.currentIndex=t,l('INIT',`Target card ${n} not visible, using closest at position ${t}`)}}if(this.card.currentIndex=Math.max(0,Math.min(this.card.currentIndex,s-1)),this.card.cardContainer&&this.card.cardContainer.isConnected?function(t,i){if(!(i&&i instanceof Element))return void l('INIT','applyBorderRadiusToSlides skipped: invalid cardContainer',{isNull:!i,type:i?.constructor?.name});if(!i.isConnected)return void l('INIT','applyBorderRadiusToSlides skipped: cardContainer not connected to DOM');const e=getComputedStyle(i).borderRadius;t.forEach(t=>{t&&t.slide&&(t.slide.style.borderRadius=e)})}(this.card.cards,this.card.cardContainer):l('INIT','Skipping border radius application - container no longer valid'),'carousel'!==e&&!this.card.ae&&this.card.sliderElement){const t=this.card.slideWidth;this.card.sliderElement.querySelectorAll('.slide:not(.carousel-mode)').forEach(i=>{i.style.width=`${t}px`,i.style.minWidth=`${t}px`,i.style.flexBasis=`${t}px`}),l('INIT','Set single mode slide widths:',t)}this.card.updateSlider(!1),this.card.re(),s>1?(this.card.swipeGestures?.addGestures(),this.card.scrollStrategy?.attach()):(this.card.swipeGestures?.removeGestures(),this.card.scrollStrategy?.detach()),l('INIT','Layout finished, slideWidth:',this.card.slideWidth,'slideHeight:',this.card.slideHeight,'currentIndex:',this.card.currentIndex,'visible cards:',s,'view mode:',e),this.card.autoSwipe?.manage(),this.card.resetAfter?.manage(),this.card.stateSynchronization?.manage(),this.card.de(),this.te(),l('PAGINATION','Updating pagination after layout finalization'),requestAnimationFrame(()=>{this.card.isConnected&&this.card.pagination&&(this.card.pagination.update(!1),l('PAGINATION','Pagination active state updated'))}),this.card.Ni&&(l('CARD_MOD','Applying card-mod styles in finishBuildLayout'),this.card.ki(),this.card.le(),'carousel'===e&&this.he().then(()=>{this.card.isConnected&&this.recalculateCarouselLayout()})),l('INIT','Creating/updating pagination before fade-in'),this.card.pagination.updateLayout(),await new Promise(t=>requestAnimationFrame(t)),this.card.ce(),Nt(this.card,this.card.ii?.uix,this.card.ii,'card'),await this.ue()}async he(){const t=getComputedStyle(this.card).getPropertyValue('--carousel-card-width').trim();if(l('CARD_MOD','Waiting for carousel CSS variable application:',{initialWidth:t,maxWaitTime:500}),t&&''!==t&&'auto'!==t)return l('CARD_MOD','CSS variable already applied:',t),Promise.resolve();const i=Date.now();return new Promise(t=>{const e=setInterval(()=>{const s=getComputedStyle(this.card).getPropertyValue('--carousel-card-width').trim(),n=Date.now()-i;if(s&&''!==s&&'auto'!==s)return clearInterval(e),l('CARD_MOD','CSS variable detected after',n,'ms:',s),void t();n>=500&&(clearInterval(e),l('CARD_MOD','CSS variable watch timed out after',500,'ms - using fallback'),t())},20)})}async ne(){for(let t=0;t<5;t++){if(await new Promise(t=>requestAnimationFrame(t)),!this.card.isConnected||!this.card.cardContainer)return l('INIT','Card disconnected during initial width read'),null;const i=this.card.cardContainer.offsetWidth;if(i>0){const e=this.card.cardContainer.offsetHeight;return l('INIT','Initial width acquired:',{width:i,height:e,frames:t+1}),{width:i,height:e}}if(null===this.card.offsetParent)return l('INIT','Element hidden during build - deferring to ResizeObserver'),null}return l('INIT','Initial width still 0 after MAX_FRAMES - using fallback'),null}async ue(){if(!this.card.isConnected||!this.card.cardContainer||!this.card.sliderElement)return void l('INIT','Card disconnected before fade-in');const t=this.card.cardContainer.offsetWidth,i=this.card.cardContainer.offsetHeight;l('INIT','Final pre-fade dimension check:',{currentStored:{width:this.card.slideWidth,height:this.card.slideHeight},actualMeasured:{width:t,height:i}}),(Math.abs(t-this.card.slideWidth)>2||Math.abs(i-this.card.slideHeight)>2)&&(l('INIT','Final dimensions differ from stored - updating before fade-in'),this.card.slideWidth=t,this.card.slideHeight=i,this.card.updateSlider(!1),'carousel'===(this.card.ii.view_mode||'single')?this.oe(t):!this.card.ae&&(this.card.style.setProperty('--single-slide-width',`${t}px`),this.card.sliderElement)&&this.card.sliderElement.querySelectorAll('.slide:not(.carousel-mode)').forEach(i=>{i.style.width=`${t}px`,i.style.minWidth=`${t}px`,i.style.flexBasis=`${t}px`}));const e=this.card.sliderElement;this.card.swipeEffects?.initialize(),e.style.transition='',e.style.opacity='1',l('INIT','Slider revealed (instant), card fully initialized')}Xi(){if(!this.card.ii.state_entity||!this.card.Oi)return this.card.currentIndex;const t=this.card.ii.state_entity,i=this.card.Oi.states[t];if(!i)return l('STATE','State entity not found during build:',t),this.card.currentIndex;const e=i.state;let s=null;if(t.startsWith('input_select.')){if(!i.attributes.options||!Array.isArray(i.attributes.options))return this.card.currentIndex;const t=i.attributes.options.indexOf(e);-1!==t&&t<this.card.visibleCardIndices.length&&(s=t)}else if(t.startsWith('input_number.')){const t=parseInt(e);if(!isNaN(t)){const i=t-1;i>=0&&i<this.card.visibleCardIndices.length&&(s=i)}}return null!==s?(l('STATE',`State sync initial index determined during build: ${s} from entity state: ${e}`),s):this.card.currentIndex}pe(t,i){const e=getComputedStyle(this.card).getPropertyValue('--carousel-card-width').trim();if(l('INIT','Checking for CSS override:',{computedWidth:e,hasValue:!!e,isEmpty:''===e,isAuto:'auto'===e}),e&&''!==e&&'auto'!==e){const s=parseFloat(e),n=(t+i)/(s+i);return l('INIT','Using CSS-overridden card width:',{cardWidth:s.toFixed(2),cardsVisible:n.toFixed(2),source:'card-mod or CSS'}),{cardWidth:s,cardsVisible:Math.max(1.1,n)}}let s;if(l('INIT','No CSS override found, calculating from config'),void 0!==this.card.ii.cards_visible)s=this.card.ii.cards_visible,l('INIT','Using legacy cards_visible approach:',s);else{const e=this.card.ii.card_min_width||200,n=(t+i)/(e+i);s=Math.max(1.1,Math.round(10*n)/10),l('INIT','Using responsive approach:',{minWidth:e,containerWidth:t,cardSpacing:i,rawCardsVisible:n.toFixed(2),finalCardsVisible:s})}return{cardWidth:(t-(s-1)*i)/s,cardsVisible:s}}recalculateCarouselLayout(){if('carousel'!==(this.card.ii.view_mode||'single'))return;const t=this.card.cardContainer?.offsetWidth;t&&(l('INIT','Recalculating carousel layout (resize or card-mod)'),this.oe(t),this.card.updateSlider(!1))}oe(t){const i=Math.max(0,parseInt(this.card.ii.card_spacing))||0,{cardWidth:e,cardsVisible:s}=this.pe(t,i);if(!this.fe(e,s,t))return l('INIT','Carousel dimensions failed validation:',{cardWidth:e,cardsVisible:s,containerWidth:t}),!1;l('INIT','Carousel layout setup (validated):',{containerWidth:t,cardsVisible:s.toFixed(2),cardSpacing:i,cardWidth:e.toFixed(2)});const n=this.card.style.getPropertyValue('--carousel-card-width').trim(),o=getComputedStyle(this.card).getPropertyValue('--carousel-card-width').trim();return!n&&o&&''!==o&&'auto'!==o?l('INIT','Skipping CSS variable set - overridden by card-mod:',o):(this.card.style.setProperty('--carousel-card-width',`${e}px`),l('INIT','Set --carousel-card-width to calculated value:',`${e}px`)),this.card.Ui=e,this.card.Bi=s,this.card.sliderElement.setAttribute('data-view-mode','carousel'),this.card.cardContainer.setAttribute('data-view-mode','carousel'),this.card.cards.forEach(t=>{t.slide&&t.slide.classList.add('carousel-mode')}),!0}fe(t,i,e){return isFinite(t)&&isFinite(i)&&isFinite(e)?t<=0||i<=0||e<=0?(l('INIT','Validation failed: Zero or negative values'),!1):t>1.5*e?(l('INIT','Validation failed: Card width exceeds container significantly'),!1):t<50?(l('INIT','Validation failed: Card width too small (< 50px)'),!1):!(i>20&&(l('INIT','Validation failed: Too many visible cards (> 20)'),1)):(l('INIT','Validation failed: Non-finite numbers detected'),!1)}Ji(t){const i=this.card.currentIndex||0,e=this.card.ii.view_mode||'single',s=this.card.loopMode.isInfiniteMode;l('INIT','Determining visible cards for stagger loading:',{currentIndex:i,viewMode:e,isInfiniteMode:s,totalCardsToLoad:t.length});let n=[];if(s)n=this.ge(i,t,e);else{const t=this.card.visibleCardIndices.length;if('single'===e)n=[i-1,i,i+1].filter(i=>i>=0&&i<t);else if('carousel'===e){const e=this.me(i,t);n=[];for(let t=e.startIndex;t<=e.endIndex;t++)n.push(t)}else n=[i]}const o=[],a=[];t.forEach(t=>{n.includes(t.visibleIndex)?(o.push(t),l('INIT',`Priority card: visibleIndex ${t.visibleIndex}, originalIndex ${t.originalIndex}, isDuplicate: ${t.isDuplicate}`)):a.push(t)}),o.sort((t,e)=>Math.abs(t.visibleIndex-i)-Math.abs(e.visibleIndex-i));const r=[];if('carousel'===e&&o.length>0)r.push(o),l('INIT',`Carousel mode: All ${o.length} priority cards in first batch`);else for(let t=0;t<o.length;t+=3)r.push(o.slice(t,t+3));for(let t=0;t<a.length;t+=3)r.push(a.slice(t,t+3));return l('INIT','Batch creation completed:',{visibleIndices:n,priorityCards:o.map(t=>`${t.visibleIndex}(${t.originalIndex}${t.isDuplicate?'D':''})`),regularCards:a.map(t=>`${t.visibleIndex}(${t.originalIndex}${t.isDuplicate?'D':''})`),totalBatches:r.length,firstBatchSize:r[0]?.length||0}),r}ge(t,i,e){const s=this.card.visibleCardIndices.length,n=this.card.loopMode.getDuplicateCount(),o=n+t;l('INIT','Infinite mode position mapping:',{virtualCurrentIndex:t,realDOMPosition:o,duplicateCount:n,totalRealCards:s,totalCardsInDOM:i.length});let a=[];if('single'===e)a=[o-1,o,o+1].filter(t=>t>=0&&t<i.length);else if('carousel'===e){const t=this.ve();let e=o,s=Math.min(i.length-1,e+Math.ceil(t)-1);s>=i.length&&(s=i.length-1,e=Math.max(0,s-Math.ceil(t)+1));for(let t=e;t<=s;t++)a.push(t);l('INIT','Infinite carousel visible range calculation:',{cardsVisible:t,realDOMPosition:o,startDOM:e,endDOM:s,visibleDOMPositions:a,calculation:`Start from DOM ${o}, show ${Math.ceil(t)} cards: ${e} to ${s}`})}else a=[o];const r=[];return a.forEach(t=>{if(t>=0&&t<i.length){const e=i[t];e&&r.push(e.visibleIndex)}}),r}ve(){if(void 0!==this.card.ii.cards_visible)return this.card.ii.cards_visible;const t=this.card.cardContainer?.offsetWidth||300,i=this.card.ii.card_min_width||200,e=Math.max(0,parseInt(this.card.ii.card_spacing))||0,s=Math.max(1,(t+e)/(i+e));return Math.max(1.1,Math.round(10*s)/10)}me(t,i){const e=this.ve();if(i<=Math.floor(e))return{startIndex:0,endIndex:i-1,cardsVisible:e};let s=t-Math.floor(e/2);s<0&&(s=0);let n=s+Math.ceil(e)-1;return n>=i&&(n=i-1,s=Math.max(0,n-Math.ceil(e)+1)),{startIndex:Math.max(0,Math.floor(s)),endIndex:Math.min(n,i-1),cardsVisible:e}}async qi(t,i,e,s=null){l('INIT',`Loading carousel ${e} content:`,t.length);const n=t.map(async t=>{try{const e=this.card.cards.find(i=>i.visibleIndex===t.visibleIndex&&i.originalIndex===t.originalIndex);if(!e||e.contentLoaded)return null;const n=await i.createCardElement(t.config);return s&&this.card.Fi!==s?(l('INIT',`Discarding carousel card ${t.visibleIndex} from stale build`),null):(this.card.Oi&&(n.hass=this.card.Oi),'picture-elements'===t.config.type&&(n.setAttribute('data-swipe-card-picture-elements','true'),e.slide.setAttribute('data-has-picture-elements','true')),requestAnimationFrame(()=>{try{if('todo-list'===t.config.type){const t=n.shadowRoot?.querySelector('ha-textfield'),i=t?.shadowRoot?.querySelector('input');i&&(i.enterKeyHint='done')}}catch(t){console.warn('Error applying post-creation logic:',t)}}),e.slide.appendChild(n),e.element=n,e.contentLoaded=!0,Nt(n,t.config?.uix,t.config,'card'),n)}catch(e){l('ERROR',`Error loading carousel card ${t.visibleIndex}:`,e);const s=this.card.cards.find(i=>i.visibleIndex===t.visibleIndex&&i.originalIndex===t.originalIndex);if(s){s.error=!0,s.contentLoaded=!0;try{const n=await i.createErrorCardElement({type:'error',error:`Failed to create card: ${e.message}`,origConfig:t.config},this.card.Oi);s.slide.appendChild(n),s.element=n}catch(t){console.error('Failed to create error card:',t)}}return null}});await Promise.allSettled(n),l('INIT',`Carousel ${e} content loading completed`)}Gi(){if(!this.card.isConnected||!this.card.sliderElement)return void l('ERROR','_insertLoadedCardsIntoDom: Card disconnected or sliderElement is null, skipping',{connected:this.card.isConnected,hasSlider:!!this.card.sliderElement});const t=this.card.cards.filter(t=>t&&t.slide&&!t.slide.parentElement).sort((t,i)=>t.visibleIndex-i.visibleIndex);t.forEach(t=>{if(!this.card.sliderElement)return void l('ERROR','Slider element disappeared during insertion loop');t.slide.setAttribute('data-index',t.originalIndex),t.slide.setAttribute('data-visible-index',t.visibleIndex),t.isDuplicate&&t.slide.setAttribute('data-duplicate','true'),t.config?.type&&t.slide.setAttribute('data-card-type',t.config.type),this.card.swipeEffects?.usesStackedMode()&&(t.slide.style.gridColumn='1',t.slide.style.gridRow='1',t.slide.style.opacity='0',t.slide.style.zIndex='0');const i=Array.from(this.card.sliderElement.children);let e=i.length;for(let s=0;s<i.length;s++)if(parseInt(i[s].getAttribute('data-visible-index')||'0')>t.visibleIndex){e=s;break}if(e===i.length?this.card.sliderElement.appendChild(t.slide):this.card.sliderElement.insertBefore(t.slide,i[e]),this.card.swipeEffects?.usesStackedMode()){const i=Array.from(this.card.sliderElement.children).indexOf(t.slide);this.card.swipeEffects.applyStackedTransformToNewSlide(t.slide,i)}this.card.autoHeight?.enabled&&this.card.autoHeight.observeSlide(t.slide,t.visibleIndex)})}ji(){let t=this.card,i=10;for(;t&&i>0&&(t=t.parentElement||t.parentNode?.host,t);){const e=t.tagName?.toLowerCase();if('layout-card'===e||'masonry-layout'===e||'horizontal-layout'===e||'vertical-layout'===e||'grid-layout'===e||'hui-masonry-view'===e)return l('INIT',`Ã¢Å“â€¦ DETECTED PARENT LAYOUT CONTAINER: ${e}`),this.card.setAttribute('data-in-layout-container',e),!0;i--}return this.card.removeAttribute('data-in-layout-container'),!1}}class Rt{constructor(t){this.card=t,this.we=null,this.be=null,this.Ie=null,this.ye=!1,this.Ee=null,this.Se=this.xe.bind(this)}manage(){if(this.card.initialized&&this.card.isConnected)if(this.stop(),this.card.ii.state_entity&&this.card.Oi){const t=this.card.ii.state_entity;this.card.templateEvaluator?.isTemplate(t)?(this.we=this.card.templateEvaluator.getEvaluatedValue('state_entity',this.card.Oi),l('STATE',`Evaluated state_entity template: "${t}" => "${this.we}"`)):this.we=t,this.we&&this.Te()?(l('STATE','State synchronization enabled for entity:',this.we),this.Ce()):(l('STATE','Invalid or missing entity:',this.we),this.we=null)}else l('STATE','State synchronization disabled',{hasEntity:!!this.card.ii.state_entity,hasHass:!!this.card.Oi})}stop(){this.Ee&&(clearTimeout(this.Ee),this.Ee=null),this.we=null,this.be=null,this.Ie=null,this.ye=!1}onCardNavigate(t){if(!this.we||!this.card.Oi||this.ye)return;const i=this.$e(t);if(null===i)return;const e=this.card.Oi.states[this.we];if(e&&e.state===i)l('STATE','Entity already at correct state:',i);else{l('STATE',`Updating entity ${this.we} to:`,i),this.ye=!0;try{'input_select'===this.be?this.card.Oi.callService('input_select','select_option',{entity_id:this.we,option:i}):'input_number'===this.be&&this.card.Oi.callService('input_number','set_value',{entity_id:this.we,value:i}),this.Ie=i,setTimeout(()=>{this.ye=!1},500)}catch(t){l('ERROR','Failed to update entity:',t),this.ye=!1}}}Te(){if(!this.card.Oi||!this.we)return!1;const t=this.card.Oi.states[this.we];if(!t)return l('STATE','Entity not found:',this.we),!1;if(this.we.startsWith('input_select.')){if(this.be='input_select',!t.attributes.options||!Array.isArray(t.attributes.options))return l('STATE','input_select entity has no options:',this.we),!1}else{if(!this.we.startsWith('input_number.'))return l('STATE','Entity is not input_select or input_number:',this.we),!1;this.be='input_number'}return!0}Ce(){if(!this.card.Oi||!this.we)return;const t=this.card.Oi.states[this.we];if(!t)return;this.Ie=t.state;const i=this.Me(t.state);null===i||i!==this.card.currentIndex?null!==i&&i!==this.card.currentIndex&&(l('STATE',`Initial sync: setting card to index ${i} from entity state:`,t.state),this.card.ii.enable_auto_swipe&&this.card.autoSwipe?.pause(2e3),this.card.goToSlide(i,1,!1)):l('STATE',`Initial sync: card already at correct position ${i}, skipping initial positioning`)}xe(){if(!this.card.Oi||!this.we||this.ye)return;const t=this.card.Oi.states[this.we];if(!t)return;const i=t.state;if(i===this.Ie)return;l('STATE',`Entity ${this.we} changed from "${this.Ie}" to "${i}"`),this.Ie=i;const e=this.Me(i);null!==e&&e!==this.card.currentIndex&&(l('STATE',`Navigating to card index ${e} from entity change`),this.card.ii.enable_auto_swipe&&this.card.autoSwipe?.pause(5e3),this.card.goToSlide(e))}Me(t){if('input_select'===this.be){const i=this.card.Oi.states[this.we];if(!i||!i.attributes.options)return null;const e=i.attributes.options,s=e.indexOf(t);return-1===s?(l('STATE',`Option "${t}" not found in input_select options:`,e),null):s>=this.card.visibleCardIndices.length?(l('STATE',`Option index ${s} exceeds visible cards count ${this.card.visibleCardIndices.length}`),null):s}if('input_number'===this.be){const i=parseInt(t);if(isNaN(i))return null;const e=i-1;return e<0||e>=this.card.visibleCardIndices.length?(l('STATE',`Index ${e} is outside visible cards range [0, ${this.card.visibleCardIndices.length-1}]`),null):e}return null}$e(t){if(t<0||t>=this.card.visibleCardIndices.length)return null;if('input_select'===this.be){const i=this.card.Oi.states[this.we];if(!i||!i.attributes.options)return null;const e=i.attributes.options;return t>=e.length?(l('STATE',`Card index ${t} exceeds input_select options count ${e.length}`),null):e[t]}return'input_number'===this.be?t+1:null}onHassChange(t,i){if(!this.we||!i)return;const e=t?.states[this.we],s=i.states[this.we];if(!s)return l('STATE','Configured entity no longer exists:',this.we),void this.stop();e&&e.state===s.state||(this.Ee&&clearTimeout(this.Ee),this.Ee=setTimeout(()=>{this.xe(),this.Ee=null},100))}}class Dt{constructor(t){this.card=t,this.slideObservers=new Map,this.cardHeights={},this.enabled=!1}initialize(){this.enabled=!0===this.card.ii.auto_height&&'single'===this.card.ii.view_mode&&'horizontal'===this.card.ii.swipe_direction&&'infinite'!==this.card.ii.loop_mode,this.enabled?(this.card.setAttribute('data-auto-height',''),l('AUTO_HEIGHT','Auto height enabled')):(this.card.removeAttribute('data-auto-height'),this.cleanup())}observeSlide(t,i){if(!this.enabled||!t)return;if(this.slideObservers.has(i))return;const e=new ResizeObserver(t=>{for(const e of t){const t=e.contentRect.height;if(t<10)return void l('AUTO_HEIGHT',`Card ${i} height too small (${t}px), waiting for content to load`);this.cardHeights[i]!==t&&(l('AUTO_HEIGHT',`Card ${i} height changed to ${t}px`),this.cardHeights[i]=t,i===this.card.currentIndex&&this.updateContainerHeight(t))}});e.observe(t),this.slideObservers.set(i,e),l('AUTO_HEIGHT',`Now observing slide ${i}`),this.Ae(t,i)}async Ae(t,i){const e=t.querySelector('*');if(!e)return;const s=e.tagName.toLowerCase();if(s.includes('-'))try{await customElements.whenDefined(s),l('AUTO_HEIGHT',`Custom element ${s} is now defined for card ${i}`)}catch(t){l('AUTO_HEIGHT',`Could not wait for custom element ${s}:`,t)}await new Promise(t=>requestAnimationFrame(t));const n=t.offsetHeight;n>=10&&this.cardHeights[i]!==n&&(l('AUTO_HEIGHT',`Initial height for card ${i}: ${n}px`),this.cardHeights[i]=n,i===this.card.currentIndex&&this.updateContainerHeight(n))}updateContainerHeight(t){if(this.enabled&&this.card.cardContainer){if(!t||0===t){if(this.card.cardContainer.offsetHeight>0)return void l('AUTO_HEIGHT','Invalid height, keeping current height');t=250,l('AUTO_HEIGHT','Using fallback height: 250px')}this.card.cardContainer.style.height=`${t}px`,l('AUTO_HEIGHT',`Container height set to ${t}px`)}}updateForCurrentCard(){if(!this.enabled)return;const t=this.cardHeights[this.card.currentIndex];t&&t>0?this.updateContainerHeight(t):l('AUTO_HEIGHT',`No height cached for card ${this.card.currentIndex}, waiting for ResizeObserver`)}cleanup(){this.slideObservers.forEach((t,i)=>{t.disconnect(),l('AUTO_HEIGHT',`Stopped observing slide ${i}`)}),this.slideObservers.clear(),this.cardHeights={},this.card.cardContainer&&(this.card.cardContainer.style.height='')}}class Lt{constructor(t){this.card=t}calculateTransform(t){if(!this.card.cards||0===this.card.cards.length)return 0;const i=this.card.cardContainer.offsetWidth,e=Math.max(0,parseInt(this.card.ii.card_spacing))||0;let s,n;if(this.card.Ui&&this.card.Bi)s=this.card.Ui,n=this.card.Bi,l('SWIPE','Using stored carousel dimensions:',{cardWidth:s.toFixed(2),cardsVisible:n.toFixed(2)});else{const t=getComputedStyle(this.card).getPropertyValue('--carousel-card-width').trim();t&&''!==t&&'auto'!==t?(s=parseFloat(t),n=(i+e)/(s+e)):(n=void 0!==this.card.ii.cards_visible?this.card.ii.cards_visible:Math.max(1.1,Math.round((i+e)/((this.card.ii.card_min_width||200)+e)*10)/10),s=(i-(n-1)*e)/n),l('SWIPE','Recalculated carousel dimensions:',{cardWidth:s.toFixed(2),cardsVisible:n.toFixed(2)})}const o=this.card.visibleCardIndices.length,a=this.card.ii.loop_mode||'none',r='center'===this.card.ii.carousel_alignment;if(!r&&o<=Math.floor(n)&&'infinite'!==this.card.ii.loop_mode)return l('SWIPE','Insufficient cards for carousel transform, staying at position 0'),0;let d;if('infinite'===a&&o>1){const i=this.card.loopMode.getDuplicateCount();d=t+i,l('SWIPE','Carousel infinite mode: logical index',t,'-> DOM position',d,'duplicateCount:',i)}else d=Math.min(t,Math.max(0,o-1));const h=s+e;let c=d*h;return r&&(c-=(i-s)/2),l('SWIPE','Carousel transform calculation:',{targetIndex:t,domPosition:d,totalCards:o,cardsVisible:n.toFixed(2),cardWidth:s.toFixed(2),cardSpacing:e,moveDistance:h.toFixed(2),transform:c.toFixed(2),loopMode:a,centered:r}),c}updateSliderPosition(t,i=!0){if(!this.card.sliderElement)return;const e=this.calculateTransform(t);if(i&&'free'===this.card.ii.swipe_behavior&&this.card.Oe>1){const t=this.card.swipeBehavior.calculateAnimationDuration(this.card.Oe),i=this.card.swipeBehavior.getEasingFunction(this.card.Oe);this.card.sliderElement.style.transition=`transform ${t}ms ${i}`,l('SWIPE',`Carousel multi-card animation: ${this.card.Oe} cards, ${t}ms duration, easing: ${i}`)}else this.card.sliderElement.style.transition=this.card.ti(i);this.card.sliderElement.style.transform=`translateX(${-e}px)`,l('SWIPE',`Carousel slider updated to index ${t}, transform: -${e.toFixed(2)}px`)}handleLoopback(t){return this.card.loopMode.handleNavigation(t,!0)}_e(t){const i=this.card.visibleCardIndices.length;return t<0?i-1:t>=i?0:t}}class Pt{constructor(t){this.card=t,this.isInfiniteMode=!1,this.virtualIndex=0,this.realIndex=0,this.totalRealCards=0,this.Ne=null,this.ke=null}getMode(){return this.card.ii.loop_mode||'none'}isInfinite(){return'infinite'===this.getMode()&&this.card.visibleCardIndices.length>1}initialize(){this.isInfiniteMode=this.isInfinite(),this.isInfiniteMode?l('LOOP','Infinite loop mode initialized for',this.card.visibleCardIndices.length,'visible cards'):(this.virtualIndex=0,this.realIndex=0,this.totalRealCards=0,'infinite'===this.getMode()&&l('LOOP','Infinite loop mode disabled - only',this.card.visibleCardIndices.length,'visible card(s)'))}getDuplicateCount(){if('infinite'!==this.getMode()||this.card.visibleCardIndices.length<=1)return 0;const t=this.card.ii.swipe_behavior||'single';if('single'===(this.card.ii.view_mode||'single'))return'free'===t?4:1;{const i=this.card.ii.cards_visible||this.card.ai(),e=Math.max(5,Math.ceil(2*i));return'free'===t?e+Math.min(5,Math.ceil(i)):e}}prepareCardsForLoading(t,i){const e=[];if(!this.isInfiniteMode)return t.forEach((t,s)=>{e.push({config:i[t],visibleIndex:s,originalIndex:t,isDuplicate:!1})}),e;const s=this.getDuplicateCount(),n=t.length;for(let o=0;o<s;o++){const a=o-s;let r;r=a<0?(a%n+n)%n:a%n;const d=t[r];e.push({config:i[d],visibleIndex:o-s,originalIndex:d,isDuplicate:!0})}t.forEach((t,s)=>{e.push({config:i[t],visibleIndex:s,originalIndex:t,isDuplicate:!1})});for(let o=0;o<s;o++){const s=t[o%n];e.push({config:i[s],visibleIndex:n+o,originalIndex:s,isDuplicate:!0})}return this.totalRealCards=e.length,e}virtualToRealIndex(t){if(!this.isInfiniteMode)return t;const i=this.card.visibleCardIndices.length;return 0===i?0:this.getDuplicateCount()+(t%i+i)%i}realToVirtualIndex(t){return this.isInfiniteMode?0===this.card.visibleCardIndices.length?0:t-this.getDuplicateCount():t}isOnDuplicateCard(t=this.card.currentIndex){if(!this.isInfiniteMode)return!1;const i=this.card.visibleCardIndices.length,e=this.getDuplicateCount();return t<e||t>=e+i}getCorrespondingRealIndex(t=this.card.currentIndex){if(!this.isInfiniteMode||!this.isOnDuplicateCard(t))return t;const i=this.card.visibleCardIndices.length,e=this.getDuplicateCount();return t<e?e+i-(e-t):e+(t-(e+i))}shouldPerformSeamlessJump(t=this.card.currentIndex){if(!this.isInfiniteMode)return!1;const i=this.card.visibleCardIndices.length;if('carousel'===(this.card.ii.view_mode||'single')){if('free'===(this.card.ii.swipe_behavior||'single')){const e=this.getDuplicateCount(),s=Math.floor(.3*e);return t-0<s||i-1-t<s}return t>=i||t<0}return t<0||t>=i}scheduleSeamlessJump(t,i=null){if(this.Re(),!this.shouldPerformSeamlessJump(t))return void l('LOOP',`Seamless jump not needed for target index ${t}`);let e;if(null!==i)e=i;else try{const t=this.card.ti(!0);l('LOOP','DEBUG: transitionStyle =',t);const i=t.match(/transform\s+([\d.]+)([a-z]*)\s/);if(l('LOOP','DEBUG: regex match =',i),i){const t=parseFloat(i[1]),s=i[2]||'s';l('LOOP','DEBUG: parsed duration =',t,'unit =',s),e='s'===s?1e3*t:'ms'===s?t:400,l('LOOP','DEBUG: final transitionDuration =',e)}else l('LOOP','DEBUG: regex match failed, using fallback'),e=400}catch(t){l('LOOP','Error reading CSS transition duration:',t),e=400}l('LOOP',`Scheduling seamless jump for target index ${t} after ${e}ms animation`);let s=!1;const n=()=>{if(!s){if(s=!0,this.Ne&&(clearTimeout(this.Ne),this.Ne=null),!this.card.isConnected||this.card.building)return l('LOOP','Seamless jump cancelled - card disconnected or building'),void(this.card.si=!1);requestAnimationFrame(()=>{try{const i=this.card.currentIndex;if(l('LOOP',`Seamless jump executing: target was ${t}, actual current is ${i}`),!this.shouldPerformSeamlessJump(i))return l('LOOP',`Seamless jump cancelled - conditions changed (target: ${t}, actual: ${i})`),void(this.card.si=!1);const e=this.card.visibleCardIndices.length;let s;if(i<0)s=e+i%e,s>=e&&(s=e-1);else{if(!(i>=e))return l('LOOP',`Seamless jump not needed - already in valid position (${i})`),void(this.card.si=!1);s=i%e}l('LOOP',`Performing seamless jump: virtual ${i} â†’ real ${s}`),this.card.si=!0,this.card.sliderElement&&(this.card.sliderElement.style.transition='none'),this.card.currentIndex=s,this.card.updateSlider(!1),requestAnimationFrame(()=>{try{this.card.sliderElement&&(this.card.sliderElement.style.transition=this.card.ti(!0)),l('LOOP',`Seamless jump completed - now at real position ${s}, ready for continued scrolling`)}catch(t){l('ERROR','Error in seamless jump transition restoration:',t)}finally{this.card.si=!1}})}catch(t){l('ERROR','Error during seamless jump execution:',t),this.card.si=!1}})}},o=t=>{t.target!==this.card.sliderElement||'transform'!==t.propertyName||s||(l('LOOP','Transform transition ended, executing seamless jump'),this.card.sliderElement.removeEventListener('transitionend',o),this.ke=null,setTimeout(n,10))};this.card.sliderElement&&e>0&&(this.ke=o,this.card.sliderElement.addEventListener('transitionend',o));const a=Math.max(100,.2*e);this.Ne=setTimeout(()=>{this.ke&&this.card.sliderElement&&(this.card.sliderElement.removeEventListener('transitionend',this.ke),this.ke=null),s||(l('LOOP','Executing seamless jump via timeout fallback'),n())},e+a)}Re(){this.Ne&&(clearTimeout(this.Ne),this.Ne=null,this.card.si&&(l('LOOP','Clearing seamless jump flag during cancellation'),this.card.si=!1),this.ke&&this.card.sliderElement&&(this.card.sliderElement.removeEventListener('transitionend',this.ke),this.ke=null),l('LOOP','Cancelled pending seamless jump and cleaned up event listeners'))}handleNavigation(t,i=!1){const e=this.getMode(),s=this.card.visibleCardIndices.length;if('infinite'===e)return t;if(!('loopback'===e&&s>1))return Math.max(0,Math.min(t,s-1));if(i){if(t<0)return s-1;if(t>=s)return 0}else{if(t<0)return s-1;if(t>=s)return 0}return t}getWrappedIndexForPagination(t=this.card.currentIndex){if(!this.isInfiniteMode)return t;const i=this.card.visibleCardIndices.length;return(t%i+i)%i}handleAutoSwipeNavigation(t,i){const e=this.getMode(),s=this.card.visibleCardIndices.length;if('infinite'===e)return{nextIndex:t+1,shouldChangeDirection:!1};if('loopback'===e){let i=t+1;return i>=s&&(i=0),{nextIndex:i,shouldChangeDirection:!1}}{let e=t,n=!1;return 1===i?t>=s-1?(n=!0,e=t-1):e=t+1:t<=0?(n=!0,e=t+1):e=t-1,e=Math.max(0,Math.min(e,s-1)),{nextIndex:e,shouldChangeDirection:n}}}handleSwipeNavigation(t,i){const e=this.getMode(),s=this.card.visibleCardIndices.length;let n=t;return i>0?(n=t-Math.abs(i),n<0&&('none'!==e&&s>1?'infinite'===e||(n=s+n,n<0&&(n=s-1)):n=0)):i<0&&(n=t+Math.abs(i),n>=s&&('none'!==e&&s>1?'infinite'===e||(n-=s,n>=s&&(n=0)):n=s-1)),l('LOOP','Swipe navigation:',{currentIndex:t,skipCount:i,mode:e,totalVisibleCards:s,nextIndex:n}),n}}class Ht{constructor(t){this.card=t}getBehavior(){return this.card.ii.swipe_behavior||'single'}calculateSkipCount(t,i,e,s){if('single'===s)return 1;let n;if('carousel'===(this.card.ii.view_mode||'single')){const t=this.card.ii.cards_visible||this.card.ai(),i=Math.max(0,parseInt(this.card.ii.card_spacing))||0;n=(this.card.slideWidth-(t-1)*i)/t}else n='horizontal'===this.card.Qt?this.card.slideWidth:this.card.slideHeight;const o=Math.max(1,Math.round(i/n));if(t>.8){let s=1;t>.8&&(s=2),t>1.5&&(s=3),t>2.5&&(s=4);const a=Math.max(s,o);return l('SWIPE','Quick swipe detected:',{velocity:t.toFixed(3),distance:i.toFixed(0),unitSize:n.toFixed(0),velocityBasedSkip:s,distanceBasedSkip:o,result:a}),Math.min(a,Math.min(4,e-1))}return l('SWIPE','Controlled drag detected:',{velocity:t.toFixed(3),distance:i.toFixed(0),unitSize:n.toFixed(0),distanceBasedSkip:o}),Math.min(o,e-1)}calculateAnimationDuration(t){const i=this.card.visibleCardIndices.length;if(i<=3){const i=Math.min(800+500*(t-1),2400);return l('SWIPE','Animation duration (few cards):',t,'cards,',i+'ms'),i}const e=200*(t-1),s=Math.min(1200+50*i,2e3),n=Math.min(600+e,s);return l('SWIPE','Animation duration (many cards):',{skipCount:t,totalCards:i,baseDuration:600,extraDuration:e,maxDuration:s,finalDuration:n+'ms'}),n}getEasingFunction(t){return 1===t?'ease-out':'cubic-bezier(0.25, 0.46, 0.45, 0.94)'}}const Vt={slide:{name:'Slide',easing:'ease-out',description:'Default smooth slide transition'},bounce:{name:'Bounce',easing:'cubic-bezier(0.68, -0.55, 0.265, 1.55)',description:'Elastic bounce with overshoot'},spring:{name:'Spring',easing:'cubic-bezier(0.175, 0.885, 0.32, 1.275)',description:'Gentle spring effect'},instant:{name:'Instant',easing:'linear',duration:0,description:'No animation, instant switch'},fade:{name:'Fade',easing:'ease-in-out',description:'Crossfade between cards',stackedMode:!0},flip:{name:'Flip',easing:'ease-in-out',description:'3D card flip',stackedMode:!0,use3D:!0},coverflow:{name:'Coverflow',easing:'ease-out',description:'3D coverflow effect',stackedMode:!0,use3D:!0},creative:{name:'Creative',easing:'cubic-bezier(0.25, 1, 0.5, 1)',description:'Slide with rotation and scale',stackedMode:!0},cards:{name:'Cards',easing:'ease-out',description:'Stacked cards effect',stackedMode:!0},reveal:{name:'Reveal',easing:'ease-out',description:'Wipe reveal transition',stackedMode:!0,usesClipPath:!0},zoom:{name:'Zoom',easing:'ease-out',description:'Zoom in/out transition',stackedMode:!0},swing:{name:'Swing',easing:'ease-in-out',description:'Swing door effect',stackedMode:!0,use3D:!0}};class zt{constructor(t){this.card=t,this.De=!1,this.Le=null}getEffect(){const t=this.card.ii.swipe_effect||'slide',i=Vt[t]||Vt.slide;return this.Pe(t,i)?i:Vt.slide}getEffectName(){const t=this.card.ii.swipe_effect||'slide';return this.Pe(t,Vt[t]||Vt.slide)?t:'slide'}Pe(t,i){return'slide'===t||'carousel'!==(this.card.ii.view_mode||'single')&&(!i.stackedMode||'free'!==(this.card.ii.swipe_behavior||'single')&&'vertical'!==(this.card.ii.swipe_direction||'horizontal'))}getEasing(){if(this.card.isConnected){const t=getComputedStyle(this.card).getPropertyValue('--simple-swipe-card-transition-easing').trim();if(t)return t}return this.getEffect().easing}getCustomDuration(){const t=this.getEffect();return void 0!==t.duration?t.duration:null}isEffectAvailable(){const t=this.getEffect(),i=this.getEffectName();if('slide'===i)return!0;if('carousel'===(this.card.ii.view_mode||'single'))return this.He&&this.He===i||(l('EFFECTS',`Effect "${i}" is not available in carousel mode. Using "slide" effect instead.`),this.He=i),!1;if(!t.stackedMode)return!0;const e=this.card.ii.swipe_direction||'horizontal';return'free'===(this.card.ii.swipe_behavior||'single')?(this.Ve&&this.Ve===i||(l('EFFECTS',`Effect "${i}" is not available with free swipe behavior. Using "slide" effect instead.`),this.Ve=i),!1):'vertical'!==e||(this.ze&&this.ze===i||(l('EFFECTS',`Effect "${i}" is not available in vertical swipe mode. Using "slide" effect instead.`),this.ze=i),!1)}usesStackedMode(){const t=this.getEffect();return!!this.isEffectAvailable()&&!0===t.stackedMode}uses3D(){const t=this.getEffect();return!!this.isEffectAvailable()&&!0===t.use3D}needsSlideTransforms(){return this.usesStackedMode()}initialize(){const t=this.getEffectName();this.Le&&this.Le!==t&&(this.resetEffects(),this.De=!1),this.Le=t,this.usesStackedMode()?(this.Fe(),this.uses3D()&&this.Ue(),this.card.isConnected&&(this.Be(this.card.currentIndex),this.De=!0,l('EFFECTS',`Swipe effects initialized for ${t} mode`))):this.De=!0}applyStackedTransformToNewSlide(t,i){if(!this.usesStackedMode()||!this.De)return;t.style.gridColumn='1',t.style.gridRow='1';const e='infinite'===(this.card.ii.loop_mode||'none')&&this.card.visibleCardIndices.length>1?this.card.loopMode.getDuplicateCount():0,s=i-(this.card.currentIndex+e),n=this.getEffectName();t.style.transition='none',this.We(t,s,n)}Fe(){const t=this.card.sliderElement?.querySelectorAll('.slide');t&&(t.forEach(t=>{t.style.gridColumn='1',t.style.gridRow='1',t.style.opacity||(t.style.opacity='0'),t.style.zIndex||(t.style.zIndex='0')}),this.card.sliderElement&&(this.card.sliderElement.style.position='relative',this.card.sliderElement.style.overflow='hidden',this.card.sliderElement.style.display='grid',this.card.sliderElement.style.gridTemplateColumns='1fr',this.card.sliderElement.style.gridTemplateRows='1fr'),l('EFFECTS','Stacked layout setup complete'))}Ue(){if(!this.card.cardContainer)return;this.card.cardContainer.style.perspective='1200px',this.card.cardContainer.style.perspectiveOrigin='center center',this.card.sliderElement&&(this.card.sliderElement.style.transformStyle='preserve-3d');const t=this.card.sliderElement?.querySelectorAll('.slide'),i=this.getEffectName();t?.forEach(t=>{t.style.transformStyle='preserve-3d',t.style.backfaceVisibility='flip'===i?'hidden':'visible'}),l('EFFECTS','3D container setup complete')}Be(t){const i=this.card.sliderElement?.querySelectorAll('.slide');if(!i||0===i.length)return;const e=this.getEffectName(),s=t+('infinite'===(this.card.ii.loop_mode||'none')&&this.card.visibleCardIndices.length>1?this.card.loopMode.getDuplicateCount():0);i.forEach((t,i)=>{const n=i-s;t.style.transition='none',this.We(t,n,e)}),l('EFFECTS',`Applied immediate transforms, active index: ${t}`)}We(t,i,e,s=null){const n=Math.abs(i),o=null!==s?s:i;switch(e){case'fade':this.Ye(t,i,n);break;case'flip':this.je(t,i,n,o);break;case'coverflow':this.Ge(t,i,n,o);break;case'creative':this.Je(t,i,n);break;case'cards':this.qe(t,i,n);break;case'reveal':this.Xe(t,i,n,o);break;case'zoom':this.Ze(t,i,n);break;case'swing':this.Ke(t,i,n,o);break;default:t.style.opacity='',t.style.transform='',t.style.zIndex='',t.style.clipPath=''}}Ye(t,i,e){e>1?(t.style.opacity='0',t.style.zIndex='0'):0===e?(t.style.opacity='1',t.style.zIndex='2'):(t.style.opacity=String(Math.max(0,1-e)),t.style.zIndex='1'),t.style.transform=''}je(t,i,e,s=null){const n=-180*i;e>1?(t.style.opacity='0',t.style.transform='rotateY(0deg)',t.style.zIndex='0'):(t.style.opacity=e<.5?'1':'0',t.style.transform=`rotateY(${n}deg)`,t.style.zIndex=e<.5?'2':'1')}Ge(t,i,e,s=null){if(e>2)return t.style.opacity='0',t.style.transform='',void(t.style.zIndex='0');const n=-45*i,o=40*i,a=100*-e,r=1-.15*e;t.style.opacity=String(Math.max(0,1-.3*e)),t.style.transform=`translateX(${o}%) translateZ(${a}px) rotateY(${n}deg) scale(${r})`,t.style.zIndex=String(10-Math.round(e))}Je(t,i,e){if(e>2)return t.style.opacity='0',t.style.transform='',void(t.style.zIndex='0');const s=100*i,n=-15*i,o=1-.2*e;t.style.opacity=String(Math.max(0,1-.5*e)),t.style.transform=`translateX(${s}%) rotate(${n}deg) scale(${o})`,t.style.zIndex=String(10-Math.round(e))}qe(t,i,e){if(e>3)return t.style.opacity='0',t.style.transform='',void(t.style.zIndex='0');const s=i>0?100:10*i,n=i<=0?8*e:0,o=i<=0?1-.05*e:1,a=i<=0?2*i:0;t.style.opacity=String(Math.max(0,i<=0?1-.2*e:1)),t.style.transform=`translateX(${s}%) translateY(${n}px) scale(${o}) rotate(${a}deg)`,t.style.zIndex=String(10-Math.round(e))}Xe(t,i,e,s=null){if(e>1)return t.style.opacity='0',t.style.transform='',t.style.clipPath='',void(t.style.zIndex='0');if(0===e)return t.style.opacity='1',t.style.clipPath='inset(0 0 0 0)',t.style.zIndex='2',void(t.style.transform='');const n=null!==s?s:i;if(n<=0&&i<0){const i=100*e;t.style.opacity='1',t.style.clipPath=`inset(0 ${i}% 0 0)`,t.style.zIndex='2'}else if(n>=0&&i>0){const i=100*e;t.style.opacity='1',t.style.clipPath=`inset(0 0 0 ${i}%)`,t.style.zIndex='2'}else t.style.opacity='1',t.style.clipPath='inset(0 0 0 0)',t.style.zIndex='1';t.style.transform=''}Ze(t,i,e){if(e>1)return t.style.opacity='0',t.style.transform='scale(1)',void(t.style.zIndex='0');if(0===e)return t.style.opacity='1',t.style.transform='scale(1)',void(t.style.zIndex='2');if(i<0){const i=1-.3*e;t.style.opacity=String(Math.max(0,1-e)),t.style.transform=`scale(${Math.max(.7,i)})`,t.style.zIndex='1'}else{const i=.7+.3*(1-e);t.style.opacity=String(Math.max(0,1-e)),t.style.transform=`scale(${i})`,t.style.zIndex='2'}}Ke(t,i,e,s=null){if(e>1)return t.style.opacity='0',t.style.transform='rotateY(0deg)',void(t.style.zIndex='0');if(0===e)return t.style.opacity='1',t.style.transform='rotateY(0deg)',t.style.transformOrigin='center center',void(t.style.zIndex='2');const n=null!==s?s:i;if(Math.abs(n)<.1){const s=90*i,n=i<0?'100%':'0%';t.style.opacity=String(Math.max(0,1-.5*e)),t.style.transform=`rotateY(${s}deg)`,t.style.transformOrigin=`${n} center`,t.style.zIndex='2'}else{const i=(n>0?-90:90)*e,s=n>0?'0%':'100%';t.style.opacity=String(Math.max(.5,1-.3*e)),t.style.transform=`rotateY(${i}deg)`,t.style.transformOrigin=`${s} center`,t.style.zIndex='1'}}applyEffect(t,i){if(!this.needsSlideTransforms())return;if(this.usesStackedMode()&&(this.Fe(),this.uses3D()&&this.Ue()),!i)return void this.Be(t);const e=this.card.sliderElement?.querySelectorAll('.slide');if(!e||0===e.length)return;const s=this.getEffectName(),n=t+('infinite'===(this.card.ii.loop_mode||'none')&&this.card.visibleCardIndices.length>1?this.card.loopMode.getDuplicateCount():0),o=this.Qe(),a=this.getEasing(),r='reveal'===s?`transform ${o}ms ${a}, opacity ${o}ms ${a}, clip-path ${o}ms ${a}`:`transform ${o}ms ${a}, opacity ${o}ms ${a}`;e.forEach((t,e)=>{const o=e-n;t.style.transition=i?r:'none',this.We(t,o,s)}),l('EFFECTS',`Applied ${s} effect, active index: ${t}, animate: ${i}`)}applySwipeProgress(t,i){if(!this.needsSlideTransforms())return;const e=this.card.sliderElement?.querySelectorAll('.slide');if(!e||0===e.length)return;const s=this.getEffectName(),n=i+('infinite'===(this.card.ii.loop_mode||'none')?this.card.loopMode.getDuplicateCount():0);e.forEach((i,e)=>{i.style.transition='none';const o=e-n;this.We(i,o+t,s,o)})}getSliderTransform(t){return this.usesStackedMode()?'translate3d(0, 0, 0)':null}resetEffects(){const t=this.card.sliderElement?.querySelectorAll('.slide');t&&t.forEach(t=>{t.style.opacity='',t.style.transform='',t.style.transition='',t.style.transformOrigin='',t.style.transformStyle='',t.style.backfaceVisibility='',t.style.zIndex='',t.style.position='',t.style.top='',t.style.left='',t.style.width='',t.style.height='',t.style.gridColumn='',t.style.gridRow='',t.style.clipPath=''}),this.card.cardContainer&&(this.card.cardContainer.style.perspective='',this.card.cardContainer.style.perspectiveOrigin=''),this.card.sliderElement&&(this.card.sliderElement.style.transformStyle='',this.card.sliderElement.style.position='',this.card.sliderElement.style.overflow='',this.card.sliderElement.style.display='',this.card.sliderElement.style.gridTemplateColumns='',this.card.sliderElement.style.gridTemplateRows=''),this.De=!1,l('EFFECTS','Reset all slide effects')}resetOpacity(){this.resetEffects()}Qe(){const t=this.getCustomDuration();if(null!==t)return t;if(!this.card.isConnected)return 300;const i=getComputedStyle(this.card).getPropertyValue('--simple-swipe-card-transition-speed').trim();return i&&i.endsWith('s')?1e3*parseFloat(i):i&&i.endsWith('ms')?parseFloat(i):300}}class Ft{constructor(t){this.card=t,this.ts=null,this.es=null,this.ss=0,this.ns=null,this.rs=null,this.ds=null,this.ls=null,this.hs=null,this.cs=0}getStrategy(){return this.card.ii?.scroll_strategy||'js'}isNative(){return'css'===this.getStrategy()}us(){return'carousel'===this.card.ii?.view_mode&&'center'===this.card.ii?.carousel_alignment}scrollToIndex(t,i=!0){const e=this.card.sliderElement;if(!e)return;const s=e.querySelectorAll('.slide')[t];if(!s)return;const n='horizontal'===this.card.Qt,o=i?'smooth':'auto',a=this.us();if(i&&(this.ss=Date.now()+600),n){let t=s.offsetLeft;a&&(t-=(e.clientWidth-s.offsetWidth)/2),e.scrollTo({left:Math.max(0,t),behavior:o})}else{let t=s.offsetTop;a&&(t-=(e.clientHeight-s.offsetHeight)/2),e.scrollTo({top:Math.max(0,t),behavior:o})}}indexFromScroll(){const t=this.card.sliderElement;if(!t)return this.card.currentIndex||0;const i=t.querySelectorAll('.slide');if(!i.length)return 0;const e='horizontal'===this.card.Qt,s=this.us(),n=e?t.scrollLeft:t.scrollTop,o=e?t.clientWidth:t.clientHeight;let a=0,r=1/0;return i.forEach((t,i)=>{let d=e?t.offsetLeft:t.offsetTop;s&&(d-=(o-(e?t.offsetWidth:t.offsetHeight))/2);const l=Math.abs(d-n);l<r&&(r=l,a=i)}),a}attach(){if(!this.isNative())return;const t=this.card.sliderElement;t&&(this.detach(),this.ts=()=>{this.es||(this.es=requestAnimationFrame(()=>{this.es=null,this.ps()}))},t.addEventListener('scroll',this.ts,{passive:!0}),this.fs(t),l('SWIPE','ScrollStrategy: native scroll listener attached'))}detach(){const t=this.card.sliderElement;t&&this.ts&&t.removeEventListener('scroll',this.ts),this.ts=null,this.es&&(cancelAnimationFrame(this.es),this.es=null),this.gs(t)}fs(t){t&&!this.ns&&(this.ns=t=>this.vs(t),this.rs=t=>this.ws(t),this.ds=()=>this.bs(),this.ls=t=>{Date.now()<this.cs&&(t.stopPropagation(),t.preventDefault(),this.cs=0)},t.addEventListener('pointerdown',this.ns),t.addEventListener('click',this.ls,{capture:!0}))}gs(t){t&&this.ns&&(t.removeEventListener('pointerdown',this.ns),t.removeEventListener('click',this.ls,{capture:!0})),window.removeEventListener('pointermove',this.rs),window.removeEventListener('pointerup',this.ds),window.removeEventListener('pointercancel',this.ds),this.ns=null,this.rs=null,this.ds=null,this.ls=null,this.hs=null}vs(t){if('mouse'!==t.pointerType||0!==t.button)return;if(this.Is(t))return;const i=this.card.sliderElement;if(!i)return;const e='horizontal'===this.card.Qt;this.hs={startX:t.clientX,startY:t.clientY,startScroll:e?i.scrollLeft:i.scrollTop,horizontal:e,moved:0,active:!1},window.addEventListener('pointermove',this.rs),window.addEventListener('pointerup',this.ds),window.addEventListener('pointercancel',this.ds)}ws(t){const i=this.hs;if(!i)return;const e=t.clientX-i.startX,s=t.clientY-i.startY;if(i.moved=Math.max(i.moved,Math.abs(e),Math.abs(s)),!i.active){if(i.moved<8)return;i.active=!0;const t=this.card.sliderElement;t.style.scrollSnapType='none',t.style.cursor='grabbing',t.style.userSelect='none'}t.preventDefault();const n=this.card.sliderElement,o=i.horizontal?e:s;i.horizontal?n.scrollLeft=i.startScroll-o:n.scrollTop=i.startScroll-o}bs(){const t=this.hs;if(this.hs=null,window.removeEventListener('pointermove',this.rs),window.removeEventListener('pointerup',this.ds),window.removeEventListener('pointercancel',this.ds),!t)return;const i=this.card.sliderElement;if(!t.active||!i)return;i.style.cursor='',i.style.userSelect='',i.style.scrollSnapType='',this.cs=Date.now()+300;const e=this.indexFromScroll();this.card.currentIndex=e,this.scrollToIndex(e,!0),this.card.pagination?.update(!1),this.card.stateSynchronization?.onCardNavigate(e)}Is(t){const i=t.composedPath?.()||[];for(const t of i){if(t===this.card.sliderElement)break;const i=t.tagName?.toLowerCase();if(i&&(e.includes(i)||n.includes(i)||['input','textarea','select','option','a'].includes(i)))return!0}return!1}ps(){if(!this.card.initialized||this.card.building)return;const t=this.indexFromScroll();t!==this.card.currentIndex&&(this.card.currentIndex=t,this.card.pagination?.update(!1),this.card.stateSynchronization?.onCardNavigate(t)),Date.now()<this.ss||!this.card.ii.enable_reset_after||this.card.autoSwipe?.isInProgress||this.card.resetAfter?.isInProgress||(this.card.resetAfter?.startTimer(),this.card.ii.enable_auto_swipe&&this.card.autoSwipe?.pause(5e3))}}class Ut{constructor(t){this.card=t,this.ys=new Set,this.Es={},this.Ss=['reset_target_card','auto_swipe_interval','reset_after_timeout','state_entity']}async initialize(){return l('TEMPLATE','Template evaluator initialized (built-in)'),!0}isJinjaTemplate(t){return'string'==typeof t&&(t.includes('{{')&&t.includes('}}')||t.includes('{%')&&t.includes('%}'))}isJsTemplate(t){return'string'==typeof t&&/\[{3}[\s\S]*\]{3}/.test(t)}isTemplate(t){return'string'==typeof t&&(this.isJinjaTemplate(t)||this.isJsTemplate(t))}get isAvailable(){return!0}evalJsTemplate(t,i){if(!this.isJsTemplate(t))return t;const e=t.trim().match(/^\[{3}([\s\S]*)\]{3}$/);if(!e)return t;const s=e[1];try{const e=new Function('states','user','hass',`'use strict'; ${s}`)(i.states,i.user,i);return l('TEMPLATE','JS Template evaluated:',t.substring(0,50)+'...','->',e),e}catch(i){const e=t.length<=100?t.trim():`${t.trim().substring(0,98)}...`;return l('ERROR',`JS Template error in '${e}':`,i.message),console.error('SimpleSwipeCard JS Template Error:',i),t}}scanConfig(t){this.ys.clear(),this.Es={};for(const i of this.Ss){const e=t[i];this.isTemplate(e)&&(this.ys.add(i),this.Es[i]=e,l('TEMPLATE',`Found template in ${i}:`,e))}this.ys.size>0&&l('TEMPLATE',`Config contains ${this.ys.size} template option(s)`)}hasTemplates(){return this.ys.size>0}getTemplateOptions(){return Array.from(this.ys)}evaluateTemplate(t,i){if(!i)return l('TEMPLATE','Cannot evaluate template - no hass object'),t;if(!this.isTemplate(t))return t;if(this.isJsTemplate(t))return this.evalJsTemplate(t,i);try{const e=t.match(/\{\{\s*(.+?)\s*\}\}/);if(!e)return t;const s=e[1].trim(),n=this.xs(s,i);return l('TEMPLATE',`Evaluated "${t}" => "${n}"`),n}catch(i){return l('TEMPLATE',`Error evaluating template "${t}":`,i.message),t}}xs(t,i){if(this.Ts(t))return this.Cs(t,i);const e=t.split('|').map(t=>t.trim());let s=this.$s(e[0],i);for(let t=1;t<e.length;t++)s=this.Ms(s,e[t],i);return s}Ts(t){return/\sif\s/.test(t)&&/\selse\s/.test(t)}Cs(t,i){const e=t.match(/^(.+?)\s+if\s+(.+?)\s+else\s+(.+)$/);if(!e)return l('TEMPLATE','Failed to parse conditional expression:',t),t;const s=e[1].trim(),n=e[2].trim(),o=e[3].trim();l('TEMPLATE','Conditional parsed:',{trueValue:s,condition:n,falseValue:o});const a=this.As(n,i);return l('TEMPLATE','Condition evaluated to:',a),this.xs(a?s:o,i)}As(t,i){const e=['>=','<=','==','!=','>','<'];for(const s of e){const e=t.indexOf(s);if(-1!==e){const n=t.substring(0,e).trim(),o=t.substring(e+s.length).trim(),a=this.xs(n,i),r=this.xs(o,i),d=parseFloat(a),h=parseFloat(r),c=!isNaN(d)&&!isNaN(h);switch(l('TEMPLATE',`Comparing: ${a} ${s} ${r} (numeric: ${c})`),s){case'>=':return c?d>=h:a>=r;case'<=':return c?d<=h:a<=r;case'==':return c?d==h:a==r;case'!=':return c?d!=h:a!=r;case'>':return c?d>h:a>r;case'<':return c?d<h:a<r}}}const s=this.xs(t,i);return'off'!==s&&'unavailable'!==s&&'unknown'!==s&&('on'===s||Boolean(s))}$s(t,i){if(t.includes('now()'))return this.Os(t);const e=t.match(/states\s*\(\s*['"]([^'"]+)['"]\s*\)/);if(e){const t=e[1],s=i.states[t];return s?s.state:(l('TEMPLATE',`Entity not found: ${t}`),'unknown')}const s=t.match(/state_attr\s*\(\s*['"]([^'"]+)['"]\s*,\s*['"]([^'"]+)['"]\s*\)/);if(s){const t=i.states[s[1]];return t&&t.attributes?t.attributes[s[2]]:void 0}const n=t.match(/is_state\s*\(\s*['"]([^'"]+)['"]\s*,\s*['"]([^'"]+)['"]\s*\)/);if(n){const t=i.states[n[1]];return t&&t.state===n[2]}if(/^[\d\s+\-*/().]+$/.test(t))try{return this._s(t)}catch{return t}if(/^\d+$/.test(t))return parseInt(t,10);const o=t.match(/^(['"])(.*)(\1)$/);return o?o[2]:t}Os(t){const i=new Date;if(t.includes('.weekday()')){const e=i.getDay(),s=0===e?6:e-1,n=t.match(/\.weekday\(\)\s*([+\-*/])\s*(\d+)/);if(n){const t=n[1],i=parseInt(n[2],10);return this.Ns(s,t,i)}return s}if(t.includes('.isoweekday()')){const e=i.getDay(),s=0===e?7:e,n=t.match(/\.isoweekday\(\)\s*([+\-*/])\s*(\d+)/);if(n){const t=n[1],i=parseInt(n[2],10);return this.Ns(s,t,i)}return s}return t.includes('.day')?i.getDate():t.includes('.month')?i.getMonth()+1:t.includes('.year')?i.getFullYear():t.includes('.hour')?i.getHours():t.includes('.minute')?i.getMinutes():i.getTime()}Ns(t,i,e){switch(i){case'+':return t+e;case'-':return t-e;case'*':return t*e;case'/':return 0!==e?t/e:t;default:return t}}_s(t){const i=t.replace(/[^0-9+\-*/().]/g,'');if(i!==t.replace(/\s/g,''))throw new Error('Invalid characters in expression');return Function(`"use strict"; return (${i})`)()}Ms(t,i,e){if('int'===i||i.startsWith('int(')){const e=parseInt(t,10);if(isNaN(e)){const t=i.match(/int\s*\(\s*(\d+)\s*\)/);return t?parseInt(t[1],10):0}return e}if('float'===i||i.startsWith('float(')){const e=parseFloat(t);if(isNaN(e)){const t=i.match(/float\s*\(\s*([\d.]+)\s*\)/);return t?parseFloat(t[1]):0}return e}const s=i.match(/round\s*\(\s*(\d+)\s*\)/);if(s||'round'===i){const i=s?parseInt(s[1],10):0,e=parseFloat(t);return isNaN(e)?t:Number(e.toFixed(i))}if('abs'===i){const i=parseFloat(t);return isNaN(i)?t:Math.abs(i)}const n=i.match(/default\s*\(\s*['"]?([^'")\s]+)['"]?\s*\)/);return n?null==t||''===t?n[1]:t:'string'===i||'str'===i?String(t):(l('TEMPLATE',`Unknown filter: ${i}`),t)}getEvaluatedValue(t,i){if(!this.ys.has(t))return;const e=this.Es[t];if(!e)return;const s=this.evaluateTemplate(e,i);return this.ks(t,s)}ks(t,i){if(['reset_target_card','auto_swipe_interval','reset_after_timeout'].includes(t)){const e=parseInt(i,10);if(isNaN(e))return l('TEMPLATE',`Warning: ${t} template evaluated to non-numeric value: ${i}`),null;switch(t){case'reset_target_card':return Math.max(1,e);case'auto_swipe_interval':return Math.max(500,e);case'reset_after_timeout':return Math.max(5e3,e);default:return e}}return i}isTemplateOption(t){return this.ys.has(t)}getReferencedEntities(){const t=new Set,i=/(?:states|is_state|state_attr|has_value)\s*\(\s*['"]([\w.]+)['"]/g;for(const e of Object.values(this.Es)){if('string'!=typeof e)continue;let s;for(;null!==(s=i.exec(e));)t.add(s[1])}return t.size>0&&l('TEMPLATE','Found referenced entities in templates:',Array.from(t)),t}clearCache(){}}class SimpleSwipeCard extends gt{constructor(){l('INIT','SimpleSwipeCard Constructor starting...');try{super(),l('INIT','SimpleSwipeCard Constructor invoked.'),this.ii={},this.Oi=null,this.cards=[],this.visibleCardIndices=[],this.currentIndex=0,this.slideWidth=0,this.slideHeight=0,this.ae=!0,this.cardContainer=null,this.sliderElement=null,this.initialized=!1,this.building=!1,this.resizeObserver=null,this.Qt='horizontal',this.ni=void 0,this.Rs=void 0,this.Ni=null,this.Ds=null,this.Ls=null,this.Ps=null,this.swipeGestures=new Et(this),this.autoSwipe=new St(this),this.resetAfter=new xt(this),this.pagination=new Tt(this),this.cardBuilder=new kt(this),this.stateSynchronization=new Rt(this),this.carouselView=new Lt(this),this.loopMode=new Pt(this),this.swipeBehavior=new Ht(this),this.swipeEffects=new zt(this),this.scrollStrategy=new Ft(this),this.autoHeight=new Dt(this),this.templateEvaluator=new Ut(this),this.Hs=null,this.Vs=null,this.zs=null,this.Fs=null,window._simpleSwipeDialogStack||(window._simpleSwipeDialogStack=[]),this.Us=this.Us.bind(this),this.Bs=this.Bs.bind(this),this.Ws=this.Ws.bind(this),l('INIT','SimpleSwipeCard Constructor completed successfully.')}catch(t){throw console.error('SimpleSwipeCard: Constructor failed with error:',t),t}}async firstUpdated(){if(l('LIFECYCLE','firstUpdated called for wrapper card'),await this.templateEvaluator.initialize(),!this.Ys&&void 0!==this.ii?.cards){this.Ys=!0,l('INIT','firstUpdated: Initializing build.');try{if(this.ii.cards&&0!==this.ii.cards.length?(await Promise.resolve(),await new Promise(t=>requestAnimationFrame(t))):await new Promise(t=>{requestAnimationFrame(()=>{requestAnimationFrame(t)})}),!this.isConnected)return l('LIFECYCLE','Card disconnected during deferred build wait - will retry on connect'),void(this.Ys=!1);if(this.initialized)return void l('LIFECYCLE','Card already initialized during deferred build wait - skipping');if(l('INIT',`Deferred build starting with ${this.ii.cards.length} cards`),!1===await this.cardBuilder.build())return void l('LIFECYCLE','Build was skipped in firstUpdated (likely disconnected) - will retry on connect');this.isConnected&&this.cardContainer&&(l('LIFECYCLE','Build finished in firstUpdated, setting up features'),this.js())}catch(t){console.error('SimpleSwipeCard: Build failed in firstUpdated:',t),l('ERROR','Build failed, card may not function properly')}}}static async getConfigElement(){return l('SYSTEM','SimpleSwipeCard.getConfigElement called'),await customElements.whenDefined('simple-swipe-card-editor'),document.createElement('simple-swipe-card-editor')}static getStubConfig(){return l('SYSTEM','SimpleSwipeCard.getStubConfig called'),{type:'custom:simple-swipe-card',cards:[]}}setConfig(t){try{if(!t)throw new Error('Invalid configuration');l('EDITOR','Editor setConfig received:',JSON.stringify(t));const i=this.ii?.cards?.length||0,e=this.ii?.scroll_strategy;if(this.ii=JSON.parse(JSON.stringify(t)),this.Gs(),Array.isArray(this.ii.cards)||(this.ii.cards=[]),void 0===this.ii.show_pagination&&(this.ii.show_pagination=!0),void 0===this.ii.auto_hide_pagination)this.ii.auto_hide_pagination=0;else{const t=parseInt(this.ii.auto_hide_pagination);this.ii.auto_hide_pagination=isNaN(t)||t<0?0:Math.min(t,3e4)}if(void 0===this.ii.card_spacing)this.ii.card_spacing=15;else{const t=parseInt(this.ii.card_spacing);this.ii.card_spacing=isNaN(t)||t<0?15:t}void 0!==this.ii.scroll_strategy&&['js','css'].includes(this.ii.scroll_strategy)||(this.ii.scroll_strategy='js');const s='css'===this.ii.scroll_strategy;if(void 0!==this.ii.enable_loopback&&void 0===this.ii.loop_mode&&(this.ii.loop_mode=this.ii.enable_loopback?'loopback':'none',delete this.ii.enable_loopback,l('CONFIG','Migrated enable_loopback to loop_mode:',this.ii.loop_mode)),void 0===this.ii.loop_mode&&(this.ii.loop_mode='none'),['none','loopback','infinite'].includes(this.ii.loop_mode)||(l('CONFIG','Invalid loop_mode, defaulting to \'none\':',this.ii.loop_mode),this.ii.loop_mode='none'),s&&'none'!==this.ii.loop_mode&&(this.ii.loop_mode='none',l('CONFIG','loop_mode forced to \'none\' for css scroll strategy')),this.loopMode?.initialize(),void 0!==this.ii.swipe_direction&&['horizontal','vertical'].includes(this.ii.swipe_direction)||(this.ii.swipe_direction='horizontal'),void 0!==this.ii.swipe_effect&&['slide','bounce','spring','instant','fade','flip','coverflow','creative','cards','reveal','zoom','swing'].includes(this.ii.swipe_effect)||(this.ii.swipe_effect='slide'),s&&'slide'!==this.ii.swipe_effect&&(this.ii.swipe_effect='slide',l('CONFIG','swipe_effect forced to \'slide\' for css scroll strategy')),'vertical'!==this.ii.swipe_direction||t.grid_options?this.removeAttribute('data-vertical-no-grid'):this.setAttribute('data-vertical-no-grid',''),this.closest('hui-card-preview')||this.closest('hui-card-element-editor')?this.setAttribute('data-editor-mode',''):this.removeAttribute('data-editor-mode'),!0===this.ii.enable_backdrop_filter?this.setAttribute('data-enable-backdrop-filter',''):this.removeAttribute('data-enable-backdrop-filter'),void 0===this.ii.swipe_behavior&&(this.ii.swipe_behavior='single'),['single','free'].includes(this.ii.swipe_behavior)?'free'===this.ii.swipe_behavior&&'infinite'!==this.ii.loop_mode&&(this.ii.swipe_behavior='single',l('CONFIG','Free swipe behavior requires infinite loop mode, defaulting to single')):this.ii.swipe_behavior='single',void 0===this.ii.auto_height&&(this.ii.auto_height=!1),!0===this.ii.auto_height&&('carousel'===this.ii.view_mode||'vertical'===this.ii.swipe_direction||'infinite'===this.ii.loop_mode||s)&&(delete this.ii.auto_height,l('CONFIG','auto_height removed: incompatible with current mode (carousel, vertical, infinite loop, or css scroll strategy)')),void 0===this.ii.enable_auto_swipe&&(this.ii.enable_auto_swipe=!1),void 0===this.ii.auto_swipe_interval?this.ii.auto_swipe_interval=2e3:(this.ii.auto_swipe_interval=parseInt(this.ii.auto_swipe_interval),(isNaN(this.ii.auto_swipe_interval)||this.ii.auto_swipe_interval<500)&&(this.ii.auto_swipe_interval=2e3)),void 0===this.ii.enable_reset_after&&(this.ii.enable_reset_after=!1),void 0===this.ii.reset_after_timeout?this.ii.reset_after_timeout=3e4:this.templateEvaluator.isTemplate(this.ii.reset_after_timeout)||(this.ii.reset_after_timeout=parseInt(this.ii.reset_after_timeout),(isNaN(this.ii.reset_after_timeout)||this.ii.reset_after_timeout<5e3)&&(this.ii.reset_after_timeout=3e4)),void 0===this.ii.reset_target_card?this.ii.reset_target_card=1:this.templateEvaluator.isTemplate(this.ii.reset_target_card)||(this.ii.reset_target_card=Math.max(1,parseInt(this.ii.reset_target_card)||1)),void 0===this.ii.view_mode&&(this.ii.view_mode='single'),['single','carousel'].includes(this.ii.view_mode)||(this.ii.view_mode='single'),'carousel'===this.ii.view_mode){if(void 0===this.ii.card_min_width)this.ii.card_min_width=200;else{const t=parseInt(this.ii.card_min_width);(isNaN(t)||t<50||t>500)&&(this.ii.card_min_width=200)}if(void 0!==this.ii.cards_visible){const t=parseFloat(this.ii.cards_visible);this.ii.cards_visible=isNaN(t)||t<1.1||t>8?2.5:Math.round(10*t)/10}['start','center'].includes(this.ii.carousel_alignment)||(this.ii.carousel_alignment='start')}t.card_mod?(l('CARD_MOD','Card-mod configuration detected',t.card_mod),this.Ni=JSON.parse(JSON.stringify(t.card_mod))):this.Ni=null,this.Qt=this.ii.swipe_direction,this.Js=this.ii.view_mode||'single',delete this.ii.title,this.autoHeight?.initialize(),this.templateEvaluator.scanConfig(this.ii);const n=this.ii.cards.length;this.initialized&&this.isConnected&&0===i&&n>0&&(l('CONFIG',`Cards added after initial build (0 -> ${n}) - triggering rebuild`),requestAnimationFrame(()=>{this.isConnected&&this.initialized&&this.cardBuilder.build()})),this.initialized&&this.isConnected&&void 0!==e&&e!==this.ii.scroll_strategy&&(l('CONFIG',`scroll_strategy changed (${e} -> ${this.ii.scroll_strategy}) - triggering rebuild`),requestAnimationFrame(()=>{this.isConnected&&this.initialized&&this.cardBuilder.build()})),this.requestUpdate(),l('CONFIG','setConfig completed successfully')}catch(t){throw l('ERROR','setConfig failed with error:',t),t}}ai(){if(!this.cardContainer)return 2.5;const t=this.cardContainer.offsetWidth;if(t<=0)return l('LOOP','Container width not available, using default cards_visible: 2.5'),2.5;const i=this.ii.card_min_width||200,e=Math.max(0,parseInt(this.ii.card_spacing))||0;return Math.max(1.1,Math.round((t+e)/(i+e)*10)/10)}Qi(){l('VISIBILITY','Handling conditional card visibility change'),this.qs&&clearTimeout(this.qs),this.qs=setTimeout(()=>{this.Xs(),this.qs=null},150)}Xs(){if(!this.ii?.cards||!this.Oi){const t=0===this.visibleCardIndices.length;return this.visibleCardIndices=[],void(t||l('VISIBILITY','No cards or hass available, cleared visible indices'))}const t=[...this.visibleCardIndices];this.visibleCardIndices=[],this.ii.cards.forEach((t,i)=>{const e=It(t.visibility,this.Oi);let s=!0;if('conditional'===t.type&&this.cards){const t=this.cards.find(t=>t&&t.originalIndex===i);t&&(s=t.conditionallyVisible)}e&&s&&this.visibleCardIndices.push(i)}),JSON.stringify(t)!==JSON.stringify(this.visibleCardIndices)&&(l('VISIBILITY',`Visible cards changed: ${this.visibleCardIndices.length}/${this.ii.cards.length} visible`,this.visibleCardIndices),this.Zs(t),this.initialized&&this.isConnected&&this.cardBuilder.build())}Yi(){if(!this.ii?.cards||!this.Oi){const t=0===this.visibleCardIndices.length;return this.visibleCardIndices=[],void(t||l('VISIBILITY','No cards or hass available, cleared visible indices'))}const t=[...this.visibleCardIndices];if(this.visibleCardIndices=[],this.ii.cards.forEach((t,i)=>{const e=It(t.visibility,this.Oi);let s=!0;'conditional'===t.type&&t.conditions&&(s=this.Ks(t.conditions));let n=!0;if(this.cards&&this.cards[i]?.element){const t=this.cards[i].element;t.classList?.contains('hidden')&&(n=!1,l('VISIBILITY',`Card ${i} has 'hidden' class from child card's own visibility logic`))}e&&s&&n&&this.visibleCardIndices.push(i)}),JSON.stringify(t)!==JSON.stringify(this.visibleCardIndices)){if(l('VISIBILITY',`Visible cards changed: ${this.visibleCardIndices.length}/${this.ii.cards.length} visible`,this.visibleCardIndices),this.Zs(t),this.building||!this.initialized)return void l('VISIBILITY','Skipping visibility rebuild during initial setup to prevent flicker');this.Qs()}}Ks(t){return!t||!Array.isArray(t)||0===t.length||!this.Oi||t.every(t=>{try{return this.tn(t)}catch(i){return l('VISIBILITY','Error evaluating conditional card condition:',t,i),!0}})}tn(t){if(!t||'object'!=typeof t)return!0;const{condition:i,entity:e,state:s,state_not:n,above:o,below:a}=t,r=i||(!e||void 0===s&&void 0===n?null:'state')||(!e||void 0===o&&void 0===a?null:'numeric_state');switch(r){case'and':{if(!t.conditions||!Array.isArray(t.conditions))return l('VISIBILITY','Conditional card AND condition missing \'conditions\' array'),!1;if(0===t.conditions.length)return l('VISIBILITY','Conditional card AND condition has empty \'conditions\' array'),!0;const i=t.conditions.every(t=>{try{return this.tn(t)}catch(i){return l('VISIBILITY','Error evaluating nested conditional card AND condition:',t,i),!1}});return l('VISIBILITY',`Conditional card AND condition result: ${i} (${t.conditions.length} nested conditions)`),i}case'or':{if(!t.conditions||!Array.isArray(t.conditions))return l('VISIBILITY','Conditional card OR condition missing \'conditions\' array'),!1;if(0===t.conditions.length)return l('VISIBILITY','Conditional card OR condition has empty \'conditions\' array'),!1;const i=t.conditions.some(t=>{try{return this.tn(t)}catch(i){return l('VISIBILITY','Error evaluating nested conditional card OR condition:',t,i),!1}});return l('VISIBILITY',`Conditional card OR condition result: ${i} (${t.conditions.length} nested conditions)`),i}case'not':if(!t.condition)return l('VISIBILITY','Conditional card NOT condition missing \'condition\' property'),!1;try{const i=this.tn(t.condition),e=!i;return l('VISIBILITY',`Conditional card NOT condition result: ${e} (nested was ${i})`),e}catch(i){return l('VISIBILITY','Error evaluating nested conditional card NOT condition:',t.condition,i),!1}case'state':{if(!e||!this.Oi.states[e])return l('VISIBILITY',`Entity ${e} not found for conditional card state condition`),!1;const t=this.Oi.states[e].state;if(void 0!==s){const i=String(s),n=String(t),o=n===i;return l('VISIBILITY',`Conditional card state condition: ${e} = ${n}, expected: ${i}, result: ${o}`),o}if(void 0!==n){const i=String(n),s=String(t),o=s!==i;return l('VISIBILITY',`Conditional card state not condition: ${e} = ${s}, not expected: ${i}, result: ${o}`),o}return!0}case'numeric_state':{if(!e||!this.Oi.states[e])return l('VISIBILITY',`Entity ${e} not found for conditional card numeric_state condition`),!1;const t=parseFloat(this.Oi.states[e].state);if(isNaN(t))return!1;let i=!0;return void 0!==o&&(i=i&&t>parseFloat(o)),void 0!==a&&(i=i&&t<parseFloat(a)),l('VISIBILITY',`Conditional card numeric state condition: ${e} = ${t}, result: ${i}`),i}case'screen':{const i=t.media_query;if(i&&window.matchMedia){const t=window.matchMedia(i).matches;return l('VISIBILITY',`Conditional card screen condition: ${i}, result: ${t}`),t}return!0}case'user':if(t.users&&Array.isArray(t.users)){const i=this.Oi.user;if(i&&i.id){const e=t.users.includes(i.id);return l('VISIBILITY',`Conditional card user condition: current user ${i.id}, allowed users: ${t.users}, result: ${e}`),e}}return!0;default:return e?(l('VISIBILITY','Unknown or invalid conditional card condition:',t),!1):(l('VISIBILITY',`Unknown conditional card condition type: ${r}`),!0)}}Qs(){this.en&&clearTimeout(this.en),this.en=setTimeout(()=>{this.initialized&&this.isConnected&&!this.building&&(l('VISIBILITY','Performing debounced rebuild due to visibility changes'),this.cardBuilder.build()),this.en=null},300)}Zs(t){if(0===this.visibleCardIndices.length)return void(this.currentIndex=0);const i=this.visibleCardIndices.indexOf(t[this.currentIndex]);if(-1!==i)this.currentIndex=i,l('VISIBILITY',`Current card still visible, adjusted index to ${this.currentIndex}`);else{const t=this.visibleCardIndices.length;this.currentIndex>=t?(this.currentIndex=t-1,l('VISIBILITY',`Adjusted to last visible card: ${this.currentIndex}`)):(this.currentIndex=Math.min(this.currentIndex,t-1),this.currentIndex=Math.max(0,this.currentIndex),l('VISIBILITY',`Adjusted to maintain relative position: ${this.currentIndex}`))}}sn(){this.nn&&clearTimeout(this.nn),this.nn=setTimeout(()=>{this.Yi(),this.nn=null},200)}an(){if(!this.ii?.cards)return!1;const t=i=>!!Array.isArray(i)&&i.some(i=>'time'===i.condition||!(!i.conditions||!Array.isArray(i.conditions))&&t(i.conditions));return this.ii.cards.some(i=>i.visibility&&t(i.visibility))}js(){this.rn||(this.an()?(l('VISIBILITY','Starting time visibility timer (5s interval)'),this.rn=setInterval(()=>{this.isConnected&&this.Oi&&(l('VISIBILITY','Time visibility timer tick - checking conditions'),this.Yi())},5e3)):l('VISIBILITY','No time conditions found, skipping timer'))}dn(){this.rn&&(l('VISIBILITY','Stopping time visibility timer'),clearInterval(this.rn),this.rn=null)}ln(t){l('ERROR',`${t}`),this.ii={...i},this.visibleCardIndices=[],this.isConnected&&this.cardBuilder.build()}hn(){l('CONFIG','Updating child card configs'),this.cards&&this.cards.length===this.visibleCardIndices.length&&this.visibleCardIndices.forEach((t,i)=>{const e=this.ii.cards[t],s=this.cards[i];if(s&&!s.error&&s.element?.setConfig&&JSON.stringify(s.config)!==JSON.stringify(e)){l('CONFIG','Updating config for visible card',i,'original index',t);try{s.element.setConfig(e),s.config=JSON.parse(JSON.stringify(e))}catch(t){console.error(`Error setting config on child card ${i}:`,t)}}})}cn(){if(l('CONFIG','Updating layout options (pagination, spacing, direction)'),this.Qt!==this.ii.swipe_direction)return this.Qt=this.ii.swipe_direction,void this.cardBuilder.build();this.pagination.updateLayout(),this.updateSlider(!1),this.Ni&&this.ki()}set hass(t){if(!t)return;const i=this.Oi;if(i===t)return;this.Oi=t;const e=!i||i.states!==t.states,s=!i||i.localize!==t.localize||i.themes!==t.themes||i.language!==t.language,n=e&&this.un(i,t);return this.si?(l('LOOP','Skipping hass-triggered visibility update during seamless jump'),void((e||s)&&this.pn(t))):this.building?(l('VISIBILITY','Skipping visibility update during build to prevent rebuild flicker'),void((e||s)&&this.pn(t))):(n&&(l('HASS','Our relevant entities changed - updating visibility'),this.nn&&(clearTimeout(this.nn),this.nn=null),this.Yi()),e&&this.stateSynchronization.onHassChange(i,t),void((e||s)&&this.pn(t)))}un(t,i){if(!t||!t.states||!i.states)return!0;const e=this.fn();if(0===e.length)return!1;for(const s of e){const e=t.states[s],n=i.states[s];if(!e!=!n)return l('HASS',`Our entity ${s} added/removed`),!0;if(e&&n&&(e.state!==n.state||e.last_changed!==n.last_changed))return l('HASS',`Our entity ${s} state changed: ${e.state} -> ${n.state}`),!0}return!1}fn(){if(this.Ls&&this.Ps===this.gn())return this.Ls;const t=new Set;if(this.ii.state_entity){const i=this.ii.state_entity;if(this.templateEvaluator?.isTemplate(i)){const i=this.templateEvaluator.getEvaluatedValue('state_entity',this.Oi);i&&'string'==typeof i&&t.add(i)}else t.add(i)}return this.ii.cards&&Array.isArray(this.ii.cards)&&this.ii.cards.forEach(i=>{i.visibility&&Array.isArray(i.visibility)&&i.visibility.forEach(i=>{i.entity&&t.add(i.entity)}),'conditional'===i.type&&i.conditions&&Array.isArray(i.conditions)&&i.conditions.forEach(i=>{i.entity&&t.add(i.entity)})}),this.templateEvaluator?.hasTemplates()&&this.templateEvaluator.getReferencedEntities().forEach(i=>t.add(i)),this.Ls=Array.from(t),this.Ps=this.gn(),this.Ls.length>0&&l('HASS',`Tracking ${this.Ls.length} entities for visibility/state sync:`,this.Ls),this.Ls}gn(){if(!this.ii||!this.ii.cards)return'';const t=[this.ii.cards.length,this.ii.state_entity||'',this.ii.cards.filter(t=>t.visibility?.length>0).length,this.ii.cards.filter(t=>'conditional'===t.type&&t.conditions?.length>0).length,this.templateEvaluator?.getTemplateOptions().join(',')||''];return t.join('|')}Gs(){this.Ls=null,this.Ps=null,l('HASS','Cleared our relevant entities cache')}getEvaluatedConfigValue(t,i){const e=this.ii[t];if(null==e)return i;if(this.templateEvaluator?.isTemplate(e)&&this.templateEvaluator.isAvailable&&this.Oi){const e=this.templateEvaluator.getEvaluatedValue(t,this.Oi);return null!=e?e:(l('TEMPLATE',`Template evaluation failed for ${t}, using default: ${i}`),i)}return e}pn(t){this.cards&&this.cards.forEach(i=>{if(i.element&&!i.error)try{i.element.hass=t}catch(t){console.error('Error setting hass on child card:',t)}})}connectedCallback(){if(super.connectedCallback(),l('LIFECYCLE','connectedCallback - simplified for wrapper card'),this.si&&(l('INIT','Clearing stuck seamless jump flag on connect'),this.si=!1),this.addEventListener('config-changed',this.Us.bind(this)),this.ii&&this.ii.cards&&this.ii.cards.length>0&&(!this.cardContainer||!this.initialized))return l('LIFECYCLE',`Card needs build (cardContainer: ${!!this.cardContainer}, initialized: ${this.initialized}) - triggering build`),requestAnimationFrame(()=>{this.isConnected&&(l('LIFECYCLE','Executing deferred build after reconnection'),this.cardBuilder.build().then(()=>{this.isConnected&&(l('LIFECYCLE','Deferred build completed successfully'),this.Ni&&(l('CARD_MOD','Reapplying card-mod styles after deferred build'),this.ki(),this.le()),this.js())}).catch(t=>{console.error('SimpleSwipeCard: Deferred build failed:',t)}))}),void l('LIFECYCLE','connectedCallback finished (deferred build scheduled)');this.cards&&this.cards.length>0&&!this.cardContainer&&this.ii?(l('LIFECYCLE','Detected reconnection scenario - rebuilding card'),this.cardBuilder.build().then(()=>{this.isConnected&&(l('LIFECYCLE','Reconnection build completed'),this.Ni&&(l('CARD_MOD','Reapplying card-mod styles after reconnection build'),this.ki(),this.le()),requestAnimationFrame(()=>{this.isConnected&&this.pagination.updateLayout()}),this.js())}).catch(t=>{console.error('SimpleSwipeCard: Reconnection build failed:',t),l('ERROR','Reconnection build failed, swipe may not work')})):this.initialized&&this.cardContainer&&(l('LIFECYCLE','connectedCallback: Handling reconnection with intact DOM'),this.re(),this.visibleCardIndices.length>1&&(this.swipeGestures.removeGestures(),setTimeout(()=>{this.isConnected&&this.swipeGestures.addGestures()},50)),this.Ni&&(this.ki(),this.le()),this.autoSwipe.manage(),this.resetAfter.manage(),this.stateSynchronization.manage(),l('LIFECYCLE','Re-creating pagination after reconnection'),requestAnimationFrame(()=>{this.isConnected&&this.pagination.updateLayout()}),this.js()),l('LIFECYCLE','connectedCallback finished')}disconnectedCallback(){super.disconnectedCallback(),l('INIT','disconnectedCallback - Enhanced cleanup starting'),this.building&&(l('INIT','Disconnecting during active build - aborting build'),this.building=!1),this.si&&(l('INIT','Clearing stuck seamless jump flag on disconnect'),this.si=!1),this.removeEventListener('config-changed',this.Us.bind(this));try{this.mn(),this.vn(),this.wn(),this.bn(),this.In(),this.yn()}catch(t){console.warn('Error during cleanup:',t)}this.initialized=!1,l('INIT','disconnectedCallback - Enhanced cleanup completed')}mn(){['_visibilityRebuildTimeout','_conditionalVisibilityTimeout','_visibilityUpdateTimeout','_layoutRetryCount'].forEach(t=>{this[t]&&(clearTimeout(this[t]),this[t]=null,l('INIT',`Cleared timeout: ${t}`))}),this.dn()}vn(){try{this.En(),this.swipeGestures&&(this.swipeGestures.removeGestures(),this.swipeGestures.bt=!1,this.swipeGestures.Ct=!1),this.scrollStrategy?.detach(),this.autoSwipe&&(this.autoSwipe.stop(),this.autoSwipe.ui=null,this.autoSwipe.fi=null),this.resetAfter&&(this.resetAfter.stopTimer(),this.resetAfter.Ii=null),this.stateSynchronization&&this.stateSynchronization.stop(),this.autoHeight&&this.autoHeight.cleanup(),l('INIT','Feature managers cleaned up (state preserved)')}catch(t){console.warn('Error cleaning up feature managers:',t)}}wn(){this.cardContainer=null,this.sliderElement=null,this.Wi(),this.ee&&(this.ee.disconnect(),this.ee=null,l('MUSHROOM','Mushroom-select observer cleaned up')),this.pagination&&this.pagination.paginationElement&&(this.pagination.paginationElement=null),l('INIT','DOM references and observers cleaned up (cards preserved)')}bn(){if(this.Ds)try{this.Ds.disconnect(),this.Ds=null,l('CARD_MOD','Card-mod observer cleaned up')}catch(t){console.warn('Error cleaning up card-mod observer:',t)}}yn(){this.swipeGestures&&this.swipeGestures.Nt&&(clearTimeout(this.swipeGestures.Nt),this.swipeGestures.Nt=null,this.swipeGestures.kt=!1),this.loopMode&&this.loopMode.Ne&&(clearTimeout(this.loopMode.Ne),this.loopMode.Ne=null,this.si=!1),this.Sn(),l('INIT','Remaining event listeners cleared')}Us(t){t.detail?.fromSwipeCardEditor&&t.detail?.editorId===this.xn||(l('EVENT','Root element received config-changed event:',t.detail),(t.detail?.fromElementEditor||t.detail?.elementConfig||t.detail?.element)&&l('ELEMENT','Caught element editor event, allowing normal propagation'))}Bs(t){if(!this.ii.enable_auto_swipe)return;const i=t.composedPath();if(!i.includes(this))return;const e=i[0];l('INPUT',`Focus event detected - e.target: ${t.target.tagName}, actualTarget: ${e.tagName}, isContentEditable: ${e.isContentEditable}`),('INPUT'===e.tagName||'TEXTAREA'===e.tagName||'SELECT'===e.tagName||e.isContentEditable)&&(l('INPUT',`Text input focused (${e.tagName||'contenteditable'}) - pausing auto-swipe indefinitely`),this.autoSwipe.pause(36e5))}Ws(t){if(!this.ii.enable_auto_swipe)return;const i=t.composedPath();if(!i.includes(this))return;const e=i[0];l('INPUT',`Blur event detected - e.target: ${t.target.tagName}, actualTarget: ${e.tagName}, isContentEditable: ${e.isContentEditable}`),('INPUT'===e.tagName||'TEXTAREA'===e.tagName||'SELECT'===e.tagName||e.isContentEditable)&&(l('INPUT',`Text input blurred (${e.tagName||'contenteditable'}) - resuming auto-swipe`),this.autoSwipe.fi&&(clearTimeout(this.autoSwipe.fi),this.autoSwipe.fi=null),this.autoSwipe.pi=!1,this.autoSwipe.start())}Zi(){this.zs?l('INPUT','Input listeners already set up, skipping'):(l('INPUT','Setting up input focus/blur listeners for auto-swipe pause on document'),this.zs=this.Bs,this.Fs=this.Ws,document.addEventListener('focusin',this.zs,!0),document.addEventListener('focusout',this.Fs,!0),l('INPUT','Input listeners successfully attached to document'))}Sn(){this.zs&&(document.removeEventListener('focusin',this.zs,!0),this.zs=null),this.Fs&&(document.removeEventListener('focusout',this.Fs,!0),this.Fs=null),l('INPUT','Cleaned up input focus/blur listeners from document')}re(){!this.resizeObserver&&this.cardContainer&&(this.resizeObserver=function(t,i){if(!t)return null;l('INIT','Setting up resize observer.');let e=null;const s=new ResizeObserver(s=>{window.requestAnimationFrame(()=>{if(t.isConnected)for(const n of s){const s=n.contentRect.width,o=n.contentRect.height;e&&clearTimeout(e),e=setTimeout(()=>{t&&(s>0&&s!==n.previousWidth||o>0&&o!==n.previousHeight)&&(l('INIT','Resize detected, recalculating layout.',{oldWidth:n.previousWidth,newWidth:s,oldHeight:n.previousHeight,newHeight:o}),i())},50),n.previousWidth=s,n.previousHeight=o}})});return s.observe(t),{observer:s,cleanup:()=>{l('INIT','Removing resize observer.'),s&&s.disconnect(),e&&(clearTimeout(e),e=null)}}}(this.cardContainer,()=>this.recalculateLayout()),this.Tn=()=>{setTimeout(()=>this.recalculateLayout(),100)},this.Cn=()=>{this.recalculateLayout()},window.addEventListener('orientationchange',this.Tn),window.addEventListener('resize',this.Cn))}En(){this.resizeObserver?.cleanup&&(this.resizeObserver.cleanup(),this.resizeObserver=null),this.Tn&&(window.removeEventListener('orientationchange',this.Tn),this.Tn=null),this.Cn&&(window.removeEventListener('resize',this.Cn),this.Cn=null)}recalculateLayout(){if(!this.cardContainer||!this.isConnected)return;const t=this.cardContainer.offsetWidth,i=this.cardContainer.offsetHeight;(t>0&&Math.abs(t-this.slideWidth)>1||i>0&&Math.abs(i-this.slideHeight)>1)&&(l('SYSTEM','Recalculating layout due to resize.',{oldWidth:this.slideWidth,newWidth:t,oldHeight:this.slideHeight,newHeight:i}),this.slideWidth=t,this.slideHeight=i,'carousel'===this.ii?.view_mode&&this.cardBuilder?this.cardBuilder.recalculateCarouselLayout():(this.ae||(this.style.setProperty('--single-slide-width',`${t}px`),this.sliderElement&&this.sliderElement.querySelectorAll('.slide:not(.carousel-mode)').forEach(i=>{i.style.width=`${t}px`,i.style.minWidth=`${t}px`,i.style.flexBasis=`${t}px`})),this.updateSlider(!1)))}ti(t){const i=this.swipeEffects?.getCustomDuration();if(0===i)return'none';const e=this.swipeEffects?.getEasing();return function(t,i=null,e=null){if(!t)return'none';if(window.matchMedia&&window.matchMedia('(prefers-reduced-motion: reduce)').matches)return'none';let s='0.3s',n=e||'ease-out';if(i&&i.isConnected){const t=getComputedStyle(i),o=t.getPropertyValue('--simple-swipe-card-transition-speed').trim(),a=t.getPropertyValue('--simple-swipe-card-transition-easing').trim();o&&(s=o),!e&&a&&(n=a)}return`transform ${s} ${n}`}(t,this,e)}ki(){!function(t,i,e,s,n){if(t&&i){if(t.style){l('CARD_MOD','Applying card-mod styles');const o=document.createElement('style');let a;if(o.setAttribute('id','card-mod-styles'),'string'==typeof t.style)a=t.style,l('CARD_MOD','Using direct string format');else{if('object'!=typeof t.style||!t.style['.'])return void l('CARD_MOD','Unknown card-mod style format, skipping');a=t.style['.'],l('CARD_MOD','Using object format with \'.\' key')}o.textContent=a;const r=i.querySelector('#card-mod-styles');if(r)try{i.removeChild(r)}catch(t){l('CARD_MOD','Error removing existing style:',t)}try{if(!i||!i.appendChild)return void l('ERROR','shadowRoot is invalid for appendChild operation');i.appendChild(o)}catch(t){return void l('ERROR','Failed to append card-mod styles:',t)}if(e){l('CARD_MOD','Forwarding CSS variables from host to shadow DOM');try{const t=window.getComputedStyle(e),o=[i.querySelector('.card-container'),s,n].filter(Boolean),a=['--simple-swipe-card-pagination-dot-inactive-color','--simple-swipe-card-pagination-dot-active-color','--simple-swipe-card-pagination-dot-inactive-opacity','--simple-swipe-card-pagination-dot-active-opacity','--simple-swipe-card-pagination-dot-size','--simple-swipe-card-pagination-dot-active-size','--simple-swipe-card-pagination-border-radius','--simple-swipe-card-pagination-dot-spacing','--simple-swipe-card-pagination-background','--simple-swipe-card-pagination-padding','--simple-swipe-card-pagination-bottom','--simple-swipe-card-pagination-right','--simple-swipe-card-transition-speed','--simple-swipe-card-transition-easing','--simple-swipe-card-pagination-fade-duration','--simple-swipe-card-pagination-animation-type','--simple-swipe-card-pagination-animation-delay','--simple-swipe-card-pagination-animation-easing'];for(let t=1;t<=15;t++)a.push(`--simple-swipe-card-pagination-dot-slide${t}-color`,`--simple-swipe-card-pagination-dot-slide${t}-active-color`);o.forEach(i=>{i&&a.forEach(e=>{try{const s=t.getPropertyValue(e);s&&(l('CARD_MOD',`Forwarding ${e}: ${s}`),i.style.setProperty(e,s))}catch(t){l('CARD_MOD',`Error forwarding ${e}:`,t)}})})}catch(t){l('ERROR','Error forwarding CSS variables:',t)}}}}else l('CARD_MOD','No card-mod config or shadow root, skipping style application')}(this.Ni,this.shadowRoot,this.shadowRoot?.host,this.sliderElement,this.pagination.paginationElement)}le(){this.Ds&&(this.Ds.disconnect(),this.Ds=null),this.Ds=function(t,i){const e=new MutationObserver(t=>{t.some(t=>'attributes'===t.type&&('style'===t.attributeName||t.attributeName.includes('style')))&&(l('CARD_MOD','Host style attribute changed, reapplying card-mod styles'),i())});return t&&t.host&&(e.observe(t.host,{attributes:!0,attributeFilter:['style']}),l('CARD_MOD','Set up mutation observer for style changes')),e}(this.shadowRoot,()=>{this.ki()})}de(){this.Hs&&(this.Hs.disconnect(),this.Hs=null),this.sliderElement&&this.cards&&0!==this.cards.length&&(l('VISIBILITY','Setting up child visibility observer for cards with self-managed visibility'),this.Hs=new MutationObserver(t=>{let i=!1;for(const e of t)if('attributes'===e.type&&'class'===e.attributeName){const t=e.target,s=t.classList?.contains('hidden'),n=e.oldValue?.includes('hidden');if(s!==n){i=!0,l('VISIBILITY','Child card visibility changed via \'hidden\' class:',t.tagName);break}}i&&(this.Vs&&clearTimeout(this.Vs),this.Vs=setTimeout(()=>{this.isConnected&&!this.building&&(l('VISIBILITY','Triggering visibility update after child card visibility change'),this.Yi()),this.Vs=null},150))}),this.cards.forEach(t=>{t.element&&this.Hs.observe(t.element,{attributes:!0,attributeFilter:['class'],attributeOldValue:!0})}))}Wi(){this.Hs&&(this.Hs.disconnect(),this.Hs=null),this.Vs&&(clearTimeout(this.Vs),this.Vs=null)}goToSlide(t,i=1,e=!0){this.Oe=i;const s=this.visibleCardIndices.length;if(!this.visibleCardIndices||0===s||!this.initialized||this.building)return void l('SWIPE','goToSlide skipped',{totalVisible:s,initialized:this.initialized,building:this.building});const n=this.ii.view_mode||'single',o=this.ii.loop_mode||'none';t=this.loopMode.handleNavigation(t,'carousel'===n),this.currentIndex=t,l('SWIPE',`Going to visible slide ${this.currentIndex} (${n} mode)`);const a='infinite'===o?(this.currentIndex%s+s)%s:this.currentIndex;this.stateSynchronization?.onCardNavigate(a),this.updateSlider(e),this.autoHeight?.updateForCurrentCard(),this.autoSwipe.isInProgress||this.resetAfter.isInProgress||this.resetAfter.startTimer(),!this.ii.enable_auto_swipe||this.autoSwipe.isInProgress||this.resetAfter.isInProgress||this.autoSwipe.pause(5e3)}updateSlider(t=!0){if(this.cardContainer){const t=0===this.slideWidth||0===this.slideHeight;if(t||300===this.slideWidth&&100===this.slideHeight){const i=this.cardContainer.offsetWidth,e=this.cardContainer.offsetHeight;i>0&&e>0&&(this.slideWidth=i,this.slideHeight=e,l('SWIPE','Recalculated dimensions in updateSlider:',{width:this.slideWidth,height:this.slideHeight,reason:t?'uninitialized':'fallback'}))}}const i=this.visibleCardIndices.length;if(l('SWIPE',`Updating slider to visible index ${this.currentIndex}`,{animate:t,totalVisible:i,viewMode:this.ii.view_mode}),!this.sliderElement||0===i||!this.initialized||this.building)return void l('SWIPE','updateSlider skipped',{slider:!!this.sliderElement,totalVisible:i,init:this.initialized,building:this.building});if(this.scrollStrategy?.isNative()){const i=Math.max(0,parseInt(this.ii.card_spacing))||0;return this.sliderElement.style.gap=`${i}px`,$t(this.cards),this.scrollStrategy.scrollToIndex(this.currentIndex,t),this.pagination.update(t),void(this.Oe=1)}const e=Math.max(0,parseInt(this.ii.card_spacing))||0,s=this.ii.loop_mode||'none';if('carousel'===(this.ii.view_mode||'single')&&this.carouselView){this.sliderElement.style.gap=`${e}px`;let i=t?null:0;if(t&&'free'===this.ii.swipe_behavior&&this.Oe>1){i=this.swipeBehavior.calculateAnimationDuration(this.Oe);const t=this.swipeBehavior.getEasingFunction(this.Oe);this.sliderElement.style.transition=`transform ${i}ms ${t}`,l('SWIPE',`Carousel multi-card animation: ${this.Oe} cards, ${i}ms duration, easing: ${t}`)}return this.carouselView.updateSliderPosition(this.currentIndex,t),this.swipeEffects?.applyEffect(this.currentIndex,t),this.pagination.update(t),this.Oe=1,void(t&&(i>0||null===i)&&this.loopMode.scheduleSeamlessJump(this.currentIndex,i))}const n='horizontal'===this.Qt;let o=this.currentIndex;if('infinite'===s&&i>1){const t=this.loopMode.getDuplicateCount();o=this.currentIndex+t,l('SWIPE',`Infinite mode: logical index ${this.currentIndex} -> DOM position ${o}`)}else'none'!==s&&i>1?this.currentIndex<0?this.currentIndex=i-1:this.currentIndex>=i&&(this.currentIndex=0):this.currentIndex=Math.max(0,Math.min(this.currentIndex,i-1)),o=this.currentIndex;this.sliderElement.style.gap=`${e}px`;let a=0;a=n?o*(this.slideWidth+e):o*(this.slideHeight+e);let r=null;if(t&&'free'===this.ii.swipe_behavior&&this.Oe>1){r=this.swipeBehavior.calculateAnimationDuration(this.Oe);const t=this.swipeBehavior.getEasingFunction(this.Oe);this.sliderElement.style.transition=`transform ${r}ms ${t}`,l('SWIPE',`Multi-card animation: ${this.Oe} cards, ${r}ms duration, easing: ${t}`)}else this.sliderElement.style.transition=this.ti(t);const d=this.swipeEffects?.getSliderTransform(t);if(this.sliderElement.style.transform=d||(this.ae?`translate${n?'X':'Y'}(calc(${-o} * (100% + ${e}px)))`:n?`translateX(-${a}px)`:`translateY(-${a}px)`),!n)if(t){this.$n&&clearTimeout(this.$n);let t=300;if(r&&r>0)t=r;else if(this.sliderElement.isConnected){const i=getComputedStyle(this.sliderElement).getPropertyValue('--simple-swipe-card-transition-speed').trim();i&&i.endsWith('s')?t=1e3*parseFloat(i):i&&i.endsWith('ms')&&(t=parseFloat(i))}this.sliderElement.classList.add('animating'),this.$n=setTimeout(()=>{this.sliderElement.classList.remove('animating'),this.Mn(o),this.$n=null},t)}else this.sliderElement.classList.remove('animating'),this.Mn(o);$t(this.cards),this.pagination.update(t),this.Oe=1,l('SWIPE',`Slider updated, DOM position: ${o}, transform: -${a}px along ${n?'X':'Y'} axis`),this.swipeEffects?.applyEffect(this.currentIndex,t),t&&(r>0||null===r)&&this.loopMode.scheduleSeamlessJump(this.currentIndex,r)}An(t){this.pagination.paginationElement&&this.pagination.paginationElement.querySelectorAll('.pagination-dot').forEach((i,e)=>{i.classList.toggle('active',e===t)})}Mn(t){if(!this.sliderElement)return;const i=this.sliderElement.querySelectorAll('.slide');0!==i.length&&(i.forEach((i,e)=>{e===t?i.classList.add('active-slide'):i.classList.remove('active-slide')}),l('SWIPE',`Active slide updated: position ${t}`))}ce(){this.shadowRoot&&(l('DROPDOWN','Setting up dropdown detection'),this.On=0,this._n=t=>{const i=t.target;t.composedPath().includes(this)&&(l('DROPDOWN',`Dropdown opened: ${i.tagName}`,i),this.Nn())},this.kn=t=>{const i=t.target;t.composedPath().includes(this)&&(l('DROPDOWN',`Dropdown closed: ${i.tagName}`,i),this.Rn())},document.addEventListener('opened',this._n,!0),document.addEventListener('closed',this.kn,!0),document.addEventListener('MDCMenuSurface:opened',this._n,!0),document.addEventListener('MDCMenuSurface:closed',this.kn,!0),this.Dn=new MutationObserver(t=>{t.forEach(t=>{t.addedNodes.forEach(t=>{t.nodeType===Node.ELEMENT_NODE&&('MWC-MENU'===t.tagName||'HA-SELECT'===t.tagName||'MUSHROOM-SELECT'===t.tagName||t.classList?.contains('mdc-menu-surface')||t.classList?.contains('mdc-select__menu'))&&t.open&&(l('DROPDOWN','Dropdown element added to DOM and opened',t),this.Nn())}),t.removedNodes.forEach(t=>{t.nodeType===Node.ELEMENT_NODE&&('MWC-MENU'===t.tagName||'HA-SELECT'===t.tagName||'MUSHROOM-SELECT'===t.tagName||t.classList?.contains('mdc-menu-surface')||t.classList?.contains('mdc-select__menu'))&&(l('DROPDOWN','Dropdown element removed from DOM',t),this.Rn())})})}),this.Dn.observe(this.shadowRoot,{childList:!0,subtree:!0}),l('DROPDOWN','Dropdown detection setup complete'))}In(){l('DROPDOWN','Cleaning up dropdown detection'),this._n&&(document.removeEventListener('opened',this._n,!0),document.removeEventListener('closed',this.kn,!0),document.removeEventListener('MDCMenuSurface:opened',this._n,!0),document.removeEventListener('MDCMenuSurface:closed',this.kn,!0),this._n=null,this.kn=null),this.Dn&&(this.Dn.disconnect(),this.Dn=null),this.On=0,this.classList.remove('dropdown-open'),l('DROPDOWN','Dropdown detection cleanup complete')}Nn(){this.On++,1===this.On&&(this.classList.add('dropdown-open'),l('DROPDOWN','Elevated z-index - dropdown opened'))}Rn(){this.On=Math.max(0,this.On-1),0===this.On&&(this.classList.remove('dropdown-open'),l('DROPDOWN','Restored z-index - all dropdowns closed'))}getCardSize(){if(0===this.visibleCardIndices.length)return 3;if(this.building){if(this.ii.min_height){const t=Math.ceil(parseInt(this.ii.min_height)/50);return l('CONFIG','Building - estimated card size from min_height:',t),t}return l('CONFIG','Building - using default estimated size: 5'),5}let t=3;if(this.cards&&this.cards.length>0){const i=this.cards[this.currentIndex];if(i?.element&&!i.error&&'function'==typeof i.element.getCardSize)try{t=i.element.getCardSize()}catch(i){console.warn('Error getting card size from current element:',i),t=3}else i?.element&&i.element.offsetHeight&&(t=Math.max(1,Math.ceil(i.element.offsetHeight/50)))}return l('CONFIG','Calculated card size:',t),Math.max(3,t)}getGridOptions(){const t={columns:12};return'vertical'!==this.ii?.swipe_direction||this.ii?.grid_options||(t.rows=4),t}}class Bt{constructor(t){this.editor=t,this.collapsibleState={advanced:!1,cards:!0},this.Ln=null,this.Pn=null}cleanup(){this.Ln&&(clearTimeout(this.Ln),this.Ln=null),this.Pn&&(clearTimeout(this.Pn),this.Pn=null),l('EDITOR','EditorUIManager cleanup completed')}async initializeEditor(){this.editor.xn=`swipe-card-editor-${Math.random().toString(36).substring(2,15)}`,this.editor.Hn=this.editor.cardManagement.handleCardPicked.bind(this.editor.cardManagement),this.editor.Vn=this.editor.eventHandling.zn.bind(this.editor.eventHandling),this.editor.Fn=new Set,this.editor.Un=null,this.editor.Bn=!1,this.editor.Wn={active:!1,parentDialogId:null,elementId:null,timestamp:null,savedState:null},Ot(o).set(this.editor.xn,this)}toggleSection(t){this.collapsibleState[t]=!this.collapsibleState[t],this.editor.requestUpdate()}getCollapsibleState(){return this.collapsibleState}async ensureComponentsLoaded(){let t=0;if(!customElements.get('hui-card-picker'))for(;!customElements.get('hui-card-picker')&&t<10;){try{if(await this.loadCustomElements(),customElements.get('hui-card-picker'))return}catch(t){}await new Promise(t=>setTimeout(t,100)),t++}}async loadCustomElements(){if(!customElements.get('hui-card-picker'))try{const t=[()=>customElements.get('hui-entities-card')?.getConfigElement?.(),()=>customElements.get('hui-conditional-card')?.getConfigElement?.(),()=>customElements.get('hui-vertical-stack-card')?.getConfigElement?.(),()=>customElements.get('hui-horizontal-stack-card')?.getConfigElement?.()];for(const i of t)try{if(await i(),customElements.get('hui-card-picker'))break}catch(t){}}catch(t){}}ensureCardPickerLoaded(){this.editor.shadowRoot&&(this.Ln&&clearTimeout(this.Ln),this.Ln=setTimeout(()=>{this.Yn(),this.Ln=null},100))}Yn(){if(l('EDITOR','_ensureCardPickerLoaded called'),!this.editor.shadowRoot)return void l('EDITOR','shadowRoot not ready, skipping card picker load');const t=this.editor.shadowRoot.querySelector('#card-picker-container');if(!t)return void l('EDITOR','Card picker container not found, skipping');t.style.display='block',t.hasAttribute('event-barrier-applied')||(t.setAttribute('event-barrier-applied','true'),t.addEventListener('config-changed',t=>{this.jn(t)},{capture:!0,passive:!1}));const i=t.querySelector('hui-card-picker');i?(i.style.display='block',i.requestUpdate&&!i.Gn&&(i.requestUpdate(),i.Gn=!0)):l('EDITOR','hui-card-picker element not found in container'),this.Jn()}jn(t){if(l('EDITOR','Intercepted config-changed at container level:',t.detail?.config?.type),t.target&&t.target.tagName&&'hui-card-picker'===t.target.tagName.toLowerCase()&&t.detail&&t.detail.config){const i=t.detail.config;if(l('EDITOR','Processing card selection:',i.type),this.editor.ii){const t=Array.isArray(this.editor.ii.cards)?[...this.editor.ii.cards]:[];t.push(i),this.editor.ii={...this.editor.ii,cards:t},this.editor.configManager.fireConfigChanged({cardAdded:!0,cardType:i.type}),this.Jn()}}return t.stopPropagation(),t.stopImmediatePropagation&&t.stopImmediatePropagation(),!1}Jn(){this.Pn||(this.Pn=setTimeout(()=>{this.editor.requestUpdate(),this.Pn=null},50))}}class Wt{constructor(t){this.editor=t,this.Pn=null}setConfig(t){if(!t)throw new Error('Invalid configuration');if(l('EDITOR','Editor setConfig received:',JSON.stringify(t)),this.editor.ii=JSON.parse(JSON.stringify(t)),Array.isArray(this.editor.ii.cards)||(this.editor.ii.cards=[]),void 0===this.editor.ii.show_pagination&&(this.editor.ii.show_pagination=!0),void 0===this.editor.ii.auto_hide_pagination)this.editor.ii.auto_hide_pagination=0;else{const t=parseInt(this.editor.ii.auto_hide_pagination);this.editor.ii.auto_hide_pagination=isNaN(t)||t<0?0:Math.min(t,3e4)}if(void 0===this.editor.ii.card_spacing)this.editor.ii.card_spacing=15;else{const t=parseInt(this.editor.ii.card_spacing);this.editor.ii.card_spacing=isNaN(t)||t<0?15:t}if(void 0!==this.editor.ii.enable_loopback&&void 0===this.editor.ii.loop_mode&&(this.editor.ii.loop_mode=this.editor.ii.enable_loopback?'loopback':'none',delete this.editor.ii.enable_loopback,l('CONFIG','Migrated enable_loopback to loop_mode:',this.editor.ii.loop_mode)),void 0===this.editor.ii.loop_mode&&(this.editor.ii.loop_mode='none'),['none','loopback','infinite'].includes(this.editor.ii.loop_mode)||(l('CONFIG','Invalid loop_mode, defaulting to \'none\':',this.editor.ii.loop_mode),this.editor.ii.loop_mode='none'),void 0!==this.editor.ii.swipe_direction&&['horizontal','vertical'].includes(this.editor.ii.swipe_direction)||(this.editor.ii.swipe_direction='horizontal'),void 0!==this.editor.ii.swipe_effect&&['slide','bounce','spring','instant','fade','flip','coverflow','creative','cards','reveal','zoom','swing'].includes(this.editor.ii.swipe_effect)||(this.editor.ii.swipe_effect='slide'),void 0!==this.editor.ii.scroll_strategy&&['js','css'].includes(this.editor.ii.scroll_strategy)||(this.editor.ii.scroll_strategy='js'),void 0===this.editor.ii.swipe_behavior&&(this.editor.ii.swipe_behavior='single'),['single','free'].includes(this.editor.ii.swipe_behavior)?'free'===this.editor.ii.swipe_behavior&&'infinite'!==this.editor.ii.loop_mode&&(this.editor.ii.swipe_behavior='single',l('CONFIG','Free swipe behavior requires infinite loop mode, defaulting to single')):this.editor.ii.swipe_behavior='single',void 0===this.editor.ii.auto_height&&(this.editor.ii.auto_height=!1),!0===this.editor.ii.auto_height&&('carousel'===this.editor.ii.view_mode||'vertical'===this.editor.ii.swipe_direction||'infinite'===this.editor.ii.loop_mode)&&(delete this.editor.ii.auto_height,l('CONFIG','auto_height removed: incompatible with current mode (carousel, vertical, or infinite loop)')),void 0===this.editor.ii.enable_auto_swipe&&(this.editor.ii.enable_auto_swipe=!1),void 0===this.editor.ii.auto_swipe_interval?this.editor.ii.auto_swipe_interval=2e3:(this.editor.ii.auto_swipe_interval=parseInt(this.editor.ii.auto_swipe_interval),(isNaN(this.editor.ii.auto_swipe_interval)||this.editor.ii.auto_swipe_interval<500)&&(this.editor.ii.auto_swipe_interval=2e3)),void 0===this.editor.ii.enable_reset_after&&(this.editor.ii.enable_reset_after=!1),void 0===this.editor.ii.reset_after_timeout?this.editor.ii.reset_after_timeout=3e4:(this.editor.ii.reset_after_timeout=parseInt(this.editor.ii.reset_after_timeout),(isNaN(this.editor.ii.reset_after_timeout)||this.editor.ii.reset_after_timeout<5e3)&&(this.editor.ii.reset_after_timeout=3e4)),void 0===this.editor.ii.reset_target_card)this.editor.ii.reset_target_card=1;else{const t=this.editor.ii.reset_target_card;'string'==typeof t&&(t.includes('{{')||t.includes('{%')||t.includes('[[['))||(this.editor.ii.reset_target_card=Math.max(1,parseInt(t)||1))}if(void 0===this.editor.ii.view_mode&&(this.editor.ii.view_mode='single'),['single','carousel'].includes(this.editor.ii.view_mode)||(this.editor.ii.view_mode='single'),'carousel'===this.editor.ii.view_mode){if(void 0===this.editor.ii.card_min_width)this.editor.ii.card_min_width=200;else{const t=parseInt(this.editor.ii.card_min_width);(isNaN(t)||t<50||t>500)&&(this.editor.ii.card_min_width=200)}if(void 0!==this.editor.ii.cards_visible){const t=parseFloat(this.editor.ii.cards_visible);this.editor.ii.cards_visible=isNaN(t)||t<1.1||t>8?2.5:Math.round(10*t)/10}['start','center'].includes(this.editor.ii.carousel_alignment)||(this.editor.ii.carousel_alignment='start')}delete this.editor.ii.title,setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),50)}handleValueChanged(t){if(!this.editor.ii||!t.target)return;const i=t.target,e=i.configValue||i.getAttribute('data-option'),s=i.parentElement?.configValue||i.parentElement?.getAttribute('data-option'),n=e||s;if(!n)return;let o;if('ha-entity-picker'===i.localName&&'value-changed'===t.type?o=t.detail.value||null:'ha-switch'===i.localName?o=i.checked:'ha-slider'===i.localName?(o=i.value,null==o&&(o=t.detail?.value||0)):['ha-textfield','ha-input','input'].includes(i.localName)&&('number'===i.type||['card_spacing','auto_swipe_interval','card_min_width','cards_visible'].includes(n))?(o=parseFloat(t.detail&&'value'in t.detail?t.detail.value:i.value),(isNaN(o)||o<0)&&(o='card_spacing'===n?15:'auto_swipe_interval'===n?2e3:'reset_after_timeout'===n?3e4:'card_min_width'===n?200:'cards_visible'===n?2.5:0)):o=t.detail&&'value'in t.detail?t.detail.value:i.value,'auto_hide_pagination'===n&&(o=1e3*parseFloat(o),isNaN(o)||o<0?o=0:o>3e4&&(o=3e4),l('EDITOR',`Auto-hide pagination: ${o/1e3}s = ${o}ms`)),this.editor.ii[n]!==o){if('view_mode'===n){l('EDITOR',`View mode changing from ${this.editor.ii[n]} to ${o}`);const t={...this.editor.ii,[n]:o};return'carousel'===o?(delete t.swipe_direction,t.auto_height&&(delete t.auto_height,l('EDITOR','Removed auto_height (incompatible with carousel mode)')),t.cards_visible||t.card_min_width||(t.card_min_width=200),l('EDITOR','Cleaned config for carousel mode:',Object.keys(t))):'single'===o&&(delete t.cards_visible,delete t.card_min_width,t.swipe_direction||(t.swipe_direction='horizontal'),l('EDITOR','Cleaned config for single mode:',Object.keys(t))),this.editor.ii=t,this.fireConfigChanged(),void this.Jn()}if('card_min_width'===n){if(l('EDITOR',`User changed card_min_width to ${o}, migrating from legacy mode`),void 0!==this.editor.ii.cards_visible){const t={...this.editor.ii};delete t.cards_visible,t.card_min_width=o,this.editor.ii=t,l('EDITOR','Migrated from cards_visible to card_min_width')}else this.editor.ii={...this.editor.ii,[n]:o};return this.fireConfigChanged(),void this.Jn()}if('view_mode'===n&&'carousel'===o||'swipe_direction'===n&&'vertical'===o||'loop_mode'===n&&'infinite'===o){l('EDITOR',`Mode change detected that affects auto_height: ${n} = ${o}`);const t={...this.editor.ii,[n]:o};return t.auto_height&&(delete t.auto_height,l('EDITOR',`Removed auto_height due to incompatible mode: ${n} = ${o}`)),this.editor.ii=t,this.fireConfigChanged(),void this.Jn()}l('EDITOR',`Value changed for ${n}:`,o),this.editor.ii={...this.editor.ii,[n]:o},this.fireConfigChanged(),this.Jn()}}Jn(){this.Pn||(this.Pn=setTimeout(()=>{this.editor.requestUpdate(),this.Pn=null},50))}handleTimeoutChange(t){const i=parseInt(t.target.value);!isNaN(i)&&i>=5&&(this.editor.ii={...this.editor.ii,reset_after_timeout:1e3*i},this.fireConfigChanged())}handleTargetChange(t){const i=t.target.value;if('string'==typeof i&&(i.includes('{{')||i.includes('{%')||i.includes('[[[')))this.editor.ii={...this.editor.ii,reset_target_card:i},this.fireConfigChanged();else{const t=parseInt(i);!isNaN(t)&&t>=1&&(this.editor.ii={...this.editor.ii,reset_target_card:t},this.fireConfigChanged())}}getCleanConfig(t){if(!t)return{};const i={type:t.type};t.view_mode&&'single'!==t.view_mode&&(i.view_mode=t.view_mode),'carousel'===t.view_mode&&(void 0!==t.cards_visible?i.cards_visible=t.cards_visible:void 0!==t.card_min_width&&200!==t.card_min_width&&(i.card_min_width=t.card_min_width),'center'===t.carousel_alignment&&(i.carousel_alignment=t.carousel_alignment));const e={show_pagination:!0,card_spacing:15,loop_mode:'none',swipe_direction:'horizontal',swipe_behavior:'single',swipe_effect:'slide',scroll_strategy:'js',enable_auto_swipe:!1,auto_swipe_interval:2e3,enable_reset_after:!1,reset_after_timeout:3e4,reset_target_card:1,enable_backdrop_filter:!1};return['card_spacing','scroll_strategy','swipe_direction','swipe_behavior','swipe_effect','show_pagination','auto_hide_pagination','auto_height'].forEach(s=>{void 0!==t[s]&&t[s]!==e[s]&&(i[s]=t[s])}),['loop_mode','enable_auto_swipe','auto_swipe_interval','enable_reset_after','reset_after_timeout','reset_target_card','state_entity','enable_backdrop_filter'].forEach(s=>{'state_entity'===s?t.state_entity&&null!==t.state_entity&&''!==t.state_entity&&(i.state_entity=t.state_entity):void 0!==t[s]&&t[s]!==e[s]&&(i[s]=t[s])}),Array.isArray(t.cards)&&(i.cards=t.cards),['grid_options','layout_options','view_layout'].forEach(e=>{void 0!==t[e]&&(i[e]=t[e])}),void 0!==t.card_mod&&(i.card_mod=t.card_mod),i}fireConfigChanged(t={}){const i=this.getCleanConfig(this.editor.ii);!function(t,i,e={}){if(!i)return;const s=!e.maintainEditorState,n=new CustomEvent('config-changed',{detail:{config:i,...e},bubbles:s,composed:!0});l('EVENT','Firing config-changed event',{bubble:s,...e}),t.dispatchEvent(n)}(this.editor,i,{editorId:this.editor.xn,fromSwipeCardEditor:!0,...t})}cleanup(){this.Pn&&(clearTimeout(this.Pn),this.Pn=null),l('EDITOR','EditorConfigManager cleanup completed')}}class Yt{constructor(t){this.editor=t}getCardDescriptor(t){if(!t?.type)return{typeName:'Unknown',name:'',isPictureElements:!1};const i=t.type.startsWith('custom:')?t.type.substring(7):t.type,e=i.split(/[-_]/).map(t=>t.charAt(0).toUpperCase()+t.slice(1)).join(' ');return{typeName:e,name:t.title||t.name||'',isPictureElements:'picture-elements'===i}}hasNestedCards(t){return!('custom:actions-card'!==t.type||!t.card)&&(Array.isArray(t.card)?t.card.length>0:!!t.card)}getNestedCards(t){return this.hasNestedCards(t)?Array.isArray(t.card)?t.card:[t.card]:[]}hasVisibilityConditions(t){return t&&Array.isArray(t.visibility)&&t.visibility.length>0}isPictureElementsCard(t){return t&&'picture-elements'===t.type}moveCard(t,i){if(!this.editor.ii?.cards)return;const e=[...this.editor.ii.cards],s=t+i;s<0||s>=e.length||(l('EDITOR',`Moving card ${t} to position ${s}`),[e[t],e[s]]=[e[s],e[t]],this.editor.ii={...this.editor.ii,cards:e},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate())}removeCard(t){if(!this.editor.ii?.cards||t<0||t>=this.editor.ii.cards.length)return;l('EDITOR',`Removing card at index ${t}`);const i=this.editor.ii.cards.filter((i,e)=>e!==t);this.editor.ii={...this.editor.ii,cards:i},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate()}moveNestedCard(t,i,e){if(!this.editor.ii?.cards||!this.editor.ii.cards[t])return;const s=this.editor.ii.cards[t];if(!this.hasNestedCards(s))return;const n=this.getNestedCards(s),o=i+e;if(o<0||o>=n.length)return;l('EDITOR',`Moving nested card ${t}.${i} to position ${t}.${o}`),[n[i],n[o]]=[n[o],n[i]];const a=[...this.editor.ii.cards];a[t]={...s,card:n},this.editor.ii={...this.editor.ii,cards:a},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate()}removeNestedCard(t,i){if(!this.editor.ii?.cards||!this.editor.ii.cards[t])return;const e=this.editor.ii.cards[t];if(!this.hasNestedCards(e))return;let s=this.getNestedCards(e);if(i<0||i>=s.length)return;l('EDITOR',`Removing nested card ${t}.${i}`),s=s.filter((t,e)=>e!==i);const n=[...this.editor.ii.cards];n[t]={...e,card:s},this.editor.ii={...this.editor.ii,cards:n},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate()}async editCard(t){if(l('EDITOR',`_editCard called for index ${t}`),!this.editor.ii||!this.editor.ii.cards||t<0||t>=this.editor.ii.cards.length)return void l('ERROR','SimpleSwipeCardEditor: Invalid index for card editing:',t);const i=this.editor.ii.cards[t],e=this.editor.hass,s=document.querySelector('home-assistant');if(e&&s)try{await customElements.whenDefined('hui-dialog-edit-card');const n=document.createElement('hui-dialog-edit-card');n.hass=e,document.body.appendChild(n),this.editor.Fn.add(n),n.qn=this.editor.xn,this.isPictureElementsCard(i)&&(n.setAttribute('data-editing-picture-elements','true'),n.Xn=!0),l('EDITOR',`[CARD INDEX ${t}] hui-dialog-edit-card created and added to body. Tracking it.`);const o=this.editor.eventHandling.handleDialogConfigChanged.bind(this.editor.eventHandling,t,n),a=this.editor.eventHandling.handleDialogShowDialog.bind(this.editor.eventHandling,t);n.addEventListener('config-changed',o,{capture:!0}),n.addEventListener('show-dialog',a,{capture:!0}),n.addEventListener('ll-show-dialog',a,{capture:!0}),this.isPictureElementsCard(i)&&(n.addEventListener('element-updated',t=>{l('ELEMENT','Element updated event on dialog',t.detail),n.Zn=!0,this.editor.eventHandling.Wn.active=!0,this.editor.eventHandling.Wn.timestamp=Date.now()},{capture:!0}),n.addEventListener('show-edit-element',t=>{l('ELEMENT','Show edit element event on dialog',t.detail),n.Zn=!0,this.editor.eventHandling.Wn.active=!0,this.editor.eventHandling.Wn.timestamp=Date.now()},{capture:!0})),'custom:actions-card'===i.type&&(n.Kn=!0);const r=()=>{if(l('EDITOR',`[CARD INDEX ${t}] hui-dialog-edit-card closed event received.`),n.removeEventListener('dialog-closed',r),n.removeEventListener('config-changed',o,{capture:!0}),n.removeEventListener('show-dialog',a,{capture:!0}),n.removeEventListener('ll-show-dialog',a,{capture:!0}),this.isPictureElementsCard(i)&&(n.removeEventListener('element-updated',d,{capture:!0}),n.removeEventListener('show-edit-element',h,{capture:!0})),this.editor.Fn.delete(n),l('EDITOR',`[CARD INDEX ${t}] hui-dialog-edit-card removed from tracking. Active child editors: ${this.editor.Fn.size}`),n.Zn&&(l('ELEMENT','Element edit session reset due to dialog close'),setTimeout(()=>{this.editor.eventHandling.Wn.active&&Date.now()-this.editor.eventHandling.Wn.timestamp>500&&(this.editor.eventHandling.Wn.active=!1)},500)),n.parentNode===document.body)try{document.body.removeChild(n),l('EDITOR',`[CARD INDEX ${t}] hui-dialog-edit-card removed from body.`)}catch(i){console.warn(`[CARD INDEX ${t}] Error removing dialog from body:`,i)}setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)};n.addEventListener('dialog-closed',r);const d=t=>{l('ELEMENT','Element updated event on dialog',t.detail),n.Zn=!0,this.editor.eventHandling.Wn.active=!0,this.editor.eventHandling.Wn.timestamp=Date.now()},h=t=>{l('ELEMENT','Show edit element event on dialog',t.detail),n.Zn=!0,this.editor.eventHandling.Wn.active=!0,this.editor.eventHandling.Wn.timestamp=Date.now()};this.isPictureElementsCard(i)&&(n.addEventListener('element-updated',d,{capture:!0}),n.addEventListener('show-edit-element',h,{capture:!0}));const c={cardConfig:i,lovelaceConfig:this.editor.lovelace||s.lovelace,saveCardConfig:async i=>{if(l('EDITOR',`[CARD INDEX ${t}] saveCardConfig callback in hui-dialog-edit-card invoked.`),n.Qn||n.Zn){if(l('ELEMENT',`[CARD INDEX ${t}] Save detected from element editor, preserving dialog state`),n.Qn=!1,this.editor.eventHandling.Wn.timestamp=Date.now(),i){l('ELEMENT','Silently updating config with element changes');const e=[...this.editor.ii.cards];e[t]=i,this.editor.ii={...this.editor.ii,cards:e},this.editor.configManager.fireConfigChanged({maintainEditorState:!0,fromElementEditor:!0,updatedCardIndex:t})}return i}if(n.io&&!i)return l('ELEMENT',`[CARD INDEX ${t}] Element editor cancel detected, restoring previous config`),void(n.io=null);if(!i)return;const e=[...this.editor.ii.cards];e[t]=i,this.editor.ii={...this.editor.ii,cards:e},this.editor.configManager.fireConfigChanged({reason:'child_dialog_saved'}),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)}};l('EDITOR',`[CARD INDEX ${t}] About to call dialog.showDialog()`),await n.showDialog(c),l('EDITOR',`[CARD INDEX ${t}] dialog.showDialog() finished.`)}catch(e){l('ERROR','SimpleSwipeCardEditor: Error opening edit dialog:',e),At(this.editor,'ll-show-dialog',{dialogTag:'hui-dialog-edit-card',dialogImport:()=>import('hui-dialog-edit-card'),dialogParams:{cardConfig:i,lovelaceConfig:this.editor.lovelace||s.lovelace,saveCardConfig:async i=>{if(!i)return;const e=[...this.editor.ii.cards];e[t]=i,this.editor.ii={...this.editor.ii,cards:e},this.editor.configManager.fireConfigChanged({reason:'child_dialog_saved_fallback'}),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)}}})}else l('ERROR','SimpleSwipeCardEditor: Cannot find Home Assistant instance')}async editNestedCard(t,i){if(l('EDITOR',`_editNestedCard called for parent ${t}, nested ${i}`),!this.editor.ii?.cards||!this.editor.ii.cards[t]||!this.hasNestedCards(this.editor.ii.cards[t]))return void l('ERROR','SimpleSwipeCardEditor: Invalid indices for nested card editing:',t,i);const e=this.editor.ii.cards[t],s=this.getNestedCards(e);if(i<0||i>=s.length)return;const n=s[i],o=this.editor.hass,a=document.querySelector('home-assistant');if(o&&a)try{await customElements.whenDefined('hui-dialog-edit-card');const r=document.createElement('hui-dialog-edit-card');r.hass=o,document.body.appendChild(r),this.editor.Fn.add(r),r.qn=this.editor.xn,this.isPictureElementsCard(n)&&(r.setAttribute('data-editing-picture-elements','true'),r.Xn=!0),r.addEventListener('config-changed',t=>{if(this.editor.eventHandling.eo(t))return l('ELEMENT','Nested card: Detected element editor event, allowing natural propagation'),r.Zn=!0,this.editor.eventHandling.Wn.active=!0,this.editor.eventHandling.Wn.timestamp=Date.now(),void(t.detail&&t.detail.config&&(r.io=JSON.parse(JSON.stringify(t.detail.config)),r.Qn=!0));(t.detail?.fromExternalEditor||t.detail?.fromActionCardEditor||t.detail?.fromSwipeCardEditor)&&(l('EDITOR','Marking nested event as already handled in _editNestedCard\'s dialog'),t.so=!0)},!0);const d=()=>{if(r.removeEventListener('dialog-closed',d),r.Zn&&(l('ELEMENT','Dialog handling element edit is closing, ending element edit session'),this.editor.eventHandling.Wn.active=!1),this.editor.Fn.delete(r),r.parentNode===document.body)try{document.body.removeChild(r)}catch(t){console.warn('Error removing nested card dialog:',t)}setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)};r.addEventListener('dialog-closed',d);const h={cardConfig:n,lovelaceConfig:this.editor.lovelace||a.lovelace,saveCardConfig:async n=>{if(r.Qn||r.Zn){if(l('ELEMENT','Nested card: Save detected from element editor, preserving dialog state'),r.Qn=!1,this.editor.eventHandling.Wn.timestamp=Date.now(),n){l('ELEMENT','Silently updating nested card config with element changes');const o=[...s];o[i]=n;const a={...e,card:o},r=[...this.editor.ii.cards];r[t]=a,this.editor.ii={...this.editor.ii,cards:r},this.editor.configManager.fireConfigChanged({maintainEditorState:!0,fromElementEditor:!0,updatedCardIndex:t,nestedCardIndex:i})}return n}if(r.io&&!n)return l('ELEMENT','Nested card: Element editor cancel detected, restoring previous config'),void(r.io=null);if(!n)return;l('EDITOR',`Saving nested card ${t}.${i} with new config`);const o=[...s];o[i]=n;const a={...e,card:o},d=[...this.editor.ii.cards];d[t]=a,this.editor.ii={...this.editor.ii,cards:d},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)}};await r.showDialog(h)}catch(o){l('ERROR','SimpleSwipeCardEditor: Error opening edit dialog for nested card:',o),At(this.editor,'ll-show-dialog',{dialogTag:'hui-dialog-edit-card',dialogImport:()=>import('hui-dialog-edit-card'),dialogParams:{cardConfig:n,lovelaceConfig:this.editor.lovelace||a.lovelace,saveCardConfig:async n=>{if(!n)return;const o=[...s];o[i]=n;const a={...e,card:o},r=[...this.editor.ii.cards];r[t]=a,this.editor.ii={...this.editor.ii,cards:r},this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100)}}})}else l('ERROR','SimpleSwipeCardEditor: Cannot find Home Assistant instance')}safelyAddCard(t){if(t&&this.editor.ii)try{const i=Array.isArray(this.editor.ii.cards)?[...this.editor.ii.cards]:[],e={...this.editor.ii,cards:[...i,t]};this.editor.ii=e,this.editor.configManager.fireConfigChanged({isSafeCardAddition:!0,addedCardType:t.type}),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),50),l('EDITOR','Safely added card:',t.type)}catch(t){l('ERROR','Failed to safely add card:',t)}}handleCardPicked(t){if(l('EDITOR','Fallback _handleCardPicked called:',t.detail?.config?.type),t.stopPropagation(),t.stopImmediatePropagation&&t.stopImmediatePropagation(),!t.detail?.config)return;const i=t.detail.config;l('EDITOR','Adding card in fallback handler:',i.type);const e=Array.isArray(this.editor.ii.cards)?[...this.editor.ii.cards]:[],s={...this.editor.ii,cards:[...e,i]};this.editor.ii=s,this.editor.configManager.fireConfigChanged(),this.editor.requestUpdate()}}class jt{constructor(t){this.editor=t,this.Vn=this.zn.bind(this),this.Wn={active:!1,parentDialogId:null,elementId:null,timestamp:null,savedState:null},this.no=0,this.oo=1e3}setupEventListeners(){document.addEventListener('config-changed',this.Vn,{capture:!0}),this.ao=t=>{if(this.eo(t)){if(l('ELEMENT','Config-changed event from element editor, allowing propagation'),t.target&&t.target.closest('hui-dialog-edit-card')){const i=t.target.closest('hui-dialog-edit-card');i&&(i.Zn=!0,this.Wn.active=!0,this.Wn.parentDialogId=i.qn||null,this.Wn.timestamp=Date.now())}}else if('config-changed'===t.type&&t.detail?.config){const i='custom:actions-card'===t.detail?.config?.type;if('hui-card-picker'===t.target?.tagName?.toLowerCase()&&(t.composedPath?t.composedPath():[]).some(t=>t===this.editor||t.shadowRoot&&t.shadowRoot.contains(this.editor)||this.editor.shadowRoot&&this.editor.shadowRoot.contains(t))&&(l('EDITOR','Card picker selection captured by global handler:',t.detail.config.type),i&&!this.editor.Bn))return this.editor.Un={time:Date.now(),config:t.detail.config},this.editor.Bn=!0,this.editor.ro(t.detail.config),t.stopImmediatePropagation&&t.stopImmediatePropagation(),void t.stopPropagation()}},document.addEventListener('config-changed',this.ao,{capture:!0}),this.do=t=>{if(t.lo)return l('EVENT','Intercepted iron-select event already processed by actions card editor'),void t.stopPropagation()},document.addEventListener('iron-select',this.do,{capture:!0}),this.ho=t=>{if(t.target&&'HUI-DIALOG-EDIT-CARD'===t.target.tagName){const i=t.target;l('EDITOR','A HUI-DIALOG-EDIT-CARD closed',{tracked:this.editor.Fn?.has(i)||!1,isActions:this.co(i),handlingElementEdit:i.Zn}),i.Zn&&(l('ELEMENT','Dialog handling element edit is closing, ending element edit session'),this.Wn.active=!1,i.io&&(l('ELEMENT','Preserving element config on dialog close'),this.Wn.savedState=i.io,i.io=null)),this.editor.Fn?.has(i)&&(this.editor.Fn.delete(i),this.editor.requestUpdate(),setTimeout(()=>this.editor.uiManager.ensureCardPickerLoaded(),100))}t.target&&('HUI-DIALOG-EDIT-ELEMENT'===t.target.tagName||'HUI-DIALOG'===t.target.tagName&&this.eo(t))&&(l('ELEMENT','Element editor dialog closed'),setTimeout(()=>{this.Wn.active&&Date.now()-this.Wn.timestamp>500&&(l('ELEMENT','Resetting element edit session after timeout'),this.Wn.active=!1)},500))},document.addEventListener('dialog-closed',this.ho,{capture:!0}),this.uo=t=>{'element-updated'!==t.type&&'show-edit-element'!==t.type||this.Wn.active||(l('ELEMENT',`Capturing ${t.type} event, starting element edit session`),this.Wn.active=!0,this.Wn.timestamp=Date.now(),t.detail&&t.detail.elementId&&(this.Wn.elementId=t.detail.elementId))},document.addEventListener('element-updated',this.uo,{capture:!0}),document.addEventListener('show-edit-element',this.uo,{capture:!0})}removeEventListeners(){document.removeEventListener('config-changed',this.ao,{capture:!0}),document.removeEventListener('iron-select',this.do,{capture:!0}),document.removeEventListener('config-changed',this.Vn,{capture:!0}),document.removeEventListener('dialog-closed',this.ho,{capture:!0}),document.removeEventListener('element-updated',this.uo,{capture:!0}),document.removeEventListener('show-edit-element',this.uo,{capture:!0})}eo(t){if(!t)return!1;const i=Date.now(),e=i-this.no>this.oo;if(t.detail&&(t.detail.fromElementEditor||t.detail.elementConfig||t.detail.elementToEdit||t.detail.element))return e&&(l('ELEMENT','Element editor detected through event detail'),this.no=i),!0;const s=t.composedPath?t.composedPath():[];for(const t of s)if(t&&t.localName){if('hui-element-editor'===t.localName||'hui-dialog-edit-element'===t.localName||'hui-card-element-editor'===t.localName||t.localName.includes('element-editor'))return e&&(l('ELEMENT','Element editor detected through path node localName:',t.localName),this.no=i),!0;if(t.po||t.fo||t.getAttribute&&(t.getAttribute('element-id')||t.getAttribute('data-element-id'))||t.classList&&t.classList.contains('element-editor'))return l('ELEMENT','Element editor detected through specialized attributes'),!0;if('HUI-DIALOG'===t.tagName&&(t.querySelector('.element-editor')||t.mo&&'string'==typeof t.mo&&t.mo.toLowerCase().includes('element')))return l('ELEMENT','Element editor detected through hui-dialog with element editor content'),!0}return'element-updated'===t.type||'config-changed'===t.type&&t.target&&('hui-element-editor'===t.target.localName||t.target.closest('hui-element-editor'))?(l('ELEMENT','Element editor detected through event characteristics'),!0):!!(this.Wn.active&&Date.now()-this.Wn.timestamp<5e3)&&(l('ELEMENT','Element editor event detected through active editing session'),!0)}co(t){if(!t)return!1;if(t.Kn)return!0;try{const i=t.cardConfig;return i&&'custom:actions-card'===i.type}catch(t){return!1}}zn(t,i){let e,s;if(t&&'function'==typeof t.preventDefault?(e=t,s=null):(s=t,e=i),!e)return;if(s&&'auto_hide_pagination'===s.option)return;if(e.detail&&(e.detail.fromSwipeCardEditor||e.detail.fromElementEditor||e.detail.elementEditorEvent||e.detail.maintainEditorState))return void l('ELEMENT','Skipping our own generated event to prevent loop');if(this.eo(e)&&(l('ELEMENT','Detected element editor event in _handleNestedCardEvents'),e.composedPath&&this.editor.Fn&&e.composedPath().some(t=>this.editor.Fn.has(t)||t.qn&&t.qn===this.editor.xn)))return void l('ELEMENT','Element editor event is related to our dialog stack, handling specially');if(e.vo||!e.detail?.fromActionCardEditor)return;const n=e.target.closest('[data-index]');if(!n||!this.editor.ii?.cards)return;const o=parseInt(n.getAttribute('data-index'));if(!(isNaN(o)||o<0||o>=this.editor.ii.cards.length)){if(l('EVENT',`Handling nested card event from actions card at index ${o}`,e.detail),e.stopPropagation(),e.preventDefault&&e.preventDefault(),e.detail.maintainEditorState){l('EVENT','Event marked to maintain editor state, preventing propagation');const t=[...this.editor.ii.cards];t[o]=e.detail.config,this.editor.ii={...this.editor.ii,cards:t},this.editor.configManager.fireConfigChanged({nestedCardUpdate:!0,updatedCardIndex:o,nestedCardType:e.detail.config.type,maintainEditorState:!0})}else{const t=[...this.editor.ii.cards];t[o]=e.detail.config,this.editor.ii={...this.editor.ii,cards:t},this.editor.configManager.fireConfigChanged({nestedCardUpdate:!0,updatedCardIndex:o,nestedCardType:e.detail.config.type})}e.vo=!0,this.editor.requestUpdate()}}handleDialogConfigChanged(t,i,e){{const t=e.composedPath?e.composedPath().map(t=>t.localName||t.nodeName).join(' > '):'No path',i=e.detail?JSON.stringify(e.detail,null,2):'{}';l('EVENT','Config change event details:',{target:e.target.localName,path:t,detail:JSON.parse(i),rawDetail:i,currentTarget:e.currentTarget.localName})}if(this.eo(e)){if(l('ELEMENT',`[CARD INDEX ${t}] Element editor event detected, preserving and allowing propagation`),i.Zn=!0,this.Wn.active=!0,this.Wn.timestamp=Date.now(),e.detail&&e.detail.config&&(i.io=JSON.parse(JSON.stringify(e.detail.config)),i.Qn=!0,i.Xn))try{l('ELEMENT','Silently updating picture-elements config');const i=[...this.editor.ii.cards];i[t]=e.detail.config,this.editor.ii={...this.editor.ii,cards:i},this.editor.configManager.fireConfigChanged({maintainEditorState:!0,fromElementEditor:!0,elementEditorEvent:!0,updatedCardIndex:t})}catch(t){l('ERROR','Error silently updating config:',t)}}else if(e.target!==i&&e.detail&&e.detail.config){e.stopPropagation();const i=e.detail.config;l('EDITOR',`[CARD INDEX ${t}] Config received in handler: ${JSON.stringify(i.type)}`);const s=[...this.editor.ii.cards];s[t]=i,this.editor.ii={...this.editor.ii,cards:s},this.editor.configManager.fireConfigChanged({maintainEditorState:!0,updatedCardIndex:t,reason:'child_dialog_update_'+(e.detail.fromActionCardEditor?'action_card':'generic')}),this.editor.requestUpdate(),l('EDITOR',`[CARD INDEX ${t}] Processed config-changed from content, stopped propagation OUTSIDE dialog.`)}else l('EDITOR',`[CARD INDEX ${t}] config-changed ignored or allowed to bubble (no config or event target is the dialog itself)`)}handleDialogShowDialog(t,i){if(i.detail&&(i.detail.dialogTag&&('hui-dialog-edit-element'===i.detail.dialogTag||i.detail.dialogTag.includes('element-editor'))||i.detail.elementToEdit)){l('ELEMENT',`[CARD INDEX ${t}] Element editor dialog detected, allowing normal event flow`);const e=i.currentTarget;return e&&(e.Zn=!0),this.Wn.active=!0,this.Wn.timestamp=Date.now(),void(i.detail&&i.detail.elementId&&(this.Wn.elementId=i.detail.elementId))}const e=i.detail?JSON.stringify(i.detail):'{}';l('EDITOR',`[CARD INDEX ${t}] INTERCEPTED "${i.type}" event from hui-dialog-edit-card OR ITS CONTENT`,{detail:JSON.parse(e),target:i.target.localName}),i.stopPropagation(),i.stopImmediatePropagation&&i.stopImmediatePropagation(),i.cancelable&&i.preventDefault(),l('EDITOR',`[CARD INDEX ${t}] Re-firing "${i.type}" event from SimpleSwipeCardEditor.`),At(this.editor,i.type,i.detail)}}var Gt='M20.11,3.89L22,2V7H17L19.08,4.92C18.55,4.23 17.64,3.66 16.36,3.19C15.08,2.72 13.63,2.5 12,2.5C10.38,2.5 8.92,2.72 7.64,3.19C6.36,3.66 5.45,4.23 4.92,4.92L7,7H2V2L3.89,3.89C4.64,3 5.74,2.31 7.2,1.78C8.65,1.25 10.25,1 12,1C13.75,1 15.35,1.25 16.8,1.78C18.26,2.31 19.36,3 20.11,3.89M19.73,16.27V16.45L19,21.7C18.92,22.08 18.76,22.39 18.5,22.64C18.23,22.89 17.91,23 17.53,23H10.73C10.36,23 10,22.86 9.7,22.55L4.73,17.63L5.53,16.83C5.75,16.61 6,16.5 6.33,16.5H6.56L10,17.25V6.5C10,6.11 10.13,5.76 10.43,5.46C10.73,5.16 11.08,5 11.5,5C11.89,5 12.24,5.16 12.54,5.46C12.84,5.76 13,6.11 13,6.5V12.5H13.78C13.88,12.5 14.05,12.55 14.3,12.61L18.84,14.86C19.44,15.14 19.73,15.61 19.73,16.27Z';function Jt({value:t,dataOption:i,options:e,valueChanged:s,disabled:n=!1}){return customElements.get('ha-dropdown-item')?Z`
      <ha-select
        .value=${t??''}
        data-option=${i}
        .options=${e}
  ...
  `}function qt({label:t,value:i,dataOption:e,type:s='text',min:n,max:o,step:a,suffix:r,required:d=!1,disabled:l=!1,pattern:h,autoValidate:c=!1,changeHandler:u,inputHandler:p,keydownHandler:f}){const g=!!customElements.get('ha-input'),m=!g&&!!customElements.get('ha-textfield');return g?Z`
      <ha-input
        label=${t}
        .value=${i??''}
        data-option=${vt(e)}
  ...
  `}class SimpleSwipeCardEditor extends gt{static get properties(){return{hass:{type:Object},ii:{type:Object,state:!0},lovelace:{type:Object}}}static get styles(){return Mt()}constructor(){super(),l('EDITOR','SimpleSwipeCardEditor Constructor invoked.'),l('EDITOR','Editor styles method available:',!!this.constructor.styles),this.uiManager=new Bt(this),this.configManager=new Wt(this),this.cardManagement=new Yt(this),this.eventHandling=new jt(this),this.uiManager.initializeEditor()}eo(t){return this.eventHandling.eo(t)}co(t){return this.eventHandling.co(t)}wo(t){return this.cardManagement.isPictureElementsCard(t)}bo(t){return this.cardManagement.hasVisibilityConditions(t)}Io(t){this.uiManager.toggleSection(t)}yo(t){return this.cardManagement.hasNestedCards(t)}Eo(t){return this.cardManagement.getNestedCards(t)}So(t,i,e){this.cardManagement.moveNestedCard(t,i,e)}xo(t,i){this.cardManagement.removeNestedCard(t,i)}async To(t,i){await this.cardManagement.editNestedCard(t,i)}async Co(t){await this.cardManagement.editCard(t)}$o(t){this.cardManagement.handleCardPicked(t)}Mo(t){return this.cardManagement.getCardDescriptor(t)}Ao(t,i){this.cardManagement.moveCard(t,i)}Oo(t){this.cardManagement.removeCard(t)}ro(t){this.cardManagement.safelyAddCard(t)}_o(){this.uiManager.ensureCardPickerLoaded()}setConfig(t){this.configManager||(l('EDITOR','Reinitializing managers in setConfig'),this.uiManager=new Bt(this),this.configManager=new Wt(this),this.cardManagement=new Yt(this),this.eventHandling=new jt(this),this.uiManager.initializeEditor()),this.configManager.setConfig(t)}No(t){this.configManager.handleValueChanged(t)}ko(t={}){this.configManager.fireConfigChanged(t)}render(){if(!this.hass||!this.ii)return Z`<ha-spinner aria-label="Loading editor"></ha-spinner>`;if(!this.uiManager||!this.configManager||!this.cardManagement)return Z`<ha-spinner aria-label="Loading editor"></ha-spinner>`;const i=this.ii.cards||[];try{return Z`
  ...
  `}(this.ii,this.No.bind(this))}
          ${function(t,i,e,s,n,o,a,r){const d=t.loop_mode||'none',l=!0===t.enable_auto_swipe,h=t.auto_swipe_interval??2e3,c=!0===t.enable_reset_after,u=t.reset_after_timeout??3e4,p=t.reset_target_card??1,f=t.state_entity||'',g=!0===t.enable_backdrop_filter;let m=0,v=0;'none'!==d&&m++,l&&m++,c&&!l&&m++,c&&l&&v++,f&&m++,g&&m++;let w='',b='';return m>0&&(w=`${m} active`),v>0&&(b=`${v} blocked`),Z`
  ...
  `}(this.ii,this.uiManager.getCollapsibleState(),this.No.bind(this),this.Io.bind(this),i,this.Ro.bind(this),this.Do.bind(this),this.hass)}
    ...
    <div class="section cards-section">
      ...
      <div class="card-list">
        ${0===t.length?Z`<div class="no-cards">
              ...
              card.
            </div>`:t.map((u,p)=>function(t,i,e,s,n,o,a,r,d,l,h,c,u,p){const f=r(t),g=d(t),m=g?l(t):[],v=h(t),w=!s||It(t.visibility,s);return Z`
    <div
    ...
    ${g?function(t,i,e,s,n,o){return Z`
  ...
  `}(i,this.hass,this.Ao.bind(this),this.Co.bind(this),this.Oo.bind(this),this.Mo.bind(this),this.yo.bind(this),this.Eo.bind(this),this.bo.bind(this),this.So.bind(this),this.To.bind(this),this.xo.bind(this))}
          ${e=this.hass,s=this.lovelace,n=this.Hn,Z`
